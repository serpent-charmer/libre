...
public class RenderMeteor extends Render {
    private static final ResourceLocation texture
        = new ResourceLocation("meteorcraft", "textures/entity/meteor.png");

    public void renderEntity(
        EntityMeteor er, double par2, double par4, double par6, float par8, float par9
    ) {
        GL11.glPushMatrix();
        ...
        float size = 6;
        //ReikaTextureHelper.bindTexture(MeteorCraft.class,
        //"/Reika/MeteorCraft/Textures/meteor.png");
