...
public class RenderTrail extends Render {
    private static final ResourceLocation texture
        = new ResourceLocation("meteorcraft", "textures/entity/smoke.png");

    public void renderEntity(
        EntityTrail er, double par2, double par4, double par6, float par8, float par9
    ) {
        ...
        //ReikaTextureHelper.bindFinalTexture(MeteorCraft.class,
        //"/Reika/MeteorCraft/Textures/smoke.png");
        ...
        //GL11.glColor4f(1-er.ticksExisted/(float)er.LIFE,
        //1-er.ticksExisted/(float)er.LIFE, 1-er.ticksExisted/(float)er.LIFE, 1);
    ...
    public void doRender(
        Entity entity, double par2, double par4, double par6, float par8, float par10
    ) {
