...
public class CustomOreLoader {
    ...
    public static class CustomOreEntry {
        ...
        public String toString() {
            return displayName + " with weight " + baseWeight + "; " + oreItems.size()
                + " ores found";
        }
    }
    ...
    public void loadFile() {
        ...
        if (f.exists()) {
            ...
            bk.setComment(
                types.name,
                "Which meteor types this ore can spawn in. This example lists all four options."
            );
            ...
            Object[] defaults
                = new Object[] { "minecraft:wood_planks", 1F,    "ore:oreCopper", 2.5F,
                                 "ore:blockSteel",        0.125F };
            for (int i = 0; i < defaults.length; i += 2) {
                ...
                if (i == 0)
                    item.setComment(
                        "item",
                        "The item type, either a namespaced item registry name, or an OreDictionary tag, prefaced with 'ore:'."
                    );
            }
    ...
    private CustomOreEntry parseOreEntry(String type, LuaBlock b)
    ...
    private boolean createOreFile(File f, LuaBlock example) {
        ...
        this.writeCommentLine(
            p, "Use this file to add custom ores to meteor generation."
        );
        this.writeCommentLine(
            p,
