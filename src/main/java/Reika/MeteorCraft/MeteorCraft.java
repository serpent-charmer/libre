...
public class MeteorCraft extends DragonAPIMod {
    ...
    public static final MeteorConfig config
        = new MeteorConfig(instance, MeteorOptions.optionList, null);

    public static ModLogger logger;

    public static Block meteorMachines;

    public static final CustomStringDamageSource meteorDamage
        = (CustomStringDamageSource) new CustomStringDamageSource("was hit by a meteor")
              .setDamageBypassesArmor();

    @SidedProxy(
        clientSide = "Reika.MeteorCraft.MeteorClient",
        serverSide = "Reika.MeteorCraft.MeteorCommon"
    )
    ...
    public void preload(FMLPreInitializationEvent evt) {
        ...
        GameRegistry.registerBlock(
            meteorMachines, ItemBlockMeteorMachine.class, "Meteor Machines"
        );
        this.basicSetup(evt);
        this.finishTiming();
    }
    ...
    public void load(FMLInitializationEvent event) {
        ...
        EntityRegistry.instance().registerModEntity(
            EntityMeteor.class,
            "ReikaMeteor",
        ...
        if (ModList.ROTARYCRAFT.isLoaded()) {
            ...
            WorktableRecipes.getInstance().addRecipe(
                new ItemStack(meteorMachines, 1, 3),
                RecipeLevel.PROTECTED,
                "SsS",
                "PLP",
                "ScS",
            ...
            WorktableRecipes.getInstance().addRecipe(
                new ItemStack(meteorMachines, 1, 4),
                RecipeLevel.PROTECTED,
                "SlS",
                "PgP",
                "SrS",
