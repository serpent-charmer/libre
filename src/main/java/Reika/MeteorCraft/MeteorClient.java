...
public class MeteorClient extends MeteorCommon {
    ...
    public void addRenders() {
        RenderingRegistry.registerEntityRenderingHandler(
            EntityMeteor.class, new RenderMeteor()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityTrail.class, new RenderTrail()
        );
    }
    ...
    public void addSounds() {
        ...
        //SoundCategory.MASTER); CustomSoundHandler.instance.addSound("meteorcraft",
        //"flyby", SoundCategory.MASTER);
        //CustomSoundHandler.instance.addSound("meteorcraft", "entry",
        //SoundCategory.MASTER); CustomSoundHandler.instance.addSound("meteorcraft",
        //"boom", SoundCategory.MASTER);
