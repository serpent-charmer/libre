...
public class ItemCritterEgg extends ItemMonsterPlacer {
    ...
    public boolean onItemUse(
        ...
        boolean flag
            = this.superonItemUse(is, ep, world, x, y, z, side, par8, par9, par10);
        if (entity != null) {
            entity.setOwner(ep);
            entity = null;
        }
    ...
    private boolean superonItemUse(
        ItemStack is,
        EntityPlayer ep,
        World world,
        int x,
        ...
        if (!world.isRemote) {
            ...
            Entity entity
                = spawnCreature(world, is.getItemDamage(), x + 0.5D, y + d0, z + 0.5D);
                ...
                if (movingobjectposition.typeOfHit == MovingObjectType.BLOCK) {
                    ...
                    if (ReikaWorldHelper.getMaterial(world, i, j, k) == Material.water) {
                        ...
                        if (entity != null) {
                            if (entity instanceof EntityLivingBase && is.hasDisplayName())
                                ((EntityLiving) entity)
                                    .setCustomNameTag(is.getDisplayName());
    ...
    spawnCreature(World world, int ordinal, double x, double y, double z) {
