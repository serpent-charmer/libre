...
public abstract class EntitySlimeBase
    extends EntitySlime implements TamedMob, TameHostile {
    ...
    protected final void updateRider() {
        ...
        if (riddenByEntity instanceof EntityLivingBase) {
            ...
            if (this.followLook())
                ...
                if (KeyWatcher.instance.isKeyDown(
                        (EntityPlayer) riddenByEntity, Key.LEFT
                    )) {
                    rotationYaw -= 5;
                } else if (KeyWatcher.instance.isKeyDown(
                               (EntityPlayer) riddenByEntity, Key.RIGHT
                           )) {
                    rotationYaw += 5;
                } else if (KeyWatcher.instance.isKeyDown(
                               (EntityPlayer) riddenByEntity, Key.FORWARD
                           )) {
    ...
    protected final boolean isNonOwnerPlayer(Entity e) {
        return e instanceof EntityPlayer
            && !e.getCommandSenderName().equals(this.getMobOwner());
    }
    ...
    protected void updateLeashedState() {
        ...
        if (this.getLeashed() && this.getLeashedToEntity() != null
            && this.getLeashedToEntity().worldObj == worldObj) {
