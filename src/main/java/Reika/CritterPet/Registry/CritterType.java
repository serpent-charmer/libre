...
public enum CritterType {
    ...
    WISP(
        "Wisp",
        "Reika.CritterPet.Entities.Mod.TameWisp",
        TameWispDummy.class,
        CritterClass.FLYING,
        ModList.THAUMCRAFT,
        22,
    ...
    SPITTER(
        "Spitter",
        "Reika.CritterPet.Entities.Mod.TameSpitter",
        EntityWolf.class,
        CritterClass.WOLF,
    ...
    private CritterType(
        ...
        try {
            entityClass
                = c != null && (mod == null || mod.isLoaded()) ? Class.forName(c) : cb;
        } catch (ClassNotFoundException e) {
            throw new RegistrationException(
                CritterPet.instance,
                "Could not find entity class for " + this.name() + "!",
                e
            );
        }
        sourceMod = mod;
    ...
    public void initializeMapping(int id) {
        if (mappings.containsKey(this)) {
            ...
            CritterPet.logger.logError(
                "Attempted to reregister " + this + " with ID " + id
                + ", when it was already registered to " + old
            );
        }
        ...
        try {
            ...
            ((Entity) es)
                .setLocationAndAngles(
                    e.posX, e.posY, e.posZ, e.rotationYaw, e.rotationPitch
                );
            ((EntityLivingBase) es).rotationYawHead
                = ((EntityLivingBase) e).rotationYawHead;
            ...
            switch (this) {
                case SLIMEBEETLE:
                    Class c1 = Class.forName(
                        "twilightforest.client.renderer.entity.RenderTFSlimeBeetle"
                    );
                    Class c2
                        = Class.forName("twilightforest.client.model.ModelTFSlimeBeetle");
                ...
                case FIREBEETLE:
                    Class c3 = Class.forName(
                        "twilightforest.client.renderer.entity.RenderTFGenericLiving"
                    );
                    Class c4
                        = Class.forName("twilightforest.client.model.ModelTFFireBeetle");
                    Constructor cb
                        = c3.getConstructor(ModelBase.class, float.class, String.class);
                    return (Render
                    ) cb.newInstance(c4.newInstance(), 0.625F, "firebeetle.png");
                case MAZESLIME:
                    Class c5 = Class.forName(
                        "twilightforest.client.renderer.entity.RenderTFMazeSlime"
                    );
                    Constructor cc = c5.getConstructor(
                        ModelBase.class, ModelBase.class, float.class
                    );
                    return (Render
                    ) cc.newInstance(new ModelSlime(16), new ModelSlime(0), 0.625F);
                case WISP:
                    Class c7
                        = Class.forName("thaumcraft.client.renderers.entity.RenderWisp");
                    return (Render) c7.newInstance();
                case MISTWOLF:
                    Class c6 = Class.forName(
                        "twilightforest.client.renderer.entity.RenderTFMistWolf"
                    );
                    Constructor cd = c6.getConstructor(
                        ModelBase.class, ModelBase.class, float.class
                    );
                    return (Render
                    ) cd.newInstance(new ModelWolf(), new ModelWolf(), 0.625F);
                case SILVERFISH:
                ...
                case MINIGHAST:
                    Class c8 = Class.forName(
                        "twilightforest.client.renderer.entity.RenderTFMiniGhast"
                    );
                ...
                case ICECORE:
                    Class c10 = Class.forName(
                        "twilightforest.client.renderer.entity.RenderTFIceShooter"
                    );
                    return (Render) c10.newInstance();
                case LUMAFLY:
                    Class c11 = Class.forName(
                        "Reika.ChromatiCraft.Render.Entity.RenderTunnelNuker"
                    );
                    return (Render) c11.newInstance();
                case SPITTER:
                    Class c12
                        = Class.forName("Reika.CritterPet.Renders.RenderTameSpitter");
    ...
    public boolean isValid(Entity e) {
        ...
        switch (this) {
            case VANILLA:
                return c == EntitySpider.class
                    || n.equalsIgnoreCase("EntityLegacySpider");
            case FIREBEETLE:
