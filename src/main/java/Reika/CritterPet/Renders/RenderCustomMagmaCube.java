...
public class RenderCustomMagmaCube extends RenderLiving {
    ...
    /**
     * Returns the location of an entity's texture. Doesn't seem to be called unless you
     * call Render.bindEntityTexture.
     */
    ...
    /**
     * Allows the render to do any OpenGL state modifications necessary before the model
     * is rendered. Args: entityLiving, partialTickTime
     */
    protected void preRenderCallback(EntitySlimeBase p_77041_1_, float p_77041_2_) {
        int i = p_77041_1_.getSlimeSize();
        float f1
            = (p_77041_1_.prevSquishFactor
               + (p_77041_1_.squishFactor - p_77041_1_.prevSquishFactor) * p_77041_2_)
            / (i * 0.5F + 1.0F);
