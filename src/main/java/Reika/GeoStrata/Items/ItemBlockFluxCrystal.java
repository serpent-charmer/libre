...
public class ItemBlockFluxCrystal extends ItemBlock {
    ...
    public boolean placeBlockAt(
        ...
        boolean ret = super.placeBlockAt(
            ...
            if (te instanceof TileRFCrystal) {
                if (!GeoOptions.RFACTIVATE.getState()
                    || (stack.stackTagCompound != null
                        && stack.stackTagCompound.getBoolean("activated")))
    ...
    public String getItemStackDisplayName(ItemStack is) {
        return GeoBlocks.RFCRYSTALSEED.hasMultiValuedName()
            ? GeoBlocks.RFCRYSTALSEED.getMultiValuedName(is.getItemDamage())
            : GeoBlocks.RFCRYSTALSEED.getBasicName();
    }
    ...
    public void addInformation(ItemStack is, EntityPlayer ep, List li, boolean vb) {
        if (GeoOptions.RFACTIVATE.getState()) {
            if (is.stackTagCompound != null
                && is.stackTagCompound.getBoolean("activated")) {
                li.add("Activated");
            } else {
