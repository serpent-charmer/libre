...
/**
 * Use this to create custom rock generation "patterns". Note that multiple may be run
 * sequentially.
 */
public class RockGenerationPatterns {
    ...
    public static interface RockGenerationPattern {
        /**
         * Called once per chunk per rock type to generate the rock. X and Z are the
         * block coordinates of the Northwest (negative XZ) corner.
         */
        public void generateRockType(
            RockTypes geo, World world, Random random, int chunkX, int chunkZ
        );
