    ...
    public boolean renderWorldBlock(
        ...
        if (renderPass == 0) {
            rb.renderStandardBlockWithAmbientOcclusion(
                b, x, y, z, rgb[0] / 255F, rgb[1] / 255F, rgb[2] / 255F
            );
            /*
            for (int i = 0; i < 6; i++) {
                ...
                this.faceBrightnessColor(dirs[i].getOpposite(), v5, c.getRed()/255F,
            c.getGreen()/255F, c.getBlue()/255F); switch(i) { case 0:
    ...
    private void renderOverlay(
        ...
        if (b.shouldSideBeRendered(world, x, y + 1, z, ForgeDirection.UP.ordinal())) {
            ArrayList<Integer> li
                = b.getEdgesForFace(world, x, y, z, ForgeDirection.UP, type);
        ...
        if (b.shouldSideBeRendered(world, x, y - 1, z, ForgeDirection.DOWN.ordinal())) {
            ArrayList<Integer> li
                = b.getEdgesForFace(world, x, y, z, ForgeDirection.DOWN, type);
        ...
        if (b.shouldSideBeRendered(world, x + 1, y, z, ForgeDirection.EAST.ordinal())) {
            ArrayList<Integer> li
                = b.getEdgesForFace(world, x, y, z, ForgeDirection.EAST, type);
        ...
        if (b.shouldSideBeRendered(world, x - 1, y, z, ForgeDirection.WEST.ordinal())) {
            ArrayList<Integer> li
                = b.getEdgesForFace(world, x, y, z, ForgeDirection.WEST, type);
        ...
        if (b.shouldSideBeRendered(world, x, y, z + 1, ForgeDirection.SOUTH.ordinal())) {
            ArrayList<Integer> li
                = b.getEdgesForFace(world, x, y, z, ForgeDirection.SOUTH, type);
        ...
        if (b.shouldSideBeRendered(world, x, y, z - 1, ForgeDirection.NORTH.ordinal())) {
            ArrayList<Integer> li
                = b.getEdgesForFace(world, x, y, z, ForgeDirection.NORTH, type);
