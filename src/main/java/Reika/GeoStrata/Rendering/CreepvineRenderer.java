...
public class CreepvineRenderer extends ISBRH {
    ...
    public boolean renderWorldBlock(
        ...
        float dy0
            = (float) ReikaRandomHelper.getRandomPlusMinus(0.125, 0.0625, renderRandNoY);
        ...
        ReikaRenderHelper.renderCropTypeTex(
            world, x, y, z, ico, Tessellator.instance, rb, w, 1, r
        );
        ...
        if (seeds > 0) {
            ...
            for (int i = 0; i < seeds; i++) {
                ReikaRenderHelper.renderCropTypeTex(
                    ...
                    rb,
                    ReikaRandomHelper.getRandomPlusMinus(0, 0.03125, renderRand),
                    1
                );
            }
        }
