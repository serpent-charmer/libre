    ...
    public static void addRecipes() {
        for (int i = 0; i < RockTypes.rockList.length; i++) {
            ...
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(brick, 4),
                new Object[] { "SS", "SS", 'S', smooth }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(round, 4),
                new Object[] { "SS", "SS", 'S', brick }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(fitted, 2),
                new Object[] { "SS", 'S', brick }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(tile, 4),
                new Object[] { " S ", "S S", " S ", 'S', smooth }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(inscribed, 3),
                new Object[] { "B", "S", "B", 'S', smooth, 'B', brick }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(engraved, 4),
                new Object[] { "SB", "BS", 'S', smooth, 'B', brick }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(engraved, 4),
                new Object[] { "BS", "SB", 'S', smooth, 'B', brick }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(connected, 8),
                new Object[] { "SSS", "S S", "SSS", 'S', smooth }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(connected2, 8),
                new Object[] { "SSS", "S S", "SSS", 'S', connected }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(etched, 3),
                new Object[] { "SSS", 'S', inscribed }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(cubed, 9),
                new Object[] { "SSS", "SSS", "SSS", 'S', smooth }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(centered, 5),
                new Object[] { " S ", "SRS", " S ", 'S', smooth, 'R', round }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(lined, 5),
                new Object[] { " S ", "SES", " S ", 'S', smooth, 'E', engraved }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(embossed, 3),
                new Object[] { "S", "T", "S", 'S', smooth, 'T', tile }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(raised, 4),
                new Object[] { "SS", "SS", 'S', tile }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(fan, 8),
                new Object[] { "AAB", "B B", "BAA", 'A', smooth, 'B', brick }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(spiral, 8),
                new Object[] { "ABA", "B B", "ABA", 'A', smooth, 'B', brick }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(moss, 2),
                new Object[] { "AB", "BA", 'A', smooth, 'B', Blocks.vine }
            );
            GameRegistry.addRecipe(
                ReikaItemHelper.getSizedItemStack(pillar, 3),
                new Object[] { "S", "S", "S", 'S', smooth }
            );
            ...
            for (int k = 0; k < RockShapes.shapeList.length; k++) {
                ...
                ItemStack stair
                    = ReikaItemHelper.getSizedItemStack(type.getStair(shape), 4);
                ItemStack slab
                    = ReikaItemHelper.getSizedItemStack(type.getSlab(shape), 6);
        ...
        for (int i = 0; i < DecoBlocks.list.length; i++) {
            ...
            if (GeoOptions.BOXRECIPES.getState())
                block.addSizedCrafting(
                    8 * block.recipeMultiplier, "BBB", "B B", "BBB", 'B', block.material
                );
            else
                block.addSizedCrafting(
                    4 * block.recipeMultiplier, "BB", "BB", 'B', block.material
                );
        }
        ...
        GameRegistry.addRecipe(new ShapedOreRecipe(
            new ItemStack(GeoBlocks.PARTIAL.getBlockInstance(), 24, 0),
            "BSB",
            "SPS",
            "gSg",
            'P',
