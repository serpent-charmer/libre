...
public class LavaRockGenerator implements RetroactiveGenerator {
    ...
    private static final int BASE_CHANCE
        = Math.max(1, (int) (1F / GeoOptions.getLavaRockDensity()));
    private static final int COUNT_CHANCE
        = Math.max(1, (int) (2F / GeoOptions.getLavaRockDensity()));
