...
public class BlockRFCrystal
    extends Block implements IWailaDataProvider, IMoveCheck, ILaputaImmobile {
    ...
    shouldSideBeRendered(IBlockAccess world, int x, int y, int z, int side) {
        return super.shouldSideBeRendered(world, x, y, z, side)
            && !(world.getBlock(x, y, z) instanceof BlockRFCrystal);
    }
    ...
    public static class TileRFCrystalAux extends TileEntity implements IEnergyHandler {
        ...
        private TileRFCrystal getParent() {
            ...
            return te instanceof TileRFCrystal ? (TileRFCrystal) te
                                               : new TileRFCrystal(); //npe protection
        }
