...
public enum DecoBlocks {
    ...
    QUARTZBRICKS(
        "Nether Quartz Bricks", 1.2F, 5F, 2, ToolMaterial.IRON, Blocks.quartz_block
    ),
    ...
    private DecoBlocks(
        String n, float hard, float blast, int recipe, ToolMaterial tool, Block b
    ) {
        name = n;
        mat = tool;
    ...
    public void addSizedCrafting(int num, Object... data) {
        GameRegistry.addRecipe(
            ReikaItemHelper.getSizedItemStack(this.getItem(), num), data
        );
    }
