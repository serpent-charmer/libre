...
public enum GeoBlocks implements BlockEnum {
    ...
    RFCRYSTALSEED(
        BlockRFCrystalSeed.class, ItemBlockFluxCrystal.class, "Flux Crystal Seed"
    ),
    ...
    private GeoBlocks(
        Class<? extends Block> cl, Class<? extends ItemBlock> ib, String n, String s
    ) {
        blockClass = cl;
        blockName = n;
        itemBlock = ib;
...
return "";//((BlockShapedRock)this.getBlockInstance()).getDisplayName()+"
"+RockTypes.getTypeFromID(this.getBlockInstance(), meta).getName();
}*/
        switch (this) {
            //case SMOOTH:
            //case SMOOTH2:
            ...
            case DECO:
                ...
                //case CONNECTED:
                //case CONNECTED2:
                //	return "Connected "+RockTypes.getTypeFromID(this.getBlockInstance(),
                //meta).getName();
            case DECOGEN:
