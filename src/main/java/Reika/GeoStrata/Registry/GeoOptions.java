...
public enum GeoOptions implements BooleanConfig, IntegerConfig, DecimalConfig,
    ...
    RFACTIVATE(
        "Flux Crystal Requires Activation", false
    ), //Whether a flux crystal requires activation to be used. What activation entails
       //depends on the pack, and how the modified item is produced.
