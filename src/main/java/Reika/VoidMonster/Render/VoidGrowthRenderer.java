...
public class VoidGrowthRenderer {
    ...
    private void render(WorldLocation c, int value, Tessellator v5) {
        ...
        if (this.render(c, ForgeDirection.UP)) {
            ...
            v5.addVertexWithUV(
                c.xCoord + 1 + o, c.yCoord + 1 + o, c.zCoord + 1 + o, du, v
            );
        ...
        if (this.render(c, ForgeDirection.EAST)) {
            ...
            v5.addVertexWithUV(
                c.xCoord + 1 + o, c.yCoord + 1 + o, c.zCoord + 1 + o, du, dv
            );
    ...
    private boolean render(WorldLocation c, ForgeDirection dir) {
        return c.getBlock().shouldSideBeRendered(
            c.getWorld(),
            c.xCoord + dir.offsetX,
            c.yCoord + dir.offsetY,
            c.zCoord + dir.offsetZ,
            dir.ordinal()
        );
    }
}
