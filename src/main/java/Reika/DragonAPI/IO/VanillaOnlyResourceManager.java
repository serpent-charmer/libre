...
@Deprecated
public class VanillaOnlyResourceManager
    implements IResourceManager, IResourceManagerReloadListener {
    private static final VanillaOnlyResourceManager instance
        = new VanillaOnlyResourceManager();
    ...
    public IResource getResource(ResourceLocation loc) throws IOException {
        ...
        if (iresourcepack1.resourceExists(loc)) {
            ...
            try {
                ...
                IMetadataSerializer frmMetadataSerializer
                    = (IMetadataSerializer) f.get(Minecraft.getMinecraft());
                return new SimpleResource(
                    loc,
                    iresourcepack1.getInputStream(loc),
                    inputstream,
    ...
    static ResourceLocation getLocationMcmeta(ResourceLocation p_110537_0_) {
        return new ResourceLocation(
            p_110537_0_.getResourceDomain(), p_110537_0_.getResourcePath() + ".mcmeta"
        );
    }
