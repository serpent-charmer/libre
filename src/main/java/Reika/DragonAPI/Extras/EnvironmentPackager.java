...
public class EnvironmentPackager {
    ...
    private File getFile() {
        return new File(
            new File(DragonAPICore.getMinecraftDirectory(), "DragonAPI"), "gameenv.export"
        );
    }
    ...
    public File export() {
        try {
            ...
            sec.add(
                "Server Mode: "
                + (DragonAPICore.isSinglePlayerFromClient() ? "Singleplayer" : "Server")
            );
            ...
            sec.addAll(ReikaFileReader.getFileAsLines(
                this.getSettingsFile(), true, Charsets.UTF_8
            ));
            data.add(sec);
            ...
            /*
            data.add("OS: "+System.getProperty("os.name")+" -
            "+System.getProperty("os.version")); data.add("CPUs:
            "+Runtime.getRuntime().availableProcessors()); data.add("CPU Model:
            "+System.getProperty("os.arch")); data.add("Java Version:
