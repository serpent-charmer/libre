...
public class APIStripper implements IClassTransformer {
     ...
     * When using this annotation on methods, ensure you do not switch on an enum inside
     * that method. JavaC implementation details means this will cause crashes.
     */
    @Documented
