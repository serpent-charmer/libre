...
public class CursorStackRender extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m
            = ReikaASMHelper.getMethodByName(cn, "func_73863_a", "drawScreen", "(IIF)V");
        ...
        min.desc
            = "(Lnet/minecraft/client/gui/inventory/GuiContainer;Lnet/minecraft/item/ItemStack;IILjava/lang/String;"
            + ri + fr + is + ")V";
        ...
        li.add(new FieldInsnNode(
            Opcodes.GETSTATIC,
            ref,
            FMLForgePlugin.RUNTIME_DEOBF ? "field_146296_j" : "itemRender",
            ri
        ));
        ...
        li.add(new FieldInsnNode(
            Opcodes.GETFIELD,
            ref,
            FMLForgePlugin.RUNTIME_DEOBF ? "field_146289_q" : "fontRendererObj",
            fr
        ));
        li.add(new VarInsnNode(Opcodes.ALOAD, 0));
        li.add(new FieldInsnNode(
            Opcodes.GETFIELD,
            ref,
            FMLForgePlugin.RUNTIME_DEOBF ? "field_147012_x" : "draggedStack",
            is
        ));
