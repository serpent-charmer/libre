...
public class StrongholdEyeRouting extends Patcher {
    public StrongholdEyeRouting() {
        super(
            "net.minecraft.world.gen.structure.StructureStrongholdPieces$Stairs2", "auz"
        );
    }
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn, "func_151553_a", "()Lnet/minecraft/world/ChunkPosition;"
        );
        ...
        m.instructions.add(new MethodInsnNode(
            ...
            "getStrongholdSeekPos",
            "(L" + cn.name.replaceAll("\\\\.", "/")
                + ";)Lnet/minecraft/world/ChunkPosition;",
            false
        ));
