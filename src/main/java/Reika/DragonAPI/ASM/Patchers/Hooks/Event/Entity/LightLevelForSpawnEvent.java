...
public class LightLevelForSpawnEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn, "func_70601_bi", "getCanSpawnHere", "()Z"
        );
        AbstractInsnNode ain
            = ReikaASMHelper.getFirstOpcode(m.instructions, Opcodes.INVOKEVIRTUAL);
        m.instructions.insert(
            ain,
            new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                "Reika/DragonAPI/Instantiable/Event/LightLevelForSpawnEvent",
                "fire",
                "(ZLnet/minecraft/entity/monster/EntityMob;)Z",
                false
            )
        );
        ...
        m = ReikaASMHelper.getMethodByName(
            cn, "func_70783_a", "getBlockPathWeight", "(III)F"
        );
        ...
        m.instructions.insert(
            ...
            new MethodInsnNode(
                ...
                "Reika/DragonAPI/Instantiable/Event/LightLevelForSpawnEvent",
                "firePathWeight",
                "(FLnet/minecraft/entity/monster/EntityMob;)F",
                false
            )
        );
        m.instructions.insert(ain, new VarInsnNode(Opcodes.ALOAD, 0));
