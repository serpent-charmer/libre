...
public class EntityAddPotionEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        ...
        JumpInsnNode skip
            = (JumpInsnNode) ReikaASMHelper.getFirstOpcode(m.instructions, Opcodes.IFEQ);
        ...
        li.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/ApplyPotionEvent",
            "fire",
            "(Lnet/minecraft/entity/EntityLivingBase;Lnet/minecraft/potion/PotionEffect;)Lnet/minecraft/potion/PotionEffect;",
            false
        ));
        ...
        m.instructions.insertBefore(
            ReikaASMHelper.getFirstInsnAfter(m.instructions, 0, Opcodes.ALOAD, 0), li
        );
    }
}
