...
public class EntitySpawnY extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn,
            "func_151350_a",
            "(Lnet/minecraft/world/World;II)Lnet/minecraft/world/ChunkPosition;"
        );
        VarInsnNode vin
            = (VarInsnNode) ReikaASMHelper.getLastOpcode(m.instructions, Opcodes.ISTORE);
        ...
        li.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/GetYToSpawnMobEvent",
            "fire",
