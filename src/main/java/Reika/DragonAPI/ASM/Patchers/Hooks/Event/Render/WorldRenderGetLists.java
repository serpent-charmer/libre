...
public class WorldRenderGetLists extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn, "func_78909_a", "getGLCallListForPass", "(I)I"
        );
        ...
        //li.add(new VarInsnNode(Opcodes.ALOAD, 0));
        //li.add(new VarInsnNode(Opcodes.GETFIELD, ReikaASMHelper.convertClassName(cn,
        //false)));
        li.add(new MethodInsnNode(
            Opcodes.INVOKESTATIC,
            "Reika/DragonAPI/Instantiable/Event/Client/ChunkWorldRenderEvent",
            "fire",
            "(ILnet/minecraft/client/renderer/WorldRenderer;I)I",
            false
        ));
        AbstractInsnNode loc
            = ReikaASMHelper.getLastOpcode(m.instructions, Opcodes.IRETURN);
