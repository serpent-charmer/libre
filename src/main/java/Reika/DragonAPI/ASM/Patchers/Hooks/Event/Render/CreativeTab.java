...
public class CreativeTab extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        ...
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn, "func_146976_a", "drawGuiContainerBackgroundLayer", "(FII)V"
        );
        String func
            = FMLForgePlugin.RUNTIME_DEOBF ? "func_73729_b" : "drawTexturedModalRect";
        ...
        min.itf = false;
        min.desc
            = "(Lnet/minecraft/client/gui/inventory/GuiContainerCreative;IIIIIILnet/minecraft/creativetab/CreativeTabs;Lnet/minecraft/client/gui/GuiTextField;I)V";
