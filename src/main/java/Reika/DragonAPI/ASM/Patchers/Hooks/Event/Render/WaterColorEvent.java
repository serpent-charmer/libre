...
public class WaterColorEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        ...
        try {
            ...
            try {
                m = ReikaASMHelper.getMethodByName(
                    cn, "colorMultiplierOld", "(Lnet/minecraft/world/IBlockAccess;III)I"
                );
        ...
        li.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/Client/WaterColorEvent",
            "fire",
            "(Lnet/minecraft/world/IBlockAccess;III)I",
            false
        ));
        ...
        AbstractInsnNode first
            = ReikaASMHelper.getFirstOpcode(m.instructions, Opcodes.ICONST_0);
