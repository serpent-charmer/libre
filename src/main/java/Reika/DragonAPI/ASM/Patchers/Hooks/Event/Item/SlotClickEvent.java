...
public class SlotClickEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        ...
        m.instructions.insertBefore(
            ...
            new TypeInsnNode(
                Opcodes.NEW,
                "Reika/DragonAPI/Instantiable/Event/SlotEvent$RemoveFromSlotEvent"
            )
        );
        ...
        m.instructions.insertBefore(
            ...
            new FieldInsnNode(
                Opcodes.GETFIELD,
                "net/minecraft/inventory/Slot",
                FMLForgePlugin.RUNTIME_DEOBF ? "field_75224_c" : "inventory",
        ...
        m.instructions.insertBefore(
            ...
            new MethodInsnNode(
                ...
                "Reika/DragonAPI/Instantiable/Event/SlotEvent$RemoveFromSlotEvent",
                "<init>",
                "(ILnet/minecraft/inventory/IInventory;Lnet/minecraft/item/ItemStack;Lnet/minecraft/entity/player/EntityPlayer;)V",
                false
            )
        );
        m.instructions.insertBefore(
        ...
        m = ReikaASMHelper.getMethodByName(
            cn, "func_75215_d", "putStack", "(Lnet/minecraft/item/ItemStack;)V"
        );
        ...
        m.instructions.insertBefore(
            ...
            new MethodInsnNode(
                ...
                "Reika/DragonAPI/Instantiable/Event/SlotEvent$AddToSlotEvent",
                "fire",
                "(Lnet/minecraft/inventory/Slot;Lnet/minecraft/item/ItemStack;)V",
                false
            )
        );
    }
