...
public class SplashPotionEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            ...
            "func_76402_a",
            "affectEntity",
            "(Lnet/minecraft/entity/EntityLivingBase;Lnet/minecraft/entity/EntityLivingBase;ID)V"
        );
        ...
        m.instructions.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/SplashPotionEvent",
            "fire",
            "(Lnet/minecraft/potion/Potion;Lnet/minecraft/entity/EntityLivingBase;Lnet/minecraft/entity/EntityLivingBase;ID)V",
            false
        ));
