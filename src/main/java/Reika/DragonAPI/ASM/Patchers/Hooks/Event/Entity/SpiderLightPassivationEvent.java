...
public class SpiderLightPassivationEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn, "func_70782_k", "findPlayerToAttack", "()Lnet/minecraft/entity/Entity;"
        );
        ...
        li.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/SpiderLightPassivationEvent",
            "fire",
            "(FLnet/minecraft/entity/monster/EntitySpider;F)F",
            false
        ));
