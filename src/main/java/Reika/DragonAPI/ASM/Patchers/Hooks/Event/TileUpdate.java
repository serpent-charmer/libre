...
public class TileUpdate extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m
            = ReikaASMHelper.getMethodByName(cn, "func_72939_s", "updateEntities", "()V");
        ...
        MethodInsnNode loc1 = ReikaASMHelper.getFirstMethodCall(
            cn, m, "net/minecraft/tileentity/TileEntity", name, "()Z"
        );
        MethodInsnNode loc2 = ReikaASMHelper.getFirstMethodCall(
            cn, m, "net/minecraft/world/World", name2, "(III)Z"
        );
        ...
        m.instructions.insertBefore(
            ...
            new MethodInsnNode(
                ...
                "Reika/DragonAPI/Instantiable/Event/TileUpdateEvent",
                "fire",
