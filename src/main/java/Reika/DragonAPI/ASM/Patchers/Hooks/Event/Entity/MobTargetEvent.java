...
public class MobTargetEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        ...
        m.instructions.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Libraries/World/ReikaWorldHelper",
            "getClosestVulnerablePlayer",
            "(Lnet/minecraft/world/World;DDDD)Lnet/minecraft/entity/player/EntityPlayer;",
            false
        ));
