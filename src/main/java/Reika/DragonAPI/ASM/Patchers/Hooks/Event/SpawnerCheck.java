...
public class SpawnerCheck extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m
            = ReikaASMHelper.getMethodByName(cn, "func_98278_g", "updateSpawner", "()V");
        ...
        MethodInsnNode min = ReikaASMHelper.getFirstMethodCall(
            cn, m, "net/minecraft/entity/EntityLiving", func, "()Z"
        );
        min.owner = "Reika/DragonAPI/Instantiable/Event/EntitySpawnerCheckEvent";
        min.name = "fire";
        min.desc
            = "(Lnet/minecraft/entity/EntityLiving;Lnet/minecraft/tileentity/MobSpawnerBaseLogic;)Z";
