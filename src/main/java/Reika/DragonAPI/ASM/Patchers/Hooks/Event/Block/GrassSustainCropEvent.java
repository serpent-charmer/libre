...
public class GrassSustainCropEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        ...
        //if
        //(/*ModList.AGRICRAFT.isLoaded()*/ReikaASMHelper.checkForClass("com/InfinityRaider/AgriCraft/api/v1/ISoilContainer"))
        //{ //too early for fml ref
        ReikaASMHelper.log("Adding AgriCraft module for " + this);
        cn.interfaces.add("com/InfinityRaider/AgriCraft/api/v1/ISoilContainer"
        ); //have to ship
        ...
        //li.add(new FieldInsnNode(Opcodes.GETSTATIC, "net/minecraft/init/Blocks",
        //"farmland", "Lnet/minecraft/block/Block;"));
        ...
        li.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/GrassSustainCropEvent",
            name2,
            sig2,
            false
        ));
    ...
    private void injectMethod(
        ClassNode cn, String name, String name2, String sig, String sig2, int varCount
    ) {
        InsnList li = new InsnList();
        /*
        li.add(new VarInsnNode(Opcodes.ALOAD, 1));
         ...
         */
        li.add(new MethodInsnNode(
            Opcodes.INVOKESPECIAL, "net/minecraft/block/Block", name, sig, false
        ));
