...
public class GrassTopIcon extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        ...
        AbstractInsnNode ain
            = ReikaASMHelper.getFirstOpcode(m.instructions, Opcodes.ARETURN)
                  .getPrevious();
        ...
        li.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/Client/GrassIconEvent",
            "fire",
            "(Lnet/minecraft/util/IIcon;Lnet/minecraft/block/Block;Lnet/minecraft/world/IBlockAccess;III)Lnet/minecraft/util/IIcon;",
            false
        ));
