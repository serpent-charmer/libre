...
public class HeldRenderEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m
            = ReikaASMHelper.getMethodByName(cn, "func_78476_b", "renderHand", "(FI)V");
        for (int i = 0; i < m.instructions.size(); i++) {
            AbstractInsnNode ain = m.instructions.get(i);
            if (ain.getOpcode() == Opcodes.INVOKEVIRTUAL) {
                String func = FMLForgePlugin.RUNTIME_DEOBF ? "func_78440_a"
                ...
                if (min.name.equals(func)) {
                    ...
                    m.instructions.insert(
                        ...
                        new MethodInsnNode(
                            ...
                            "Reika/DragonAPI/Instantiable/Event/Client/RenderFirstPersonItemEvent",
                            "<init>",
                            "()V",
                            false
                        )
