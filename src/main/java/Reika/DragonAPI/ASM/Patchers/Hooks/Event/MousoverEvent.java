...
public class MousoverEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m
            = ReikaASMHelper.getMethodByName(cn, "func_78473_a", "getMouseOver", "(F)V");
        AbstractInsnNode ain
            = ReikaASMHelper.getNthOpcode(m.instructions, Opcodes.PUTFIELD, 2);
        m.instructions.insert(
            ain,
            new MethodInsnNode(
                Opcodes.INVOKESTATIC,
                "Reika/DragonAPI/Instantiable/Event/Client/GetMouseoverEvent",
                "fire",
                "(F)V",
                false
            )
