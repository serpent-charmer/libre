...
public class BlockTilledEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        ...
        MethodInsnNode ain = ReikaASMHelper.getFirstMethodCall(
            cn,
            m,
            "net/minecraft/world/World",
            FMLForgePlugin.RUNTIME_DEOBF ? "func_147449_b" : "setBlock",
        ...
        m.instructions.insert(
            ...
            new MethodInsnNode(
                ...
                "Reika/DragonAPI/Instantiable/Event/BlockTillEvent",
                "fire",
