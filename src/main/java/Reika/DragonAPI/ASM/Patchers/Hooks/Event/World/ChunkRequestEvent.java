...
public class ChunkRequestEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn, "func_73154_d", "provideChunk", "(II)Lnet/minecraft/world/chunk/Chunk;"
        );
        ...
        li.add(new FieldInsnNode(
            Opcodes.GETFIELD,
            cn.name,
            FMLForgePlugin.RUNTIME_DEOBF ? "field_73251_h" : "worldObj",
        ...
        li.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/ChunkRequestEvent",
            "fire",
            "(Lnet/minecraft/world/WorldServer;Lnet/minecraft/world/gen/ChunkProviderServer;II)V",
            false
        ));
