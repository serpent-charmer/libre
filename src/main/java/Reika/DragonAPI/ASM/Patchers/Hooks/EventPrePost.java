...
public class EventPrePost extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn, "post", "(Lcpw/mods/fml/common/eventhandler/Event;)Z"
        );
    ...
    private InsnList createCall(boolean pre) {
        ...
        String sig
            = "(Lcpw/mods/fml/common/eventhandler/Event;Lcpw/mods/fml/common/eventhandler/IEventListener;)V";
        li.add(new MethodInsnNode(
            Opcodes.INVOKESTATIC,
            "Reika/DragonAPI/Auxiliary/Trackers/EventProfiler",
            pre ? "firePre" : "firePost",
            sig,
            false
        ));
        return li;
