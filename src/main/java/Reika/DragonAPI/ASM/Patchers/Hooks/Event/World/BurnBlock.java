...
public class BurnBlock extends Patcher {
    ...
    private void
    redirectMethod(ClassNode cn, MethodNode m, String func, String sig, String call) {
    ...
    private void redirectSetBlock(ClassNode cn, MethodNode m) {
        this.redirectMethod(
            cn,
            m,
            FMLForgePlugin.RUNTIME_DEOBF ? "func_147465_d" : "setBlock",
    ...
    private void redirectSetBlockAir(ClassNode cn, MethodNode m) {
        this.redirectMethod(
            cn,
            m,
            FMLForgePlugin.RUNTIME_DEOBF ? "func_147468_f" : "setBlockToAir",
            "(III)Z",
            "fireFromSetBlockAir"
        );
    }
