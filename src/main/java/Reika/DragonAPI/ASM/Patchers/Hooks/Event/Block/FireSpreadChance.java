...
public class FireSpreadChance extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        ...
        m = ReikaASMHelper.getMethodByName(
            cn,
            "tryCatchFire",
            "(Lnet/minecraft/world/World;IIIILjava/util/Random;ILnet/minecraftforge/common/util/ForgeDirection;)V"
        );
        AbstractInsnNode ain = CoreModDetection.BUKKIT.isInstalled()
            ? ReikaASMHelper.getFirstOpcode(m.instructions, Opcodes.ISTORE)
            : ReikaASMHelper.getFirstInsnAfter(m.instructions, 0, Opcodes.ISTORE, 9);
        ...
        String sig
            = "(Lnet/minecraft/world/World;IIILnet/minecraftforge/common/util/ForgeDirection;I)I";
        li.add(new MethodInsnNode(
            Opcodes.INVOKESTATIC,
            "Reika/DragonAPI/Instantiable/Event/FireChanceEvent",
            "fire",
            sig,
            false
        ));
        ...
        //"Reika/DragonAPI/Instantiable/Event/FireChanceEvent", "pass2", "(I)I", false));
