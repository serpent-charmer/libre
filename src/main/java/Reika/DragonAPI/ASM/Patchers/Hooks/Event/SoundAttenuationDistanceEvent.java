...
public class SoundAttenuationDistanceEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn, "func_148611_c", "playSound", "(Lnet/minecraft/client/audio/ISound;)V"
        );
        ...
        MethodInsnNode min = ReikaASMHelper.getFirstMethodCall(
            ...
            FMLForgePlugin.RUNTIME_DEOBF ? "func_147653_e" : "getVolume",
            "()F"
        );
        LdcInsnNode ldc = (LdcInsnNode) ReikaASMHelper.getFirstInsnAfter(
            m.instructions, m.instructions.indexOf(min), Opcodes.LDC, 16F
        );
        InsnList li = new InsnList();
        li.add(new VarInsnNode(Opcodes.ALOAD, 1));
        li.add(new MethodInsnNode(
            Opcodes.INVOKESTATIC,
            "Reika/DragonAPI/Instantiable/Event/Client/SoundAttenuationDistanceEvent",
            "fire",
            "(FLnet/minecraft/client/audio/ISound;)F",
            false
        ));
