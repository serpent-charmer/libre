...
public class MusicEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m
            = ReikaASMHelper.getMethodByName(cn, "func_73660_a", "update", "()V");

        MethodInsnNode min = ReikaASMHelper.getFirstMethodCallByName(
            cn, m, FMLForgePlugin.RUNTIME_DEOBF ? "func_147682_a" : "playSound"
        );
        min.owner = "Reika/DragonAPI/Instantiable/Event/Client/PlayMusicEvent";
        min.name = "fire";
        min.desc
            = "(Lnet/minecraft/client/audio/SoundHandler;Lnet/minecraft/client/audio/ISound;Lnet/minecraft/client/audio/MusicTicker;)V";
