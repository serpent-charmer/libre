...
public class AttackAggroEvent1 extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        ...
        AbstractInsnNode loc = ReikaASMHelper.getNthOfOpcodes(
            m.instructions, 3, Opcodes.IF_ACMPEQ, Opcodes.IF_ACMPNE
        );
        ...
        li.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/AttackAggroEvent",
            "fire",
            "(Lnet/minecraft/entity/monster/EntityMob;Lnet/minecraft/util/DamageSource;F)Z",
            false
        ));
