...
public class SheepShearEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn,
            "onSheared",
            "(Lnet/minecraft/item/ItemStack;Lnet/minecraft/world/IBlockAccess;IIII)Ljava/util/ArrayList;"
        );
        ...
        m.instructions.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/SheepShearEvent",
            "fire",
            "(Lnet/minecraft/entity/passive/EntitySheep;Lnet/minecraft/item/ItemStack;I)Ljava/util/ArrayList;",
            false
        ));
