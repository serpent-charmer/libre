...
public class SprintEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            ...
            "func_147357_a",
            "processEntityAction",
            "(Lnet/minecraft/network/play/client/C0BPacketEntityAction;)V"
        );
        String func = FMLForgePlugin.RUNTIME_DEOBF ? "func_70031_b" : "setSprinting";
        AbstractInsnNode call = ReikaASMHelper.getFirstMethodCall(
            cn, m, "net/minecraft/entity/player/EntityPlayerMP", func, "(Z)V"
        );
        ...
        evt.add(new FieldInsnNode(
            Opcodes.GETFIELD,
            "net/minecraft/network/NetHandlerPlayServer",
            field,
            "Lnet/minecraft/entity/player/EntityPlayerMP;"
        ));
        evt.add(new MethodInsnNode(
            Opcodes.INVOKESTATIC,
            "Reika/DragonAPI/Instantiable/Event/PlayerSprintEvent",
            "fire",
