...
public class PigZombieAggroSpreadEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        ...
        AbstractInsnNode loc = ReikaASMHelper.getNthOpcode(
            m.instructions, Opcodes.INSTANCEOF, 1
        ); //would be 2, but since ASM remove the other, is 1
        ...
        li.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/PigZombieAggroSpreadEvent",
            "fire",
            "(Lnet/minecraft/entity/monster/EntityPigZombie;Lnet/minecraft/entity/Entity;Lnet/minecraft/util/DamageSource;F)Z",
            false
        ));
