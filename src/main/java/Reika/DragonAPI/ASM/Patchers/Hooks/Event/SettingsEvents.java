...
public class SettingsEvents extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m
            = ReikaASMHelper.getMethodByName(cn, "func_74300_a", "loadOptions", "()V");
        this.addCall(
            cn,
            m,
            ReikaASMHelper.getFirstMethodCallByName(
                cn,
                m,
                FMLForgePlugin.RUNTIME_DEOBF ? "func_74508_b"
        ...
        //this.addCall(cn, m, FMLForgePlugin.RUNTIME_DEOBF ? "func_82879_c" :
        //"sendSettingsToServer", "fireSave");
        this.addCall(
            cn,
            m,
            ReikaASMHelper.getFirstInsnAfter(m.instructions, 0, Opcodes.ALOAD, 1),
            "fireSave"
        );
    }
    ...
    private void addCall(ClassNode cn, MethodNode m, AbstractInsnNode call, String hook) {
        ...
        li.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/Client/SettingsEvent",
            hook,
