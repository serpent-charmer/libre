...
public class MusicTypeEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            ...
            "func_147109_W",
            "func_147109_W",
            "()Lnet/minecraft/client/audio/MusicTicker$MusicType;"
        );
        m.instructions.clear();
        m.instructions.add(new VarInsnNode(Opcodes.ALOAD, 0));
        m.instructions.add(new MethodInsnNode(
            Opcodes.INVOKESTATIC,
            "Reika/DragonAPI/Instantiable/Event/Client/MusicTypeEvent",
            "fire",
            "(Lnet/minecraft/client/Minecraft;)Lnet/minecraft/client/audio/MusicTicker$MusicType;",
            false
        ));
