...
public class BlockPlace extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        ...
        MethodInsnNode min = ReikaASMHelper.getFirstMethodCallByName(
            cn, m, FMLForgePlugin.RUNTIME_DEOBF ? "func_147465_d" : "setBlock"
        );
        min.owner = "Reika/DragonAPI/Instantiable/Event/PlayerPlaceBlockEvent";
        min.name = "fireTryPlace";
        min.desc
            = "(Lnet/minecraft/world/World;IIILnet/minecraft/block/Block;IIILnet/minecraft/entity/player/EntityPlayer;Lnet/minecraft/item/ItemStack;)Z";
