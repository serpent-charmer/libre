...
public class FarClipEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn, "func_78479_a", "setupCameraTransform", "(FI)V"
        );
        String fd = FMLForgePlugin.RUNTIME_DEOBF ? "field_78530_s" : "farPlaneDistance";
        InsnList add = new InsnList();
        add.add(new TypeInsnNode(
            Opcodes.NEW, "Reika/DragonAPI/Instantiable/Event/Client/FarClippingPlaneEvent"
        ));
        ...
        add.add(new FieldInsnNode(
            Opcodes.GETFIELD, "net/minecraft/client/renderer/EntityRenderer", fd, "F"
        ));
        add.add(new MethodInsnNode(
            Opcodes.INVOKESPECIAL,
            "Reika/DragonAPI/Instantiable/Event/Client/FarClippingPlaneEvent",
            "<init>",
            "(FIF)V",
            false
        ));
        ...
        add.add(new FieldInsnNode(
            Opcodes.PUTFIELD, "net/minecraft/client/renderer/EntityRenderer", fd, "F"
        ));
