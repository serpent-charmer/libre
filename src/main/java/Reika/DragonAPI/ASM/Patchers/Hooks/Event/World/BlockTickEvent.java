...
public class BlockTickEvent extends Patcher {
    private final String func
        = FMLForgePlugin.RUNTIME_DEOBF ? "func_149674_a" : "updateTick";
    ...
    protected void apply(ClassNode cn) {
        MethodNode m
            = ReikaASMHelper.getMethodByName(cn, "func_147456_g", "func_147456_g", "()V");
        ...
        m = ReikaASMHelper.getMethodByName(
            ...
            "(IIILnet/minecraft/block/Block;II)V"
        );
        ...
        for (int i = 0; i < m.instructions.size(); i++) {
            ...
            if (ain instanceof MethodInsnNode) {
                ...
                if (min.name.equals(func)) {
                    ...
                    ReikaASMHelper.addTrailingArgument(
                        min,
                        "LReika/DragonAPI/Instantiable/Event/BlockTickEvent$UpdateFlags;"
                    );
                    FieldInsnNode flag = new FieldInsnNode(
                        Opcodes.GETSTATIC,
                        "Reika/DragonAPI/Instantiable/Event/BlockTickEvent$UpdateFlags",
                        flagType,
                        "LReika/DragonAPI/Instantiable/Event/BlockTickEvent$UpdateFlags;"
                    );
