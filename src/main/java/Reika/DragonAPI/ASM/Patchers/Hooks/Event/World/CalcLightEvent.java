...
public class CalcLightEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            ...
            "func_147463_c",
            "updateLightByType",
            "(Lnet/minecraft/world/EnumSkyBlock;III)Z"
        );
        ...
        li.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/LightCalculationEvent",
            "fire",
            "(Lnet/minecraft/world/World;IIILnet/minecraft/world/EnumSkyBlock;)Z",
            false
        ));
        ...
        AbstractInsnNode ref
            = ReikaASMHelper.getFirstInsnAfter(m.instructions, 0, Opcodes.ISTORE, 5)
                  .getPrevious();
