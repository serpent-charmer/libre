...
public class ItemStackUpdateEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            ...
            "func_77945_a",
            "updateAnimation",
            "(Lnet/minecraft/world/World;Lnet/minecraft/entity/Entity;IZ)V"
        );
        AbstractInsnNode update
        ...
        li.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/ItemStackUpdateEvent",
            "fire",
            "(Lnet/minecraft/item/ItemStack;Lnet/minecraft/entity/Entity;IZ)V",
            false
        ));
