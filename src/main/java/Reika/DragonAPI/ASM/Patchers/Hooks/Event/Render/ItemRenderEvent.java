...
public class ItemRenderEvent extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn, "func_146977_a", "func_146977_a", "(Lnet/minecraft/inventory/Slot;)V"
        );
        ...
        m.instructions.insertBefore(
            ...
            new MethodInsnNode(
                ...
                "Reika/DragonAPI/Instantiable/Event/Client/RenderItemInSlotEvent",
                "firePre",
                "(Lnet/minecraft/client/gui/inventory/GuiContainer;Lnet/minecraft/inventory/Slot;)V",
                false
            )
        );

        AbstractInsnNode ref = ReikaASMHelper.getFirstInsnAfter(
            m.instructions, 0, Opcodes.LDC, -2130706433
        );
        VarInsnNode stack = (VarInsnNode) ReikaASMHelper.getFirstInsnAfter(
            m.instructions, m.instructions.indexOf(ref), Opcodes.ALOAD, 4
        );
        ...
        call.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Instantiable/Event/Client/RenderItemInSlotEvent",
            "fireMid",
            "(Lnet/minecraft/item/ItemStack;Lnet/minecraft/client/gui/inventory/GuiContainer;Lnet/minecraft/inventory/Slot;)Lnet/minecraft/item/ItemStack;",
            false
        ));
        while (stack != null) {
            m.instructions.insert(stack, ReikaASMHelper.copyInsnList(call));
            stack = (VarInsnNode) ReikaASMHelper.getFirstInsnAfter(
                m.instructions,
                m.instructions.indexOf(stack) + 1,
                stack.getOpcode(),
                stack.var
            );
        }
