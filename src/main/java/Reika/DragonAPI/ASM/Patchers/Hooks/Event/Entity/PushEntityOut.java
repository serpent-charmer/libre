...
public class PushEntityOut extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        ...
        /*
        MethodInsnNode min = ReikaASMHelper.getFirstMethodCallByName(cn, m,
        FMLForgePlugin.RUNTIME_DEOBF ? "func_147461_a" : "func_147461_a"); min.owner =
        "Reika/DragonAPI/Instantiable/Event/EntityPushOutOfBlocksEvent"; min.name =
        "checkAABBs"; ReikaASMHelper.addLeadingArgument(min,
        "Lnet/minecraft/world/World;"); ReikaASMHelper.addTrailingArgument(min,
        ReikaASMHelper.convertClassName(cn, true)); min.setOpcode(Opcodes.INVOKESTATIC);
        m.instructions.insertBefore(min, new VarInsnNode(Opcodes.ALOAD, 0));
         */
        int var = 16;
        AbstractInsnNode loc1
            = ReikaASMHelper.getFirstInsnAfter(m.instructions, 0, Opcodes.ALOAD, var);
        AbstractInsnNode loc2 = ReikaASMHelper.getFirstMethodCallByName(
            cn, m, FMLForgePlugin.RUNTIME_DEOBF ? "func_147469_q" : "func_147469_q"
        );
        ...
        m.instructions.insertBefore(
            ...
            new MethodInsnNode(
                ...
                "Reika/DragonAPI/Instantiable/Event/EntityPushOutOfBlocksEvent",
                "fire",
                "(Lnet/minecraft/entity/Entity;Ljava/util/List;III)Z",
                false
            )
        );
    }
