...
public class SaveOpen extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn, "<init>", "(Ljava/io/File;Ljava/lang/String;Z)V"
        );
        ...
        li.add(new FieldInsnNode(
            Opcodes.GETFIELD,
            s,
            (FMLForgePlugin.RUNTIME_DEOBF ? "field_75770_b" : "worldDirectory"),
            "Ljava/io/File;"
        ));
        li.add(new VarInsnNode(Opcodes.ALOAD, 0));
        li.add(new FieldInsnNode(
            Opcodes.GETFIELD,
            s,
            (FMLForgePlugin.RUNTIME_DEOBF ? "field_75769_e" : "initializationTime"),
            "J"
        ));
        li.add(new MethodInsnNode(
            Opcodes.INVOKESTATIC,
            "Reika/DragonAPI/ASM/ASMCalls",
            "trackSaveHandleStart",
            "(Lnet/minecraft/world/storage/SaveHandler;Ljava/io/File;J)V",
            false
        ));
