...
public class StopWorldUnload extends Patcher {
    ...
    public void apply(ClassNode cn) {
        MethodNode mn = ReikaASMHelper.getMethodByName(
            cn, "func_73156_b", "unloadQueuedChunks", "()Z"
        );
        MethodInsnNode node = ReikaASMHelper.getFirstMethodCall(
            cn,
            mn,
        ...
        String playerFieldName
            = FMLForgePlugin.RUNTIME_DEOBF ? "field_73010_i" : "playerEntities";
