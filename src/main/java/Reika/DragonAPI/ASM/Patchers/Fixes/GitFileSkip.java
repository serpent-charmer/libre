...
public class GitFileSkip extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn,
            "searchDirForLanguages",
            "(Ljava/io/File;Ljava/lang/String;Lcpw/mods/fml/relauncher/Side;)V"
        );
        JumpInsnNode jin
            = (JumpInsnNode) ReikaASMHelper.getFirstOpcode(m.instructions, Opcodes.IFEQ);
        VarInsnNode vin = (VarInsnNode) ReikaASMHelper.getLastOpcodeBefore(
            m.instructions, m.instructions.indexOf(jin), Opcodes.ALOAD
        );
