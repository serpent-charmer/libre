...
/**
 * Fixes Forge only checking for BlockFluidBase, which neither vanilla, CoFH's
 * overwrites, nor some mod fluids extend. Also allows location-specific density, which
 * would be the only way to implement temperature-specific density (as real fluids
 * have).
 */
