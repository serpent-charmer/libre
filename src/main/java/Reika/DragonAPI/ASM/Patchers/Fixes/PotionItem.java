...
public class PotionItem extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn, "func_70184_a", "onImpact", "(Lnet/minecraft/util/MovingObjectPosition;)V"
        );
        AbstractInsnNode start
            = ReikaASMHelper.getFirstOpcode(m.instructions, Opcodes.GETSTATIC);
        AbstractInsnNode end
            = ReikaASMHelper.getFirstOpcode(m.instructions, Opcodes.ASTORE);
