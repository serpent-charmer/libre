...
public abstract class RecipeStackParser extends Patcher {
    ...
    protected final void apply(ClassNode cn) {
        ...
        AbstractInsnNode start = ReikaASMHelper.getFirstInsnAfter(
            m.instructions, 0, Opcodes.NEW, "java/util/HashMap"
        );
        AbstractInsnNode loc2 = ReikaASMHelper.getFirstInsnAfter(
            m.instructions,
            m.instructions.indexOf(start),
            Opcodes.ANEWARRAY,
            this.getArrayType()
        );
        ...
        li.add(new MethodInsnNode(
            ...
            "parseItemMappings",
            "(IZ[Ljava/lang/Object;)Ljava/util/HashMap;",
            false
        ));
