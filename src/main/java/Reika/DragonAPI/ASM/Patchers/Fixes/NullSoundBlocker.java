...
public class NullSoundBlocker extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn,
            "<init>",
            "(Lnet/minecraft/client/audio/SoundHandler;Lnet/minecraft/client/settings/GameSettings;)V"
        );
    ...
    private static class FilteredSoundList extends ArrayList {
        ...
        public boolean addAll(int pos, Collection c) {
            ...
            if (invalid.isEmpty()) {
                ...
                throw new IllegalArgumentException(
                    "Invalid sound objects (" + invalid + ") were added to the list!"
                );
            }
        }
        ...
        public Object set(int pos, Object o) {
            if (this.verify(o)) {
                ...
                throw new IllegalArgumentException(
                    "Invalid sound object (" + o + ") was added to the list!"
                );
            }
        }
