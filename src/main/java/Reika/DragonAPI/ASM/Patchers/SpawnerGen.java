...
public abstract class SpawnerGen extends Patcher {
    ...
    protected final void apply(ClassNode cn) {
        ...
        AbstractInsnNode ain = ReikaASMHelper.getFirstMethodCall(
            ...
            FMLForgePlugin.RUNTIME_DEOBF ? "func_98272_a" : "setEntityName",
            "(Ljava/lang/String;)V"
        );
        VarInsnNode spawner = (VarInsnNode) ReikaASMHelper.getLastOpcodeBefore(
            m.instructions, m.instructions.indexOf(ain), Opcodes.ALOAD
        );
        VarInsnNode z = (VarInsnNode) ReikaASMHelper.getLastOpcodeBefore(
            m.instructions, m.instructions.indexOf(spawner), Opcodes.ILOAD
        );
        ...
        li.add(new FieldInsnNode(
            Opcodes.GETSTATIC,
            "Reika/DragonAPI/Instantiable/Event/SpawnerGenerationEvent$SpawnerSource",
            this.getEnumEntry().name(),
            "LReika/DragonAPI/Instantiable/Event/SpawnerGenerationEvent$SpawnerSource;"
        ));
