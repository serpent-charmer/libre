...
public class ModIDCalc extends Patcher {
    ...
    protected void apply(ClassNode cn) {
        MethodNode m = ReikaASMHelper.getMethodByName(
            cn, "hash", "(LReika/DragonAPI/Base/DragonAPIMod;)Ljava/lang/String;"
        );
        ...
        m.instructions.add(new MethodInsnNode(
            Opcodes.INVOKEVIRTUAL, "java/lang/String", "hashCode", "()I", false
        ));
        ...
        m.instructions.add(new MethodInsnNode(
            ...
            "Reika/DragonAPI/Base/DragonAPIMod",
            "getModVersion",
            "()LReika/DragonAPI/Extras/ModVersion;",
            false
        ));
        m.instructions.add(new MethodInsnNode(
            Opcodes.INVOKEVIRTUAL,
            "Reika/DragonAPI/Extras/ModVersion",
            "hashCode",
            "()I",
            false
        ));
