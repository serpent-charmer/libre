...
public class ThermalRecipeHelper {
    ...
    public static void
    addFluidTransposerFill(ItemStack in, ItemStack out, int energy, FluidStack f) {
        addFluidTransposerFill(in, out, energy, f, false);
    }

    public static void addFluidTransposerFill(
        ItemStack in, ItemStack out, int energy, FluidStack f, boolean reversible
    ) {
        NBTTagCompound toSend = new NBTTagCompound();
        toSend.setInteger("energy", energy);
        ...
        fireEvent(
            ThermalRecipeEvent.ThermalMachine.TRANSPOSER, in, null, out, null, 0, energy
        );
    }

    private static void
    fireEvent(ThermalMachine type, ItemStack in, FluidStack out, int rf) {
    ...
    private static void fireEvent(
        ...
        MinecraftForge.EVENT_BUS.post(
            new ThermalRecipeEvent(type, in1, in2, out1, out2, out2chance, rf)
        );
    }

    public static void
    addFluidTransposerDrain(ItemStack in, ItemStack out, int energy, FluidStack f) {
        addFluidTransposerDrain(in, out, energy, f, 100);
    }

    public static void addFluidTransposerDrain(
        ItemStack in, ItemStack out, int energy, FluidStack f, boolean reversible
    ) {
    ...
    public static void addFluidTransposerDrain(
        ItemStack in, ItemStack out, int energy, FluidStack f, int chance
    ) {
    ...
    public static void addFluidTransposerDrain(
        ...
        FMLInterModComms.sendMessage(
            "ThermalExpansion", "TransposerExtractRecipe", toSend
        );
        fireEvent(
            ThermalRecipeEvent.ThermalMachine.TRANSPOSER, in, null, out, null, 0, energy
        );
    ...
    public static void
    addInductionSmelter(ItemStack in1, ItemStack in2, ItemStack out1, int energy) {
        addInductionSmelter(in1, in2, out1, null, energy);
    }

    public static void addInductionSmelter(
        ItemStack in1, ItemStack in2, ItemStack out1, ItemStack out2, int energy
    ) {
    ...
    public static void addInductionSmelter(
        ...
        addTwoInTwoOutWithChance(
            "SmelterRecipe", in1, in2, out1, out2, out2chance, energy
        );
    }

    public static void
    addPulverizerRecipe(ItemStack in, ItemStack out1, ItemStack out2, int energy) {
    ...
    public static void addPulverizerRecipe(
        ItemStack in, ItemStack out1, ItemStack out2, int out2chance, int energy
    ) {
        addOneInTwoOutWithChance("PulverizerRecipe", in, out1, out2, out2chance, energy);
    }

    public static void
    addSawmillRecipe(ItemStack in, ItemStack out1, ItemStack out2, int energy) {
    ...
    private static void addTwoInTwoOutWithChance(
        String type,
        ItemStack in1,
        ItemStack in2,
        ItemStack out1,
        ...
        fireEvent(
            ThermalRecipeEvent.ThermalMachine.getType(type),
            in1,
            in2,
            out1,
            out2,
    ...
    private static void addOneInTwoOutWithChance(
        String type,
        ItemStack in,
        ItemStack out1,
        ItemStack out2,
