...
public abstract class StatementBase implements ITriggerExternal {
    ...
    private static StatementArgument
    createArgument(Class<? extends StatementArgument> type, StatementBase func) {
        try {
    ...
    public final boolean isTriggerActive(
        TileEntity target,
        ForgeDirection side,
    ...
    public static abstract class StatementArgument implements IStatementParameter {
        ...
        protected void
        onClick(TileEntity caller, ItemStack held, int button, boolean shift) {}
    ...
    public static class StackArgument extends StatementArgument {
        ...
        public void readFromNBT(NBTTagCompound tag) {
            stack
                = tag.getBoolean("hasStack") ? ItemStack.loadItemStackFromNBT(tag) : null;
        }
