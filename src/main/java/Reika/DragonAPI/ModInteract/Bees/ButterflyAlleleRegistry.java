...
public class ButterflyAlleleRegistry {
    private static final NestedMap<Class, String, ButterflyGene> geneMap
        = new NestedMap();
    private static final EnumMap<EnumButterflyChromosome, Class<? extends ButterflyGene>>
        classTypes = new EnumMap(EnumButterflyChromosome.class);
    ...
    public static ButterflyGene getEnum(EnumButterflyChromosome ebc, String name) {
        return (ButterflyGene) Enum.valueOf(
    ...
    public static enum Speeds implements ButterflyGene {
        ...
        public static Speeds createNew(String id, float speed, boolean dominant) {
            ...
            IAlleleFloat allele = AlleleManager.alleleFactory.createFloat(
                "dragonapi", "speed", id, speed, dominant, EnumButterflyChromosome.SPEED
            );
            AlleleManager.alleleRegistry.registerAllele(
                allele, EnumButterflyChromosome.SPEED
            );
    ...
    public static enum Size implements ButterflyGene {
        ...
        public static Size createNew(String id, float size, boolean dominant) {
            id = ReikaStringParser.capFirstChar(id);
            IAlleleFloat allele = AlleleManager.alleleFactory.createFloat(
                "dragonapi", "size", id, size, dominant, EnumButterflyChromosome.SIZE
            );
            AlleleManager.alleleRegistry.registerAllele(
                allele, EnumButterflyChromosome.SIZE
            );
            return EnumHelper.addEnum(
                Size.class,
                id.toUpperCase(),
    ...
    public static enum Fertility implements ButterflyGene {
        ...
        public static Fertility createNew(String id, int drones, boolean dominant) {
            ...
            AlleleManager.alleleRegistry.registerAllele(
                allele, EnumButterflyChromosome.FERTILITY
            );
            return EnumHelper.addEnum(
                Fertility.class,
                id.toUpperCase(),
        ...
        public static Fertility getFromBee(BeeAlleleRegistry.Fertility l) {
            return BeeAlleleRegistry.getEnum(l.getAllele(),
        BeeAlleleRegistry.Fertility.class);
        }
         */
        ...
        public static Fertility createNewFromBee(BeeAlleleRegistry.Fertility l) {
            return EnumHelper.addEnum(
                ...
                l.name(),
                new Class[] { String.class, String.class },
                new Object[] { "dragonapi", ReikaStringParser.capFirstChar(l.name()) }
            );
        }
    }
    ...
    public static enum Territory implements ButterflyGene {
        ...
        createNew(String id, int rangeXZ, int rangeY, boolean dominant) {
            ...
            AlleleManager.alleleRegistry.registerAllele(
                allele, EnumButterflyChromosome.TERRITORY
            );
            return EnumHelper.addEnum(
                Territory.class,
                id.toUpperCase(),
    ...
    public static enum Life implements ButterflyGene {
        ...
        public static Life createNew(String id, int life, boolean dominant) {
            ...
            AlleleManager.alleleRegistry.registerAllele(
                allele, EnumButterflyChromosome.LIFESPAN
            );
            return EnumHelper.addEnum(
                Life.class,
                id.toUpperCase(),
    ...
    { id = ReikaStringParser.capFirstChar(id); IAlleleInteger allele =
    AlleleManager.alleleFactory.createInteger("dragonapi", "metabolism", id, Metabolisms,
    dominant, EnumButterflyChromosome.METABOLISM);
            AlleleManager.alleleRegistry.registerAllele(allele,
    EnumButterflyChromosome.METABOLISM); return EnumHelper.addEnum(Metabolisms.class,
    id.toUpperCase(), new Class[]{String.class, String.class}, new Object[]{"dragonapi",
    id});
        }
    ...
    public static enum Tolerance implements ButterflyGene {
        ...
        public static Tolerance createNew(String id, ToleranceCheck t, boolean dominant) {
            id = ReikaStringParser.capFirstChar(id);
            Tolerance allele = AlleleManager.alleleFactory.createTolerance("dragonapi",
        "lifespan", id, life, dominant, EnumButterflyChromosome.);
            AlleleManager.alleleRegistry.registerAllele(allele,
        EnumButterflyChromosome.TEMPERATURE_TOLERANCE,
        EnumButterflyChromosome.HUMIDITY_TOLERANCE); return EnumHelper;
        }*/
