...
public abstract class ButterflySpecies
    extends GeneBase implements IAlleleButterflySpecies {
    ...
    private final IAllele[] template
        = new IAllele[EnumButterflyChromosome.values().length];
    ...
    public final void register() {
        ...
        AlleleManager.alleleRegistry.registerAllele(
            this, EnumButterflyChromosome.SPECIES
        );
    ...
    public final ItemStack getButterflyItem(World world, EnumFlutterType type) {
        return butterflyRoot.getMemberStack(butterflyRoot.getButterfly(world,
    butterflyRoot.templateAsGenome(template)), type.ordinal());
    }
     */
    ...
    public final IAlleleButterflyEffect getNoEffect() {
        return (IAlleleButterflyEffect
        ) AlleleManager.alleleRegistry.getAllele("forestry.bfNone");
    }
    ...
    protected final IAllele[] getSpeciesTemplate() {
        ...
        alleles[EnumButterflyChromosome.LIFESPAN.ordinal()]
            = this.getLifespan().getAllele();
        alleles[EnumButterflyChromosome.METABOLISM.ordinal()]
            = ReikaBeeHelper.getIntegerAllele(this.getMetabolism());
        alleles[EnumButterflyChromosome.FERTILITY.ordinal()]
            = ReikaBeeHelper.getIntegerAllele(this.getFertility().getAllele().getValue());
        alleles[EnumButterflyChromosome.TEMPERATURE_TOLERANCE.ordinal()]
            = ReikaBeeHelper.getToleranceGene(
                this.getTemperatureToleranceDir(), this.getTemperatureTolerance()
            );
        alleles[EnumButterflyChromosome.HUMIDITY_TOLERANCE.ordinal()]
            = ReikaBeeHelper.getToleranceGene(
                this.getHumidityToleranceDir(), this.getHumidityTolerance()
            );
        alleles[EnumButterflyChromosome.NOCTURNAL.ordinal()]
            = ReikaBeeHelper.getBooleanAllele(this.isNocturnal());
        alleles[EnumButterflyChromosome.TOLERANT_FLYER.ordinal()]
            = ReikaBeeHelper.getBooleanAllele(this.isTolerantFlyer());
        alleles[EnumButterflyChromosome.FIRE_RESIST.ordinal()]
            = ReikaBeeHelper.getBooleanAllele(this.isFireproof());
        alleles[EnumButterflyChromosome.FLOWER_PROVIDER.ordinal()]
            = this.getFlowerAllele();
        alleles[EnumButterflyChromosome.EFFECT.ordinal()] = this.getEffect();
        //alleles[EnumButterflyChromosome.TERRITORY.ordinal()] =
    ...
    public static abstract class BasicButterflySpecies extends ButterflySpecies {
        protected BasicButterflySpecies(
            String name, String uid, String latinName, String creator, IClassification g
        ) {
