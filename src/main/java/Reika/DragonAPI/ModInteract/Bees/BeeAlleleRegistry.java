...
public class BeeAlleleRegistry {
    ...
    private static final EnumMap<EnumBeeChromosome, Class<? extends BeeGene>> classTypes
        = new EnumMap(EnumBeeChromosome.class);
    ...
    public static enum Speeds implements BeeGene {
        ...
        public static Speeds createNew(String id, float speed, boolean dominant) {
            ...
            IAlleleFloat allele = AlleleManager.alleleFactory.createFloat(
                "dragonapi", "speed", id, speed, dominant, EnumBeeChromosome.SPEED
            );
    ...
    public static enum Fertility implements BeeGene {
        ...
        public static Fertility createNew(String id, int drones, boolean dominant) {
            ...
            AlleleManager.alleleRegistry.registerAllele(
                allele, EnumBeeChromosome.FERTILITY
            );
            return EnumHelper.addEnum(
                Fertility.class,
                id.toUpperCase(),
    ...
    public static enum Flowering implements BeeGene {
        ...
        public static Flowering createNew(String id, int value, boolean dominant) {
            id = ReikaStringParser.capFirstChar(id);
            IAlleleInteger allele = AlleleManager.alleleFactory.createInteger(
                "dragonapi", "flowering", id, value, dominant, EnumBeeChromosome.FLOWERING
            );
            AlleleManager.alleleRegistry.registerAllele(
                allele, EnumBeeChromosome.FLOWERING
            );
            return EnumHelper.addEnum(
                Flowering.class,
                id.toUpperCase(),
    ...
    public static enum Territory implements BeeGene {
        ...
        createNew(String id, int rangeXZ, int rangeY, boolean dominant) {
            ...
            AlleleManager.alleleRegistry.registerAllele(
                allele, EnumBeeChromosome.TERRITORY
            );
            return EnumHelper.addEnum(
                Territory.class,
                id.toUpperCase(),
    ...
    public static enum Life implements BeeGene {
        ...
        public static Life createNew(String id, int life, boolean dominant) {
            id = ReikaStringParser.capFirstChar(id);
            IAlleleInteger allele = AlleleManager.alleleFactory.createInteger(
                "dragonapi", "lifespan", id, life, dominant, EnumBeeChromosome.LIFESPAN
            );
            AlleleManager.alleleRegistry.registerAllele(
                allele, EnumBeeChromosome.LIFESPAN
            );
            return EnumHelper.addEnum(
                Life.class,
                id.toUpperCase(),
    ...
    public static enum Tolerance implements BeeGene {
        ...
        "lifespan", id, life, dominant, EnumBeeChromosome.);
            AlleleManager.alleleRegistry.registerAllele(allele,
        EnumBeeChromosome.TEMPERATURE_TOLERANCE, EnumBeeChromosome.HUMIDITY_TOLERANCE);
            return EnumHelper;
        }*/
