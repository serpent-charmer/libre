...
public class MagicCropHandler extends CropHandlerBase {
    ...
    public enum EssenceType {
        ...
        private static boolean initialized() {
            ...
            return cropIDs.size() == len && seedIDs.size() == len
                && essenceIDs.size() == len;
        }
    ...
    private MagicCropHandler() {
        ...
        if (this.hasMod()) {
            try {
                ...
                Class essences
                    = Class.forName("com.mark719.magicalcrops.handlers.Essence");
    ...
    public boolean initializedProperly() {
        return EssenceType.initialized() && MiscEssence.initialized()
            && configChance != -1 && oreID != null && netherOreID != null
            && endOreID != null;
    }
    ...
    public ArrayList<ItemStack> getAdditionalDrops(
        ...
        if (MiscEssence.CHRISTMAS.item != null
            && ReikaRandomHelper.doWithChance(20 * (1 + fortune)))
