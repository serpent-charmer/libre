...
public final class TinkerToolHandler extends ModHandlerBase {
    ...
    public enum WeaponParts implements TinkerPart {
        ...
        public ItemStack getCast() {
            return new ItemStack(
                weaponCast ? getInstance().weaponCastItem : getInstance().toolCastItem,
                1,
                castMeta
            );
        }
        ...
        public ItemStack getPattern() {
            return new ItemStack(
                weaponCast ? getInstance().weaponWoodPattern
                           : getInstance().toolWoodPattern,
                1,
                castMeta
            );
        }
    ...
    private final EnumMap<Tools, EnumMap<ToolPartType, ToolParts>> toolPartMap
