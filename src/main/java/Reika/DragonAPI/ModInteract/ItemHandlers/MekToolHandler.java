...
public final class MekToolHandler extends ModHandlerBase {
    public static enum Materials {
        ...
        public Item getItem(Tools t) {
            return instance.initializedProperly()
                ? instance.itemsMaterial.get(this).get(t)
                : null;
        }
            ...
            switch (this) {
                case BRONZE:
                    return new ItemStack(
                        MekanismHandler.getInstance().ingotID,
                        1,
                        MekanismHandler.bronzeIngotMeta
                    );
                case GLOWSTONE:
                    return new ItemStack(
                        MekanismHandler.getInstance().ingotID,
                        1,
                        MekanismHandler.glowstoneIngotMeta
                    );
                case OBSIDIAN:
                    return new ItemStack(
                        MekanismHandler.getInstance().ingotID,
                        1,
                        MekanismHandler.obsidianIngotMeta
                    );
                case OSMIUM:
                    return new ItemStack(
                        MekanismHandler.getInstance().ingotID,
                        1,
                        MekanismHandler.osmiumIngotMeta
                    );
                case STEEL:
                    return new ItemStack(
                        MekanismHandler.getInstance().ingotID,
                        1,
                        MekanismHandler.steelIngotMeta
                    );
                case STONE:
    ...
    public static enum Tools {
        ...
        public Item getItem(Materials m) {
            return instance.initializedProperly() ? instance.itemsTool.get(this).get(m)
                                                  : null;
        }
    ...
    private final EnumMap<Tools, EnumMap<Materials, Item>> itemsTool
        = new EnumMap(Tools.class);
    private final EnumMap<Materials, EnumMap<Tools, Item>> itemsMaterial
        = new EnumMap(Materials.class);
    ...
    public boolean isPickTypeTool(ItemStack held) {
        ...
        if (!this.initializedProperly())
            return false;
        return itemsTool.get(Tools.PAXEL).containsValue(held.getItem())
            || itemsTool.get(Tools.PICK).containsValue(held.getItem());
    }
