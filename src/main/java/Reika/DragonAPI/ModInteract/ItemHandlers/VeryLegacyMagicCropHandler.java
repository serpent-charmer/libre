...
public class VeryLegacyMagicCropHandler extends CropHandlerBase {
    ...
    private static final VeryLegacyMagicCropHandler instance
        = new VeryLegacyMagicCropHandler();
    ...
    private VeryLegacyMagicCropHandler() {
        ...
        christmasEssence
            = cropEssenceID != null ? new ItemStack(cropEssenceID, 1, 20) : null;
    }
    ...
    public boolean initializedProperly() {
        return EssenceType.initialized() && configChance != -1 && oreID != null
            && netherOreID != null && essenceID != null && cropEssenceID != null;
    }
