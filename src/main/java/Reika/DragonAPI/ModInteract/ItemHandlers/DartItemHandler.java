        ...
        if (this.hasMod()) {
            try {
                ...
                DragonAPICore.logError(
                    "DartCraft Item class not found! Cannot read its items!"
                );
                e.printStackTrace();
                this.logFailure(e);
            } catch (NoSuchFieldException e) {
                DragonAPICore.logError(
                    "DartCraft item field not found! " + e.getMessage()
                );
                e.printStackTrace();
                this.logFailure(e);
            } catch (SecurityException e) {
                DragonAPICore.logError(
                    "Cannot read DartCraft items (Security Exception)! " + e.getMessage()
                );
                e.printStackTrace();
                this.logFailure(e);
                ...
                DragonAPICore.logError(
                    "Illegal access exception for reading DartCraft items!"
                );
                e.printStackTrace();
                this.logFailure(e);
            }
