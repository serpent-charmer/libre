...
public class FluxedCrystalHandler extends CropHandlerBase {
    ...
    private FluxedCrystalHandler() {
        ...
        if (this.hasMod()) {
            try {
                ...
                doDrop = idcrop.getClass().getMethod(
                    "dropCropDrops",
                    World.class,
                    int.class,
                    int.class,
                ...
                //Class c3 = Class.forName("fluxedCrystals.config.ConfigProps");
                 ...
                 DragonAPICore.log("DRAGONAPI: "+this.getMod()+" class not found!
    ...
    public boolean initializedProperly() {
        return seed != null && crop != null && universalSeed != null && roughShard != null
            && smoothShard != null;
    }
    ...
    private void
    triggerDropCode(World world, int x, int y, int z, Block id, int meta, int fortune) {
