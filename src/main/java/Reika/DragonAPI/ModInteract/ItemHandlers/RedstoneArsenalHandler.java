    ...
    private RedstoneArsenalHandler() {
        ...
        if (this.hasMod()) {
            try {
                ...
                Method get = obj.getClass()
                                 .getMethod("get", String.class, String.class, int.class);
                ...
                DragonAPICore.logError(
                    this.getMod() + " config not being read properly! " + e.getMessage()
                );
                e.printStackTrace();
                this.logFailure(e);
                ...
                DragonAPICore.logError(
                    this.getMod() + " method not found! " + e.getMessage()
                );
                e.printStackTrace();
                this.logFailure(e);
                ...
                DragonAPICore.logError(
                    "Invocation target exception for reading " + this.getMod() + "!"
                );
                e.printStackTrace();
                this.logFailure(e);
