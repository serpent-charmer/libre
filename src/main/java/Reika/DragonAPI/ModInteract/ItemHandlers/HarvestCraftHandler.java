...
public class HarvestCraftHandler extends CropHandlerBase {
    ...
    //private static final EnumMap<CropType, Block> saplings = new
    //EnumMap(CropType.class); private static final EnumMap<CropType, Block> blocks = new
    //EnumMap(CropType.class); private static final EnumMap<CropType, ItemStack> seeds =
    //new EnumMap(CropType.class); private static final EnumMap<CropType, ItemStack> drops
