...
public class ChiselBlockHandler extends ModHandlerBase {
    ...
    public static boolean isWorldgenBlock(Block b, int meta) {
        if (meta != 0)
            return false;
        return b == BlockEntry.MARBLE.getBlock() || b == BlockEntry.SANDSTONE.getBlock()
            || b == BlockEntry.LIMESTONE.getBlock() || b == BlockEntry.GRANITE.getBlock()
            || b == BlockEntry.DIORITE.getBlock() || b == BlockEntry.ANDESITE.getBlock();
    }
}
