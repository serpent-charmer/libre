...
public class ForestryHandler extends ModHandlerBase implements CropHandler {
    ...
    public enum ItemEntry {
        ...
        TREEPOLLEN(
            "forestry.arboriculture.items.ItemRegistryArboriculture", "pollenFertile"
        ),
        ...
        BUTTERFLY(
            "forestry.lepidopterology.items.ItemRegistryLepidopterology", "butterflyGE"
        ),
        CATERPILLAR(
            "forestry.lepidopterology.items.ItemRegistryLepidopterology", "caterpillarGE"
        ),
        ...
        IMPREGFRAME(
            "forestry.apiculture.items.ItemRegistryApiculture", "frameImpregnated"
        ),
    ...
    public enum BlockEntry {
        ...
        FIRELOG(
            "forestry.arboriculture.blocks.BlockRegistryArboriculture", "logsFireproof"
        ),
    ...
    public Collection<Item> getAllCrates() {
        try {
            return Collections.unmodifiableCollection(
                (Collection<Item>) crateList.get(null)
            );
        } catch (IllegalArgumentException e) {
            e.printStackTrace();
    ...
    public boolean isLog(Block b) {
        return b == BlockEntry.LOG.getBlock() || b == BlockEntry.FIRELOG.getBlock()
            || (b != null && b == extraTreeLog);
    }
    ...
    getDropsOverride(World world, int x, int y, int z, Block id, int meta, int fortune) {
        ...
        if (te != null) {
            ...
            if (tree != null) {
                ItemStack[] fruit = tree.produceStacks(
                    world, x, y, z, ReikaBeeHelper.getTreeRipeness(te)
                );
