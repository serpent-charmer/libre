...
public enum ModOreList implements OreType {
    ...
    CINNABAR(
        "Mercury", 0x811A1A, OreRarity.SCATTERED, "itemQuicksilver", 1, "oreCinnabar"
    ),
    AMBER("Amber", 0xB17F17, OreRarity.SCATTERED, "gemAmber", 1, "oreAmber"),
    INFUSEDAIR(
        "Air Infused", 0xA88C32, OreRarity.SCATTERED, "shardAir", 2, "oreInfusedAir"
    ),
    INFUSEDFIRE(
        "Fire Infused", 0xB52100, OreRarity.SCATTERED, "shardFire", 2, "oreInfusedFire"
    ),
    INFUSEDWATER(
        "Water Infused", 0x007C99, OreRarity.AVERAGE, "shardWater", 2, "oreInfusedWater"
    ),
    INFUSEDEARTH(
        "Earth Infused", 0x008200, OreRarity.SCATTERED, "shardEarth", 2, "oreInfusedEarth"
    ),
    INFUSEDENTROPY(
        "Entropy Infused",
        0x555576,
    ...
    INFUSEDORDER(
        "Order Infused", 0xDCDCFF, OreRarity.SCARCE, "shardOrder", 2, "oreInfusedOrder"
    ),
    APATITE("Apatite", 0x3296C5, OreRarity.COMMON, "gemApatite", 3, "oreApatite"),
    SALTPETER(
        "Saltpeter", 0xFFFFFF, OreRarity.AVERAGE, "dustSaltpeter", 2, "oreSaltpeter"
    ),
    TUNGSTEN(
        "Tungsten",
        0x1E1E1E,
    ...
    NETHERCOAL(
        "Nether Coal", 0x262626, OreRarity.EVERYWHERE, "itemCoal", 1, "oreNetherCoal"
    ),
    NETHERIRON(
        "Nether Iron", 0xD8AD91, OreRarity.COMMON, "ingotIron", 1, "oreNetherIron"
    ),
    NETHERGOLD(
        "Nether Gold", 0xD6A400, OreRarity.AVERAGE, "ingotGold", 1, "oreNetherGold"
    ),
    NETHERREDSTONE(
        "Nether Redstone",
        0xBC0000,
    ...
    NETHERLAPIS(
        "Nether Lapis", 0x2B4BFF, OreRarity.AVERAGE, "dyeBlue", 6, "oreNetherLapis"
    ),
    NETHERDIAMOND(
        "Nether Diamond", 0x68FFE3, OreRarity.SCARCE, "gemDiamond", 1, "oreNetherDiamond"
    ),
    NETHEREMERALD(
        "Nether Emerald", 0x12DB00, OreRarity.SCARCE, "gemEmerald", 1, "oreNetherEmerald"
    ),
    NETHERTIN("Nether Tin", 0xA9CCE2, OreRarity.COMMON, "ingotTin", 1, "oreNetherTin"),
    NETHERCOPPER(
        "Nether Copper", 0xC8850C, OreRarity.COMMON, "ingotCopper", 1, "oreNetherCopper"
    ),
    NETHERLEAD(
        "Nether Lead", 0x6F7DA3, OreRarity.AVERAGE, "ingotLead", 1, "oreNetherLead"
    ),
    NETHERNICKEL(
        "Nether Nickel", 0xB6AE85, OreRarity.AVERAGE, "ingotNickel", 1, "oreNetherNickel"
    ),
    NETHERSILVER(
        "Nether Silver", 0xA7E4EC, OreRarity.AVERAGE, "ingotSilver", 1, "oreNetherSilver"
    ),
    NETHERNIKOLITE(
        "Nether Nikolite",
        0xA7E4EC,
    ...
    NETHERPIGIRON(
        "Pig Iron", 0xC5B3AA, OreRarity.SCATTERED, "ingotSteel", 1, "oreNetherSteel"
    ), //...
    SULFUR("Sulfur", 0xFFFF00, OreRarity.COMMON, "dustSulfur", 3, "oreSulfur"),
    PITCHBLENDE(
        "Pitchblende", 0x4E4E7B, OreRarity.AVERAGE, "ingotUranium", 1, "orePitchblende"
    ),
    ...
    CHIMERITE(
        "Chimerite", 0xCBE5F5, OreRarity.SCATTERED, "gemChimerite", 2, "oreChimerite"
    ),
    VINTEUM("Vinteum", 0x507BBC, OreRarity.SCATTERED, "dustVinteum", 1, "oreVinteum"),
    BLUETOPAZ(
        "Blue Topaz", 0x92B1F0, OreRarity.SCATTERED, "gemBlueTopaz", 1, "oreBlueTopaz"
    ),
    ...
    MAGNETITE(
        "Magnetite", 0x44442D, OreRarity.AVERAGE, "gemMagnetite", 1, "oreMagnetite"
    ),
    ESSENCE(
        "Essence",
        0x158215,
    ...
    MIMICHITE(
        "Mimichite", 0x8900FF, OreRarity.SCATTERED, "gemMimichite", 1, "oreMimichite"
    ),
    NETHERURANIUM(
        "Nether Uranium",
        0x00aa00,
    ...
    NETHERIRIDIUM(
        "Nether Iridium", 0xb6f6c7, OreRarity.RARE, "ingotIridium", 1, "oreNetherIridium"
    ),
    DARKIRON(
        "Dark Iron", 0x4F00D1, OreRarity.AVERAGE, "ingotFzDarkIron", 1, "oreFzDarkIron"
    ),
    ...
    NETHERSULFUR(
        "Nether Sulfur", 0x0a408, OreRarity.COMMON, "dustSulfur", 3, "oreNetherSulfur"
    ),
    NETHEROSMIUM(
        "Nether Osmium", 0x98A0D7, OreRarity.AVERAGE, "ingotOsmium", 1, "oreNetherOsmium"
    ),
    ...
    AMETHYST("Amethyst", 0xFF72F3, OreRarity.RARE, "gemAmethyst", 1, "oreAmethyst"),
    TESLATITE(
        "Teslatite", 0x2F81F1, OreRarity.COMMON, "dustTeslatite", 3, "oreTeslatite"
    ),
    ...
    DRACONIUM(
        "Draconium", 0x9F01E2, OreRarity.SCATTERED, "dustDraconium", 2, "oreDraconium"
    ),
    ENDIUM(
        "Endium",
        0x372356,
    ...
    DILITHIUM(
        "Dilithium", 0xC7BAB7, OreRarity.SCATTERED, "dustDilithium", 1, "oreDilithium"
    ),
    ...
    private ModOreList(
        String n, int color, OreRarity r, String prod, int count, String... ore
    ) {
        //if (!DragonAPIInit.canLoadHandlers())
        //	throw new MisuseException("Accessed registry enum too early! Wait until
        //postInit!");
        dropCount = count;
        oreColor = color;
        displayName = n;
        ...
        DragonAPICore.log(
            "Adding ore entries for " + this.toString()
            + " (Ore Names: " + Arrays.toString(ore) + ")"
        );
    }
    ...
    public static void initializeAll() {
        if (!DragonAPIInit.canLoadHandlers())
            throw new MisuseException(
                "Initialized registry enum too early! Wait until postInit!"
            );
    ...
    public void initialize() {
        ...
        for (int i = 0; i < oreLabel.length; i++) {
            ...
            if (!toadd.isEmpty()) {
                ...
                DragonAPICore.log(
                    "\tDetected the following blocks for " + this + " from OreDict \""
                    + label + "\": " + toadd.toString()
                );
                for (ItemStack is : toadd) {
                    if (ReikaItemHelper.isBlock(is)) {
                        ...
                        DragonAPICore.log(
                            "\t" + is
                            + " is not an ore block, but was OreDict fetched by \""
                            + label + "\"!"
                        );
                    }
                }
    ...
    public boolean isThaumcraft() {
        return this.name().contains("INFUSED") || this.name().equals("CINNABAR")
            || this.name().equals("AMBER");
    }
    ...
    public static ModOreList getModOreFromOre(ItemStack is) {
        ...
        if (ReikaItemHelper.matchStackWithBlock(is, MekanismHandler.getInstance().oreID))
            return MekanismHandler.getInstance().getModOre(
    ...
    public boolean isRare() {
        return this == PLATINUM || this == NETHERPLATINUM || this == IRIDIUM ||	this ==
    MOONSTONE || this == NETHERIRIDIUM;
    }*/
    ...
    public EnumSet<OreLocation> getOreLocations() {
        ...
        return this.isEnd()   ? EnumSet.of(OreLocation.END)
            : this.isNether() ? EnumSet.of(OreLocation.NETHER)
                              : EnumSet.of(OreLocation.OVERWORLD);
    }
