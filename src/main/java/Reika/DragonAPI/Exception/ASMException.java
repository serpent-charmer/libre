...
public abstract class ASMException extends RuntimeException {
    ...
    private abstract static class NoSuchInstructionASMException extends ASMException {
        ...
        public String getMessage() {
            StringBuilder sb = new StringBuilder();
            sb.append(
                "Error ASMing method " + method.name + " " + method.desc + " in "
                + owner.name + ":\n"
            );
            return sb.toString();
        }
    ...
    public static class NoSuchASMMethodInstructionException
        extends NoSuchInstructionASMException {
        private final String callName;
        private final String callDesc;
        private final int callInt;

        public NoSuchASMMethodInstructionException(
            ClassNode cn, MethodNode m, String own, String name, String sig, int n
        ) {
            super(cn, m, own);
            callName = name;
            callDesc = sig;
        ...
        public String getMessage() {
            ...
            sb.append(
                "Could not find an instruction for a method call to " + memberOwner
                + "'s " + callName + " " + callDesc + ":\n"
            );
            if (callInt > 0)
    ...
    public static class NoSuchASMFieldInstructionException
        extends NoSuchInstructionASMException {
        private final String callName;
        //private final String callDesc;
        private final int callInt;

        public NoSuchASMFieldInstructionException(
            ClassNode cn, MethodNode m, String own, String name, int n
        ) {
            super(cn, m, own);
            callName = name;
            //callDesc = desc;
        ...
        public String getMessage() {
            ...
            sb.append(super.getMessage());
            sb.append(
                "Could not find an instruction for a field call to " + memberOwner + "'s "
                + callName + ":\n"
            );
            if (callInt > 0)
    ...
    private abstract static class NoSuchMemberASMException extends ASMException {
        ...
        public final String getMessage() {
            ...
            sb.append(
                " If you are the developer of this mod, check for proper use of SRG/deobf names and/or sideonly elements."
            );
        ...
        public final boolean isVanillaClass() {
            return ASMException.isVanillaClass(node
            ); //need the direct class reference or compiler has a seizure <_<
        }
    ...
    public static final class NoSuchASMMethodException extends NoSuchMemberASMException {
        ...
        protected String getAdditionalInformation() {
            ...
            if (DEV_ENV && label.startsWith("func_")) {
                ...
                sb.append(
                    "Use of non-SRG name in compiled game on vanilla code. This is very likely an error.\n"
                );
            }
    ...
    public static final class DuplicateASMMethodException
        extends DuplicateMemberASMException {
        private final String signature;
    ...
    public static final class DuplicateASMFieldException
        extends DuplicateMemberASMException {
    ...
    public static final class ASMConflictException extends ASMException {
        ...
        public ASMConflictException(
            String mod, ClassNode cn, MethodNode m, String p, String msg
        ) {
            super(cn);
        ...
        public String getMessage() {
            ...
            sb.append("\n");
            sb.append(
                "It is not possible to identify the other conflicting mod or mods; there may be multiple and the condition may be complex."
            );
            sb.append("\n");
            sb.append(
                "However, try reproducing this error with ONLY a base Forge installation, without tweaks such as KCauldron, Optifine, or FastCraft."
            );
            sb.append("\n");
            sb.append(
                "Due to their nature, such tweak mods are the most likely causes of the conflict."
            );
            sb.append("\n");
            sb.append(
                "Once you identify the conflict, contact the developers of both mods so that a solution can be attempted."
            );
            sb.append("\n");
            ...
            sb.append("\n");
            sb.append(
                "A .class file was generated in your MC folder, under the \"ClassError\" subfolder. Find the one with the matching name."
            );
            return sb.toString();
        }
    }
