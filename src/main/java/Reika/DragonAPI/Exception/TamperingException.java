...
public class TamperingException extends DragonAPIException {
    public TamperingException(DragonAPIMod mod, String culpritMod) {
        ...
        message.append(
            culpritMod + "tried to edit " + mod.getDisplayName() + "'s code.\n"
        );
        message.append(
            "The author of " + culpritMod + " is NOT authorized to do this and "
            + mod.getModAuthorName() + " has \n"
        );
        message.append(
            "disallowed the game from continuing. Try contacting the author of "
            + culpritMod + ", or\n"
        );
        message.append(
        ...
        message.append(
            "This is not a " + mod.getDisplayName()
            + " bug, but please post it to the mod site at\n"
        );
