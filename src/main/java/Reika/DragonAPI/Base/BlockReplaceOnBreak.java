...
public abstract class BlockReplaceOnBreak extends Block {
    ...
    {
        //ReikaBlockHelper.doBlockHarvest(world, ep, x, y, z, meta, this,
    this.harvesters);
    }*/
    ...
    public abstract Block getBlockReplacedWith(
        EntityPlayer ep, int x, int y, int z, int oldMeta, boolean willHarvest
    );
    public abstract int getMetaReplacedWith(
        EntityPlayer ep, int x, int y, int z, int oldMeta, boolean willHarvest
    );
    ...
    public class BlockReplaceSelfOnBreak extends BlockReplaceOnBreak {
        ...
        @Override
        public final Block getBlockReplacedWith(
            EntityPlayer ep, int x, int y, int z, int oldMeta, boolean willHarvest
        ) {
            return this;
        }
        ...
        @Override
        public final int getMetaReplacedWith(
            EntityPlayer ep, int x, int y, int z, int oldMeta, boolean willHarvest
        ) {
            return oldMeta;
        }
