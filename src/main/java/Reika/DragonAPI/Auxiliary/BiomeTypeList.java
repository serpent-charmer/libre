...
public enum BiomeTypeList {
    ...
    RAINBOW(
        ...
        "Reika.ChromatiCraft.World.BiomeRainbowForest"
    ),
    ENDER(
        "Ender Forest",
        ModList.CHROMATICRAFT,
        "Reika.ChromatiCraft.World.BiomeEnderForest"
    ),
    GLOWCLIFFS(
        "Luminous Cliffs",
        ModList.CHROMATICRAFT,
        "Reika.ChromatiCraft.World.BiomeGlowingCliffs"
    );
    ...
    public static BiomeTypeList getEntry(BiomeGenBase biome) {
        ...
        if (biome.getClass().getCanonicalName() == null
            && biome.getClass().getEnclosingClass() != null) {
