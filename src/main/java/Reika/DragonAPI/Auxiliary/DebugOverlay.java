...
public class DebugOverlay {
    ...
    public void eventHandler(RenderGameOverlayEvent.Post event) {
        if (event.type == ElementType.HELMET) {
            ...
            if (DragonOptions.TABNBT.getState()
                && Keyboard.isKeyDown(DragonOptions.DEBUGKEY.getValue())) {
                ...
                if (mc.currentScreen == null) {
                    ...
                    MovingObjectPosition hit
                        = ReikaPlayerAPI.getLookedAtBlockClient(4, false);
                    if (hit != null) {
                        int x = hit.blockX;
                        int y = hit.blockY;
                        int z = hit.blockZ;
                        ...
                        if (b.hasTileEntity(ep.worldObj.getBlockMetadata(x, y, z))) {
                            ...
                            if (te != null) {
                                ...
                                try {
                                    ...
                                    li.add(
                                        EnumChatFormatting.RED.toString() + e.getClass()
