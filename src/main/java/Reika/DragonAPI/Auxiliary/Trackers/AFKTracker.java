...
public class AFKTracker {
    ...
    public boolean isPlayerAFK(EntityPlayer ep) {
        return TIMER > 0 && lastActivity.containsKey(ep)
            && lastActivity.get(ep) + TIMER < ep.worldObj.getTotalWorldTime();
    }
    ...
    public static void refreshPlayer(NetHandlerPlayServer nh, Packet p) {
        ...
        if (p.getClass() != C03PacketPlayer.class) {
            ...
            //ReikaJavaLibrary.pConsole("Refreshing "+ep+" @
            //"+ep.worldObj.getTotalWorldTime());
    ...
    private static class PositionData {
        ...
        public boolean equals(Object o) {
            if (o instanceof PositionData) {
                ...
                return pd.posX == posX && pd.posY == posY && pd.posZ == posZ
                    && pd.bottomY == bottomY && pd.onGround == onGround;
            }
            return false;
        }
    }
