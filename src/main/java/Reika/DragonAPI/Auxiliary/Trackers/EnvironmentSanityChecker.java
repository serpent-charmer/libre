...
public class EnvironmentSanityChecker {
    public static final EnvironmentSanityChecker instance
        = new EnvironmentSanityChecker();
            ...
            if (b != null) {
                if (b.biomeID != i) {
                    if (i != BiomeGenBase.megaTaigaHills.biomeID + 128 + 1) {
                        ...
                        throw new EnvironmentSanityException(
                            ErrorType.IDMISMATCH, b, i, b.biomeID
                        );
                    }
                } else {
                    this.verifyBiome(b);
    ...
    private void checkEnchants() {
        for (int i = 0; i < Enchantment.enchantmentsList.length; i++) {
            ...
            if (e != null) {
                if (e.effectId != i) {
                    throw new EnvironmentSanityException(
                        ErrorType.IDMISMATCH, e, i, e.effectId
                    );
                } else {
    ...
    private void checkDungeonLoot() {
        try {
            ...
            for (String s : map.keySet()) {
                ...
                ArrayList<WeightedRandomChestContent> li
                    = (ArrayList<WeightedRandomChestContent>) f2.get(c);
                ...
                while (it.hasNext()) {
                    ...
                    try {
                        if (is == null) {
                            throw new EnvironmentSanityException(
                                ErrorType.LOOT, is, s, "Null Stack"
                            );
                        } else if (is.getItem() == null) {
                            throw new EnvironmentSanityException(
                                ErrorType.LOOT, is, s, "Null-Item ItemStack"
                            );
                        } else if (!ReikaItemHelper.verifyItemStack(is, true)) {
                            throw new EnvironmentSanityException(
                                ErrorType.LOOT, is, s, "Errors on handling"
                            );
                        }
                    } catch (EnvironmentSanityException e) {
                        if (DragonOptions.FIXSANITY.getState()) {
                            DragonAPICore.logError(
                                "Found invalid item " + getSafeItemString(is)
                                + " registered to dungeon loot tag '" + s + "'"
                            );
                            it.remove();
                        } else {
                            throw e;
    ...
    private void verifyOreDictItem(String tag, ItemStack is) {
        ...
        try {
            ...
            throw new EnvironmentSanityException(
                ErrorType.OREDICT, is, tag, e, "Display Name"
            );
        }
    ...
    private void doClientOreDictVerification(String tag, ItemStack is2) {
        ...
        for (ItemStack is : li) {
            try {
                ...
                throw new EnvironmentSanityException(
                    ErrorType.OREDICT, is, tag, e, "Icon"
                );
            }
            ...
            try {
                ...
                RuntimeException exc = new IllegalStateException("Could not reset
            tessellator when trying to recover parsing invalid OreDict entry");
                ex.initCause(e);
                exc.initCause(ex);
                throw exc;
            }*/
                ...
                throw new EnvironmentSanityException(
                    ErrorType.OREDICT, is, tag, e, "Render"
                );
            }
        }
    }
    ...
    public void verifyBlock(Block b) throws EnvironmentSanityException {
        if (b.getMaterial() == null) {
            throw new EnvironmentSanityException(
                ErrorType.INVALIDVALUE, b, b.getMaterial(), "Material"
            );
        }
        if (b.stepSound == null) {
            throw new EnvironmentSanityException(
                ErrorType.INVALIDVALUE, b, b.stepSound, "Step Sound"
            );
        }
        if (b instanceof IFluidBlock && ((IFluidBlock) b).getFluid() == null) {
            throw new EnvironmentSanityException(
                ErrorType.INVALIDVALUE, b, null, "Null-fluid fluid block"
            );
        }
        try {
            b.getLocalizedName();
            ...
            throw new EnvironmentSanityException(
                ErrorType.UNPARSEABLE, b, e, "Localization"
            );
        }
    }
    ...
    public void verifyItem(Item i) throws EnvironmentSanityException {
        ...
        try {
            ...
            throw new EnvironmentSanityException(
                ErrorType.UNPARSEABLE, i, e, "Max Damage"
            );
        }
        try {
            ...
            throw new EnvironmentSanityException(
                ErrorType.UNPARSEABLE, i, e, "Stacksize Limit"
            );
        }
    }
    ...
    public void verifyBiome(BiomeGenBase b) throws EnvironmentSanityException {
        if (b.biomeName == null) {
            if (DragonOptions.FIXSANITY.getState())
                ...
                throw new EnvironmentSanityException(
                    ErrorType.INVALIDVALUE, b, b.biomeName, "Name"
                );
        }
        if (b.topBlock == null) {
            if (DragonOptions.FIXSANITY.getState())
                ...
                throw new EnvironmentSanityException(
                    ErrorType.INVALIDVALUE, b, b.topBlock, "Top Block"
                );
        }
        if (b.fillerBlock == null) {
            if (DragonOptions.FIXSANITY.getState())
                ...
                throw new EnvironmentSanityException(
                    ErrorType.INVALIDVALUE, b, b.fillerBlock, "Filler Block"
                );
        }
        if (b.theBiomeDecorator == null) {
            if (DragonOptions.FIXSANITY.getState())
                ...
                throw new EnvironmentSanityException(
                    ErrorType.INVALIDVALUE, b, b.theBiomeDecorator, "Decorator"
                );
        }
        ...
        for (int i = 0; i < EnumCreatureType.values().length; i++) {
            ...
            if (b.getSpawnableList(e) == null) {
                throw new EnvironmentSanityException(ErrorType.INVALIDVALUE, b,
        b.getSpawnableList(e), "Spawnable List");
            }
        }*/
    }
    ...
    public void verifyEnchant(Enchantment e) throws EnvironmentSanityException {
        if (e.type == null) {
            if (DragonOptions.FIXSANITY.getState())
                ...
                throw new EnvironmentSanityException(
                    ErrorType.INVALIDVALUE, e, e.type, "Type"
                );
        }
        try {
            e.getName();
        ...
        try {
            ...
            throw new EnvironmentSanityException(
                ErrorType.UNPARSEABLE, e, ex, "Localization"
            );
        }
    }
    ...
    public void verifyPotion(Potion p) throws EnvironmentSanityException {
        if (p.getName() == null) {
            if (DragonOptions.FIXSANITY.getState())
                ...
                throw new EnvironmentSanityException(
                    ErrorType.INVALIDVALUE, p, p.getName(), "Name"
                );
        }
    }
