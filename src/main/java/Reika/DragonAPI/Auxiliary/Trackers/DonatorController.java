...
public final class DonatorController {
    ...
    public static final String reikaURL
        = "https://reikasminecraft.overminddl1.com/Donator/donators_";
    ...
    public void registerMod(DragonAPIMod mod, String root) {
        ...
        if (file == null) {
            DragonAPICore.logError(
                "Could not create URL to donator file. Donators will not be loaded."
            );
            return;
        }
    ...
    private void addDonators(DragonAPIMod mod, List<String> lines) {
        for (String s : lines) {
            ...
            parts[parts.length - 1]
                = ReikaStringParser.clipStringBefore(parts[parts.length - 1], "//");
            if (parts.length == 3) {
    ...
    /**
     * This function does all the work for you. Provide the donation in dollar.cent
     * amounts (eg 12.50F). Returns the total from this donator.
     */
     ...
     */
    private float
    addDonation(DragonAPIMod mod, String donator, String ingame, float donation) {
        boolean flag = false;
        ...
        Donator d = li.addDonation(
            donator, ingame != null ? UUID.fromString(ingame) : null, donation
        );
    ...
    public static class Donator {
        ...
        public boolean equals(Object o) {
            if (o instanceof Donator) {
                ...
                if (d.ingameName == null || ingameName == null)
                    return false;
                return d.ingameName.equals(ingameName)
                    && d.displayName.equals(displayName);
            }
            return false;
        }
        ...
        @Override
        public int hashCode() {
            return (ingameName != null ? ingameName.hashCode() : 0)
