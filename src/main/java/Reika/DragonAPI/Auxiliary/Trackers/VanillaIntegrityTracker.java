...
public final class VanillaIntegrityTracker {
                ...
                try {
                    ...
                    if (o == null) {
                        throw new WTFException(
                            "Some mod is deleting the value of the block field " + f, true
                        );
        ...
        for (int i = 0; i < items.length; i++) {
            ...
            if (Modifier.isStatic(f.getModifiers())) {
                try {
                    ...
                    if (o == null) {
                        throw new WTFException(
                            "Some mod is deleting the value of the item field " + f, true
                        );
    ...
    public void addWatchedBlock(DragonAPIMod mod, Block b) {
        ...
        if (f == null)
            throw new MisuseException(
                "Invalid block specified! No vanilla block has ID " + b + " and class "
    ...
    public void addWatchedItem(DragonAPIMod mod, Item i) {
        ...
        if (f == null)
            throw new MisuseException(
                "Invalid item specified! No vanilla item has ID " + i + " and class "
