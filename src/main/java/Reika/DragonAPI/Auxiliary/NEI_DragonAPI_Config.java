...
/**
 * Allows you to hide items from NEI without having to write a special class implementing
 * {@link codechicken.nei.api.IConfigureNEI}. Only call this class if NEI is loaded, or
 * you will create an NEI dependence in your mod.
 */
