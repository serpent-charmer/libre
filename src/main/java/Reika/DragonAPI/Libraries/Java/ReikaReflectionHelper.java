...
public final class ReikaReflectionHelper extends DragonAPICore {
    ...
    public static Block createBlockInstance(DragonAPIMod mod, RegistrationList list) {
        try {
            Constructor c
                = list.getObjectClass().getConstructor(list.getConstructorParamTypes());
            ...
            throw new RegistrationException(
                mod,
                list.getObjectClass().getSimpleName()
                    + " does not have the specified constructor "
                    + Arrays.toString(list.getConstructorParamTypes())
                    + "! Check visibility and material args!"
            );
        } catch (SecurityException e) {
            throw new RegistrationException(
                mod, list.getObjectClass().getSimpleName() + " threw security exception!"
            );
        } catch (InstantiationException e) {
            throw new RegistrationException(
                mod,
                list.getObjectClass().getSimpleName() + " did not allow instantiation!"
            );
        } catch (IllegalAccessException e) {
            throw new RegistrationException(
                mod,
                list.getObjectClass().getSimpleName()
                    + " threw illegal access exception! (Nonpublic constructor)"
            );
        } catch (IllegalArgumentException e) {
            throw new RegistrationException(
                mod,
                list.getObjectClass().getSimpleName() + " was given invalid parameters!"
            );
            ...
            if (t instanceof IllegalArgumentException)
                ...
                throw new RegistrationException(
                    mod,
                    list + " (" + list.getObjectClass().getSimpleName()
                        + ") threw invocation target exception: " + e + " with "
                        + e.getCause() + " (" + e.getCause().getMessage() + ")"
                );
            }
            //return null;
            ...
            e.printStackTrace();
            throw new RegistrationException(
                mod, "Failed to load " + list + " due to a missing class: ", e
            );
        }
    }
    ...
    public static Item createItemInstance(DragonAPIMod mod, RegistrationList list) {
        try {
            ...
            throw new RegistrationException(
                mod,
                "Item Class " + list.getObjectClass().getSimpleName()
                    + " does not have the specified constructor "
                    + Arrays.toString(list.getConstructorParamTypes()) + "!"
            );
        } catch (SecurityException e) {
    ...
    public static Item createBasicItemInstance(
        DragonAPIMod mod,
        Class<? extends Item> cl,
        int id,
        String unloc,
        boolean overwrite
    ) {
        ...
        try {
            ...
            throw new MisuseException(
                "Item Class " + cl.getSimpleName()
                + " does not have the specified constructor!"
            );
        } catch (SecurityException e) {
            throw new MisuseException(
                "Item Class " + cl.getSimpleName() + " threw security exception!"
            );
        } catch (InstantiationException e) {
            throw new MisuseException(
                cl.getSimpleName() + " did not allow instantiation!"
            );
        } catch (IllegalAccessException e) {
            throw new MisuseException(
                cl.getSimpleName()
            ...
            throw new MisuseException(
                cl.getSimpleName() + " was given invalid parameters!"
            );
        } catch (InvocationTargetException e) {
            Throwable t = e.getCause();
            if (t instanceof IllegalArgumentException)
                ...
                throw new MisuseException(
                    cl.getSimpleName() + " threw invocation target exception: " + e
                    + " with " + e.getCause() + " (" + e.getCause().getMessage() + ")"
                );
        } catch (NoClassDefFoundError e) {
            e.printStackTrace();
            throw new RegistrationException(
                mod, "Failed to load " + cl + " due to a missing class: " + e
            );
        }
    }

    public static Enchantment createEnchantmentInstance(
        DragonAPIMod mod,
        Class<? extends Enchantment> cl,
        int id,
        String unloc,
        boolean overwrite
    ) {
        ...
        try {
            ...
            throw new MisuseException(
                "Enchantment Class " + cl.getSimpleName()
                + " does not have the specified constructor!"
            );
        } catch (SecurityException e) {
            throw new MisuseException(
                "Enchantment Class " + cl.getSimpleName() + " threw security exception!"
            );
        } catch (InstantiationException e) {
            throw new MisuseException(
                cl.getSimpleName() + " did not allow instantiation!"
    ...
    public static int getPrivateInteger(Object obj, String field, ModLogger log) {
        try {
            ...
            if (f == null) {
                if (log.shouldDebug()) {
                    DragonAPICore.logError(
                        "Could not find field " + field + " in " + obj
                    );
            ...
            if (log.shouldDebug()) {
                DragonAPICore.logError(
                    "Security Manager locked field " + field + " in " + obj
                );
    ...
    /**
     * Gets a nonvisible field that may be inherited by any of the superclasses. Returns
     * null if none exists.
     */
    ...
    getProtectedInheritedMethod(Object o, String method, Class... types) {
        return getProtectedInheritedMethod(o.getClass(), method, types);
    }

    /**
     * Gets a nonvisible Method that may be inherited by any of the superclasses. Returns
     * null if none exists.
     */
    public static Executable
    getProtectedInheritedMethod(Class c, String method, Class... types) {
        Executable f = null;
    ...
    public static void setFinalField(Class c, String s, Object instance, Object o)
        throws Exception {
        setFinalField(getProtectedInheritedField(c, s), instance, o);
    }

    public static void setFinalField(Field f, Object instance, Object o)
        throws Exception {
        try {
            f.setAccessible(true);
            ...
            if (e.toString().contains("Can not set final")) {
                throw new RuntimeException(
                    "You need to un-final a field BEFORE any accesses (ie f.get() calls)!",
                    e
                );
            } else {
                throw e;
    ...
    checkForMethod(Class c, String name, Class[] args, int... modifiers) {
        try {
    ...
    /**
     * Note that this does not support overloading, as to do so would compromise
     * performance.
     */
    public static Object
    cacheAndInvokeMethod(String cl, String name, Object ref, Object... args) {
        try {
