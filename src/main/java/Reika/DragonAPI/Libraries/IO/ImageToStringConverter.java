...
public class ImageToStringConverter {
    ...
    private static void setColorsAt(BufferedImage img, int px, int color) {
        ...
        int c1 = ReikaColorAPI.RGBtoHex(
            rand.nextInt(255),
            rand.nextInt(255),
            vals[0],
            ReikaRandomHelper.getRandomBetween(64, 255)
        );
        int c2 = ReikaColorAPI.RGBtoHex(
            rand.nextInt(255),
            vals[1],
            rand.nextInt(255),
            ReikaRandomHelper.getRandomBetween(64, 255)
        );
        int c3 = ReikaColorAPI.RGBtoHex(
            vals[2],
            rand.nextInt(255),
            rand.nextInt(255),
            ReikaRandomHelper.getRandomBetween(64, 255)
        );
        int c4 = ReikaColorAPI.RGBtoHex(
            rand.nextInt(255), rand.nextInt(255), rand.nextInt(255), vals[3]
        );
