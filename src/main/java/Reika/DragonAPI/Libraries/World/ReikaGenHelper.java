...
public final class ReikaGenHelper extends DragonAPICore {
    /**
     * Adds an ItemStack to chest generation. Args: Chest Type, ItemStack, min size, max
     * size, frequency
     */
    public static void
    addStackToChestGen(String chest, ItemStack is, int min, int max, int rate) {
        addChestLoot(chest, is, min, max, rate);
    }

    /**
     * Adds an ItemStack to village chests. Args: ItemStack, min size, max size,
     * frequency
     */
    ...
    /**
     * Adds an ItemStack to dungeons (and many mod dungeons). Args: ItemStack, min size,
     * max size, frequency
     */
    ...
    /**
     * Adds an ItemStack to abandoned mineshafts. Args: ItemStack, min size, max size,
     * frequency
     */
    ...
    /**
     * Adds an ItemStack to stronghold hallways. Args: ItemStack, min size, max size,
     * frequency
     */
    ...
    /**
     * Adds an ItemStack to stronghold "crossings". Args: ItemStack, min size, max size,
     * frequency
     */
    ...
    /**
     * Adds an ItemStack to stronghold libraries. Args: ItemStack, min size, max size,
     * frequency
     */
    ...
    /**
     * Adds an ItemStack to desert temples. Args: ItemStack, min size, max size,
     * frequency
     */
    ...
    /**
     * Adds ItemStacks to chest generation. Args: Chest Type, ItemStacks, min size, max
     * size, frequency
     */
    public static void addStacksToChestGen(
        String chest, Collection<ItemStack> li, int min, int max, int rate
    ) {
        for (ItemStack is : li)
            addChestLoot(
                chest, is, min, max, rate
            ); //ChestGenHooks.getInfo(chest).addItem(new WeightedRandomChestContent(is,
               //min, max, rate));
    }

    public static void
    addChestLoot(Location loc, ItemStack is, int minSize, int maxSize, int weight) {
        addChestLoot(loc.tag, is, minSize, maxSize, weight);
    }

    public static void
    addChestLoot(String location, ItemStack is, int minSize, int maxSize, int weight) {
        if (is == null || is.getItem() == null)
            throw new MisuseException("You cannot add null items to the loot tables!");
        WeightedRandomChestContent stack
            = new WeightedRandomChestContent(is, minSize, maxSize, weight);
