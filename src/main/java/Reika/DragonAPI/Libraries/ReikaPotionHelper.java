...
public final class ReikaPotionHelper extends DragonAPICore {
    ...
    getPotionItem(Potion potion, boolean extended, boolean levelII, boolean splash) {
    ...
    public static int getPotionDamageValue(Potion potion) {
        return potionDamageValues.containsKey(potion) ? potionDamageValues.get(potion)
                                                      : 0;
    }
    ...
    public static void clearPotionsExceptSome(EntityLivingBase e, Potion... potions) {
        ...
        for (int i = 0; i < keep.size(); i++) {
            ...
            e.addPotionEffect(new PotionEffect(pot.getPotionID(), pot.getDuration(),
    pot.getAmplifier()));
        }
    }
