...
public enum ReikaDyeHelper {
    ...
    private static final MultiMap<KeyedItemStack, ReikaDyeHelper> colorMap
        = new MultiMap(CollectionType.HASHSET).setNullEmpty();
    private static final MultiMap<ReikaDyeHelper, ReikaDyeHelper> similarityMap
    ...
    public int getColor() {
        return ReikaTextureHelper.isDefaultResourcePack() ? color
    ...
    public Color getJavaColor() {
        return Color.decode(String.valueOf(
    ...
    public double[] getRedstoneParticleVelocityForColor() {
        ...
        double[] c = new double[] { this.getRed() / 255D,
                                    this.getGreen() / 255D,
                                    this.getBlue() / 255D };
        return c;
    }
    ...
    public void setGLColorBlend() {
        ...
        GL11.glColor3d(
            this.getRed() / 255D, this.getGreen() / 255D, this.getBlue() / 255D
        );
    }
