...
public class GasPropertyCalculator {
    ...
    //these vary with T, and that is going into too much detail; assume calorically
    //perfect public double pressureCoefficient; public double volumeCoefficient;
    ...
    getPressure(double rho, double t) { //ideal gas law, p = rho * R * T
        return Rair * rho * t;
    }
