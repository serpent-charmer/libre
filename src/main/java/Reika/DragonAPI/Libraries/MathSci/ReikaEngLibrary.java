...
public final class ReikaEngLibrary extends DragonAPICore {
    ...
    mat_rot_tensfailure(double m, int rpm, double radius, double A, double sigmamax) {
    ...
    /**
     * Returns true if the material would fail due to centripetal tensile forces. Assumes
     * a solid circular shaft. Args: Density, radius, omega, Ultimate Tensile Strength
     */
    public static boolean
    mat_rotfailure(double rho, double radius, double omega, double sigmamax) {
    ...
    /**
     * Calculates the rotational kinetic energy of a circular mass. Args: density,
     * thickness, omega, radius
     */
    ...
    getHeatFromFriction(double Fnormal, double mu, double vSlip, double eta) {
