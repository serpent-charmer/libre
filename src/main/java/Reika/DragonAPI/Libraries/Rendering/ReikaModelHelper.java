...
public class ReikaModelHelper {
    ...
    public static void flipUVs(ModelBox box, boolean x, boolean y, boolean z) {
        boolean[] doFlip
            = new boolean[] { y || z, y || z, x || z, x || z, x || y, x || y };
        for (int i = 0; i < 6; i++) {
            ForgeDirection dir = ForgeDirection.VALID_DIRECTIONS[i];
            if ((dir.offsetX == 0 && x) || (dir.offsetY == 0 && y)
                || (dir.offsetZ == 0 && z)) {
    ...
    private static void
    flipFace(TexturedQuad quad, ForgeDirection face, boolean x, boolean y, boolean z) {
        /*
        if (x) {
        ...
        float temp;
        switch (face) {
            case DOWN: //boxURoot + sizeZ, boxVRoot, boxURoot + sizeZ + sizeX, boxVRoot +
                       //sizeZ
            case UP: //boxURoot + sizeZ + sizeX, boxVRoot + sizeZ, boxURoot + sizeZ +
                     //sizeX + sizeX, boxVRoot
                if (x) {
                ...
                break;
            case EAST: //boxURoot + sizeZ + sizeX, boxVRoot + sizeZ, boxURoot + sizeZ +
                       //sizeX + sizeZ, boxVRoot + sizeZ + sizeY
            case WEST: //boxURoot, boxVRoot + sizeZ, boxURoot + sizeZ, boxVRoot + sizeZ +
                       //sizeY
                if (z) {
                    temp = quad.vertexPositions[0].texturePositionX;
                    quad.vertexPositions[0].texturePositionX
                ...
                break;
            case NORTH: //boxURoot + sizeZ, boxVRoot + sizeZ, boxURoot + sizeZ + sizeX,
                        //boxVRoot + sizeZ + sizeY
            case SOUTH: //boxURoot + sizeZ + sizeX + sizeZ, boxVRoot + sizeZ, boxURoot +
                        //sizeZ + sizeX + sizeZ + sizeX, boxVRoot + sizeZ + sizeY
                if (x) {
                    temp = quad.vertexPositions[0].texturePositionX;
                    quad.vertexPositions[0].texturePositionX
                        = quad.vertexPositions[2].texturePositionX;
