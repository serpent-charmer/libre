...
public interface OreType extends RegistryType {
    ...
    public static enum OreRarity {
        EVERYWHERE(
            "Large and very common veins", "Copper and Fluorite"
        ), //Copper, Fluorite
        ...
        SCARCE(
            "Veins are smaller and often hard to find", "Lapis and Diamond"
        ), //Lapis, Diamond
        RARE(
            "Generally a single block or two per chunk", "Emerald and Platinum"
        ); //Emerald, Platinum
