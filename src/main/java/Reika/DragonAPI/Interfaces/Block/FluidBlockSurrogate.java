...
/**
 * Implement this if the block can be treated as a liquid source block for some
 * implementations (eg an open-top vat being a valid source for a suction pump).
 */
