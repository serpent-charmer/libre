...
public abstract class ReflectiveBasedCommand extends DragonCommandBase {
    ...
    static {
        ...
        packageShortcuts.put(
            "mcworld", "net.minecraft.world"
        ...
        classShortcuts
            .put("EntityLivingBase", net.minecraft.entity.EntityLivingBase.class);
        classShortcuts
            .put("EntityPlayer", net.minecraft.entity.player.EntityPlayer.class);
        classShortcuts
            .put("EntityPlayerMP", net.minecraft.entity.player.EntityPlayerMP.class);
        ...
        classShortcuts.put(
            "ChunkProviderServer", net.minecraft.world.gen.ChunkProviderServer.class
        );
        classShortcuts.put(
            "ChunkProviderGenerate", net.minecraft.world.gen.ChunkProviderGenerate.class
        );

        classShortcuts
            .put("DimensionManager", net.minecraftforge.common.DimensionManager.class);
        ...
        classShortcuts
            .put("ForgeDirection", net.minecraftforge.common.util.ForgeDirection.class);
        ...
        classShortcuts
            .put("FluidRegistry", net.minecraftforge.fluids.FluidRegistry.class);
        classShortcuts
            .put("GameRegistry", cpw.mods.fml.common.registry.GameRegistry.class);
        classShortcuts
            .put("OreDictionary", net.minecraftforge.oredict.OreDictionary.class);

        classShortcuts
            .put("ASMHelper", Reika.DragonAPI.Libraries.Java.ReikaASMHelper.class);
        classShortcuts.put(
            "ReflectionHelper", Reika.DragonAPI.Libraries.Java.ReikaReflectionHelper.class
        );
        classShortcuts
            .put("JavaLibrary", Reika.DragonAPI.Libraries.Java.ReikaJavaLibrary.class);
        classShortcuts
            .put("StringParser", Reika.DragonAPI.Libraries.Java.ReikaStringParser.class);
        classShortcuts
            .put("ArrayHelper", Reika.DragonAPI.Libraries.Java.ReikaArrayHelper.class);
        classShortcuts
            .put("MathLibrary", Reika.DragonAPI.Libraries.MathSci.ReikaMathLibrary.class);
        classShortcuts.put(
            "PhysicsHelper", Reika.DragonAPI.Libraries.MathSci.ReikaPhysicsHelper.class
        );
        classShortcuts
            .put("WorldHelper", Reika.DragonAPI.Libraries.World.ReikaWorldHelper.class);
        classShortcuts
            .put("BiomeHelper", Reika.DragonAPI.Libraries.World.ReikaBiomeHelper.class);
        classShortcuts
            .put("BlockHelper", Reika.DragonAPI.Libraries.World.ReikaBlockHelper.class);
        classShortcuts
            .put("ItemHelper", Reika.DragonAPI.Libraries.Registry.ReikaItemHelper.class);
        classShortcuts
            .put("InventoryHelper", Reika.DragonAPI.Libraries.ReikaInventoryHelper.class);
        classShortcuts.put("PlayerAPI", Reika.DragonAPI.Libraries.ReikaPlayerAPI.class);
        classShortcuts.put(
            "PlantHelper", Reika.DragonAPI.Libraries.Registry.ReikaPlantHelper.class
        );
        classShortcuts
            .put("CropHelper", Reika.DragonAPI.Libraries.Registry.ReikaCropHelper.class);
        classShortcuts
            .put("OreHelper", Reika.DragonAPI.Libraries.Registry.ReikaOreHelper.class);
        classShortcuts
            .put("TreeHelper", Reika.DragonAPI.Libraries.Registry.ReikaTreeHelper.class);
    ...
    protected final UUID getUID(ICommandSender ics) {
        return ics instanceof EntityPlayer ? ((EntityPlayer) ics).getUniqueID()
                                           : consoleUUID;
    }
    ...
    protected final String toReadableString(Object o) {
        try {
            ...
            return "Object " + o.getClass().getName()
                + " threw exception on toString(): " + e.toString();
        }
    }
