        ...
        if (args.length != 2) {
            this.sendChatToSender(
                ...
                EnumChatFormatting.RED
                    + "You must specify an entity name and a number to spawn."
            );
            return;
        }
        ...
        if (test != null) {
            ...
            for (int i = 0; i < n; i++) {
                ...
                e.setLocationAndAngles(
                    ...
                    ey,
                    ez,
                    ReikaRandomHelper.getSafeRandomInt(360),
                    (float) ReikaRandomHelper.getRandomPlusMinus(0, 45D)
                );
            ...
            this.sendChatToSender(
                ics, EnumChatFormatting.RED + "Unrecognized entity '" + args[0] + "'."
            );
            return;
        }
    }
