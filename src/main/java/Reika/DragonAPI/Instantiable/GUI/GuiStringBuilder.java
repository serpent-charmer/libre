...
public final class GuiStringBuilder extends GuiScreen {
    ...
    public void initGui() {
        ...
        buttonList.add(
            new GuiButton(1, j + xSize / 3 + 3, k - 11, xSize / 3 - 2, 20, "Save To File")
        );
        buttonList.add(new GuiButton(
            2, j + 2 * xSize / 3, k - 11, xSize / 3 - 2, 20, "Read From File"
        ));
    ...
    public void sendPacket(int a) {
        ReikaPacketHelper.sendStringPacket(
            packetChannel, packetID + a, this.getFinalString(), world, x, y, z
        );
    }
