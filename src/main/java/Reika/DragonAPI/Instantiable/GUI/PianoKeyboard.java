...
public class PianoKeyboard extends Gui {
    ...
    private static final KeyShape[] shapeList
        = { KeyShape.LEFT,   KeyShape.BLACK,  KeyShape.MIDDLE, KeyShape.BLACK,
            KeyShape.MIDDLE, KeyShape.BLACK,  KeyShape.RIGHT,  KeyShape.LEFT,
            KeyShape.BLACK,  KeyShape.MIDDLE, KeyShape.BLACK,  KeyShape.RIGHT };
    ...
    public PianoKeyboard(int x, int y, MusicGui gui) {
        ...
        for (int m = 0; m < 4; m++) {
            for (int i = 0; i <= 4; i += 2) {
                int id = i + 1 + m * 12;
                keyList.add(new PianoKey(
                    id, x + dx + i * 4, y + 1, this.getShapeFromIndex(id), guiInstance
                ));
            }
            dx += 32;
            for (int i = 0; i <= 2; i += 2) {
        ...
        for (int i = 0; i <= 56; i += 2) {
            ...
            keyList.add(new PianoKey(
                id, x + i * 4, y + 1, this.getShapeFromIndex(id), guiInstance
            ));
        }
    }
    ...
    public static class PianoKey extends GuiButton {
        ...
        public void drawButton(Minecraft mc, int x, int y) {
            ...
            if (alpha > 0) {
                switch (hitbox) {
                    ...
                    case LEFT:
                        this.drawRect(
                            xPosition + 1, yPosition, xPosition + 6, yPosition + 35, rgb
                        );
                        this.drawRect(
                            xPosition + 6,
                            yPosition + 21,
                    ...
                    case MIDDLE:
                        this.drawRect(
                            xPosition + 2, yPosition, xPosition + 6, yPosition + 21, rgb
                        );
                        this.drawRect(
                            xPosition + 1,
                            yPosition + 21,
                    ...
                    case RIGHT:
                        this.drawRect(
                            xPosition + 2, yPosition, xPosition + 7, yPosition + 35, rgb
                        );
                        this.drawRect(
                            xPosition + 1,
                            yPosition + 21,
                    ...
                    case WHITE:
                        this.drawRect(
                            xPosition + 1, yPosition, xPosition + 7, yPosition + 35, rgb
                        );
                        break;
                    default:
                        break;
        ...
        public boolean mousePressed(Minecraft mc, int x, int y) {
            ...
            switch (hitbox) {
                case BLACK:
                    if (api.isMouseInBox(
                            xPosition, xPosition + 4, yPosition, yPosition + 21
                        ))
                        flag = true;
                    break;
                case LEFT:
                    if (api.isMouseInBox(
                            xPosition + 1, xPosition + 6, yPosition, yPosition + 35
                        ))
                        flag = true;
                    if (api.isMouseInBox(
                            xPosition + 5, xPosition + 7, yPosition + 21, yPosition + 35
                        ))
                        flag = true;
                    break;
                case MIDDLE:
                    if (api.isMouseInBox(
                            xPosition + 2, xPosition + 6, yPosition, yPosition + 35
                        ))
                        flag = true;
                    if (api.isMouseInBox(
                            xPosition + 1, xPosition + 7, yPosition + 21, yPosition + 35
                        ))
                        flag = true;
                    break;
                case RIGHT:
                    if (api.isMouseInBox(
                            xPosition + 2, xPosition + 7, yPosition, yPosition + 35
                        ))
                        flag = true;
                    if (api.isMouseInBox(
                            xPosition + 1, xPosition + 7, yPosition + 21, yPosition + 35
                ...
                case WHITE:
                    if (api.isMouseInBox(
                            xPosition + 1, xPosition + 7, yPosition, yPosition + 35
                        ))
                        flag = true;
                    break;
                default:
