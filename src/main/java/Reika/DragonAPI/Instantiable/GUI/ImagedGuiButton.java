...
public class ImagedGuiButton extends GuiButton {
    ...
    /**
     * Draw a Gui Button with an image background. Args: id, x, y, width, height, u, v,
     * filepath, class root
     */
    public ImagedGuiButton(
        int par1,
        int par2,
        int par3,
        int par4,
    ...
    */
    ...
    public final void drawButton(Minecraft mc, int mx, int my) {
        ...
        if (visible && !invisible) {
            ...
            if (displayString != null && !hasToolTip) {
                ...
                renderer.drawString(
                    displayString,
                    this.getLabelX() + alignment.getDX(renderer, displayString),
                    this.getLabelY(),
                    this.getLabelColor(),
                    shadow
                );
            ...
            if (icon != null) {
                ...
                ReikaGuiAPI.instance.drawTexturedModelRectFromIcon(
                    xPosition + dx, yPosition + dy, icon, iconWidth, iconHeight
                );
                GL11.glPopAttrib();
            }
    ...
    protected boolean isPositionWithin(int mx, int my) {
        return mx >= xPosition && my >= yPosition && mx < xPosition + width
            && my < yPosition + height;
    }
    ...
    public void
    drawTexturedModalRect(int x, int y, int u, int v, int w, int h, int c, int a) {
    ...
    public void func_146113_a(SoundHandler sh) {
        sh.playSound(
            PositionedSoundRecord.func_147674_a(new ResourceLocation(sound), 1.0F)
        );
    }
