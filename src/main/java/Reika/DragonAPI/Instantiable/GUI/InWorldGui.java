...
public abstract class InWorldGui {
    ...
    addButton(int id, int x, int y, int w, int h, int u, int v, String tex, Class root) {
    ...
    private static class TexturedButton extends Button {
        ...
        private TexturedButton(
            int id, int x, int y, int w, int h, int u, int v, Class c, String t
        ) {
            super(id, x, y, w, h);
            tex = t;
            root = c;
