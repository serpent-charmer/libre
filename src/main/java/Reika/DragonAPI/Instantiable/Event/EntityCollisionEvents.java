...
public class EntityCollisionEvents {
    public static class CollisionBoxEvent extends WorldPositionEvent {
        ...
        public AxisAlignedBB getDefaultAABB() {
            return this.getBlock().getCollisionBoundingBoxFromPool(
    ...
    getInterceptedCollisionBox(Entity e, World world, int x, int y, int z) {
    ...
    getInterceptedRaytrace(Entity e, Vec3 vec1, Vec3 vec2) {
