...
/**
  Generally not used for actual profiling handling, but for the massive number of hooks
  it provides into vanilla code. Check the profiler's calls to see potential uses.
*/
public class ProfileEvent {
    private static final MultiMap<String, ProfileEventWatcher> watchedTags
