...
public class EntityInvisibilityDeRenderEvent extends EntityEvent {
    ...
    public static boolean fire(Entity e, EntityPlayer caller) {
        EntityInvisibilityDeRenderEvent evt
            = new EntityInvisibilityDeRenderEvent(e, caller);
        ...
        switch (evt.getResult()) {
            ...
            default:
                return e instanceof EntityPlayer
                    ? isPlayerInvisible((EntityPlayer) e, caller)
                    : e.isInvisible();
        }
    }
    ...
    private static boolean isPlayerInvisible(EntityPlayer ep, EntityPlayer caller) {
        if (!ep.isInvisible()) {
            ...
            return team == null || caller == null || caller.getTeam() != team
                || !team.func_98297_h();
        }
    }
}
