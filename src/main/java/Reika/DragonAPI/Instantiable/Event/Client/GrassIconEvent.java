...
public class GrassIconEvent extends PositionEventClient {
    ...
    public GrassIconEvent(
        IBlockAccess world, int x, int y, int z, IIcon ico, Block b, boolean top
    ) {
        super(world, x, y, z);
    ...
    doFire(IIcon orig, Block b, IBlockAccess iba, int x, int y, int z, boolean top) {
