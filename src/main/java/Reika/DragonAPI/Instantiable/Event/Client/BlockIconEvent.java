...
public class BlockIconEvent extends PositionEventClient {
    ...
    public BlockIconEvent(
        IBlockAccess world, int x, int y, int z, IIcon ico, Block b, int m, int s
    ) {
        super(world, x, y, z);
    ...
    public static IIcon
    fire(Block b, IBlockAccess iba, int x, int y, int z, IIcon def, int s, int m) {
