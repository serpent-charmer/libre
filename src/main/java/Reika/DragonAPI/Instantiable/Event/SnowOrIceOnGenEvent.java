...
public final class SnowOrIceOnGenEvent extends WorldPositionEvent {
    ...
    private static boolean fireEvent(SnowOrIceOnGenEvent evt, boolean flag) {
        ...
        switch (evt.getResult()) {
            ...
            case DEFAULT:
            default:
                return evt.snowType == SnowType.SNOW
                    ? evt.world.func_147478_e(evt.xCoord, evt.yCoord, evt.zCoord, flag)
                    : evt.world.isBlockFreezable(evt.xCoord, evt.yCoord, evt.zCoord);
        }
    }
