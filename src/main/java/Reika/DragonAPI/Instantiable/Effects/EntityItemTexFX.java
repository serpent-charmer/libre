...
public class EntityItemTexFX extends EntityFX {
    ...
    public void renderParticle(
        Tessellator v5, float ptick, float rx, float ry, float rz, float rw, float rh
    ) {
        IIcon ico = item.getIconIndex();
        float f6 = ico.getMinU(
        ); //ico.getInterpolatedU(particleTextureJitterX / 4.0F * 16.0F);
        float f7 = ico.getMaxU(
        ); //ico.getInterpolatedU((particleTextureJitterX + 1.0F) / 4.0F * 16.0F);
        float f8 = ico.getMinV(
        ); //ico.getInterpolatedV(particleTextureJitterY / 4.0F * 16.0F);
        float f9 = ico.getMaxV(
        ); //ico.getInterpolatedV((particleTextureJitterY + 1.0F) / 4.0F * 16.0F);
        ...
        v5.addVertexWithUV(
            f11 - rx * f10 - rw * f10, f12 - ry * f10, f13 - rz * f10 - rh * f10, f6, f9
        );
        v5.addVertexWithUV(
            f11 - rx * f10 + rw * f10, f12 + ry * f10, f13 - rz * f10 + rh * f10, f6, f8
        );
        v5.addVertexWithUV(
            f11 + rx * f10 + rw * f10, f12 + ry * f10, f13 + rz * f10 + rh * f10, f7, f8
        );
        v5.addVertexWithUV(
            f11 + rx * f10 - rw * f10, f12 - ry * f10, f13 + rz * f10 - rh * f10, f7, f9
        );
    }
}
