...
public class LightningBolt {
    ...
    public DecimalPosition getPosition(int n) {
        return new DecimalPosition(
            middle[n].xCoord + offsets[n][0],
            middle[n].yCoord + offsets[n][1],
            middle[n].zCoord + offsets[n][2]
        );
    }
    ...
    public LightningBolt setVariance(
        double vx,
        double vy,
        double vz,
        Function<Integer, Double> funcX,
        Function<Integer, Double> funcY,
        Function<Integer, Double> funcZ
    ) {
    ...
    public LightningBolt setVelocity(
        double vx,
        double vy,
        double vz,
        Function<Integer, Double> funcX,
