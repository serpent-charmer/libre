...
public abstract class TemperatureEffect {
    ...
    public static final TemperatureEffect groundGlassing
        = new BlockConversionEffect(900) {
              @Override
              protected Block getBlock(int temperature) {
                  return Blocks.glass;
              }
    ...
    public static final TemperatureEffect snowVaporization
        = new BlockConversionEffect(0) {
              @Override
              protected Block getBlock(int temperature) {
                  return Blocks.air;
              }
    ...
    public final void
    apply(World world, int x, int y, int z, int temperature, TemperatureCallback call) {
