...
/**
 * <b>Oh look, a double-based version of rectangle, too. I wonder why that was
 * necessary...</b><br><br> A <code>Rectangle</code> specifies an area in a coordinate
 * space that is enclosed by the <code>Rectangle</code> object's upper-left point
 * {@code (x,y)}
...
public class DoubleRectangle {
    ...
    public String toString() {
        return this.getClass().getName() + "[x=" + x + ",y=" + y + ",width=" + width
            + ",height=" + height + "]";
    }
}
