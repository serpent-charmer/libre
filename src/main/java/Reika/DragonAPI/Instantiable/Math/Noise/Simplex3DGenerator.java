...
public class Simplex3DGenerator extends SimplexNoiseGenerator {
    ...
    calcValue(double x, double y, double z, double f, double a, Object obj) {
        ...
        //Floor to get simplectic honeycomb coordinates of rhombohedron (stretched cube)
        //super-cell origin.
        ...
        if (inSum <= 1) { //We're inside the tetrahedron (3-Simplex) at (0,0,0)
            ...
            //contribute. This depends on the closest two tetrahedral vertices, including
            //(0,0,0)
            double wins = 1 - inSum;
            if (wins > aScore
                || wins
                    > bScore) { //(0,0,0) is one of the closest two tetrahedral vertices.
                byte c
            ...
            if (attn0 > 0) {
                attn0 *= attn0;
                value += attn0 * attn0
                    * this.extrapolate(xsb + 0, ysb + 0, zsb + 0, dx0, dy0, dz0);
            }
            ...
            if (attn1 > 0) {
                attn1 *= attn1;
                value += attn1 * attn1
                    * this.extrapolate(xsb + 1, ysb + 0, zsb + 0, dx1, dy1, dz1);
            }
            ...
            if (attn2 > 0) {
                attn2 *= attn2;
                value += attn2 * attn2
                    * this.extrapolate(xsb + 0, ysb + 1, zsb + 0, dx2, dy2, dz2);
            }
            ...
            if (attn3 > 0) {
                attn3 *= attn3;
                value += attn3 * attn3
                    * this.extrapolate(xsb + 0, ysb + 0, zsb + 1, dx3, dy3, dz3);
            }
            ...
            if (wins < aScore
                || wins
                    < bScore) { //(1,1,1) is one of the closest two tetrahedral vertices.
                byte c
                    = (bScore < aScore ? bPoint : aPoint
                    ); //Our other closest vertex is the closest out of a and b.
            ...
            if (attn3 > 0) {
                attn3 *= attn3;
                value += attn3 * attn3
                    * this.extrapolate(xsb + 1, ysb + 1, zsb + 0, dx3, dy3, dz3);
            }
            ...
            if (attn2 > 0) {
                attn2 *= attn2;
                value += attn2 * attn2
                    * this.extrapolate(xsb + 1, ysb + 0, zsb + 1, dx2, dy2, dz2);
            }
            ...
            if (attn1 > 0) {
                attn1 *= attn1;
                value += attn1 * attn1
                    * this.extrapolate(xsb + 0, ysb + 1, zsb + 1, dx1, dy1, dz1);
            }
            ...
            if (attn0 > 0) {
                attn0 *= attn0;
                value += attn0 * attn0
                    * this.extrapolate(xsb + 1, ysb + 1, zsb + 1, dx0, dy0, dz0);
            }
            ...
            if (attn4 > 0) {
                attn4 *= attn4;
                value += attn4 * attn4
                    * this.extrapolate(xsb + 1, ysb + 1, zsb + 0, dx4, dy4, dz4);
            }
            ...
            if (attn5 > 0) {
                attn5 *= attn5;
                value += attn5 * attn5
                    * this.extrapolate(xsb + 1, ysb + 0, zsb + 1, dx5, dy5, dz5);
            }
            ...
            if (attn6 > 0) {
                attn6 *= attn6;
                value += attn6 * attn6
                    * this.extrapolate(xsb + 0, ysb + 1, zsb + 1, dx6, dy6, dz6);
            }
        }
    ...
    private double
    extrapolate(int xsb, int ysb, int zsb, double dx, double dy, double dz) {
