...
public class NonUniformDistribution {
    ...
    public static class CosineDistribution extends Distribution {
        ...
        public double evaluate(double arg) throws ArithmeticException {
            if (arg == peakX) {
                ...
                return ReikaMathLibrary.cosInterpolation2(
                    peakX, maxX, arg, peakY, baseValue
                );
            } else if (arg < peakX) {
                return ReikaMathLibrary.cosInterpolation2(
                    minX, peakX, arg, baseValue, peakY
                );
            } else {
                return 0;
            }
        ...
        public String toString() {
            return "Cosine distribution [" + minX + ", " + maxX + "] base " + baseValue
                + " peaking at " + peakX + "," + peakY;
        }
    }
    ...
    public static class TriangularDistribution extends Distribution {
        ...
        public TriangularDistribution(
            int x1, int x2, double base, int peakX, double peakY
        ) {
            super(x1, x2);
            this.peakX = peakX;
            this.peakY = peakY;
        ...
        @Override
        public String toString() {
            return "Pyramid distribution [" + minX + ", " + maxX + "] base " + baseValue
                + " peaking at " + peakX + "," + peakY;
        }
    }
}