...
public class VariableEndpointSpline {
    ...
    public VariableEndpointSpline(
        ...
        this(
            new DecimalPosition(x, y, z),
            new DecimalPosition(x2, y2, z2),
            t,
            points,
            variance,
            velocity
    ...
    public VariableEndpointSpline(
        ...
        for (int i = 0; i <= pointCount; i++) {
            BasicVariablePoint a = new BasicVariablePoint(
                new DecimalPosition(0, 0, 0), variance, velocity
            );
            a.tolerance = 0.0625;
            this.points.add(a);
            curve.addPoint(a);
