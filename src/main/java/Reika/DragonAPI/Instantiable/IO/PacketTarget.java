...
public abstract class PacketTarget {
    ...
    public static final class OtherPlayersTarget extends CompoundPlayerTarget {
        public OtherPlayersTarget(EntityPlayer ep, double r) {
            super(ep.worldObj.getEntitiesWithinAABBExcludingEntity(
                ep,
                ReikaAABBHelper.getEntityCenteredAABB(ep, r),
                new ReikaEntityHelper.ClassEntitySelector(EntityPlayerMP.class, true)
            ));
        }
    }
