...
public class Comparators {
    public static class CoordinateDistanceComparator implements Comparator<Coordinate> {
        ...
        public int compare(Coordinate o1, Coordinate o2) {
            return (int) Math.signum(ReikaMathLibrary.py3d(
                o1.xCoord - target.xCoord,
                o1.yCoord - target.yCoord,
                o1.zCoord - target.zCoord
            ));
        }
    }
    ...
    public static class PointDistanceComparator implements Comparator<Point> {
        ...
        public int compare(Point o1, Point o2) {
            return (int
            ) Math.signum(ReikaMathLibrary.py3d(o1.x - target.x, 0, o1.y - target.y));
        }
    }
}
