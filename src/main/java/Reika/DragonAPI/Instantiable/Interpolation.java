...
public class Interpolation {
    ...
    public double getValue(double key) {
        ...
        return isColor
            ? ReikaColorAPI.mixColors(d2.intValue(), d1.intValue(), f)
            : (cosInterpolate ? ReikaMathLibrary.cosInterpolation(key, x1, x2, d1, d2)
                              : ReikaMathLibrary.linterpolate(key, x1, x2, d1, d2));
    }
