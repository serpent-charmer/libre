...
public class MutableStructureRenderer extends StructureRenderer {
    ...
    public void addBlock(int x, int y, int z, Block b, int meta, TileEntity te) {
        ...
        //ReikaJavaLibrary.pConsole("Adding "+access.data[x+range][y+range][z+range]+" to
        //REL ("+x+","+y+","+z+")"); ReikaJavaLibrary.pConsole("Adding
        //"+access.data[dx][dy][dz]+" to
        //"+(x+access.negativeCorner.xCoord)+","+(y+access.negativeCorner.yCoord)+","+(z+access.negativeCorner.zCoord)+"
        //("+x+","+y+","+z+")");
        ...
        //ReikaJavaLibrary.pConsole("Adding "+access.data[dx][dy][dz]+" to rel
        //("+x+","+y+","+z+") (index "+dx+", "+dy+","+dz+")");
    }
}
