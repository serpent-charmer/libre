...
public class RGBColorData {
    ...
    public int getRenderColor() {
        return this.isBlack()
            ? 0x101010
            : ReikaColorAPI.RGBtoHex(red ? 255 : 0, green ? 255 : 0, blue ? 255 : 0);
    }
    ...
    public String toString() {
        return this.getName() + ": " + red + "/" + green + "/" + blue + " : "
            + Integer.toHexString(this.getRenderColor() & 0xffffff);
    }
    ...
    public Collection<RGBColorData>
    getReductiveChildren(boolean allowSelf, boolean allowBlack) {
    ...
    public Collection<RGBColorData>
    getAdditiveChildren(boolean allowSelf, boolean allowWhite) {
        Collection<RGBColorData> ret = this.getAllPossibilities();
        Iterator<RGBColorData> it = ret.iterator();
        while (it.hasNext()) {
            RGBColorData c = it.next();
