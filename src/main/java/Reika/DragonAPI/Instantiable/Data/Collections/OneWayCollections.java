...
public class OneWayCollections {
    public static final class OneWayList<E> extends ArrayList<E> {
        ...
        public final E remove(int o) {
            throw new UnsupportedOperationException(
                "You cannot remove entries from this list!"
            );
        }
        ...
        public final E set(int index, E element) {
            throw new UnsupportedOperationException(
                "You cannot overwrite entries in this list!"
            );
        }
    ...
    public static final class OneWaySet<E> extends HashSet<E> {
        ...
        public final boolean remove(Object o) {
            throw new UnsupportedOperationException(
                "You cannot remove entries from this set!"
            );
        }
    ...
    public static final class OneWayMap<K, V> extends HashMap<K, V> {
        ...
        public final V put(K key, V value) {
            if (this.containsKey(key)) {
                throw new UnsupportedOperationException(
                    "You cannot overwrite entries in this map!"
                );
            } else {
    ...
    private static final class WrapperEntrySet<K, V>
        ...
        public boolean remove(Object o) {
            throw new UnsupportedOperationException(
                "You cannot remove entries from this map with its entry set!"
            );
        }
    ...
    private static final class WrapperIterator<E> implements Iterator<E> {
        ...
        public final void remove() {
            throw new UnsupportedOperationException(
                "You cannot remove entries from this collection with an iterator!"
            );
        }
