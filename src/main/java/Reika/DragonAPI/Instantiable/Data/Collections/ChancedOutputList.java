...
public final class ChancedOutputList {
    ...
    public float getItemChance(ItemStack is) {
        ...
        return get != null ? allowOverflow ? get.floatValue() :
    MathHelper.clamp_float(get.floatValue(), 0, 100) : 0;
    }
    ...
    public ArrayList<ItemStack> calculate(double factor) {
        ...
        for (ItemWithChance key : data) {
            ...
            if (ch >= 1
                || ReikaRandomHelper.doWithChance(ch)) // /100 to force all into 0-1 range
                li.add(key.getItem());
        }
        return li;
    }
