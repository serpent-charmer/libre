...
public class ProportionedBlockBox {
    ...
    private int calculateEdges() {
        ...
        edgeLengths.addEntry(
            new CubeEdge(
                new Coordinate(volume.minX, volume.minY, volume.minZ),
                ForgeDirection.UP,
                len,
                false,
                false,
        ...
        edgeLengths.addEntry(
            new CubeEdge(
                new Coordinate(volume.maxX - 1, volume.minY, volume.minZ),
                ForgeDirection.UP,
                len,
                true,
                false,
        ...
        edgeLengths.addEntry(
            new CubeEdge(
                new Coordinate(volume.maxX - 1, volume.minY, volume.maxZ - 1),
                ForgeDirection.UP,
                len,
                true,
                false,
        ...
        edgeLengths.addEntry(
            new CubeEdge(
                new Coordinate(volume.minX, volume.minY, volume.maxZ - 1),
                ForgeDirection.UP,
                len,
                false,
                false,
        ...
        edgeLengths.addEntry(
            new CubeEdge(
                new Coordinate(volume.minX, volume.maxY - 1, volume.minZ),
                ForgeDirection.EAST,
                len,
                false,
                true,
        ...
        edgeLengths.addEntry(
            new CubeEdge(
                new Coordinate(volume.minX, volume.maxY - 1, volume.maxZ - 1),
                ForgeDirection.EAST,
                len,
                false,
                true,
        ...
        edgeLengths.addEntry(
            new CubeEdge(
                new Coordinate(volume.maxX - 1, volume.maxY - 1, volume.minZ),
                ForgeDirection.SOUTH,
                len,
                true,
                true,
    ...
    public static class CubeEdge {
        ...
        private CubeEdge(
            Coordinate c, ForgeDirection dir, int l, boolean px, boolean py, boolean pz
        ) {
            root = c;
            axis = dir;
            length = l;
