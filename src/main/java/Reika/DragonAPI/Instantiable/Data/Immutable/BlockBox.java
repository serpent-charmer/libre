...
public final class BlockBox {
    ...
    public boolean equals(Object o) {
        if (o instanceof BlockBox) {
            ...
            return b.maxX == maxX && b.maxY == maxY && b.maxZ == maxZ && b.minX == minX
                && b.minY == minY && b.minZ == minZ;
        }
        return false;
    }
    ...
    public String toString() {
        return String.format(
            "%d, %d, %d >> %d, %d, %d", minX, minY, minZ, maxX, maxY, maxZ
        );
    }
    ...
    public int getLongestEdge() {
        return ReikaMathLibrary.multiMax(
    ...
    public static BlockBox between(Entity e1, Entity e2) {
        return new BlockBox(
            MathHelper.floor_double(e1.posX),
            MathHelper.floor_double(e1.posY),
            MathHelper.floor_double(e1.posZ),
            MathHelper.floor_double(e2.posX),
            MathHelper.floor_double(e2.posY),
            MathHelper.floor_double(e2.posZ)
        );
    }

    public static BlockBox between(DecimalPosition e1, DecimalPosition e2) {
        return new BlockBox(
            MathHelper.floor_double(e1.xCoord),
            MathHelper.floor_double(e1.yCoord),
            MathHelper.floor_double(e1.zCoord),
            MathHelper.floor_double(e2.xCoord),
            MathHelper.floor_double(e2.yCoord),
            MathHelper.floor_double(e2.zCoord)
        );
    }
