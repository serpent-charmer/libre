...
public final class LineSegment {
    ...
    public static final LineSegment
    getFromXYZDir(int x1, int y1, int z1, ForgeDirection dir, int len) {
    ...
    public static final LineSegment
    getFromXYZDir(int x1, int y1, int z1, CubeDirections dir, double len) {
        return new LineSegment(
            x1,
            y1,
            z1,
    ...
    public DecimalLineSegment asDecimalSegment() {
        return new DecimalLineSegment(
            new DecimalPosition(origin), new DecimalPosition(target)
        );
    }
}
