        ...
        if (li != null && !li.isEmpty()) {
            ...
            while (flag) {
                ...
                if (cut1 >= 0 && cut2 >= 0) {
                    ...
                    //ReikaJavaLibrary.pConsole("Cutting "+cut1+" -> "+cut2+" from list of
                    //size "+lic.size()+" due to neighbors "+lic.get(cut1)+",
                    //"+lic.get(cut2));
                    flag = true;
            ...
            //		TickScheduler.instance.scheduleEvent(new ScheduledTickEvent(new
            //ScheduledBlockPlace(e.worldObj, c.xCoord, c.yCoord, c.zCoord,
            //Blocks.stone)), 120+lic.indexOf(c)*4);
            //}
