...
public class EntityTumblingBlock
    extends EntityFallingBlock implements IEntityAdditionalSpawnData {
    ...
    public EntityTumblingBlock(
        World world, double x, double y, double z, Block b, int meta
    ) {
    ...
    public String getCommandSenderName() {
        return "Flying "
            + new ItemStack(this.func_145805_f(), 1, field_145814_a).getDisplayName();
    }
