...
public class ParticlePath {
    ...
    private ParticlePath(
        Coordinate c1, Coordinate c2, Spline s, HashSet<Coordinate> set
    ) {
        source = c1;
        target = c2;
        spline = s;
    ...
    public static ParticlePath getPath(
        World world,
        BlockVector from,
        BlockVector to,
        double offset,
    ...
    private static ParticlePath calculateParticlePath(
        World world,
        BlockVector from,
        BlockVector to,
        double endOffset,
        ...
        LinkedList<Coordinate> li
            = BreadthFirstSearch
                  .getOpenPathBetween(
                      ...
                      to.getCoord(),
                      24,
                      EnumSet.of(PassRules.SOFT, PassRules.SMALLNONSOLID)
                  )
                  .getPath();
        if (li != null) {
