...
public class GuiHelp extends InWorldGui {
    ...
    protected void init() {
        ...
        //this.addButton(0, xSize-10, ySize/2-32, 8, 64, 176, 0, tex,
        //ChromatiCraft.class); this.addButton(1, 2, ySize/2-32, 8, 64, 184, 0, tex,
        //ChromatiCraft.class);

        this.addButton(2, xSize / 2 - 32, 2, 64, 8, 192, 0, tex, ChromatiCraft.class);
        this.addButton(
            3, xSize / 2 - 32, ySize - 10, 64, 8, 192, 8, tex, ChromatiCraft.class
        );
    }
