...
public class GuiItemBurner extends GuiContainer {
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ChromaFontRenderer.FontType.GUI.renderer.drawString(
            StatCollector.translateToLocal("container.inventory"), 8, 30, 0xffffff
        );
        String s = "Lumen Incineration";
        ChromaFontRenderer.FontType.GUI.renderer.drawString(
            s,
            xSize / 2 - ChromaFontRenderer.FontType.GUI.renderer.getStringWidth(s) / 2,
            4,
            0xffffff
        );
    ...
    public static class ButtonItemBurner extends ImagedGuiButton {
        ...
        public ButtonItemBurner(GuiContainer gui, int x, int y) {
            super(
                ...
                20,
                20,
                gui instanceof GuiInventory ? 200 : 220,
                36,
                TEXTURE,
                ChromatiCraft.class
            );
