...
public class GuiStructure extends GuiBookSection {
    ...
    public GuiStructure(EntityPlayer ep, ChromaResearch r) {
        ...
        musicStructure = ReikaRandomHelper.doWithChance(5)
            && ChromaResearchManager.instance.playerHasFragment(ep, ChromaResearch.MUSIC)
            && !page.getStructure().isNatural()
            && !page.level.isAtLeast(ResearchLevel.ENERGY);
        array = musicStructure ? new MusicTempleStructure().getStructureForDisplay()
                               : page.getStructure().getStructureForDisplay();
        ...
        if (musicStructure) {
            ...
            array.setBlock(
                ...
                array.getMaxY() - 3,
                array.getMidZ(),
                ChromaTiles.MUSIC.getBlock(),
                ChromaTiles.MUSIC.getBlockMetadata()
            );
        } else {
            if (page.name().toLowerCase(Locale.ENGLISH).contains("casting")) {
                    ...
                    for (int i = -4; i <= 4; i += 2) {
                        for (int k = -4; k <= 4; k += 2) {
                            if (i != 0 || k != 0) {
                                ...
                                int dy = array.getMinY() + 1
                                    + (Math.abs(i) != 4 && Math.abs(k) != 4 ? 0 : 1);
                                array.setBlock(
                                    dx,
                                    dy,
                                    dz,
                                    ChromaTiles.STAND.getBlock(),
                                    ChromaTiles.STAND.getBlockMetadata()
                                );
                            }
                        }
                    }
                    for (Coordinate c :
                         CastingTuningManager.instance.getTuningKeyLocations(
                         )) { //hide tuning runes from the lexicon
                        array.setBlock(
                            c.xCoord,
                            c.yCoord + 1,
                            c.zCoord,
                ...
                array.setBlock(
                    array.getMidX() + 1, array.getMinY() + 1, array.getMidZ(), Blocks.air
                );
                array.setBlock(
                    array.getMidX() - 1, array.getMinY() + 1, array.getMidZ(), Blocks.air
                );
                array.setBlock(
                    array.getMidX(), array.getMinY() + 1, array.getMidZ() + 1, Blocks.air
                );
                array.setBlock(
                    array.getMidX(), array.getMinY() + 1, array.getMidZ() - 1, Blocks.air
                );
            ...
            if (page == ChromaResearch.PLAYERINFUSION) {
                array.setBlock(
                    ...
                    array.getMaxY(),
                    array.getMidZ(),
                    ChromaTiles.PLAYERINFUSER.getBlock(),
                    ChromaTiles.PLAYERINFUSER.getBlockMetadata()
                );
            }
            ...
            if (page == ChromaResearch.PYLON) {
                array.setBlock(
                    array.getMidX(), array.getMinY() + 1, array.getMidZ(), Blocks.air
                );
            }
            ...
            if (page == ChromaResearch.VOIDTRAPSTRUCT
                || page == ChromaResearch.VOIDTRAPSTRUCTN) {
                array.setBlock(
                    array.getMidX(),
                    array.getMaxY(),
                    array.getMidZ(),
                    ChromaTiles.VOIDTRAP.getBlock(),
                    ChromaTiles.VOIDTRAP.getBlockMetadata()
                );
            }
        ...
        switch (page) {
            ...
            case BOOSTTREE: {
                ...
                for (Coordinate c : arr.keySet()) {
                    ...
                    if (key.blockID != Blocks.air
                        && key.equals(array.getBlockKeyAt(c.xCoord, c.yCoord, c.zCoord)))
                        set.add(c);
                }
                break;
            }
            ...
            case WIRELESSPED2: {
                FilledBlockArray arr
                    = ChromaStructures.WIRELESSPEDESTAL.getStructureForDisplay();
                for (Coordinate c : arr.keySet()) {
                    BlockKey key = arr.getBlockKeyAt(c.xCoord, c.yCoord, c.zCoord);
                    if (key.blockID != Blocks.air
                        && key.equals(array.getBlockKeyAt(c.xCoord, c.yCoord, c.zCoord)))
        ...
        if (page == ChromaResearch.PYLON || page == ChromaResearch.PYLONTURBORING) {
            ...
            render.addOverride(
                ...
                array.getMinY() + 2,
                array.getMidZ(),
                ChromaTiles.INFUSER.getCraftedProduct()
            );
            ...
            render.addOverride(
                ...
                array.getMaxY(),
                array.getMidZ(),
                ChromaTiles.PLAYERINFUSER.getCraftedProduct()
            );
            ...
            render.addOverride(
                ...
                array.getMaxY(),
                array.getMidZ(),
                ChromaTiles.VOIDTRAP.getCraftedProduct()
            );
            render.addOverride(
                new ItemStack(
                    ChromaTiles.LUMENWIRE.getBlock(),
                    ChromaTiles.LUMENWIRE.getBlockMetadata()
                ),
                ChromaTiles.LUMENWIRE.getCraftedProduct()
            );
            ...
            for (int c = 0; c < 16; c++) {
                ...
                for (int i = 0; i < max; i++) {
                    ...
                    cc = cc.offset(
                        array.getMidX() - 1, array.getMaxY(), array.getMidZ()
                    ); //tile location
                    render.addOverride(
                        cc.xCoord, cc.yCoord, cc.zCoord, new LumenLeafHook(i, e)
                    );
                }
            }
            ...
            render.addOverride(
                ...
                array.getMinY() + 1,
                array.getMidZ(),
                ChromaTiles.BEACON.getCraftedProduct()
            );
            ...
            render.addOverride(
                ...
                array.getMaxY(),
                array.getMidZ(),
                ChromaTiles.PROGRESSLINK.getCraftedProduct()
            );
            ...
            render.addOverride(
                ...
                array.getMinY() + 8,
                array.getMidZ(),
                ChromaTiles.OPTIMIZER.getCraftedProduct()
            );
            ...
            //render.addOverride(array.getMidX(), array.getMaxY(), array.getMidZ(),
            //ChromaTiles.WEAKREPEATER.getCraftedProduct());
            ...
            render.addOverride(
                ...
                ChromaItems.ENDERCRYSTAL.getStackOfMetadata(1)
            );
        ...
        if (page != ChromaResearch.CAVERN) {
            render.addBlockHook(
                ChromaBlocks.RUNE.getBlockInstance(), new RuneRenderHook()
            );
        }
        ...
        if (page == ChromaResearch.GATESTRUCT) {
            render.addOverride(
                ...
                array.getMinY() + 1,
                array.getMidZ(),
                ChromaTiles.TELEPORT.getCraftedProduct()
            );
        }
        ...
        if (page == ChromaResearch.DATATOWER) {
            render.addOverride(
                ...
                array.getMaxY(),
                array.getMidZ(),
                ChromaTiles.DATANODE.getCraftedProduct()
            );
            render.addOverride(
                array.getMidX(),
                array.getMaxY() - 1,
        ...
        if (page == ChromaResearch.CASTING2 || page == ChromaResearch.CASTING3) {
                ...
                for (int k = -4; k <= 4; k += 2) {
                    if (i != 0 || k != 0) {
                        ...
                        int dy = array.getMinY() + 1
                            + (Math.abs(i) != 4 && Math.abs(k) != 4 ? 0 : 1);
                        render.addOverride(
                            dx, dy, dz, ChromaTiles.STAND.getCraftedProduct()
                        );
                    }
                }
            }
            render.addOverride(
                new ItemStack(
                    ChromaTiles.STAND.getBlock(), ChromaTiles.STAND.getBlockMetadata()
                ),
                ChromaTiles.STAND.getCraftedProduct()
            );
        }

        if (page == ChromaResearch.BIOMESTRUCT) {
            //render.addOverride(ChromaBlocks.HOVER.getStackOfMetadata(HoverType.ELEVATE.getPermanentMeta()),
            //new ItemStack(Blocks.air));

            //render.addOverride(ChromaBlocks.CHROMA.getStackOf(),
            //ChromaItems.BUCKET.getStackOfMetadata(0)); render.addOverride(new
            //ItemStack(FluidRegistry.getFluid("ender").getBlock()),
            //ChromaItems.BUCKET.getStackOfMetadata(1));

            //render.addOverride(ChromaBlocks.LUMA.getStackOf(),
            //ChromaItems.BUCKET.getStackOfMetadata(3));
            render.addBlockHook(Blocks.water, new CCFluidHook());
            render.addBlockHook(
                ChromaBlocks.LAMP.getBlockInstance(), new BiomeCrystalHook()
            );
            render.addBlockHook(
                ChromaBlocks.RUNE.getBlockInstance(), new BiomeRuneHook()
            );
            render.addOverride(
                ChromaBlocks.LIGHTPANEL.getStackOfMetadata(0),
                ChromaBlocks.LIGHTPANEL.getStackOfMetadata(1)
            );
            render.addOverride(
                ChromaBlocks.LIGHTPANEL.getStackOfMetadata(2),
                ChromaBlocks.LIGHTPANEL.getStackOfMetadata(3)
            );
        }

        render.addRenderHook(
            ChromaTiles.PYLON.getCraftedProduct(), new PylonRenderHook()
        );
    }
    ...
    public void initGui() {
        ...
        if (!(page.getStructure().getStructure() instanceof FragmentStructureBase))
            buttonList.add(new CustomSoundGuiButton(
                4, mode == 1 ? j + 125 : j + 165, k - 2, 20, 20, "N#", this
            ));
    ...
    public final void drawScreen(int mx, int my, float f) {
        ...
        String s = "(" + array.getSizeX() + "x" + array.getSizeY() + "x"
            + array.getSizeZ() + ")";
    ...
    private void drawTally(int j, int k) {
        ...
        for (ItemStack is : c) {
            ...
            if (ChromaBlocks.CHROMA.match(is)) {
                ...
                if (ChromaBlocks.getEntryByID(ChromaTiles.STAND.getBlock()).match(is2)
                    && is2.getItemDamage() == ChromaTiles.STAND.getBlockMetadata()) {
                    is2 = ChromaTiles.STAND.getCraftedProduct();
                }
            }
            if (ChromaBlocks.getEntryByID(ChromaTiles.MUSIC.getBlock()).match(is2)
                && is2.getItemDamage() == ChromaTiles.MUSIC.getBlockMetadata()) {
                is2 = ChromaTiles.MUSIC.getCraftedProduct();
            }
            if (ChromaBlocks.PYLON.match(is2)) {
                is2 = ChromaTiles
                          .getTileFromIDandMetadata(
                              Block.getBlockFromItem(is2.getItem()), is2.getItemDamage()
                          )
                          .getCraftedProduct();
            }
            if (is2 != null
                && Block.getBlockFromItem(is2.getItem())
                        instanceof BlockModelledChromaTile) {
                is2 = ChromaTiles
                          .getTileFromIDandMetadata(
                              Block.getBlockFromItem(is2.getItem()), is2.getItemDamage()
                          )
            ...
            if (is2 != null) {
                ...
                if (map2 != null) {
                    int dx2 = dx + 20 + fontRendererObj.getStringWidth(s)
                        + fontRendererObj.getCharWidth(' ');
    ...
    private static class LumenLeafHook implements BlockChoiceHook {
        ...
        public ItemStack getBlock(Coordinate pos, ItemStack orig) {
            ...
            return show
                ? new BlockKey(ChromaBlocks.POWERTREE.getBlockInstance(), color.ordinal())
                      .asItemStack()
                : null;
        }
    }
    ...
    private static abstract class BiomeRandomColorHook implements BlockChoiceHook {
        ...
        private final ArrayList<CrystalElement> colors
        ...
        private int getRandomColor(Coordinate pos) {
            return colors
                .get((int
                ) ((pos.xCoord + 237 * pos.zCoord + System.currentTimeMillis() / 1000)
                   % 16))
                .ordinal();
        }
    }
    ...
    private static class CCFluidHook implements BlockChoiceHook {
        private final ArrayList<String> fluids
            = ReikaJavaLibrary.makeListFrom("chroma", "ender", "luma");
    ...
    private static class LogRenderHook implements BlockChoiceHook {
        @Override
        public ItemStack getBlock(Coordinate pos, ItemStack orig) {
            ArrayList<TreeType> li
                = ReikaJavaLibrary.makeListFromArray(ReikaTreeHelper.treeList);
            for (int i = 0; i < ModWoodList.woodList.length; i++) {
                ModWoodList tree = ModWoodList.woodList[i];
                if (tree.exists()) {
                    li.add(tree);
