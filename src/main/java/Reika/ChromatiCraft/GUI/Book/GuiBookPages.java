...
public class GuiBookPages extends GuiContainer implements CustomSoundGui {
    ...
    public void initGui() {
        ...
        buttonList.add(new CustomSoundImagedGuiButton(
            0, j + 148, k + 4, 10, 10, 90, 16, tex, ChromatiCraft.class, this
        ));
        buttonList.add(new CustomSoundImagedGuiButton(
            1, j + 158, k + 4, 10, 10, 90, 26, tex, ChromatiCraft.class, this
        ));
    }
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ReikaGuiAPI.instance.drawCenteredStringNoShadow(
            fontRendererObj,
            "Pages: " + inv.getPageCount() + "/" + inv.getSize(),
            xSize / 2,
            6,
            0xffffff
        );
    ...
    private void scroll(boolean up) {
        ...
        ReikaPacketHelper.sendPacketToServer(
            ChromatiCraft.packetChannel, ChromaPackets.BOOKINVSCROLL.ordinal(), up ? 1 : 0
        );
    }
