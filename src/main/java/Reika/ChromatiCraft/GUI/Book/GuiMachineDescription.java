...
public class GuiMachineDescription extends GuiDescription {
    ...
    private ElementTagCompound getUsedEnergy() {
        ...
        if (m == ChromaTiles.ADJACENCY) {
            ...
            int offset = li.get((int
            ) ((System.currentTimeMillis() / (1000 * TileEntityAdjacencyUpgrade.MAX_TIER))
               % li.size()));
    ...
    public final void drawScreen(int x, int y, float f) {
        ...
        if (page == ChromaResearch.ACCEL
            && ((GuiAdjacencyDescription) this).getMachine() != null) {
            ...
            switch (pageList.get(subpage)) {
                ...
                case ENERGY:
                    ...
                    if (tag != null) {
                        ...
                        p.setGeometry(
                            ...
                            dy,
                            r,
                            System.identityHashCode(this) + this.getGuiTick() % 360
                        );
                ...
                case AOE:
                    ComplexAOE te
                        = (ComplexAOE) page.getMachine().createTEInstanceForRender(0);
                    ...
                    //ReikaGuiAPI.instance.drawRectFrame(posX+xSize/2-30, posY+3, 90,
                    //height, 0xff0000, LineType.SOLID);
                    for (Coordinate c : li) {
                        ...
                        int clr = ReikaColorAPI.mixColors(
                            ...
                            0.5F
                                + 0.5F
                                    * MathHelper.sin(
                                        (this.getGuiTick() * 0.1F
                                         + System.identityHashCode(c) % 10000)
                                    )
                                    * 0.2F
                        );
                        ReikaGuiAPI.instance.drawRect(dx, dy, w, w, clr, true);
                        ReikaGuiAPI.instance.drawRectFrame(
                            dx, dy, w, w, clr | (a / 3 << 24), LineType.SOLID
                        );
                    }
                    break;
                case NOTES:
    ...
    private void drawMachineRender(int posX, int posY) {
        ...
        if (m == ChromaTiles.ADJACENCY) {
            ...
            offset = (int
            ) ((System.currentTimeMillis() / 4000) % CrystalTier.tierList.length);
        }
                ...
                if (te != null) {
                    ...
                    is.stackTagCompound.setInteger(
                        ...
                        (int
                           ...
                           % TileEntityAdjacencyUpgrade.MAX_TIER)
                    );
