...
public class GuiRitual extends GuiBookSection {
    ...
    public final void drawScreen(int x, int y, float f) {
        ...
        topY = (height - ySize) / 2;
        String s
            = "Textures/Ability/" + ability.name().toLowerCase(Locale.ENGLISH) + ".png";
        ...
        this.drawTexturedModalRect(
            (int) ((leftX + 103) / d), (int) ((topY + 11) / d), 0, 0, 256, 256
        );
        GL11.glPopMatrix();
        ...
        for (CrystalElement e : tag.elementSet()) {
            ...
            fontRendererObj.drawString(s1, leftX+descX+3,
        topY+descY-5+(fontRendererObj.FONT_HEIGHT+2)*i, color);
            fontRendererObj.drawString(s2, leftX+descX+3+56,
        topY+descY-5+(fontRendererObj.FONT_HEIGHT+2)*i, color); i++;
        }
        ...
        fontRendererObj.drawSplitString(
            "Total Energy:", leftX + descX + 3 + 40, topY + descY - 5 - 9, 80, 0xffffff
        );
        fontRendererObj.drawSplitString(
            String.valueOf(tot),
            leftX + descX + 3 + 40,
        ...
        fontRendererObj.drawSplitString(
            "Lumens", leftX + descX + 3 + 40, topY + descY - 5 - 9 + h * 2, 80, 0xffffff
        );

        int frac = (int
        ) (125
           * Math.pow(
               (double) tot / AbilityRituals.instance.getMaxAbilityTotalCost(), 0.5
           ));
        ...
        for (int i = 0; i < 4; i++)
            api.drawTexturedModelRectFromIcon(
                leftX + descX + 11,
                topY + descY + 108 - frac + 3,
                ChromaIcons.RIFT.getIcon(),
                16,
                frac + 6
            );
        ...
        api.drawTexturedModalRect(
            leftX + descX + 1, topY + descY + 108 - frac, 0, 118, 36, 7
        );
    }
