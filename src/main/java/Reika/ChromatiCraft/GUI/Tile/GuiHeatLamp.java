...
public class GuiHeatLamp extends GuiContainer {
    ...
    private void sendData() {
        ...
        ReikaPacketHelper.sendPacketToServer(
            ...
            ChromaPackets.HEATLAMP.ordinal(),
            tile,
            temperature
        );
    }
    ...
    protected void drawGuiContainerForegroundLayer(int par1, int par2) {
        ...
        ReikaGuiAPI.instance.drawCenteredStringNoShadow(
            fontRendererObj,
            StatCollector.translateToLocal("chroma.heatlamp"),
            xSize / 2,
            5,
            0xffffff
        );
        ...
        if (!input.isFocused()) {
            fontRendererObj.drawString(
                String.format("%d", temperature), xSize / 2 + 12, 25, 0xffffffff
            );
        }
        //ReikaGuiAPI.instance.drawCenteredStringNoShadow(fontRendererObj,
        //String.format("[%d]", sn), xSize/2+46, 25, c);
    }
