...
public class GuiItemCollector extends GuiChromaBase {
    ...
    public void initGui() {
        ...
        buttonList.add(new CustomSoundImagedGuiButtonSneakIcon(
            0, j + 11, k + 75, 10, 10, 100, 66, tex, ChromatiCraft.class, this, 100, 86
        ));
        buttonList.add(new CustomSoundImagedGuiButtonSneakIcon(
            1, j + 83, k + 75, 10, 10, 100, 56, tex, ChromatiCraft.class, this, 100, 76
        ));

        buttonList.add(new CustomSoundImagedGuiButton(
            3, j + 120, k + 77, 10, 10, 90, 16, tex, ChromatiCraft.class, this
        ));
        buttonList.add(new CustomSoundImagedGuiButton(
            2, j + 132, k + 77, 10, 10, 90, 26, tex, ChromatiCraft.class, this
        ));
    }
    ...
    protected void actionPerformed(GuiButton b) {
        ...
        if (b.id <= 1) {
            ...
            ReikaPacketHelper.sendPacketToServer(
                ...
                ChromaPackets.COLLECTORRANGE.ordinal(),
                vac,
                b.id,
                amt
            );
    ...
    protected void drawGuiContainerForegroundLayer(int a, int b)
    {
        ...
        fontRendererObj.drawString("XP: "+String.format("%d", vac.getExperience()),
    150-fontRendererObj.getStringWidth(String.format("%d", vac.getExperience())), 6,
    4210752);
    }
     */
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        this.drawTexturedModalRect(
            var5, var6 + inventoryRows * 18 + 17, 0, 126, xSize, 96
        );
    }
                ...
                if (idx >= slots) {
                    ...
                    int a = 96
                        + (int
                           ...
                           * Math.sin(
                               System.currentTimeMillis() / 400D
                               + System.identityHashCode(inventorySlots.getSlot(i))
                           ));
