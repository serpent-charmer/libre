...
public class GuiRouterFilter extends GuiContainer {
    ...
    public GuiRouterFilter(EntityPlayer player, RouterFilter te) {
        ...
        blacklist = te instanceof TileEntityRouterNode
            ? ((TileEntityRouterNode) te).isBlacklist
            : false;
    }
    ...
    public void initGui() {
        ...
        if (tile instanceof TileEntityRouterNode) {
            ...
            buttonList.add(new ImagedGuiButton(
                               ...
                               90,
                               v,
                               "/Reika/ChromatiCraft/Textures/GUIs/buttons.png",
                               ChromatiCraft.class
            )
                               .setTooltip("Blacklist/Whitelist"));
        }
    }
    ...
    protected void actionPerformed(GuiButton b) {
        ...
        if (b.id == 0) {
            ...
            ReikaPacketHelper.sendPacketToServer(
                ...
                ChromaPackets.ROUTERFILTERFLAG.ordinal(),
                (TileEntity) tile,
                blacklist ? 1 : 0
            );
        ...
        for (int i = 0; i < 9; i++) {
            ...
            if (ir != null) {
                ...
                ReikaGuiAPI.instance.drawItemStack(
                    itemRender,
                    fontRendererObj,
                    ReikaItemHelper.getSizedItemStack(ir.getItem(), 1),
                    x,
                    y
                );
                ...
                ReikaGuiAPI.instance.drawRectFrame(
                    x - 1, y - 1, 18, 18, 0xff000000 | ir.mode.color
                );
                GL11.glPopAttrib();
            }
        }
