...
public class GuiMIDIDisc extends GuiScreen {
    ...
    public GuiMIDIDisc(ItemStack in) {
    ...
    public void updateScreen() {
        ...
        if (input.getText().isEmpty()) {
            ...
            file = input.getText();
        //packet removed ReikaPacketHelper.sendStringPacket(ChromatiCraft.packetChannel,
        //ChromaPackets.MUSICDISC.ordinal(), file);
    }
    ...
    public void drawScreen(int x, int y, float f) {
        String var4 = "/Reika/ChromatiCraft/Textures/GUIs/discgui.png";
        ...
        ReikaGuiAPI.instance.drawCenteredStringNoShadow(
            fontRendererObj,
            "Select a MIDI file. Be sure to include",
            posX + xSize / 2 + 1,
            posY + 4,
            4210752
        );
        ReikaGuiAPI.instance.drawCenteredStringNoShadow(
            fontRendererObj,
            "C:/ and file extension and use \"/\", not \"\\\".",
            posX + xSize / 2 + 1,
            posY + 14,
            4210752
        );
