...
/**
 * Use this to blacklist entity types from the spawner reprogrammer, to prevent
 * progression skips, rendering glitches, crashes, or similar. It is strongly discouraged
 * to use this to blacklist mobs that can be safely made into spawners.
 * */
...
public class SpawnerBlacklist {
    ...
    public static void blacklistEntityType(String name) {
        try {
            ...
            ReikaJavaLibrary.pConsole(
                "Could not blacklist entity type '" + name
                + "' from the spawner reprogrammer!"
            );
            e.printStackTrace();
        }
    }
    ...
    public static void blacklistEntityType(Class<? extends EntityLiving> c) {
        try {
            ...
            ReikaJavaLibrary.pConsole(
                "Could not blacklist entity class '" + c
                + "' from the spawner reprogrammer!"
            );
            e.printStackTrace();
        }
    ...
    static {
        try {
            tile = Class.forName(
                "Reika.ChromatiCraft.TileEntity.Processing.TileEntitySpawnerReprogrammer"
            );
            ...
            ReikaJavaLibrary.pConsole(
                "Could not initialize spawner reprogrammer blacklist API!"
            );
            e.printStackTrace();
        }
    }
