 ...
 * healing core behavior on your Block or TileEntity.
 */
public interface CustomHealing extends CustomAdjacencyHandler {
    ...
    public static interface CustomTileHealing extends CustomHealing {
        /**
         * This will be called once per tick, with 'te' being your TE and 'tier' being
         * the tier of the core, 0-7 inclusive.
         */
    ...
    public static interface CustomBlockHealing extends CustomHealing {
        /**
         * This will be called once per tick, with your block's position and 'tier' being
         * the tier of the core, 0-7 inclusive.
         */
