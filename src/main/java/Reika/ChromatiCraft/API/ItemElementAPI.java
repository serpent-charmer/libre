...
/**
 * Use this to add custom recipe objects that ChromatiCraft can use for item element
 * value calculation.
 */
public interface ItemElementAPI {
    ...
    public static interface ItemInOutHandler {
        /**
         * All items that go into making the given item, through this recipe handler.
         * Return null or empty if the handler cannot make this item.
         */
        public Collection<ItemStack> getInputItemsFor(ItemStack out);

        /**
         * These represent the elements added by the process itself, eg smelting adds
         * orange, for fire. Return null or empty for none.
         */
