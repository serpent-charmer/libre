...
/**
 * Fired when a chest generates in a "prefab" ChromatiCraft structure. You can use it to
 * add custom loot; note that if you fill the inventory, the loot may fail to be added,
 * but the inventory is the size of a double chest, making this unlikely.
 */
