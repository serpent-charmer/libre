...
public class CrystalElementAccessor {
    ...
    /**
     * An interface for the internal CrystalElement enum, to which (or just {@link Enum})
     * you can cast it; consult that enum for thematic meanings.
     */
    ...
    public static CrystalElementProxy getByEnum(String name) {
        return (CrystalElementProxy
        ) Enum.valueOf(elementClass, name.toUpperCase(Locale.ENGLISH));
    }
