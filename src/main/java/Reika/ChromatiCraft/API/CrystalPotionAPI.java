...
public interface CrystalPotionAPI {
    /**
     * Whether a world is "evil" like the Nether, thus corrupting the effect of the
     * crystals.
     */
    ...
    /**
     * Constructs a potion effect for the given color, with a specified duration and
     * amplifier, optionally corrupting it.
     */
    public PotionEffect
