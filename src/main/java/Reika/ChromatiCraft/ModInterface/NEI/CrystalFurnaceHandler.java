...
public class CrystalFurnaceHandler extends TemplateRecipeHandler {
    private class CrystalFurnaceRecipe extends CachedRecipe {
        ...
        public CrystalFurnaceRecipe(ItemStack in, ItemStack out) {
            ...
            input = in;
            output = ReikaItemHelper.getSizedItemStack(
                out, TileEntityCrystalFurnace.getMultiplyRate(in, out) * out.stackSize
            );
    ...
    public void drawBackground(int recipe) {
        ...
        ReikaGuiAPI.instance.drawTexturedModalRectWithDepth(
            0, 0, 5, 15, 166, 56, ReikaGuiAPI.NEI_DEPTH
        );
    }
    ...
    public void loadTransferRects() {
        if (!(Minecraft.getMinecraft().thePlayer.openContainer
              instanceof ContainerCrystalFurnace))
            transferRects.add(
                new RecipeTransferRect(new Rectangle(70, 13, 34, 29), "ccfurnace")
            );
    }
