...
public class ChromaAspectManager {
    private final ReversibleMultiMap<CrystalElement, Aspect> aspectsColor
        = new ReversibleMultiMap(CollectionType.HASHSET);
    private final ReversibleMultiMap<CrystalElement, Aspect> aspectsThematic
        = new ReversibleMultiMap(CollectionType.HASHSET);

    public final Aspect PUZZLE = new Aspect(
        "perplexus",
        0x90ffb0,
        new Aspect[] { Aspect.MIND, Aspect.TRAP },
        new ResourceLocation("chromaticraft", "textures/aspects/puzzle.png"),
        1
    );
    public final Aspect SIGNAL = new Aspect(
        "signum",
        0xffff00,
        new Aspect[] { Aspect.ENERGY, Aspect.AURA },
        new ResourceLocation("chromaticraft", "textures/aspects/signal.png"),
        1
    );
    public final Aspect PRECURSOR = new Aspect(
        "principia",
        0x75DAFF,
        new Aspect[] { Aspect.ELDRITCH, Aspect.MIND },
        new ResourceLocation("chromaticraft", "textures/aspects/precursor.png"),
        1
    );
    ...
    private ChromaAspectManager() {
        ...
        this.addAspectColor(
            CrystalElement.GREEN, Aspect.PLANT, Aspect.POISON, Aspect.EARTH
        );
        ...
        this.addAspectColor(
            CrystalElement.PURPLE, Aspect.MAGIC, Aspect.TAINT, Aspect.ELDRITCH
        );
        this.addAspectColor(CrystalElement.CYAN, Aspect.ARMOR, Aspect.SENSES);
        this.addAspectColor(
            CrystalElement.LIGHTGRAY, Aspect.VOID, Aspect.SOUL, Aspect.METAL
        );
        ...
        this.addAspectColor(
            CrystalElement.YELLOW, Aspect.LIGHT, Aspect.AIR, Aspect.GREED, SIGNAL
        );
        this.addAspectColor(
            CrystalElement.LIGHTBLUE, Aspect.CRYSTAL, Aspect.MECHANISM, Aspect.MOTION
        );
        this.addAspectColor(CrystalElement.MAGENTA, Aspect.FLESH);
        this.addAspectColor(CrystalElement.ORANGE, Aspect.FIRE);
        this.addAspectColor(
            CrystalElement.WHITE, Aspect.ORDER, Aspect.COLD, Aspect.FLIGHT, Aspect.WEATHER
        );
        ...
        this.addAspectTheme(
            CrystalElement.LIME, Aspect.MOTION, Aspect.TRAVEL, Aspect.FLIGHT
        );
    ...
    public Collection<Aspect> getAspects(CrystalElement color, boolean theme) {
        ReversibleMultiMap<CrystalElement, Aspect> map
            = theme ? aspectsThematic : aspectsColor;
    ...
    public void register() {
        Object[] asp = new Object[] { Aspect.AURA,
                                      10,
                                      Aspect.AIR,
                                      3,
                                      Aspect.CROP,
                                      ...
                                      Aspect.PLANT,
                                      10,
                                      /*Aspect.SEED, 2,*/ Aspect.VOID,
                                      1 };
        ReikaThaumHelper.addAspectsToBlock(
            ChromaBlocks.RAINBOWLEAF.getBlockInstance(), asp
        );
        ReikaThaumHelper.addAspectsToBlock(
            ChromaBlocks.RAINBOWSAPLING.getBlockInstance(), asp
        );

        for (int i = 0; i < CrystalElement.elements.length; i++) {
            CrystalElement dye = CrystalElement.elements[i];
            ItemStack crystal
                = new ItemStack(ChromaBlocks.CRYSTAL.getBlockInstance(), 1, i);
            ...
            ItemStack leaf2
                = new ItemStack(ChromaBlocks.DYELEAF.getBlockInstance(), 1, i);
            ItemStack berry = ChromaItems.BERRY.getStackOfMetadata(i);
            ItemStack lumenleaf
                = new ItemStack(ChromaBlocks.POWERTREE.getBlockInstance(), 1, i);
        ...
        Aspect[] flowers = { Aspect.DARKNESS, Aspect.LIFE,  Aspect.POISON, Aspect.BEAST,
                             Aspect.WATER,    Aspect.TAINT, Aspect.MOTION, Aspect.SOUL,
                             Aspect.ENTROPY,  Aspect.FLESH, Aspect.SLIME,  Aspect.GREED,
                             Aspect.COLD,     Aspect.MAGIC, Aspect.FIRE,   Aspect.ORDER };
        for (int i = 0; i < 16; i++)
            ReikaThaumHelper.addAspectsToBlockMeta(
                ChromaBlocks.DYEFLOWER.getBlockInstance(),
                i,
                flowers[i],
                1,
                Aspect.PLANT,
        ...
        for (PoolRecipe r : PoolRecipes.instance.getAllPoolRecipes()) {
            ...
            for (ItemStack in : ins) {
                AspectList al2
                    = ThaumcraftApiHelper.generateTags(in.getItem(), in.getItemDamage());
                if (al2 != null)
                    al.merge(al2);
            }
            AspectList al2
                = ThaumcraftApiHelper.generateTags(main.getItem(), main.getItemDamage());
            if (al2 != null)
                al.merge(al2);
        ...
        Aspect[] tierores = {
            Aspect.MAGIC,    Aspect.CRAFT, Aspect.TRAP,   Aspect.LIGHT,   Aspect.TRAVEL,
            Aspect.WATER,    Aspect.FIRE,  Aspect.ORDER,  Aspect.ENTROPY, Aspect.AURA,
            Aspect.ELDRITCH, Aspect.GREED, Aspect.WEAPON, Aspect.CRYSTAL, Aspect.ENERGY,
        };

        Aspect[] tierplants
            = { Aspect.AURA,     Aspect.ORDER, Aspect.ENERGY, Aspect.PLANT,
                Aspect.EXCHANGE, Aspect.LIGHT, Aspect.GREED };

        for (int i = 0; i < TieredOres.list.length; i++) {
            ReikaThaumHelper.addAspects(
                ChromaBlocks.TIEREDORE.getStackOfMetadata(i), tierores[i], 2
            );
            ReikaThaumHelper.addAspects(
                ChromaBlocks.TIEREDORE.getStackOfMetadata(i), Aspect.MAGIC, 3
            );
        }

        for (int i = 0; i < TieredPlants.list.length; i++) {
            ReikaThaumHelper.addAspects(
                ChromaBlocks.TIEREDPLANT.getStackOfMetadata(i), tierplants[i], 2
            );
            ReikaThaumHelper.addAspects(
                ChromaBlocks.TIEREDPLANT.getStackOfMetadata(i), Aspect.MAGIC, 3
            );
        }

        ReikaThaumHelper.addAspects(
            ChromaBlocks.LOOTCHEST.getStackOf(),
            Aspect.MAGIC,
            2,
            Aspect.GREED,
            2,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.SELECTIVEGLASS.getStackOf(),
            Aspect.MAGIC,
            5,
            Aspect.CRYSTAL,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.REPEATERLAMP.getStackOf(), Aspect.LIGHT, 8, Aspect.CRYSTAL, 8
        );
        ReikaThaumHelper.addAspects(
            ChromaBlocks.CAVEINDICATOR.getStackOf(), Aspect.LIGHT, 4, Aspect.TRAP, 2
        );
        ReikaThaumHelper.addAspects(
            ChromaBlocks.METAALLOYLAMP.getStackOf(),
            PRECURSOR,
            6,
            Aspect.LIGHT,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.CHROMA.getStackOf(),
            Aspect.MAGIC,
            10,
            Aspect.WATER,
            5,
        ...
        ReikaThaumHelper.addAspects(
            ChromaItems.DATACRYSTAL.getStackOf(), PRECURSOR, 10, Aspect.MIND, 5
        );
        ReikaThaumHelper.addAspects(ChromaStacks.unknownArtefact, PRECURSOR, 20);
        ReikaThaumHelper.addAspects(
            ChromaStacks.unknownFragments, PRECURSOR, 4, Aspect.ENTROPY, 2
        );

        ReikaThaumHelper.addAspects(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.SMOOTH.ordinal()),
            Aspect.EARTH,
            4,
            Aspect.CRYSTAL,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.BEAM.ordinal()),
            Aspect.EARTH,
            4,
            Aspect.CRYSTAL,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.COLUMN.ordinal()),
            Aspect.EARTH,
            4,
            Aspect.CRYSTAL,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.GLOWCOL.ordinal()),
            Aspect.EARTH,
            4,
            Aspect.CRYSTAL,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.GLOWBEAM.ordinal()),
            Aspect.EARTH,
            4,
            Aspect.CRYSTAL,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.FOCUS.ordinal()),
            Aspect.EARTH,
            4,
            Aspect.CRYSTAL,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.CORNER.ordinal()),
            Aspect.EARTH,
            4,
            Aspect.CRYSTAL,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.EMBOSSED.ordinal()),
            Aspect.EARTH,
            4,
            Aspect.CRYSTAL,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.FOCUSFRAME.ordinal()),
            Aspect.EARTH,
            4,
            Aspect.CRYSTAL,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.GROOVE1.ordinal()),
            Aspect.EARTH,
            4,
            Aspect.CRYSTAL,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.GROOVE2.ordinal()),
            Aspect.EARTH,
            4,
            Aspect.CRYSTAL,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.BRICKS.ordinal()),
            Aspect.EARTH,
            4,
            Aspect.CRYSTAL,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.STABILIZER.ordinal()),
            Aspect.EARTH,
            4,
            Aspect.CRYSTAL,
            4,
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.RESORING.ordinal()),
            Aspect.EARTH,
            4,
            Aspect.CRYSTAL,
            4,
        ...
        for (int i = 0; i < 16; i++) {
            for (Aspect a : aspectsThematic.getForward(CrystalElement.elements[i])) {
                ReikaThaumHelper.addAspects(
                    ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(
        ...
        for (int i = 0; i < Flowers.list.length; i++) {
            ...
            switch (Flowers.list[i]) {
                case ENDERFLOWER:
                    ...
                    ReikaThaumHelper.addAspects(
                        is2, Aspect.ELDRITCH, 1, Aspect.MOTION, 1
                    );
                    break;
                case FLOWIVY:
        ...
        ReikaThaumHelper.addAspects(
            ChromaBlocks.WARPNODE.getStackOf(),
            Aspect.TRAVEL,
            20,
            Aspect.AURA,
            5,
    ...
    public ElementTagCompound getElementCost(Aspect a, float depthcost) {
        ...
        if (tag.isEmpty()) {
            ChromatiCraft.logger.logError(
                "Aspect " + a.getName() + " was calculated to have zero cost!"
            );
        }
        return tag;
    }
    ...
    private void
    recursiveCount(Aspect a, ElementTagCompound tag, int depth, float depthcost) {
