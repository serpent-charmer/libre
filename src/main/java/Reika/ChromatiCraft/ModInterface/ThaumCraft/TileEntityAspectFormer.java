...
public class TileEntityAspectFormer extends CrystalReceiverBase implements GuiController {
    ...
    private static final AdjacencyCheckHandlerImpl throughputBonus
        = TileEntityAdjacencyUpgrade.getOrCreateAdjacencyCheckHandler(
            CrystalElement.PURPLE, "Increase lumen throughput", ChromaTiles.ASPECT
        );
    ...
    private void spawnParticles(World world, int x, int y, int z, IAspectContainer iac) {
        ...
        if (ReikaRandomHelper.doWithChance(15)) {
            ...
            EntityCenterBlurFX fx = new EntityCenterBlurFX(world, rx, y + h, rz, 0, 0, 0)
                                        .setColor(a.getColor());
    ...
    public AxisAlignedBB getRenderBoundingBox() {
        return AxisAlignedBB.getBoundingBox(
            xCoord, yCoord - 1, zCoord, xCoord + 1, yCoord + 1, zCoord + 2
        );
    }
    ...
    public static enum AspectMode {
        ...
        private void collectEnergy(
            TileEntityAspectFormer te,
            World world,
            int x,
            int y,
            int z,
            IAspectContainer iac
        ) {
        ...
        private void
        addAspect(TileEntityAspectFormer te, Aspect a, IAspectContainer iac) {
