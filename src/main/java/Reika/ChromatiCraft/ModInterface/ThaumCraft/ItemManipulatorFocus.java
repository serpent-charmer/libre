...
public class ItemManipulatorFocus extends ItemCustomFocus {
    ...
    public ItemStack onFocusRightClick(
        ...
        if (mov == null) {
            ...
            ChromaItems.TOOL.getItemInstance().onItemUse(
    ...
    public void onUsingFocusTick(ItemStack wandstack, EntityPlayer player, int count) {
        ChromaItems.TOOL.getItemInstance().onUsingTick(
            ChromaItems.TOOL.getStackOf(), player, count
        );
    }
    ...
    public int getFocusColor(ItemStack focusstack) {
        return CrystalElement.getBlendedColor(
            Minecraft.getMinecraft().thePlayer.ticksExisted, 12
        );
    }
