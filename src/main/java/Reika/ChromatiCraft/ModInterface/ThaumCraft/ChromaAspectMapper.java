...
public class ChromaAspectMapper {
    ...
    private ChromaAspectMapper() {
        ...
        this.addAspect(
            ChromaTiles.DIMENSIONCORE, ChromaAspectManager.instance.PRECURSOR, 8
        );
        ...
        this.addAspect(
            ChromaTiles.STRUCTCONTROL, ChromaAspectManager.instance.PRECURSOR, 8
        );
        ...
        this.addAspect(
            ChromaTiles.PROGRESSLINK, ChromaAspectManager.instance.PRECURSOR, 2
        );
            ...
            if (is != null) {
                ...
                if (al != null) {
                    ...
                    ReikaThaumHelper.addAspectsToBlockMeta(
                        m.getBlock(), m.getBlockMetadata(), al
                    );
                }
            }
        }
