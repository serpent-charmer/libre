...
public class VoidMonsterRitualStructure extends ChromaStructureBase {
    ...
    public FilledBlockArray getArray(World world, int x, int y, int z) {
        ...
        array.setBlock(x + 13, y + 2, z + 14, crystalstone, 1);
        ...
        array.setBlock(x + 14, y + 2, z + 14, crystalstone, 1);
        ...
        for (Coordinate c : wires.keySet()) {
            array.setBlock(
                x + c.xCoord, y + c.yCoord, z + c.zCoord, this.getLumenWire(wires.get(c))
            );
        }
        ...
        public boolean matchInWorld(World world, int x, int y, int z) {
            if (block.matchInWorld(world, x, y, z)) {
                TileEntityLumenWire te
                    = (TileEntityLumenWire) world.getTileEntity(x, y, z);
