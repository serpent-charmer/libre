...
public class VoidMonsterRitualClientEffects implements TickHandler {
    public static final VoidMonsterRitualClientEffects instance
        = new VoidMonsterRitualClientEffects();
    ...
    public static abstract class EffectVisual {
        ...
        private static final Collection<EffectVisual> terrainShaderEffects
            = new HashSet();
        ...
        protected final void fadeShader() {
            shaderIntensity
                = Math.max(0, shaderIntensity * shaderDecayFactor - shaderDecayLinear);
        }
        ...
        public final String toString() {
            return "Visual effect for " + cause + " [" + hasTerrainShader
                + "] F=" + shaderIntensity + " with data " + shaderData;
        }
    }
