...
public class ForestryMultifarmAcceleration extends SpecialAcceleration {
    public static final ForestryMultifarmAcceleration instance
        = new ForestryMultifarmAcceleration();
    ...
    public void register() {
        ...
        e); ChromatiCraft.logger.logError("Could not find Forestry Multifarm internal
        members!");
        }
         */
    }
