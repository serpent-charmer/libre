...
public class ModInteraction {
        ...
        try {
            ...
            if (check.getBoolean(null)) {
                ...
                for (int i = 0; i < add.size(); i++) {
                    next[next.length - add.size() + i]
                        = ReikaRegistryHelper.getGameRegistryName(
                            ChromatiCraft.instance, add.get(i)
                        );
                }
                f.set(null, next);
                //ArrayList<UniqueIdentifier> li =
                //(ArrayList<UniqueIdentifier>)f2.get(inst.get(null)); for (ChromaBlocks b
                //: add) {
                //	li.add(GameRegistry.findUniqueIdentifierFor(b.getBlockInstance()));
                //}
                for (ChromaBlocks b : add) {
                    FMLInterModComms.sendMessage(
                        ModList.ENDERIO.modLabel,
                        "teleport:blacklist:add",
                        ReikaRegistryHelper.getGameRegistryName(ChromatiCraft.instance, b)
                    );
                }
            }
        } catch (Exception e) {
            ChromatiCraft.logger.logError(
                "Could not add EnderIO travelling staff blacklisting!"
            );
    ...
    public static void addThaumCraft() {
        ...
        ThaumcraftApi.portableHoleBlackList.add(
            ChromaBlocks.STRUCTSHIELD.getBlockInstance()
        );
        ThaumcraftApi.portableHoleBlackList.add(
            ChromaBlocks.SPECIALSHIELD.getBlockInstance()
        );
        ...
        if (ModList.THAUMICTINKER.isLoaded()) {
            try {
                Class c = Class.forName(
                    "thaumic.tinkerer.common.item.foci.ItemFocusDislocation"
                );
                ...
                ChromatiCraft.logger.logError(
                    "Could not add dislocation focus blacklisting!"
                );
                ReflectiveFailureTracker.instance.logModReflectiveFailure(
                    ModList.THAUMICTINKER, e
                );
                e.printStackTrace();
            }
        }
    ...
    public static void blacklistMekBoxes() {
        for (int i = 0; i < 16; i++) {
            try {
                ...
                MekanismAPI.addBoxBlacklist(
                    ChromaBlocks.PYLONSTRUCT.getBlockInstance(), i
                );
                MekanismAPI.addBoxBlacklist(
                    ChromaBlocks.STRUCTSHIELD.getBlockInstance(), i
                );
                MekanismAPI.addBoxBlacklist(
                    ChromaBlocks.SPECIALSHIELD.getBlockInstance(), i
                );
                ...
                MekanismAPI.addBoxBlacklist(
                    ChromaBlocks.LOCKFREEZE.getBlockInstance(), i
                );
                ...
                MekanismAPI.addBoxBlacklist(
                    ChromaBlocks.GOLCONTROL.getBlockInstance(), i
                );
                MekanismAPI.addBoxBlacklist(
                    ChromaBlocks.MUSICMEMORY.getBlockInstance(), i
                );
                MekanismAPI.addBoxBlacklist(ChromaBlocks.COLORLOCK.getBlockInstance(), i);
                ...
                ChromatiCraft.logger.logError(
                    "Unable to blacklist tiles from Mekanism box"
                );
                e.printStackTrace();
    ...
    public static void addForestry() {
        try {
            ...
            FlowerManager.flowerRegistry.registerAcceptableFlower(
                ChromaBlocks.DECOFLOWER.getBlockInstance(),
                Flowers.ENDERFLOWER.ordinal(),
                FlowerManager.FlowerTypeVanilla
            );
            FlowerManager.flowerRegistry.registerAcceptableFlower(
                ChromaBlocks.DECOFLOWER.getBlockInstance(),
                Flowers.GLOWDAISY.ordinal(),
                FlowerManager.FlowerTypeVanilla
            );
            FlowerManager.flowerRegistry.registerAcceptableFlower(
                ChromaBlocks.DECOFLOWER.getBlockInstance(),
                Flowers.RESOCLOVER.ordinal(),
                FlowerManager.FlowerTypeVanilla
            );
            FlowerManager.flowerRegistry.registerAcceptableFlower(
                ChromaBlocks.DECOFLOWER.getBlockInstance(),
                Flowers.LUMALILY.ordinal(),
                FlowerManager.FlowerTypeVanilla
            );
            FlowerManager.flowerRegistry.registerAcceptableFlower(
                ChromaBlocks.DECOFLOWER.getBlockInstance(),
            ...
            FlowerManager.flowerRegistry.registerAcceptableFlower(
                ChromaBlocks.DECOFLOWER.getBlockInstance(),
                Flowers.SANOBLOOM.ordinal(),
                FlowerManager.FlowerTypeJungle
            );
            FlowerManager.flowerRegistry.registerAcceptableFlower(
                ChromaBlocks.DECOFLOWER.getBlockInstance(),
                Flowers.VOIDREED.ordinal(),
            ...
            e.printStackTrace();
            ChromatiCraft.logger.logError(
                "Could not add Forestry integration. Check your versions; if you are up-to-date with both mods, notify Reika."
            );
        } catch (LinkageError e) {
            e.printStackTrace();
            ChromatiCraft.logger.logError(
    ...
    public static void addTFLoot() {
        for (int i = 0; i < 16; i++) {
            ...
            TwilightForestLootHooks.DungeonTypes.TREE_DUNGEON.addItem(
                is, LootLevels.COMMON, rarity
            );
            TwilightForestLootHooks.DungeonTypes.RUINS_BASEMENT.addItem(
                is, LootLevels.COMMON, rarity * 6 / 5
            );
        }

        TwilightForestLootHooks.DungeonTypes.TREE_DUNGEON.addItem(
            ChromaItems.FRAGMENT.getStackOf(), LootLevels.COMMON, 8
        );
        TwilightForestLootHooks.DungeonTypes.RUINS_BASEMENT.addItem(
            ChromaItems.FRAGMENT.getStackOf(), LootLevels.COMMON, 12
        );
        TwilightForestLootHooks.DungeonTypes.HEDGE_MAZE.addItem(
            ChromaItems.FRAGMENT.getStackOf(), LootLevels.COMMON, 4
        );
        TwilightForestLootHooks.DungeonTypes.LICH_LIBRARY.addItem(
            ChromaItems.FRAGMENT.getStackOf(), LootLevels.COMMON, 15
        );
        TwilightForestLootHooks.DungeonTypes.LABYRINTH_VAULT.addItem(
            ChromaItems.FRAGMENT.getStackOf(), LootLevels.COMMON, 15
        );
        TwilightForestLootHooks.DungeonTypes.LABYRINTH_END.addItem(
            ChromaItems.FRAGMENT.getStackOf(), LootLevels.COMMON, 8
        );
        TwilightForestLootHooks.DungeonTypes.SMALL_HOLLOW.addItem(
            ChromaItems.FRAGMENT.getStackOf(), LootLevels.COMMON, 6
        );
        TwilightForestLootHooks.DungeonTypes.MEDIUM_HOLLOW.addItem(
            ChromaItems.FRAGMENT.getStackOf(), LootLevels.COMMON, 8
        );
        TwilightForestLootHooks.DungeonTypes.LARGE_HOLLOW.addItem(
            ChromaItems.FRAGMENT.getStackOf(), LootLevels.COMMON, 12
        );

        TwilightForestLootHooks.DungeonTypes.HEDGE_MAZE.addItem(
            ChromaBlocks.GLOWSAPLING.getStackOf(), LootLevels.RARE, 6
        );
        TwilightForestLootHooks.DungeonTypes.TREE_DUNGEON.addItem(
            ChromaBlocks.GLOWSAPLING.getStackOf(), LootLevels.ULTRARARE, 2
        );
    }
    ...
    public static void addChocoDungeonLoot() {
        try {
            ...
            e.printStackTrace();
            ChromatiCraft.logger.logError(
                "Could not add ChocolateQuest integration, as his API is not accessible (Java code visiblity). Contact that developer."
            );
        } catch (IncompatibleClassChangeError e) {
            e.printStackTrace();
            ChromatiCraft.logger.logError(
                "Could not add ChocolateQuest integration. Check your versions; if you are up-to-date with both mods, notify Reika."
            );
        } catch (Exception e) {
            e.printStackTrace();
            ChromatiCraft.logger.logError(
    ...
    public static void blacklistLoonium() {
        try {
            ...
            e.printStackTrace();
            ChromatiCraft.logger.logError(
                "Could not add Botania integration. Check your versions; if you are up-to-date with both mods, notify Reika."
            );
        } catch (Exception e) {
            e.printStackTrace();
            ChromatiCraft.logger.logError(
    ...
    public static void blacklistMFRSafariNet() {
        try {
            ...
            ChromatiCraft.logger.logError(
                "Could not blacklist Ball Lightning from MFR Safari Net!"
            );
            ReflectiveFailureTracker.instance.logModReflectiveFailure(
                ModList.MINEFACTORY, e
            );
            e.printStackTrace();
        }
    }
    ...
    public static void addCarpenterCovers() {
        try {
            ...
            ChromatiCraft.logger.logError(
                "Could not add compatibility with Carpenter's blocks!"
            );
            ReflectiveFailureTracker.instance.logModReflectiveFailure(
                ModList.CARPENTER, e
            );
    ...
    public static void blacklistRFToolsTeleport() {
        try {
            Class c
                = Class.forName("mcjty.rftools.blocks.teleporter.TeleportConfiguration");
            ...
            ChromatiCraft.logger.logError(
                "Could not add RF Tools teleportation blacklisting!"
            );
    ...
    public static void addRCGPRColors() {
        for (int i = 0; i < ReikaDyeHelper.dyes.length; i++) {
            ...
            BlockColorInterface.addGPRBlockColor(
                ChromaBlocks.DECAY.getBlockInstance(), i, dye.color
            );
            BlockColorInterface.addGPRBlockColor(
                ChromaBlocks.DYELEAF.getBlockInstance(), i, dye.color
            );
            BlockColorInterface.addGPRBlockColor(
                ChromaBlocks.DYE.getBlockInstance(), i, dye.color
            );
            BlockColorInterface.addGPRBlockColor(
                ChromaBlocks.DYESAPLING.getBlockInstance(), i, dye.color
            );
            BlockColorInterface.addGPRBlockColor(
                ChromaBlocks.CRYSTAL.getBlockInstance(), i, e.getColor()
            );
            BlockColorInterface.addGPRBlockColor(
                ChromaBlocks.SUPER.getBlockInstance(), i, e.getColor()
            );
            BlockColorInterface.addGPRBlockColor(
                ChromaBlocks.LAMP.getBlockInstance(), i, e.getColor()
            );
            BlockColorInterface.addGPRBlockColor(
                ChromaBlocks.GLOW.getBlockInstance(), i, e.getColor()
            );
            BlockColorInterface.addGPRBlockColor(
                ChromaBlocks.GLASS.getBlockInstance(), i, e.getColor()
            );
            BlockColorInterface.addGPRBlockColor(
                ChromaBlocks.PLANT.getBlockInstance(),
                i,
                ReikaColorAPI.mixColors(e.getColor(), 0x00990F, 0.5F)
            );
            BlockColorInterface.addGPRBlockColor(
                ChromaBlocks.RUNE.getBlockInstance(),
                i,
                ReikaColorAPI.mixColors(e.getColor(), 0x303030, 0.5F)
            );
        }

        BlockColorInterface.addGPRBlockColor(
            ChromaBlocks.STRUCTSHIELD.getBlockInstance(), 0x3F3F3F
        );
        BlockColorInterface.addGPRBlockColor(
            ChromaBlocks.PYLONSTRUCT.getBlockInstance(), 0x303030
        );
        BlockColorInterface.addGPRBlockColor(
            ChromaBlocks.CHROMA.getBlockInstance(), 0xE5C7E5
        );
        BlockColorInterface.addGPRBlockColor(
            ChromaBlocks.LUMA.getBlockInstance(), 0x570091
        );

        for (int i = 0; i < Flowers.list.length; i++) {
            BlockColorInterface.addGPRBlockColor(
                ChromaBlocks.DECOFLOWER.getBlockInstance(), i, Flowers.list[i].getColor()
            );
        }

        for (int i = 0; i < TieredOres.list.length; i++) {
            BlockColorInterface.addGPRBlockMimic(
                ChromaBlocks.TIEREDORE.getBlockInstance(), i, Blocks.stone
            );
        }

        for (int i = 0; i < TieredPlants.list.length; i++) {
            BlockColorInterface.addGPRBlockMimic(
                ChromaBlocks.TIEREDPLANT.getBlockInstance(), i, Blocks.air
            );
        }
    }
    ...
    public static void addMicroblocks() {
        ...
        FMLInterModComms.sendMessage(
            "ForgeMicroblock",
            "microMaterial",
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(1)
        );
        FMLInterModComms.sendMessage(
            "ForgeMicroblock",
            "microMaterial",
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(2)
        );
        FMLInterModComms.sendMessage(
            "ForgeMicroblock",
            "microMaterial",
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(7)
        );
        FMLInterModComms.sendMessage(
            "ForgeMicroblock",
            "microMaterial",
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(8)
        );
        FMLInterModComms.sendMessage(
            "ForgeMicroblock",
            "microMaterial",
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(10)
        );
        FMLInterModComms.sendMessage(
            "ForgeMicroblock",
            "microMaterial",
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(11)
        );
        FMLInterModComms.sendMessage(
            "ForgeMicroblock",
            "microMaterial",
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(12)
        );

        FMLInterModComms.sendMessage(
            "ForgeMicroblock",
            "microMaterial",
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.CLOAK.ordinal())
        );
        FMLInterModComms.sendMessage(
            "ForgeMicroblock",
            "microMaterial",
        ...
        FMLInterModComms.sendMessage(
            "ForgeMicroblock",
            "microMaterial",
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.GLASS.ordinal())
        );
        FMLInterModComms.sendMessage(
            "ForgeMicroblock",
            "microMaterial",
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.MOSS.ordinal())
        );
        FMLInterModComms.sendMessage(
            "ForgeMicroblock",
            "microMaterial",
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.CRACKS.ordinal())
        );
        FMLInterModComms.sendMessage(
            "ForgeMicroblock",
            "microMaterial",
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.COBBLE.ordinal())
        );
        FMLInterModComms.sendMessage(
            "ForgeMicroblock",
            "microMaterial",
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.LIGHT.ordinal())
        );
    }
    ...
    public static void addChromastoneTools() {
        ...
        CustomTinkerMaterial mat = TinkerMaterialHelper.instance.createMaterial(
            id, ChromatiCraft.instance, "Chromastone"
        );
        mat.durability = 200;
        mat.damageBoost = 10;
    ...
    public static void addThaumRecipes() {
        ...
        ReikaThaumHelper.addBookCategory(
            new ResourceLocation("chromaticraft", "textures/blocks/tile/table_top.png"),
            "chromaticraft",
            "Reika/ChromatiCraft/Textures/Thaumonomicon/bcg.png"
        );
...

        {
            ...
            InfusionRecipe ir = ThaumcraftApi.addInfusionCraftingRecipe(
                "WARPPROOF", out, 24, al, in, recipe
            );
            ReikaThaumHelper
                ...
                .setParents("ELDRITCHMAJOR", "CCCONVERT")
                .setSpecial()
                .setConcealed();
...

        {
            ...
            InfusionRecipe ir = ThaumcraftApi.addInfusionCraftingRecipe(
                "ROD_CRYSTALWAND",
                ChromaStacks.crystalWand,
                18,
                al,
                ChromaStacks.iridChunk,
                recipe
            );
            ReikaThaumHelper
                .addInfusionRecipeBookEntryViaXML(
                    ChromatiCraft.instance,
                    "ROD_CRYSTALWAND",
                    "Fashioning a wand from crystals",
                    "chromaticraft",
                    ir,
                    costFactor,
                    -3,
                ...
                .setSpecial()
                .setParents("ROD_silverwood", "CAP_thaumium", "SCEPTRE", "PYLONWANDING")
                .setConcealed();
        }

        {
            ...
            InfusionRecipe ir = ThaumcraftApi.addInfusionCraftingRecipe(
                "MANIPFOCUS",
                ChromaItems.MANIPFOCUS.getStackOf(),
                0,
                al,
            ...
            ReikaThaumHelper
                .addInfusionRecipeBookEntryViaXML(
                    ChromatiCraft.instance,
                    "MANIPFOCUS",
                    "Why have two wands when you can have one?",
                    "chromaticraft",
                    ir,
                    costFactor,
                    -2,
                ...
                .setParents("FOCUSFIRE", "INFUSION", "CCINTRO")
                .setConcealed();
        }

        {
            ...
            ResourceLocation ico = DragonAPICore.getDirectResource(
                "Reika/ChromatiCraft/Textures/Thaumonomicon/pylonwanding.png"
            );
            ResearchItem ri = ReikaThaumHelper.addBasicBookEntryViaXML(
                ChromatiCraft.instance,
                "PYLONWANDING",
                "Pylon-Sourced Vis",
                desc,
            ...
            if (ChromaOptions.HARDTHAUM.getState())
                ri.setParents(
                    "NODETAPPER2", "WANDPEDFOC", "CCCONVERT", "CAP_gold", "ROD_greatwood"
                );
            else
                ri.setParents(
                    "BASICTHAUMATURGY",
...

        {
            ...
            InfusionRecipe ir = ThaumcraftApi.addInfusionCraftingRecipe(
                "ABILITYFOCUS",
                ChromaItems.ABILITYFOCUS.getStackOf(),
                5,
                al,
                in,
            ...
            ReikaThaumHelper
                .addInfusionRecipeBookEntryViaXML(
                    ChromatiCraft.instance,
                    "ABILITYFOCUS",
                    "For when convenience becomes inconvenient",
                    "chromaticraft",
                    ir,
                    costFactor,
                    -1,
                ...
                .setParents("FOCALMANIPULATION", "INFUSION", "MANIPFOCUS", "FOCUSPRIMAL");
        }

        {
            String desc = "Independent streams of magic";
            ResourceLocation ico = DragonAPICore.getDirectResource(
                "Reika/ChromatiCraft/Textures/Thaumonomicon/intro.png"
            );
            ResearchItem ri = ReikaThaumHelper.addBasicBookEntryViaXML(
                ChromatiCraft.instance,
                "CCINTRO",
                "Thaumaturgic vs Elemental Energy",
                desc,
                "chromaticraft",
                null,
                0,
...

        {
            ...
            ResourceLocation ico = DragonAPICore.getDirectResource(
                "Reika/ChromatiCraft/Textures/Thaumonomicon/convert.png"
            );
            ResearchItem ri = ReikaThaumHelper.addBasicBookEntryViaXML(
                ChromatiCraft.instance,
                "CCCONVERT",
        ...
        ThaumcraftApi.addWarpToResearch(
            "ROD_CRYSTALWAND", ChromaOptions.HARDTHAUM.getState() ? 5 : 2
        );

        ThaumcraftApi.addWarpToResearch(
            "PYLONWANDING", ChromaOptions.HARDTHAUM.getState() ? 4 : 2
        );
    }
    ...
    public static void modifyRFToolsPages() {
        for (int i = 0; i < Biomes.biomeList.length; i++) {
            FMLInterModComms.sendMessage(
                ModList.RFTOOLS.modLabel,
                "dimlet_blacklist",
                "Biome." + Biomes.biomeList[i].getBiome().biomeName
            );
        }
        for (int i = 0; i < SubBiomes.biomeList.length; i++) {
            FMLInterModComms.sendMessage(
                ModList.RFTOOLS.modLabel,
                "dimlet_blacklist",
                "Biome." + SubBiomes.biomeList[i].getBiome().biomeName
            );
        }
        FMLInterModComms.sendMessage(
            ModList.RFTOOLS.modLabel,
            "dimlet_blacklist",
            "Biome." + ChromatiCraft.glowingcliffsEdge.biomeName
        );

        FMLInterModComms.sendMessage(
            ModList.RFTOOLS.modLabel,
            "dimlet_configure",
            "Biome." + ChromatiCraft.rainbowforest.biomeName + "=600000,12000,600,3"
        );
        FMLInterModComms.sendMessage(
            ModList.RFTOOLS.modLabel,
            "dimlet_configure",
            "Biome." + ChromatiCraft.glowingcliffs.biomeName + "=400000,9000,300,2"
        );
        FMLInterModComms.sendMessage(
            ModList.RFTOOLS.modLabel,
            "dimlet_configure",
            "Biome." + ChromatiCraft.enderforest.biomeName + "=500000,9000,400,3"
        );
    }
    ...
    public static void setDynSurroundSettings() {
        ...
        try {
            Class c
                = Class.forName("org.blockartistry.mod.DynSurround.data.BiomeRegistry");
            Class c2 = Class.forName(
                "org.blockartistry.mod.DynSurround.data.BiomeRegistry$Entry"
            );
    ...
    private static void clearSounds(
        Method m, Field soundField1, Field soundField2, ChromaDimensionBiome biome
    ) throws Exception {
        ...
        if (entry != null) {
            ...
            ChromatiCraft.logger.logError(
                "Entry for biome " + biome.biomeName + " was null."
            );
        }
    }
    ...
    public static void registerCliffSoil() {
        ((APIv2) API.getAPI(2))
            .registerDefaultSoil(new BlockWithMeta(
                ChromaBlocks.CLIFFSTONE.getBlockInstance(),
                Variants.FARMLAND.getMeta(false, false)
            ));
    }

    public static boolean
    triggerPylonScanProgress(EntityPlayer ep, TileEntityCrystalPylon te) {
        boolean color = ChromaOptions.HARDTHAUM.getState()
            ? ProgressStage.ALLCOLORS.isPlayerAtStage(ep)
            : ProgressionManager.instance.hasPlayerDiscoveredColor(ep, te.getColor());
        if (color && ProgressStage.PYLON.isPlayerAtStage(ep)
            && (ChromaOptions.HARDTHAUM.getState() ? ProgressStage.USEENERGY
                                                   : ProgressStage.CHARGE)
                   .isPlayerAtStage(ep)) {
            if (!ReikaThaumHelper.isResearchComplete(ep, "CCCONVERT")
                && ReikaThaumHelper.hasResearchPrereqs(ep, "CCCONVERT")) {
                ...
                ReikaPacketHelper.sendDataPacket(
                    ...
                    ChromaPackets.WANDCHARGE.ordinal(),
                    (EntityPlayerMP) ep,
                    ElementTagCompound.of(te.getColor(), 200000).toArray()
                );
                return true;
            }
        }
