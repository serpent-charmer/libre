...
public class ItemRemoteTerminal
    extends ItemChromaTool /*implements IWirelessTermHandler*/ {
    ...
    public boolean onItemUse(
        ...
        if (te instanceof IGridHost) {
            IGridNode ign
                = ((IGridHost) te).getGridNode(ForgeDirection.VALID_DIRECTIONS[s]);
            if (ign != null) {
    ...
    public ItemStack onItemRightClick(ItemStack is, World world, EntityPlayer ep) {
        ep.openGui(
            ChromatiCraft.instance, ChromaGuis.REMOTETERMINAL.ordinal(), world, 0, 0, 0
        );
        ...
        if (loaded)
            ...
            ReikaChatHelper.sendChatToPlayer(ep, "Cannot open terminal GUI; interfacing
        code errored.");
         */
        return is;
    }
    ...
    public IGridHost getLink(ItemStack is, World world) {
        ...
        if (te instanceof IGridHost) {
            ...
            ForgeDirection dir
                = ForgeDirection.VALID_DIRECTIONS[is.stackTagCompound.getInteger("dir")];
            return igh;
        }
        return null;
    }
    ...
    static {
        try {
            ...
            openGui = plat.getMethod("openGui", EntityPlayer.class, TileEntity.class,
    ForgeDirection.class, bridge); Field enu = bridge.getField("GUI_WIRELESS_TERM");
