...
public class NetherSpiral {
    ...
    private static void
    generateLayer(World world, int i, int y, int k, int j, Random rand) {
        ...
        if (j == 1) {
            ChromaAux.generateLootChest(
                world, i + 9, j + y, k + 9, 3, rand, Location.JUNGLE_DISPENSER, 0
            );

            ChromaAux.generateLootChest(
                world, i + 1, j + y, k + 5, 3, rand, Location.JUNGLE_PUZZLE, 2
            );
            ChromaAux.generateLootChest(
                world, i + 5, j + y, k + 17, 1, rand, Location.JUNGLE_PUZZLE, 2
            );
            ChromaAux.generateLootChest(
                world, i + 13, j + y, k + 1, 0, rand, Location.JUNGLE_PUZZLE, 2
            );
            ChromaAux.generateLootChest(
                world, i + 17, j + y, k + 13, 2, rand, Location.JUNGLE_PUZZLE, 2
            );
        }
    }
}
