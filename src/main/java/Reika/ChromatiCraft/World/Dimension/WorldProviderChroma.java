...
public class WorldProviderChroma
    extends WorldProvider implements CustomBiomeDistributionWorld {
    ...
    public void updateWeather() {
        /*
        worldObj.getWorldInfo().setRaining(true); //always raining, but most biomes do not
        render it if (worldObj.isRemote) worldObj.setRainStrength(0.25F);
         */
    }
    ...
    public static boolean isUnbreakableTerrain(World world, int x, int y, int z) {
        ...
        return (b == Blocks.grass || b == Blocks.stone)
