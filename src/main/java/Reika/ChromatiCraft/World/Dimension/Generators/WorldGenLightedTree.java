...
public class WorldGenLightedTree extends ChromaWorldGenerator {
    ...
    public boolean generate(World world, Random rand, int x, int y, int z) {
        return this.canGenerateTree(world, x, y, z)
            && TreeGen.genList[rand.nextInt(TreeGen.genList.length)].generate(
                world, x, y, z, rand
            );
    }
    ...
    public static enum TreeGen {
        ...
        private static void
        generateBallTree(World world, int i, int j, int k, Random rand) {
        ...
        private static void
        generateTallTree(World world, int i, int j, int k, Random rand) {
            Block b = ChromaBlocks.GLOWLOG.getBlockInstance();
            i -= 2;
            k -= 2;
        ...
        private static void
        generateOakTree(World world, int i, int j, int k, Random rand) {
            Block b = ChromaBlocks.GLOWLOG.getBlockInstance();
            i -= 3;
            k -= 3;
        ...
        private static void placeLeaf(World world, int x, int y, int z, Random rand) {
            if (world.getBlock(x, y, z).canBeReplacedByLeaves(world, x, y, z))
                world.setBlock(
                    x, y, z, ChromaBlocks.GLOWLEAF.getBlockInstance(), rand.nextInt(5), 3
                );
        }
    }
}
