...
public class WorldGenMoonPool extends ChromaWorldGenerator {
    ...
    public boolean generate(World world, Random rand, int x, int y, int z) {
        ...
        if (world.getBlock(x, dy, z) == Blocks.water
            && ReikaWorldHelper.getWaterDepth(world, x, dy, z) >= 5) {
            if (ReikaWorldHelper.getWaterDepth(world, x + 6, dy, z) >= 3
                && ReikaWorldHelper.getWaterDepth(world, x - 6, dy, z) >= 3) {
                if (ReikaWorldHelper.getWaterDepth(world, x, dy, z + 6) >= 3
                    && ReikaWorldHelper.getWaterDepth(world, x, dy, z - 6) >= 3) {
            ...
            for (int k = -r; k <= r; k++) {
                ...
                for (int h = 0; h <= r; h++) {
                    ...
                    if (ReikaMathLibrary.isPointInsideEllipse(i, h, k, r, ry, ra)) {
                        BlockKey b = ReikaMathLibrary.isPointInsideEllipse(
                                         i, h, k, r - 1, ry - 1, ra - 1
                                     )
