...
public class WorldGenAurorae extends ChromaWorldGenerator {
    ...
    public static Collection<EntityAurora>
    generateAurorae(World world, Random rand, double x, double y, double z) {
        ...
        for (int i = 0; i < num; i++) {
            ...
            double y1 = Math.max(
                ReikaWorldHelper.getTopSolidOrLiquidBlockForDouble(world, x1, z1) + 40,
                120 + rand.nextDouble() * 100
            );
            double y2 = Math.max(
                ReikaWorldHelper.getTopSolidOrLiquidBlockForDouble(world, x2, z2) + 40,
                120 + rand.nextDouble() * 100
            );
            ...
            AuroraData dat
                = new AuroraData(x1, y1, z1, x2, y2, z2, c1.color, c2.color, speed);
