...
public class WorldGenCrystalPit extends ChromaWorldGenerator {
                            ...
                            if (j >= 0
                                ...
                                if (j <= -2 && rand.nextInt(3) == 0) {
                                    world.setBlock(
                                        ...
                                        colors[primary][rand.nextInt(4)].ordinal(),
                                        3
                                    );
                                }
                            }
                    ...
                    if (ReikaMathLibrary.isPointInsideEllipse(i, j, k, r1, r2, r1)) {
                        ...
                        if (j >= 0
                            ...
                            if (bd.isAir(world, dx, dy - 1, dz))
                                return false;
                            if (bd.getMaterial() != Material.rock
                                && bd.getMaterial() != Material.grass
                                && bd.getMaterial() != Material.iron
                                && bd.getMaterial() != Material.ground)
                                return false;
                        }
                    }
                }
    ...
    static {
        colors[0] = new CrystalElement[] { CrystalElement.BLUE,
                                           CrystalElement.RED,
                                           CrystalElement.PURPLE,
                                           CrystalElement.MAGENTA };
        colors[1] = new CrystalElement[] { CrystalElement.GREEN,
                                           CrystalElement.YELLOW,
                                           CrystalElement.CYAN,
                                           CrystalElement.LIME };
        colors[2] = new CrystalElement[] { CrystalElement.BROWN,
                                           CrystalElement.PINK,
                                           CrystalElement.ORANGE,
                                           CrystalElement.LIGHTBLUE };
        colors[3] = new CrystalElement[] { CrystalElement.BLACK,
                                           CrystalElement.GRAY,
