...
public class TracePuzzleGenerator
    ...
    private TracePuzzle[] getPuzzles() {
        switch (ChromaOptions.getStructureDifficulty()) {
            case 1:
                return new TracePuzzle[] { new TracePuzzle(this, 5, 4),
                                           new TracePuzzle(this, 5, 5),
                                           new TracePuzzle(this, 6, 6),
                                           new TracePuzzle(this, 10, 8) };
            case 2:
                return new TracePuzzle[] { new TracePuzzle(this, 5, 4),
                                           new TracePuzzle(this, 5, 5),
                                           new TracePuzzle(this, 6, 6),
                                           new TracePuzzle(this, 8, 8),
                                           new TracePuzzle(this, 12, 10) };
            case 3:
            default:
                return new TracePuzzle[] {
                    new TracePuzzle(this, 4, 4),   new TracePuzzle(this, 5, 5),
                    new TracePuzzle(this, 6, 6),   new TracePuzzle(this, 8, 8),
                    new TracePuzzle(this, 10, 10), new TracePuzzle(this, 12, 12)
                };
        }
    }
