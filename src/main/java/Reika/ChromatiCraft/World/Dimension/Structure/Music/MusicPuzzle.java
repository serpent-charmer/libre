...
public class MusicPuzzle
    extends StructurePiece<MusicPuzzleGenerator> implements TileCallback {
    ...
    public void generate(ChunkSplicedGenerationCache world, int x, int y, int z) {
        ...
        world.setTileEntity(
            x + 5, y + 1, z + 5, ChromaBlocks.MUSICMEMORY.getBlockInstance(), 0, this
        );
        if (index == 0)
    ...
    public void initialize(Random rand) {
        ...
        validNotes
            = new ArrayList(CrystalMusicManager.instance.getValidNotesToMixWith(center));
        //validColors = new
        //ArrayList(CrystalMusicManager.instance.getChordMixes(signature));
    ...
    private MusicKey randomKey(Random rand) {
        //CrystalElement e =
        //validColors.get(rand.nextInt(validColors.size()));//CrystalElement.randomElement();
