        ...
        for (int i = 0; i <= size; i++) {
            for (int j = 0; j <= size; j++) {
                for (int k = 0; k <= size; k++) {
                     ...
                     */
                    boolean tunnel
                        = tunnel0 || tunnel1 || tunnel2 || tunnel3 || tunnel4 || tunnel5;
                    ...
                    boolean wall5
                        = k == size; // && !room[ForgeDirection.SOUTH.ordinal()];
                    ...
                    boolean light1
                        = lights && i == size && j == size / 2 && k == size / 2;
                    boolean light2 = lights && j == 0 && i == size / 2 && k == size / 2;
                    boolean light3
                        = lights && j == size && i == size / 2 && k == size / 2;
                    boolean light4 = lights && k == 0 && j == size / 2 && i == size / 2;
                    boolean light5
                        = lights && k == size && j == size / 2 && i == size / 2;
                    boolean light
                    ...
                    Block b = fill ? ChromaBlocks.STRUCTSHIELD.getBlockInstance()
                                   : Blocks.air;
                    int meta = fill
                        ? (light ? BlockType.LIGHT.metadata : BlockType.STONE.metadata)
                        : 0;
                    if (window)
