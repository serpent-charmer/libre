    ...
    public void generate(ChunkSplicedGenerationCache world, int x, int y, int z) {
        ...
        for (int i = 0; i <= DEPTH; i++) {
            for (int l = 0; l <= WIDTH; l++) {
                ...
                int m = l == 0 || l == WIDTH ? BlockType.STONE.metadata
                                             : BlockType.COBBLE.metadata;
                world.setBlock(
                    dx, y, dz, ChromaBlocks.STRUCTSHIELD.getBlockInstance(), m
                );
                world.setBlock(
                    dx,
                    y + HEIGHT,
            ...
            for (int u = 1; u <= HEIGHT; u++) {
                ...
                world.setBlock(
                    x + dir.offsetX * i + left.offsetX * WIDTH,
                    y + u,
                    z + dir.offsetZ * i + left.offsetZ * WIDTH,
                    ChromaBlocks.STRUCTSHIELD.getBlockInstance(),
                    BlockType.STONE.metadata
                );
            }
        ...
        for (int u = 1; u <= HEIGHT; u++) {
            world.setBlock(
                x + dir.offsetX * DEPTH + left.offsetX * 4,
                y + u,
                z + dir.offsetZ * DEPTH + left.offsetZ * 4,
                ChromaBlocks.STRUCTSHIELD.getBlockInstance(),
                BlockType.STONE.metadata
            );
            world.setBlock(
                x + dir.offsetX * DEPTH + left.offsetX * 5,
                y + u,
                z + dir.offsetZ * DEPTH + left.offsetZ * 5,
                ChromaBlocks.STRUCTSHIELD.getBlockInstance(),
                BlockType.STONE.metadata
            );
        }
        ...
        world.setBlock(
            x + dir.offsetX + left.offsetX * WIDTH,
            y + 2,
            z + dir.offsetZ + left.offsetZ * WIDTH,
            ChromaBlocks.STRUCTSHIELD.getBlockInstance(),
            BlockType.LIGHT.metadata
        );
        ...
        for (int i = 1; i <= d; i++) {
            ...
            for (int l = 0; l <= WIDTH; l++) {
                for (int dh = 0; dh <= h; dh++) {
                    ...
                    world.setBlock(
                        x + left.offsetX * l + dir.offsetX * (i + DEPTH),
                        y + dh,
                        z + left.offsetZ * l + dir.offsetZ * (i + DEPTH),
                        b,
                        m
                    );
                }
