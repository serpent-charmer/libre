...
public class MazeBaseBuilder {
    public static void build(
        ...
        if (extraGen != null) {
            extraGen.generateExtras(
                gen, world, segmentOffsetX, posY, segmentOffsetZ, segment
            );
        }
    }

    @SuppressWarnings("incomplete-switch")
    private static void carveWalls(
        ChunkSplicedGenerationCache world,
        int posX,
        int posY,
        int posZ,
    ...
    public static void
    doBasicGen(ChunkSplicedGenerationCache world, int posX, int posY, int posZ) {
