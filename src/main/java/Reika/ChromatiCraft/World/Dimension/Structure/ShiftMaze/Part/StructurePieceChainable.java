...
public abstract class StructurePieceChainable<V extends DimensionStructureGenerator>
    extends StructurePiece {
    public StructurePieceChainable(V s) {
        super(s);
    }

    public int generateAndMoveCursor(
        ChunkSplicedGenerationCache world, int x, int y, int z, int cursor
    ) {
