...
public class MazePartEndCore extends StructureLootRoom<ShiftMazeGenerator> {
    public MazePartEndCore(ShiftMazeGenerator s) {
        super(s);
    }
    ...
    public void generate(ChunkSplicedGenerationCache world, int x, int y, int z) {
        ...
        this.setEndBreakableStone(world, x - 5, y + 1, z + 5);
        this.setEndBreakableStone(world, x - 5, y + 2, z + 5);
        this.setEndBreakableStone(world, x - 5, y + 3, z + 5);
        this.setEndBreakableStone(world, x - 5, y + 1, z - 5);
        this.setEndBreakableStone(world, x - 5, y + 2, z - 5);
        this.setEndBreakableStone(world, x - 5, y + 3, z - 5);
        ...
        this.setEndBreakableStone(world, x - 6, y + 1, z + 5);
        this.setEndBreakableStone(world, x - 6, y + 2, z + 5);
        this.setEndBreakableStone(world, x - 6, y + 3, z + 5);
        this.setEndBreakableStone(world, x - 6, y + 1, z - 5);
        this.setEndBreakableStone(world, x - 6, y + 2, z - 5);
        this.setEndBreakableStone(world, x - 6, y + 3, z - 5);
        ...
        this.setEndBreakableStone(world, x - 7, y + 1, z + 5);
        this.setEndBreakableStone(world, x - 7, y + 2, z + 5);
        this.setEndBreakableStone(world, x - 7, y + 3, z + 5);
        this.setEndBreakableStone(world, x - 7, y + 1, z - 5);
        this.setEndBreakableStone(world, x - 7, y + 2, z - 5);
        this.setEndBreakableStone(world, x - 7, y + 3, z - 5);
        ...
        this.setEndBreakableStone(world, x - 12, y + 1, z);
        this.setEndBreakableStone(world, x - 12, y + 1, z + 1);
        this.setEndBreakableStone(world, x - 12, y + 1, z - 1);
        this.setEndBreakableStone(world, x - 12, y + 2, z);
        this.setEndBreakableStone(world, x - 12, y + 2, z + 1);
        this.setEndBreakableStone(world, x - 12, y + 2, z - 1);
        this.setEndBreakableStone(world, x - 12, y + 3, z);
        this.setEndBreakableStone(world, x - 12, y + 3, z + 1);
        this.setEndBreakableStone(world, x - 12, y + 3, z - 1);
    ...
    private void
    setEndBreakableStone(ChunkSplicedGenerationCache world, int x, int y, int z) {
        ...
        world.setBlock(
            ...
            BlockStructureShield.BlockType.STONE.metadata
        );
    }
}
