...
public class NonEuclideanGenerator extends DimensionStructureGenerator {
    ...
    private final HashMap<Coordinate, HashMap<Coordinate, TeleportTriggerAction>> actions
        = new HashMap();
    ...
    protected void calculate(int chunkX, int chunkZ, Random rand) {
        ...
        this.placeWindow(
            x + 9, posY + 2, z + 44, ForgeDirection.WEST, x + 3, posY + 2, z + 52
        );
        this.placeWindow(
            x + 3, posY + 2, z + 52, ForgeDirection.EAST, x + 9, posY + 2, z + 44
        );
        ...
        this.createPortal(
            ...
            new BlockVector(-16, 0, 8, ForgeDirection.NORTH)
        );
        this.createPortal(
            x + 23,
            posY + 1,
            ...
            new BlockVector(16, 0, -8, ForgeDirection.SOUTH)
        );
        this.createPortal(
            x + 31,
            posY + 1,
            z + 48,
            ForgeDirection.NORTH,
            new BlockVector(-8, 0, 12, ForgeDirection.NORTH),
            new Coordinate(-8, 0, 14),
            DeactivateOneOf.instance,
            new Coordinate(8, 0, 4),
            DeactivateOneOf.instance
        );

        RerouteIf newLoc1
            = new RerouteIf(new BlockVector(-2, 0, 12, ForgeDirection.EAST));
        RerouteIf newLoc2 = new RerouteIf(new BlockVector(-2, 0, 4, ForgeDirection.EAST));
        RerouteIf newLoc3
            = new RerouteIf(new BlockVector(-2, 0, -4, ForgeDirection.EAST));
        this.createPortal(
            x + 24,
            posY + 1,
            z + 33,
            ForgeDirection.WEST,
            new BlockVector(11, 0, 8, ForgeDirection.EAST),
            new Coordinate(0, 0, 0),
            newLoc1,
            new Coordinate(0, 0, 8),
            newLoc1,
            new Coordinate(0, 0, 16),
            newLoc1
        );
        this.createPortal(
            x + 24,
            ...
            z + 41,
            ForgeDirection.WEST,
            new BlockVector(11, 0, 0, ForgeDirection.EAST),
            new Coordinate(0, 0, -8),
            newLoc2,
            new Coordinate(0, 0, 0),
            newLoc2,
        ...
        this.createPortal(
            ...
            z + 4,
            ForgeDirection.NORTH,
            new BlockVector(12, 0, 0, ForgeDirection.NORTH),
            SameFacing.instance
        );
        this.createPortal(
            x + 21,
            ...
            z + 6,
            ForgeDirection.NORTH,
            new BlockVector(12, 0, -2, ForgeDirection.SOUTH),
            SameFacing.instance
        );
        this.createPortal(
            x + 33,
            ...
            z + 6,
            ForgeDirection.SOUTH,
            new BlockVector(12, 0, -2, ForgeDirection.NORTH),
            SameFacing.instance
        );
        this.createPortal(
            x + 45,
            ...
            z + 6,
            ForgeDirection.SOUTH,
            new BlockVector(-36, 0, 0, ForgeDirection.SOUTH),
            SameFacing.instance
        );
        ...
        this.createPortal(
            ...
            z + 20,
            ForgeDirection.EAST,
            new BlockVector(10, 0, 25, ForgeDirection.WEST)
        );
        this.createPortal(
            x + 22,
            posY + 1,
            z + 20,
            ForgeDirection.WEST,
            new BlockVector(-6, 0, 21, ForgeDirection.SOUTH)
        );
        this.createPortal(
            x + 16,
            posY + 1,
            z + 34,
            ForgeDirection.SOUTH,
            new BlockVector(14, 0, -7, ForgeDirection.NORTH),
            SameFacing.instance /*, new Coordinate(6, 0, -14), DeactivateOneOf.instance,
                                   new Coordinate(-6, 0, -14), DeactivateOneOf.instance*/
        );
        ...
        this.createPortal(
            ...
            z + 16,
            ForgeDirection.WEST,
            new BlockVector(8, 0, 37, ForgeDirection.WEST),
            SameFacing.instance
        );
        ...
        this.createPortal(
            ...
            z + 18,
            ForgeDirection.NORTH,
            new BlockVector(-4, 0, 27, ForgeDirection.EAST)
        );
        this.createPortal(
            x + 41,
            posY + 1,
            z + 31,
            ForgeDirection.SOUTH,
            new BlockVector(-6, 0, 10, ForgeDirection.EAST)
        );
        ...
        this.createPortal(
            ...
            z + 35,
            ForgeDirection.EAST,
            new BlockVector(24, 0, 13, ForgeDirection.NORTH)
        );
        this.createPortal(
            x + 18,
            posY + 1,
            z + 50,
            ForgeDirection.NORTH,
            new BlockVector(-4, 0, 0, ForgeDirection.NORTH)
        );
        ...
        this.createPortal(
            ...
            z + 12,
            ForgeDirection.SOUTH,
            new BlockVector(0, 0, 0, ForgeDirection.SOUTH)
        ); //trigger for key portal
    ...
    private void
    generateAir(ChunkSplicedGenerationCache world, Random rand, int x, int posY, int z) {
        HashSet<Coordinate> set = world.getLocationsOf(new BlockKey(
            ChromaBlocks.SPECIALSHIELD.getBlockInstance(), BlockType.CLOAK.metadata
        ));
    ...
    private void
    createPortal(int x, int y, int z, ForgeDirection dir, BlockVector bv, Object... ts) {
        ...
        while (!li.isEmpty()) {
            ...
            if (o instanceof TriggerCriteria) {
                ...
                this.addAction(
                    x, y, z, (Coordinate) o, (TeleportTriggerAction) li.remove(0)
                );
            }
        }
        ...
        for (int d = -1; d <= 1; d++) {
            if (d != 0) {
                world.setBlock(
                    ...
                    y,
                    z + d * left.offsetZ,
                    ChromaBlocks.TELEPORT.getBlockInstance(),
                    1
                );
            }
            world.setBlock(
    ...
    private void
    addAction(int x, int y, int z, Coordinate rel, TeleportTriggerAction act) {
    ...
    private void
    placeWindow(int x, int y, int z, ForgeDirection dir, int dx, int dy, int dz) {
        WindowPlace wp = new WindowPlace(dir, new Coordinate(dx, dy, dz));
        world.setTileEntity(
            x,
            y,
            z,
            ChromaTiles.WINDOW.getBlock(),
            ChromaTiles.WINDOW.getBlockMetadata(),
            wp
        );
    }
    ...
    private void placeKey(int x, int y, int z, Random rand) {
        world.setTileEntity(
            ...
            BlockLootChest.getMeta(ForgeDirection.EAST),
            new LootChestCallback(door, rand)
        );
    }
    ...
    private void placeDoor(int x, int y, int z, ForgeDirection dir) {
        ...
        for (int d = -1; d <= 1; d++) {
            world.setTileEntity(
                x + d * left.offsetX, y, z + d * left.offsetZ, b, m, doorCallback
            );
            world.setTileEntity(
                x + d * left.offsetX, y + 1, z + d * left.offsetZ, b, m, doorCallback
            );
            world.setTileEntity(
                x + d * left.offsetX, y + 2, z + d * left.offsetZ, b, m, doorCallback
            );
        }
    ...
    public void removeAction(int x, int y, int z, Coordinate rel) {
        HashMap<Coordinate, TeleportTriggerAction> map
            = actions.get(new Coordinate(x, y, z));
        if (map != null) {
            map.remove(rel);
        }
    }
    ...
    public boolean hasBeenSolved(World world) {
        return BlockChromaDoor.isOpen(
            world, doorLoc.xCoord, doorLoc.yCoord, doorLoc.zCoord
        );
    }
    ...
    private static class WindowPlace extends DimensionStructureTileCallback {
        ...
        public void onTilePlaced(World world, int x, int y, int z, TileEntity te) {
            if (te instanceof TileEntityTransportWindow) {
                ...
                if (other.getBlock(world) != ChromaTiles.WINDOW.getBlock()
                    || other.getBlockMetadata(world)
                        != ChromaTiles.WINDOW.getBlockMetadata())
                    other.setBlock(
                        world,
                        ChromaTiles.WINDOW.getBlock(),
                ...
                if (te2 instanceof TileEntityTransportWindow) {
                    ((TileEntityTransportWindow) te)
                        .linkTo((TileEntityTransportWindow) te2);
                }
            }
        }
    }
