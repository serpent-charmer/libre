...
public class StructureMapRenderer implements IItemRenderer {
    ...
    public boolean shouldUseRenderHelper(
        ...
        return baseRender.shouldUseRenderHelper(
            type, item, helper
    ...
    private void prepareRender(float ptick, AbstractClientPlayer e) {
        float f1 = 1; //this.prevEquippedProgress + (this.equippedProgress -
                      //this.prevEquippedProgress) * ptick;
        float f13 = 0.8F;
        ...
        GL11.glTranslatef(
            0.0F, 0.0F * f13 - (1.0F - f1) * 1.2F - f5 * 0.5F + 0.04F, -0.9F * f13
        );
        ...
        for (int i1 = 0; i1 < 2; ++i1) {
            ...
            RenderPlayer renderplayer
                = (RenderPlayer) RenderManager.instance.getEntityRenderObject(e);
    ...
    private void drawBackground() {
        ...
        ReikaTextureHelper.bindTexture(
            ChromatiCraft.class, "Textures/StructureMap/bcg.png"
        );
