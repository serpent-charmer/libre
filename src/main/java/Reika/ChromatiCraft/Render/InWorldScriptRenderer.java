...
public class InWorldScriptRenderer {
    ...
    public static void
    renderBiomeScript(TileEntityStructControl te, float par8, Tessellator v5, double sc) {
        ...
        ArrayList<LorePanel> li
            = LoreScripts.ScriptLocations.BIOMESTRUCT.getUniqueRandomPanels(rand, 4);
        ...
        for (int r = 0; r < 4; r++) {
            ...
            for (int k = 0; k < p.lineCount; k++) {
                ...
                float f2 = (float) Math.min(
                    1,
                    (0.75 + 0.25 * Math.sin(tick * 0.25 - 4.7)
                     + 0.03125 * Math.sin(tick * 5 - 1))
                );
    ...
    public static void
    renderSnowScript(TileEntityStructControl te, float par8, Tessellator v5, double sc) {
        //GL11.glDisable(GL11.GL_DEPTH_TEST);
        ...
        ArrayList<LorePanel> li
            = LoreScripts.ScriptLocations.SNOWSTRUCT.getUniqueRandomPanels(rand, 4);
    ...
    public static void
    renderPylonScript(TileEntityCrystalPylon te, float par8, Tessellator v5, double sc) {
        ...
        GL11.glPushMatrix();
        ArrayList<LorePanel> li
            = LoreScripts.ScriptLocations.PYLON.getUniqueRandomPanels(rand, 8);
    ...
    public static void renderAlvearyScript(
        TileEntityLumenAlveary te, float par8, Tessellator v5, double sc, double maxDSq
    ) {
        int c1 = 0xFFFFFF;
        int c2 = 0x73DCFF;
        ...
        GL11.glPushMatrix();
        ArrayList<LorePanel> li
            = LoreScripts.ScriptLocations.ALVEARY.getUniqueRandomPanels(rand, 4);
    ...
    public static void renderTowerScript(
        TileEntityDataNode te, float par8, Tessellator v5, double sc, double maxDSq
    ) {
        int c1 = 0xFFFFFF;
        int c2 = 0x73DCFF;
        ...
        GL11.glPushMatrix();
        ArrayList<LorePanel> li
            = LoreScripts.ScriptLocations.TOWER.getUniqueRandomPanels(rand, 4);
    ...
    public static void renderDesertScript(
        TileEntityStructControl te, float par8, Tessellator v5, double sc
    ) {
        //GL11.glDisable(GL11.GL_DEPTH_TEST);
        ...
        ArrayList<LorePanel> li
            = LoreScripts.ScriptLocations.DESERT.getUniqueRandomPanels(rand, 4);
    ...
    public static void
    renderOceanScript(TileEntityStructControl te, float par8, Tessellator v5, double sc) {
        //GL11.glDisable(GL11.GL_DEPTH_TEST);
        ...
        GL11.glPushMatrix();
        ArrayList<LorePanel> li
            = LoreScripts.ScriptLocations.OCEAN.getUniqueRandomPanels(rand, 2);
    ...
    public static void renderBurrowScript(
        TileEntityStructControl te, float par8, Tessellator v5, double sc
    ) {
        //GL11.glDisable(GL11.GL_DEPTH_TEST);
        ...
        GL11.glPushMatrix();
        ArrayList<LorePanel> li
            = LoreScripts.ScriptLocations.BURROW.getUniqueRandomPanels(rand, 3);
        ...
        GL11.glPushMatrix();
        //li = ReikaJavaLibrary.makeListFrom("AnotHER 8024", "sh OR t sTG", "a 5 2 hF a
        //7", "test num 4", "a FIFTH line");
        ...
        GL11.glPushMatrix();
        //li = ReikaJavaLibrary.makeListFrom("type 102 7", "trest the 81", " 23iig kgj",
        //"chAr gROUp", "number FIVE 5");
    ...
    public static void renderCavernScript(
        TileEntityStructControl te, float par8, Tessellator v5, double sc
    ) {
        //GL11.glDisable(GL11.GL_DEPTH_TEST);
        ...
        GL11.glPushMatrix();
        ArrayList<LorePanel> li
            = LoreScripts.ScriptLocations.CAVERN1.getUniqueRandomPanels(rand, 2);
        GL11.glTranslated(0, 0, -1 + 0.005);
        GL11.glTranslated(0.25, 0, 0);
        GL11.glScaled(sc, sc, sc);
        int c1 = 0x70f0ff;
