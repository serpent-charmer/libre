...
public class RenderMeteorShot extends Render {
    @Override
    public void
    doRender(Entity e, double par2, double par4, double par6, float par8, float ptick) {
        ReikaTextureHelper.bindTerrainTexture();
        EntityMeteorShot eb = (EntityMeteorShot) e;
        Tessellator v5 = Tessellator.instance;
        IIcon icon = ChromaIcons.FADE_CLOUD.getIcon();
        ...
        double s1 = 1 + 0.75 * eb.getTier();
        double d = 0.001;
        int c1 = 0xffa000; //eb.getRenderColor();
