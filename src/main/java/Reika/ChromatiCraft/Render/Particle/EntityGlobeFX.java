...
public class EntityGlobeFX extends EntityFX implements CustomRenderFX {
    private static final TextureMode texture
        = new CustomTextureMode(ChromatiCraft.class, "Textures/Particle/16x.png");
    ...
    "Textures/Particle/16x.png"); BlendMode.ADDITIVEDARK.apply(); GL11.glColor4f(1, 1, 1,
