...
public class RenderWarpNode extends ChromaRenderBase {
    private final RemoteSourcedAsset texture
        = ChromaClient.dynamicAssets.createAsset("Textures/warpnode-small.png");
    ...
    public void renderTileEntityAt(
        ...
        if (!tile.hasWorldObj() || MinecraftForgeClient.getRenderPass() == 1
            ...
            float f = sch == Double.POSITIVE_INFINITY
                ? 1
                : 0.5F + 0.5F * (float) (1 - d / 8D);
            ...
            if (te.hasWorldObj()) {
                ...
                //if (dist >= 0.875 && !ReikaEntityHelper.isLookingAt(ep, te.xCoord+0.5,
                //te.yCoord+0.5, te.zCoord+0.5)) 	val = 0;
                ChromaShaders shd
                    = te.isOpen() ? ChromaShaders.WARPNODE_OPEN : ChromaShaders.WARPNODE;
