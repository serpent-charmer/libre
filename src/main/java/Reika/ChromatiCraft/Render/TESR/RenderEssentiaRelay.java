...
public class RenderEssentiaRelay extends ChromaRenderBase {
    ...
    private void renderNetwork(TileEntityEssentiaRelay te, float fade, float par8) {
        ...
        for (Coordinate c : map) {
            if (c.hashCode() < new Coordinate(te).hashCode())
                continue;
            float f =
    (float)(0.5+0.5*Math.sin((te.getTicksExisted()+par8)/10D+System.identityHashCode(c)));
            ...
            /*
            v5.addVertex(c.xCoord-te.xCoord+o, c.yCoord-te.yCoord+o,
    c.zCoord-te.zCoord+o); v5.addVertex(c.xCoord-te.xCoord+o, c.yCoord-te.yCoord+1-o,
    c.zCoord-te.zCoord+o); v5.addVertex(c.xCoord-te.xCoord+1-o, c.yCoord-te.yCoord+o,
    c.zCoord-te.zCoord+o); v5.addVertex(c.xCoord-te.xCoord+1-o, c.yCoord-te.yCoord+1-o,
    c.zCoord-te.zCoord+o); v5.addVertex(c.xCoord-te.xCoord+o, c.yCoord-te.yCoord+o,
    c.zCoord-te.zCoord+1-o); v5.addVertex(c.xCoord-te.xCoord+o, c.yCoord-te.yCoord+1-o,
    c.zCoord-te.zCoord+1-o); v5.addVertex(c.xCoord-te.xCoord+1-o, c.yCoord-te.yCoord+o,
    c.zCoord-te.zCoord+1-o); v5.addVertex(c.xCoord-te.xCoord+1-o, c.yCoord-te.yCoord+1-o,
    c.zCoord-te.zCoord+1-o);
    ...
    private void drawInner(TileEntityEssentiaRelay te, float par8) {
        ...
        double t = te.isInWorld() ? (te.getTicksExisted() + par8)
                                  : System.currentTimeMillis() / 50D;

        double s2 = 0.75
            + 0.0625
                * (0.25 * Math.sin(t) + 1 * Math.sin(6 * t) + 1 * Math.cos(t / 2D)
                   + 0.75 * Math.cos(2 * t) + 2.5 * Math.sin(t / 64D));
        if (!te.isInWorld())
            s2 *= 1.875;
