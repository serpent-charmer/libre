...
public class RenderCrystalBeacon extends ChromaRenderBase {
    ...
    private final RemoteSourcedAsset fireTexture
        = ChromaClient.dynamicAssets.createAsset("Textures/fire.png");
    ...
    private void renderGlow(
        TileEntityCrystalBeacon te, double par2, double par4, double par6, float par8
    ) {
