...
public class RenderAspectFormer extends ChromaRenderBase {
    ...
    private void renderAspect(
        TileEntityAspectFormer te, double par2, double par4, double par6, float ptick
    ) {
    ...
    private void renderAspectTransfer(
        TileEntityAspectFormer te, double par2, double par4, double par6, float ptick
    ) {
        Aspect a = te.getAspectForRender();
        if (a == null)
        ...
        for (double dy = -0.0625; dy > -0.9375; dy -= 0.0625) {
            ...
            EntityFX fx = new EntityCenterBlurFX(
                              CrystalElement.WHITE, te.worldObj, px, py, pz, 0, 0, 0
            )
                              .setLife(4)
                              .setScale(2F)
                              .setColor(a.getColor());
