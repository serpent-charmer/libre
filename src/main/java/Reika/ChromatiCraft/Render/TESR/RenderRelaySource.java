...
public class RenderRelaySource extends ChromaRenderBase {
    ...
    public void renderTileEntityAt(
        ...
        GL11.glColor4f(
            ReikaColorAPI.getRed(color) / 255F,
            ReikaColorAPI.getGreen(color) / 255F,
            ReikaColorAPI.getBlue(color) / 255F,
            1
        );
    ...
    private void renderCrystal(
        TileEntityRelaySource te, double par2, double par4, double par6, float par8
    ) {
        ...
        if (is != null) {
            ...
            if (!tag.isEmpty()) {
                ...
                for (CrystalElement e : tag.elementSet()) {
                    ...
                    int c = e.getColor(
                    ); //ReikaColorAPI.mixColors(e.getColor(), 0xb0b0b0, frac);
                    int a = 255; //127;
