...
public class RenderItemRift extends ChromaRenderBase {
    ...
    public String getImageFileName(RenderFetcher te) {
        return ((TileEntityItemRift) te).isEmitting() ? "itemrift_emit.png"
                                                      : "itemrift_receive.png";
    }
    ...
    /*
    private void renderCenter(TileEntityItemRift te, double par2, double par4, double
    par6, float par8) { Tessellator v5 = Tessellator.instance; Coordinate c =
    te.getConnection(); if (c == null) return;
