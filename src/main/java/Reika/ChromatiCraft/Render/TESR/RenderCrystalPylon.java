...
public class RenderCrystalPylon extends CrystalTransmitterRender {
    ...
    public void renderTileEntityAt(
        ...
        if (tile.hasWorldObj()
            ...
            if (VoidGazeLevels.PYLONXRAY.isActiveOnPlayer(
            ...
            if (MinecraftForgeClient.getRenderPass() == 1
                && ScriptLocations.PYLON.isEnabled()
            ...
            for (int di = 0; di < count; di++) {
                ...
                double t = (i * 60 + te.randomOffset
                            + System.currentTimeMillis() / 2000D * (1 + 3 * i))
                    % 360;
                ...
                if (StructureRenderer.isRenderingTiles()
                    && !StructureRenderer.isRenderingRealTiles()) {
                    color
                        = CrystalElement
                              .elements[(int) ((System.currentTimeMillis() / 4000) % 16)]
                              .getColor();
                }
