...
public class RenderAvoLaser extends ChromaRenderBase {
    ...
    public void renderTileEntityAt(
        ...
        if (te.hasWorldObj()) {
            GL11.glPushMatrix();
            //ReikaAABBHelper.renderAABB(te.getScanBox(te.worldObj, te.xCoord, te.yCoord,
            //te.zCoord), par2, par4, par6, te.xCoord, te.yCoord, te.zCoord, 255, 255,
            //255, 255, true);
    ...
    private void renderCrystal(TileEntityAvoLaser te) {
        ...
        for (int i = 0; i < 360; i += n) {
            ...
            v5.setColorOpaque_I(
                ReikaColorAPI.getColorWithBrightnessMultiplier(0xff4040, f)
            );
