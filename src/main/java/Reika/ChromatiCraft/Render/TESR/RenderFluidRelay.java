...
public class RenderFluidRelay extends ChromaRenderBase {
    ...
    public void renderTileEntityAt(
        ...
        if (MinecraftForgeClient.getRenderPass() == 1) {
            ...
            double s = 0.625
                + 0.25 * Math.sin(System.currentTimeMillis() / 800D - te.hashCode())
                + 0.1 * Math.sin(System.currentTimeMillis() / 300D - te.hashCode());
            GL11.glScaled(s, s, s);
            ...
            if (!set.isEmpty()) {
                if (connectionAlphaTick != te.getWorldObj().getTotalWorldTime()
                    ...
                    if (HoldingChecks.MANIPULATOR.isClientHolding()
                        || ReikaItemHelper.matchStacks(
                            ...
                            ChromaTiles.FLUIDRELAY.getCraftedProduct()
                        )) {
                        if (connectionAlphaOverride < 255) {
                            connectionAlphaOverride
                                = Math.min(255, connectionAlphaOverride + 3);
                        }
                ...
                for (Coordinate c : set) {
                    ...
                    if (o != null && o instanceof TileEntityFluidRelay
                        && o.hashCode()
                            > te.hashCode()) { //ensure only one renders of the two
                        int a = Math.max(
                            connectionAlphaOverride,
                            ((int
                             ) (240
                                * Math.sin(
                                    te.getTicksExisted() / 32D + te.hashCode()
                        ...
                        if (a > 0) {
                            ...
                            ChromaFX.renderBeam(
                                ...
                                y,
                                z,
                                c.xCoord - te.xCoord + x2,
                                c.yCoord - te.yCoord + y2,
                                c.zCoord - te.zCoord + z2,
                                par8,
                                a,
                                0.1875
                            );
