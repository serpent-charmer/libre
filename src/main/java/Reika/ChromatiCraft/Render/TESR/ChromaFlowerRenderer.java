...
public class ChromaFlowerRenderer extends ChromaRenderBase {
    ...
    public void renderTileEntityAt(
        ...
        IIcon ico2 = ((BlockChromaPlantTile) ChromaBlocks.TILEPLANT.getBlockInstance())
                         .getPlantTexture(0, 4);
        ...
        if (pass == 0 || !te.isInWorld()) {
            IIcon ico = ((BlockChromaPlantTile) ChromaBlocks.TILEPLANT.getBlockInstance())
                            .getPlantTexture(0, 1);
            float u = ico.getMinU();
        ...
        if (pass != 0 || !te.isInWorld()) {
            ...
            for (int k = 0; k < 3; k++) {
                IIcon ico
                    = ((BlockChromaPlantTile) ChromaBlocks.TILEPLANT.getBlockInstance())
                          .getPlantTexture(0, k + 1);
                float u = ico.getMinU();
                float du = ico.getMaxU();
                float v = ico.getMinV();
                float dv = ico.getMaxV();
