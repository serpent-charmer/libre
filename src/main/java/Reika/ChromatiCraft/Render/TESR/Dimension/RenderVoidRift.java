...
public class RenderVoidRift extends ChromaRenderBase {
    ...
    private final RemoteSourcedAsset texture
        = ChromaClient.dynamicAssets.createAsset("Textures/voidaura-strip_page.png");
    ...
    private void renderAura(TileEntityVoidRift te) {
        ...
        for (int i = 2; i < 6; i++) {
            ...
            if (b.blockID != te.getBlockType()) {
                ...
                colors[i - 2]
                    = ReikaColorAPI.mixColors(e.getColor(), e2.getColor(), 0.5F);
            }
        }
        for (int i = 0; i < 4; i++) {
            ...
            if (color != null) {
                float ang = (float
                ) (0.875F + 0.125F * Math.sin(System.currentTimeMillis() / 800D));
                ...
                for (int k = 1; k < h; k++) {
                    ...
                    switch (ForgeDirection.VALID_DIRECTIONS[i + 2]) {
                        case NORTH:
                            ...
                            v5.addVertexWithUV(
                                colors[ForgeDirection.WEST.ordinal() - 2] == null
                                    ? 0
                                    : wave[0],
                                k + 1,
                                te.hasAt(-1, -1) ? 0 : wave[1],
                                u,
                                v
                            );
                            this.calcWave(te, t, r, te.xCoord + 1, y + 1, te.zCoord);
                            v5.addVertexWithUV(
                                colors[ForgeDirection.EAST.ordinal() - 2] == null
                                    ? 1
                                    : 1 - wave[0],
                                k + 1,
                                te.hasAt(1, -1) ? 0 : wave[1],
                        ...
                        case EAST:
                            this.calcWave(te, t, r, te.xCoord + 1, y + 1, te.zCoord);
                            v5.addVertexWithUV(
                                te.hasAt(1, -1) ? 1 : 1 - wave[0],
                                k + 1,
                                colors[ForgeDirection.NORTH.ordinal() - 2] == null
                                    ? 0
                                    : wave[1],
                                u,
                                v
                            ...
                            v5.addVertexWithUV(
                                te.hasAt(1, 1) ? 1 : 1 - wave[0],
                                k + 1,
                                colors[ForgeDirection.SOUTH.ordinal() - 2] == null
                                    ? 1
                                    : 1 - wave[1],
                                du,
                                v
                    ...
                    switch(ForgeDirection.VALID_DIRECTIONS[i+2]) {
                        case NORTH:
                            v5.addVertexWithUV(colors[ForgeDirection.WEST.ordinal()-2] ==
                    null ? 0 : o[0][1][0], dk, o[0][1][1], u, v);
                            v5.addVertexWithUV(colors[ForgeDirection.EAST.ordinal()-2] ==
                    null ? 1 : o[1][3][0], dk, o[1][3][1], du, v);
                            v5.addVertexWithUV(colors[ForgeDirection.EAST.ordinal()-2] ==
                    null ? 1 : o[1][2][0], k,  o[1][2][1], du, dv);
                            v5.addVertexWithUV(colors[ForgeDirection.WEST.ordinal()-2] ==
                    null ? 0 : o[0][0][0], k,  o[0][0][1], u, dv); break; case SOUTH:
                            v5.addVertexWithUV(colors[ForgeDirection.WEST.ordinal()-2] ==
                    null ? 0 : o[2][0][0], k,  o[2][0][1], u, dv);
                            v5.addVertexWithUV(colors[ForgeDirection.EAST.ordinal()-2] ==
                    null ? 1 : o[3][2][0], k,  o[3][2][1], du, dv);
                            v5.addVertexWithUV(colors[ForgeDirection.EAST.ordinal()-2] ==
                    null ? 1 : o[3][3][0], dk, o[3][3][1], du, v);
                            v5.addVertexWithUV(colors[ForgeDirection.WEST.ordinal()-2] ==
                    null ? 0 : o[2][1][0], dk, o[2][1][1], u, v); break; case EAST:
                            v5.addVertexWithUV(o[1][3][0], dk,
                    colors[ForgeDirection.NORTH.ordinal()-2] == null ? 0 : o[1][3][1], u,
                    v); v5.addVertexWithUV(o[3][3][0], dk,
                    colors[ForgeDirection.SOUTH.ordinal()-2] == null ? 1 : o[3][3][1], du,
                    v); v5.addVertexWithUV(o[3][2][0], k,
                    colors[ForgeDirection.SOUTH.ordinal()-2] == null ? 1 : o[3][2][1], du,
                    dv); v5.addVertexWithUV(o[1][2][0], k,
                    colors[ForgeDirection.NORTH.ordinal()-2] == null ? 0 : o[1][2][1], u,
                    dv); break; case WEST: v5.addVertexWithUV(o[0][0][0], k,
                    colors[ForgeDirection.NORTH.ordinal()-2] == null ? 0 : o[0][0][1], u,
                    dv); v5.addVertexWithUV(o[2][0][0], k,
                    colors[ForgeDirection.SOUTH.ordinal()-2] == null ? 1 : o[2][0][1], du,
                    dv); v5.addVertexWithUV(o[2][1][0], dk,
                    colors[ForgeDirection.SOUTH.ordinal()-2] == null ? 1 : o[2][2][1], du,
                    v); v5.addVertexWithUV(o[0][1][0], dk,
                    colors[ForgeDirection.NORTH.ordinal()-2] == null ? 0 : o[0][1][1], u,
    ...
    private void
    calcWave(TileEntityVoidRift te, double t, double r, int x, int y, int z) {
