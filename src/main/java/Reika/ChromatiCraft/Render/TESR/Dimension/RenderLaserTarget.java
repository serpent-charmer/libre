...
public class RenderLaserTarget extends ChromaRenderBase {
    ...
    public void renderTileEntityAt(
        ...
        if (te.isTriggered())
            t *= 2;
        double s = (te.isTriggered() ? 0.625 : 0.5) + 0.0625 * Math.sin(t / 400D)
            + 0.125 * Math.sin(t / 2000D);
        double dy = (te.isTriggered() ? 0.1875 : 0.125) + 0.0625 * Math.cos(t / 1200D)
            + 0.125 * Math.cos(t / 4000D);
