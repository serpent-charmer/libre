...
public class CrystalPlantRenderer extends ChromaRenderBase {
    @Override
    public void
    renderTileEntityAt(TileEntity te, double par2, double par4, double par6, float f) {
        ...
        if (tile.renderPod()) {
            ...
            if (tile.emitsLight()) {
                ...
                GL11.glColor4f(
                    dye.getRed() / 255F, dye.getGreen() / 255F, dye.getBlue() / 255F, 1
                );
                double s = 0.25;
    ...
    private void drawBulb(TileEntityCrystalPlant tile) {
        Tessellator v5 = Tessellator.instance;
        IIcon ico = ((BlockCrystalPlant) ChromaBlocks.PLANT.getBlockInstance())
                        .getBulbIcon(tile.getColor());
        float u = ico.getMinU();
        float v = ico.getMinV();
        float du = ico.getMaxU();
        float dv = ico.getMaxV();
