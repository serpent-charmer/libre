...
public class CliffStoneRenderer extends ISBRH {
    ...
    renderInventoryBlock(Block b, int metadata, int modelId, RenderBlocks rb) {
        //rb.renderBlockAsItem(BlockCliffStone.Variants.getVariant(metadata).getBlockProxy(),
        //0, 1);
    ...
    public boolean renderWorldBlock(
        ...
        if (v == Variants.GRASS) {
            int c = Blocks.grass.colorMultiplier(world, x, y, z);
            v5.setColorOpaque_I(c);
            rb.renderFaceYPos(block, x, y, z, block.getIcon(world, x, y, z, 1));
        }
        return true;
    }
