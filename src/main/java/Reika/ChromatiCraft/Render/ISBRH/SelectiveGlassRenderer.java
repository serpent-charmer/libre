...
public class SelectiveGlassRenderer extends ISBRH {
    ...
    private IIcon getOverlayIcon(
        long t,
        ConnectedTextureGlass b,
        int meta,
        ForgeDirection dir,
        IBlockAccess world,
        int x,
    ...
    public boolean renderWorldBlock(
        ...
        float l = Math.max(
            w.getSavedLightValue(EnumSkyBlock.Block, x, y, z),
            w.getSavedLightValue(EnumSkyBlock.Sky, x, y, z) * w.getSunBrightnessFactor(0)
        );
        ...
        if (renderPass == 1) {
            ...
            if (block.shouldSideBeRendered(
                    world, x, y, z, ForgeDirection.DOWN.ordinal()
                )) {
            ...
            v5.setBrightness(240);
            if (block.shouldSideBeRendered(
                    world, x, y, z, ForgeDirection.EAST.ordinal()
                )) {
            ...
            v5.setBrightness(240);
            if (block.shouldSideBeRendered(
                    world, x, y, z, ForgeDirection.WEST.ordinal()
                )) {
            ...
            v5.setBrightness(240);
            if (block.shouldSideBeRendered(
                    world, x, y, z, ForgeDirection.SOUTH.ordinal()
                )) {
            ...
            v5.setBrightness(240);
            if (block.shouldSideBeRendered(
                    world, x, y, z, ForgeDirection.NORTH.ordinal()
                )) {
