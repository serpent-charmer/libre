...
public class ChromatiPackets implements PacketHandler {
    ...
    public void handleData(PacketObj packet, World world, EntityPlayer ep) {
        ...
        try {
            switch (pack) {
                ...
                case SPAWNERPROGRAM: {
                    TileEntitySpawnerReprogrammer prog
                        = (TileEntitySpawnerReprogrammer) tile;
                ...
                case PYLONATTACKRECEIVE:
                    ChromaOverlays.instance.triggerPylonEffect(
                        CrystalElement.elements[data[0]]
                    );
                    break;
                case ABILITYCHOOSE:
                    ((TileEntityRitualTable) tile)
                        .setChosenAbility(Chromabilities.getAbilityByInt(data[0]));
                    break;
                case BUFFERSET:
                    PlayerElementBuffer.instance.setPlayerCapOnClient(
                        ep, data[0], data[1] > 0
                    );
                    break;
                    /*
                ...
                case TELEPUMP:
                    ...
                    break;
                    //case TRANSMIT:
                    //((TileEntityFiberTransmitter)tile).transmitParticle(ForgeDirection.VALID_DIRECTIONS[data[0]],
                    //data[1], CrystalElement.elements[data[2]]); break;
                case ASPECT:
                ...
                case LAMPINVERT:
                    ...
                    break;
                case TNT:
                    ((TileEntityEnderTNT) tile)
                        .setTarget(ep, data[0], data[1], data[2], data[3]);
                    break;
                case BOOKINVSCROLL:
             ...
             case FRAGPROGRAM: {
                ...
                case LEAFBREAK:
                    BlockPowerTree.breakEffectsClient(
                        world, x, y, z, CrystalElement.elements[data[0]]
                    );
                    break;
                case GIVEPROGRESS: {
                    ProgressStage p = ProgressStage.list[data[0]];
                    ProgressionManager.instance.setPlayerStageClient(
                        ep, p, data[1] > 0, true
                    );
                    break;
                }
                case HEALTHSYNC:
                    AbilityHelper.instance.setHealthClient(
                        ep, ReikaJavaLibrary.buildDoubleFromInts(data[0], data[1])
                    );
                    break;
                case INVCYCLE:
                ...
                case RELAYCONNECT: {
                    ...
                    for (int i = 0; i < num; i += 3) {
                        Coordinate c
                            = new Coordinate(data[i + 0], data[i + 1], data[i + 2]);
                        li.add(c);
                    }
                ...
                case BIOMEPAINT: {
                    BiomeGenBase b = data[2] >= 0
                        ? BiomeGenBase.biomeList[data[2]]
                        : ReikaWorldHelper.getNaturalGennedBiomeAt(
                            world, data[0], data[1]
                        );
                ...
                case PYLONCACHE: {
                    ...
                    PylonGenerator.instance.cachePylonLocation(
                        world,
                        data[0],
                        data[1],
                        data[2],
                        CrystalElement.elements[data[3]],
                        li,
                        data[4] > 0,
                        uid,
                        data[5] > 0
                ...
                case TRANSITIONWAND: {
                    ((ItemTransitionWand) ep.getCurrentEquippedItem().getItem())
                        .setMode(
                            ep.getCurrentEquippedItem(), TransitionMode.list[data[0]]
                        );
                    break;
                }
                case NEWTELEPORT:
                ...
                case TELEPORT:
                    ...
                    break;
                case MAPTELEPORT:
                    AbilityHelper.instance.gotoMapWarpPoint(
                        new WorldLocation(data[0], data[1], data[2], data[3]),
                        (EntityPlayerMP) ep
                    );
                    break;
                case DELTELEPORT:
                    ...
                    break;
                case SENDTELEPORT:
                    AbilityHelper.instance.addWarpPoint(
                        stringdata,
                        ep,
                        new WorldLocation(data[0], data[1], data[2], data[3])
                    );
                ...
                case GROWTH:
                    ...
                    break;
                case PROGRESSNOTE:
                    ChromaResearchManager.instance.notifyPlayerOfProgression(
                        ep, ChromaResearchManager.instance.getProgressForID(data[0])
                    );
                    break;
                case PORTALRECIPE:
                    PortalRecipe.onClientSideRandomTick(
                        (TileEntityCastingTable) tile, data[0]
                    );
                    break;
                case PYLONTURBORECIPE:
                    PylonTurboRecipe.onClientSideRandomTick(
                        (TileEntityCastingTable) tile, data[0]
                    );
                    break;
                case REPEATERTURBORECIPE:
                    RepeaterTurboRecipe.onClientSideRandomTick(
                        (TileEntityCastingTable) tile, data[0]
                    );
                    break;
                case HEATLAMP:
                ...
                case BULKNUMBER:
                    ...
                    break;
                case CASTAUTOUPDATE:
                    ((CastingAutomationBlock) tile)
                        .getAutomationHandler()
                        .receiveUpdatePacket(world, data);
                    break;
                case AUTORECIPE: {
                    CastingRecipe cr = !Strings.isNullOrEmpty(stringdata)
                        ? RecipesCastingTable.instance.getRecipeByStringID(stringdata)
                        : null;
                    ((CastingAutomationBlock) tile)
                        .getAutomationHandler()
                        .setRecipe(cr, data[0], ep);
                    break;
                }
                case AUTOCANCEL:
                    ((CastingAutomationBlock) tile)
                    ...
                    break;
                case AUTORECURSE: {
                    RecursiveCastingAutomationSystem sys
                        = (RecursiveCastingAutomationSystem
                        ) ((CastingAutomationBlock) tile)
                              .getAutomationHandler();
                ...
                case CHAINGUNEND:
                    ...
                    break;
                case METRANSFER:
                    ((TileEntityMEDistributor) tile)
                        .spawnTransferParticles(world, x, y, z, data[0], data[1]);
                    break;
                ...
                case MEDISTRIBFUZZY:
                    ...
                    break;
                case HOVERWAND: {
                    ItemFlightWand.setMode(
                        ep.getCurrentEquippedItem(), HoverType.list[data[0]]
                    );
                    break;
                }
                case AURATTACK:
                ...
                case HEALNODE:
                    ...
                    break;
                case NEWASPECTNODE:
                    NodeReceiverWrapper.triggerNewAspectFX(
                        world, x, y, z, Aspect.getAspect(stringdata)
                    );
                    break;
                ...
                case VACUUMGUNEND:
                    ...
                    break;
                case RFSEND:
                    ((TileEntityRFDistributor) tile)
                        .sendRFToClient(data[0], data[1], data[2], data[3]);
                    break;
                case DIMPING:
                ...
                case CRYSTALMUS:
                    ((TileEntityCrystalMusic) tile)
                        .doParticles(
                            ...
                            CrystalElement.elements[data[3]],
                            data[4],
                            MusicKey.getByIndex(data[5])
                        );
                    break;
                case MUSICTEMPLE:
                    ((TileEntityCrystalMusic) tile)
                        .onTempleNote(MusicKey.getByIndex(data[0]), data[1], data[2]);
                    break;
                case MUSICTEMPLESTART: {
                    Coordinate c = Coordinate.readFromNBT("tile", NBT);
                    ((TileEntityCrystalMusic) c.getTileEntity(world)).onTempleStart(NBT);
                    break;
                }
                case MUSICTEMPLEEND:
                    ((TileEntityCrystalMusic) tile).onTempleEnd();
                    break;
                ...
                case MUSICNOTE:
                    ((TileEntityCrystalMusic) tile)
                        .addNote(
                            data[0], MusicKey.getByIndex(data[1]), data[2], data[3] > 0
                        );
                    break;
                case FIXEDMUSICNOTE:
                    ((TileEntityCrystalMusic) tile)
                ...
                case PYLONTURBOCOMPLETE:
                    ((TileEntityPylonTurboCharger) tile)
                        .doCompleteParticlesClient(world, x, y, z);
                    break;
                case PYLONTURBOEVENT:
                    if (tile != null)
                        ((TileEntityPylonTurboCharger) tile)
                            .doEventClient(world, x, y, z, data[0], data[1]);
                    break;
                case PYLONTURBOFAIL:
                    ((TileEntityPylonTurboCharger) tile)
                        .doFailParticlesClient(world, x, y, z, data[0] > 0);
                    break;
                case MUSICPLAY:
                ...
                case MONUMENTSTART:
                    ...
                    break; /*
                 case MONUMENTSYNC:
                     ((TileEntityStructControl)tile).syncMonument(ReikaJavaLibrary.buildLong(data[0],
                 data[1])); break;*/
                case MONUMENTCOMPLETE:
                    MonumentCompletionRitual.completeMonumentClient(
                        world, data[0], data[1], data[2]
                    );
                    break;
                case RESETMONUMENT:
                    MonumentCompletionRitual.resetSettings(
                        world, data[0], data[1], data[2]
                    );
                    break;
                    //case MONUMENTEVENT:
                    //	MonumentCompletionRitual.triggerMonumentEventClient(world,
                    //data[0], data[1], data[2], data[3]); 	break;
                case MONUMENTEND:
                    ((TileEntityStructControl) tile).endMonumentRitual();
                    break;
                case DASH:
                    ChromaFX.doDashParticles(
                        world,
                        (EntityPlayer) world.getEntityByID(data[0]),
                        data[0] != ep.getEntityId()
                    );
                    break;
                case FENCETRIGGER:
                ...
                case REPEATERCONN:
                    ...
                    break;
                case CHARGERTOGGLE:
                    ((TileEntityCrystalCharger) tile)
                        .toggle(CrystalElement.elements[data[0]]);
                    break;
                case BOOKNOTE: {
                ...
                case REPEATERSURGE: {
                    TileEntityCrystalRepeater.overloadClient(
                        world, x, y, z, CrystalElement.elements[data[0]]
                    );
                    break;
                }
                ...
                case FIREDUMPSHOCK: {
                    ...
                    if (e instanceof EntityLivingBase)
                        ChromaFX.dischargeIntoPlayerFX(
                            world,
                            x,
                            y,
                            z,
                ...
                case INSERTERMODE: {
                    ((TileEntityItemInserter) tile)
                        .setInsertionType(
                            data[0],
                            ((TileEntityItemInserter) tile)
                                .getInsertionType(data[0])
                                .next()
                        );
                    break;
                }
                ...
                case INSERTERACTION: {
                    ((TileEntityItemInserter) tile)
                        .sendItemClientside(data[0], data[1], data[2], data[3], data[4]);
                    break;
                }
                case COBBLEGENEND: {
                    ((TileEntityCobbleGen) tile)
                        .endCraftingFX(world, x, y, z, data[0], data[1] > 0);
                    break;
                }
                case LIGHTERACT: {
                    ((TileEntityCaveLighter) tile)
                        .doLightedParticles(data[0], data[1], data[2]);
                    break;
                }
                case LIGHTERDELTAY: {
                ...
                case PARTICLESPAWNER: {
                    ...
                    ((TileEntityParticleSpawner) c.getTileEntity(world))
                ...
                case WIRELESS: {
                    ((TileEntityWirelessPowered) tile)
                        .doEnergyRequestClient(
                            world,
                            x,
                            y,
                            z,
                ...
                case ORECREATE: {
                    TileEntityOreCreator.doOreCreationFX(
                        world, x, y, z, data[0], data[1]
                    );
                    break;
                }
                case THROWNGEM: {
                    ...
                    if (e instanceof EntityThrownGem) {
                        ((EntityThrownGem) e)
                            .doImpactFX(CrystalElement.elements[data[1]]);
                    }
                    break;
                }
                case FLAREMSG: {
                ...
                case FLAREATTACK: {
                    ...
                    if (e instanceof EntityDimensionFlare) {
                        OuterRegionsEvents.instance.doRejectAttack(
                            (EntityDimensionFlare) e, ep
                        );
                    }
                    break;
                }
                case ASPECTMODE:
                    ...
                    break;
                case FLUIDSEND:
                    ((TileEntityFluidDistributor) tile)
                        .sendFluidToClient(
                            data[0],
                            data[1],
                            data[2],
                            FluidRegistry.getFluid(data[3]),
                            data[4]
                        );
                    break;
                case COLLECTORRANGE:
                ...
                case DIMSOUND:
                    if (ChromaOptions.RECEIVEDIMSOUND.getState())
                        ReikaSoundHelper.playClientSound(
                            ChromaSounds.GOTODIM, ep, 0.75F, 1
                        );
                    break;
                case SKYRIVER_SYNC:
                ...
                case TRIGGERTELEPORT:
                    TileEntityTeleportGate.startTriggerTeleport(
                        new WorldLocation(data[0], data[1], data[2], data[3]),
                        new WorldLocation(data[4], data[5], data[6], data[7]),
                        (EntityPlayerMP) ep
                    );
                    break;
                case TELEPORTCONFIRM:
                    ...
                    break;
                case BIOMELOCS:
                    BiomeDistributor.fillFromPacket(
                        NBT.getTagList("data", NBTTypes.BYTE.ID)
                    );
                    break;
                ...
                case RELAYCOPY:
                    ...
                    break;
                case RELAYAUTO:
                    ((TileEntityFluidRelay) tile).autoFilter
                        = !((TileEntityFluidRelay) tile).autoFilter;
                    break;
                case RELAYFLUID:
                    ((TileEntityFluidRelay) tile)
                        .sendFluidParticles(
                            world, x, y, z, FluidRegistry.getFluid(data[0])
                        );
                    break;
                case RELAYFLUIDKEY:
                    ((TileEntityFluidRelay) tile)
                        .setFluid(
                            data[0], data[1] < 0 ? null : FluidRegistry.getFluid(data[1])
                        );
                    break;
                case RELAYFILTER:
                    ((TileEntityRelayFilter) tile)
                        .setFlag(CrystalElement.elements[data[0]], data[1] > 0);
                    break;
                case ROUTERFILTERFLAG:
                    ...
                    break;
                case ROUTERLINK:
                    ((TileEntityRouterHub) tile)
                        .addHighlight(new Coordinate(data[0], data[1], data[2]));
                    break;
                case STRUCTFIND: {
                    ItemStructureFinder.doTriggerFX(
                        ep,
                        ChromaStructures.structureList[data[0]],
                        data[1],
                        data[2],
                        data[3] > 0,
                        data[4] > 0
                ...
                case STRUCTFINDTICK: {
                    ItemStructureFinder.doTickFX(
                        ep, ChromaStructures.structureList[data[0]]
                    );
                    break;
                }
                case DATASCAN:
                ...
                case LOREPUZZLECOMPLETE:
                    ...
                    break;
                case INSCRIBE:
                    InscriptionRecipes.instance.getRecipeByID(data[0]).doFX(
                        world, x, y, z
                    );
                    break;
                case TOWERLOC:
                    ...
                    /*
                case DIGARTEFACT:
                    ArtefactSpawner.instance.checkPlayerBreakClient(world, data[0],
                data[1], data[2]); break; case ARTEFACTCONFIRM:
                ...
                case NUKERLOC: {
                    ...
                    if (e instanceof EntityPlayer)
                        AbilityCalls.doNukerFX(
                            world, data[0], data[1], data[2], (EntityPlayer) e
                        );
                    break;
                }
                case BURNERINV: {
                ...
                case BROADCASTLINK:
                    ((TileEntityCrystalBroadcaster) tile)
                        .onConnectedParticles(CrystalElement.elements[data[0]]);
                    break;
                case SPELLFAIL:
                    ChromaClientEventController.doDimensionSpellFailParticles(
                        world, dx, dy, dz
                    );
                    break;
                case UAFX:
                ...
                case MINERCATEGORY:
                    ...
                    break;
                case BOTTLENECK:
                    ChromaOverlays.instance.addBottleneckWarning(
                        data[0],
                        data[1],
                        data[2],
                        data[3],
                        data[4],
                        data[5] > 0,
                        CrystalElement.elements[data[6]]
                    );
                    break;
                ...
                case VOIDMONSTERRITUALSET:
                    ...
                    break;
                case ALVEARYEFFECT:
                    ((TileEntityLumenAlveary) tile)
                        .setEffectSelectionState(stringdata, data[0] > 0);
                    break;
                case SUPERBUILD:
                    AbilityCalls.doSuperbuildFX(
                        world, x, y, z, ForgeDirection.VALID_DIRECTIONS[data[0]]
                    );
                    break;
                case OPTIMIZE:
                    TileEntityNetworkOptimizer.runOptimizationStepFX(
                        world, x, y, z, data[0]
                    );
                    break;
                case ENDEREYESYNC: {
                ...
                case NODERECEIVERSYNC:
                    ...
                    break;
                case RFWEBSEND:
                    RFWeb.doSendParticle(
                        world, x, y, z, data[0], data[1], data[2], data[3]
                    );
                    break;
                case STRUCTSEED:
                    StructureCalculator.assignSeed(
                        ReikaJavaLibrary.buildLong(data[0], data[1])
                    );
                    break;
                case RAYBLENDPING:
                    RayBlendPuzzle.spawnPingParticle(
                        world, CrystalElement.elements[data[0]], x, y, z
                    );
                    break;
                case RAYBLENDMIX:
                    RayBlendPuzzle.CrystalMix.doParticle(
                        world, dx, dy, dz, CrystalElement.elements[data[0]], data[1] > 0
                    );
                    break;
                case CONNECTIVITY:
                    ProbeInfoOverlayRenderer.instance.markConnectivity(
                        ep, CrystalElement.elements[data[0]], data[1] > 0, data[2] > 0
                    );
                    break;
                case STRUCTUREERROR:
                    StructureErrorOverlays.instance.onBlockFailure(
                        world, x, y, z, new BlockKey(Block.getBlockById(data[0]), data[1])
                    );
                    break;
                case CLEARHOVERBOX:
                ...
                case LINKFAIL:
                    ...
                    ((TileEntityProgressionLinker) tile)
                        .showFailure(LinkFailure.readFromNBT(NBT));
                    break;
                case VOIDTRAPEAT:
                    TileEntityVoidMonsterTrap.doEatFX(world, x, y, z);
                    break;
                case OREPINGLOC:
                    OreOverlayRenderer.instance.addCoordinate(
                        world, x, y, z, Block.getBlockById(data[0]), data[1], data[2] > 0
                    );
                    break;
                case SMELTERYFLUIDSEND:
                    ((TileEntitySmelteryDistributor) tile)
                        .sendFluidToClient(
                            data[0],
                            data[1],
                            data[2],
                            ...
                            data[4],
                            data[5],
                            ForgeDirection.VALID_DIRECTIONS[data[6]],
                            FluidRegistry.getFluid(data[7])
                        );
                    break;
                case PROGSYNC:
                    ProgressionLinking.instance.attemptSyncTriggerProgressFor(
                        ep, ProgressStage.list[data[0]]
                    );
                    break;
                case ALLOYPATTERN: {
                    PoolRecipe pr = PoolRecipes.instance.getByID(stringdata);
                    if (pr != null) {
                        int slot = ReikaInventoryHelper.locateInInventory(
                            AppEngHandler.getInstance().getBlankPattern(),
                            ep.inventory.mainInventory,
                            false
                        );
                        if (slot >= 0 || ep.capabilities.isCreativeMode) {
                            int empty = ReikaInventoryHelper.findEmptySlot(
                                ep.inventory.mainInventory
                            );
                            if (empty >= 0) {
                                ...
                                if (!ep.capabilities.isCreativeMode)
                                    ReikaInventoryHelper.decrStack(
                                        slot, ep.inventory.mainInventory
                                    );
                            }
                        }
                    }
                ...
                case ENDERBUCKETLINK:
                    ((ItemEnderBucket) ep.getCurrentEquippedItem().getItem())
                        .setLinkIndex(ep.getCurrentEquippedItem(), data[0]);
                    break;
                case ENDERBUCKETMODE:
                    ((ItemEnderBucket) ep.getCurrentEquippedItem().getItem())
                        .stepMode(ep.getCurrentEquippedItem());
                    break;
                case ENDERBUCKETREMOVE:
                    ((ItemEnderBucket) ep.getCurrentEquippedItem().getItem())
                        .removeLinkIndex(ep.getCurrentEquippedItem(), data[0]);
                    break;
                case COLLECTORROW:
                    ...
                    break;
                case STRUCTMAPSTART:
                    StructureMapCommand.startCollecting(
                        ChromaStructures.values()[data[5]],
                        data[0],
                        stringdata,
                        data[1],
                        data[2],
                ...
                case STRUCTMAPDAT: {
                    ...
                    for (int i = 0; i < StructureMapCommand.PACKET_COMPILE; i++) {
                        int a = 1 + i * 3;
                        StructureMapCommand.addDataPoint(
                            hash,
                            data[a],
                            data[a + 1],
                            StructureGenStatus.list[data[a + 2]]
                        );
                    }
                    break;
                }
                ...
                case ARTEALLOYBURST:
                    Entity e = world.getEntityByID(data[0]);
                    if (e instanceof EntityItem) {
                        ArtefactWithDataCrystalAlloyingEffect.instance.doBurst((EntityItem
                        ) e);
                    }
                    break;
                case ITEMRIFTMOVE:
                    ((TileEntityItemRift) tile)
                        .doMoveParticles(
                            data[0],
                            data[1],
                            ForgeDirection.VALID_DIRECTIONS[data[2]],
                            data[3]
                        );
                    break; /*
                 case CLEARSTAND:
                     if (world.provider.dimensionId == data[0]) {
                         if (world.checkChunksExist(data[1], data[2], data[3], data[1],
                 data[2], data[3])) {
                             ReikaInventoryHelper.clearInventory((TileEntityItemStand)world.getTileEntity(data[1],
                 data[2], data[3]));
                         }
                     }
                     break;*/
                case RUNEPARTICLE: {
                    ...
                    ChromaFX.doElementalParticle(
                        world, dx, dy, dz, CrystalElement.elements[data[0]], s, v, data[5]
                    );
                    break;
                }
                case ABILITYFOCUS: {
                ...
                case DOGGOSONAR: {
                    Entity hit = SFAPI.genericLookups.getDoggoClass()
                                     .getConstructor(new Class[] { World.class })
                                     .newInstance(new Object[] { world });
                    hit.setLocationAndAngles(
                        data[0] + 0.5, data[1] + 0.5, data[2] + 0.5, 0, 0
                    );
                ...
                case FRAGSELECT: {
                    //ProgressionChoiceSystem.Selection.giveToPlayer(ep,
                    //ChromaResearch.researchList[data[0]]);
                ...
                case ALTARBREAK: {
                    ...
                    for (int i = 0; i < n; i++)
                        ReikaItemHelper.dropItem(
                            world,
                            data[0] + DragonAPICore.rand.nextDouble(),
                            data[1] + DragonAPICore.rand.nextDouble(),
                            data[2] + DragonAPICore.rand.nextDouble(),
                            ChromaStacks.crystalPowder
                        );
                ...
                case NETWORKITEMMODE: {
                    if (ep.openContainer instanceof ContainerNetworkItemTransporter)
                        ((ContainerNetworkItemTransporter) ep.openContainer)
                            .setFilterDisplay(data[0] > 0);
                    break;
                }
            ...
            ChromatiCraft.logger.logError(
                "TileEntity at " + x + ", " + y + ", " + z
                + " was deleted before its packet " + pack + " could be received!"
            );
        } catch (Exception e) {
            e.printStackTrace();
        }
    ...
    private void handleTeleconfirm(int data, EntityPlayer ep) {
        ((GuiTeleportGate) Minecraft.getMinecraft().currentScreen)
            .handleTriggerConfirm(data > 0);
    }
}
