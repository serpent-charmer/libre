...
public enum ChromaTiles implements TileEnum {
    CHROMAFLOWER(
        "chroma.flower",
        ChromaBlocks.TILEPLANT,
        TileEntityChromaFlower.class,
        0,
        "ChromaFlowerRenderer"
    ),
    ENCHANTER(
        "chroma.enchanter", ChromaBlocks.TILEENTITY, TileEntityAutoEnchanter.class, 0
    ),
    VILLAGEREPAIR(
        "chroma.village", ChromaBlocks.TILEENTITY, TileEntityVillageRepair.class, 1
    ),
    REPROGRAMMER(
        "chroma.reprogrammer",
        ChromaBlocks.TILEMODELLED,
        TileEntitySpawnerReprogrammer.class,
        0,
        "RenderSpawnerProgrammer"
    ),
    ...
    GUARDIAN(
        "chroma.guardian",
        ChromaBlocks.TILECRYSTAL,
        TileEntityGuardianStone.class,
        0,
        "GuardianStoneRenderer"
    ),
    ADJACENCY(
        "chroma.accelerator",
        ChromaBlocks.ADJACENCY,
        TileEntityAdjacencyUpgrade.class,
        -1,
        "AdjacencyUpgradeRenderer"
    ),
    PYLON(
        "chroma.pylon",
        ChromaBlocks.PYLON,
        TileEntityCrystalPylon.class,
        0,
        "RenderCrystalPylon"
    ),
    REPEATER(
        "chroma.repeater",
        ChromaBlocks.PYLON,
        TileEntityCrystalRepeater.class,
        1,
        "RenderCrystalRepeater"
    ),
    LASER(
        "chroma.laser",
        ChromaBlocks.TILEMODELLED,
        TileEntityCrystalLaser.class,
        1,
        "RenderCrystalLaser"
    ),
    STAND(
    ...
    CHARGER(
        "chroma.charger",
        ChromaBlocks.TILEMODELLED,
        TileEntityCrystalCharger.class,
        3,
        "RenderCrystalCharger"
    ),
    ...
    TANK(
        "chroma.tank",
        ChromaBlocks.TILEENTITY,
        TileEntityCrystalTank.class,
        9,
        "TankRender"
    ),
    FENCE(
    ...
    ITEMRIFT(
        "chroma.itemrift",
        ChromaBlocks.TILEMODELLED,
        TileEntityItemRift.class,
        6,
        "RenderItemRift"
    ),
    CRYSTAL(
        "chroma.chromacrystal",
        ChromaBlocks.RAINBOWCRYSTAL,
        TileEntityChromaCrystal.class,
        0
    ),
    INFUSER(
        "chroma.infuser",
        ChromaBlocks.TILEMODELLED,
        TileEntityItemInfuser.class,
        7,
        "RenderInfuser3"
    ),
    FABRICATOR(
        "chroma.fabricator",
        ChromaBlocks.TILEMODELLED,
        TileEntityItemFabricator.class,
        8,
        "RenderItemFabricator"
    ),
    MINER(
        "chroma.miner", ChromaBlocks.TILEMODELLED, TileEntityMiner.class, 9, "RenderMiner"
    ),
    HEATLILY("chroma.heatlily", ChromaBlocks.DECOPLANT, TileEntityHeatLily.class, 0),
    ITEMCOLLECTOR(
        "chroma.itemcoll", ChromaBlocks.TILEENTITY, TileEntityItemCollector.class, 10
    ),
    TICKER("chroma.ticker", ChromaBlocks.TILEENTITY, TileEntityInventoryTicker.class, 11),
    AISHUTDOWN(
        "chroma.aishutdown", ChromaBlocks.TILEMODELLED, TileEntityAIShutdown.class, 10
    ),
    TELEPUMP(
        "chroma.telepump", ChromaBlocks.TILEENTITY, TileEntityTeleportationPump.class, 12
    ),
    COMPOUND(
        "chroma.compound",
        ChromaBlocks.PYLON,
        TileEntityCompoundRepeater.class,
        2,
        "RenderMultiRepeater"
    ),
    RELAYSOURCE(
        "chroma.fibersource",
        ChromaBlocks.TILEMODELLED,
        TileEntityRelaySource.class,
        12,
        "RenderRelaySource"
    ),
    ASPECTJAR(
        "chroma.aspectjar",
        ChromaBlocks.TILEMODELLED2,
        TileEntityAspectJar.class,
        2,
        "AspectJarRenderer",
        ModList.THAUMCRAFT
    ),
    ...
    LAMPCONTROL(
        "chroma.lampcontrol",
        ChromaBlocks.TILEMODELLED2,
        TileEntityLampController.class,
        0,
        "RenderLampControl"
    ),
    CREATIVEPYLON(
        "chroma.creativepylon",
        ChromaBlocks.PYLON,
        TileEntityCreativeSource.class,
        4,
        "RenderCreativePylon"
    ),
    STRUCTCONTROL(
        "chroma.structcontrol",
        ChromaBlocks.PYLON,
        TileEntityStructControl.class,
        5,
        "RenderStructControl"
    ),
    LIFEEMITTER(
        "chroma.lifeemitter",
        ChromaBlocks.TILEMODELLED2,
        TileEntityLifeEmitter.class,
        1 /*, "RenderLifeEmitter"*/
    ),
    FARMER(
        "chroma.farmer",
        ChromaBlocks.TILEMODELLED2,
        TileEntityFarmer.class,
        4,
        "RenderFarmer"
    ),
    AURAPOINT(
        "chroma.aurapoint",
        ChromaBlocks.TILECRYSTALNONCUBE,
        TileEntityAuraPoint.class,
        1,
        "RenderAuraPoint"
    ),
    DIMENSIONCORE(
    ...
    WINDOW(
        "chroma.window",
        ChromaBlocks.TILEMODELLED2,
        TileEntityTransportWindow.class,
        6,
        "RenderTransportWindow"
    ),
    RFDISTRIBUTOR(
        "chroma.rfdistrib",
        ChromaBlocks.TILEMODELLED2,
        TileEntityRFDistributor.class,
        7,
        "RenderRFDistributor"
    ),
    PERSONAL(
        "chroma.personal",
        ChromaBlocks.PYLON,
        TileEntityPersonalCharger.class,
        7,
        "RenderPersonalCharger"
    ),
    MUSIC(
        "chroma.music",
        ChromaBlocks.TILECRYSTAL,
        TileEntityCrystalMusic.class,
        2,
        "RenderCrystalMusic"
    ),
    PATTERNS(
    ...
    PYLONTURBO(
        "chroma.turbo",
        ChromaBlocks.TILEMODELLED2,
        TileEntityPylonTurboCharger.class,
        8,
        "RenderPylonTurboCharger"
    ),
    TURRET(
        "chroma.turret",
        ChromaBlocks.TILEMODELLED2,
        TileEntityLumenTurret.class,
        9,
        "RenderLumenTurret"
    ),
    CONSOLE(
        "chroma.console",
        ChromaBlocks.CONSOLE,
        TileEntityCrystalConsole.class,
        0,
        "RenderCrystalConsole"
    ),
    BROADCAST(
        "chroma.broadcast",
        ChromaBlocks.PYLON,
        TileEntityCrystalBroadcaster.class,
        8,
        "RenderCrystalBroadcast"
    ),
    CLOAKING(
        "chroma.tower",
        ChromaBlocks.TILEMODELLED2,
        TileEntityCloakingTower.class,
        10,
        "RenderCloakingTower"
    ),
    //POSLINK("chroma.poslink",			ChromaBlocks.TILEMODELLED2,
    //TileEntityPositionRelay.class,		10),
    HOLOGRAM(
        "chroma.hologram",
        ChromaBlocks.TILEMODELLED2,
        TileEntityAreaHologram.class,
        11,
        "RenderAreaHologram"
    ),
    LIGHTER(
        "chroma.lighter",
        ChromaBlocks.TILEMODELLED2,
        TileEntityCaveLighter.class,
        12,
        "RenderCaveLighter"
    ),
    STORAGE(
        "chroma.itemstorage", ChromaBlocks.TILEENTITY, TileEntityMultiStorage.class, 14
    ),
    GLOWFIRE(
        "chroma.glowfire",
        ChromaBlocks.TILEMODELLED2,
        TileEntityGlowFire.class,
        13,
        "RenderGlowFire"
    ),
    ESSENTIARELAY(
        "chroma.essentia",
        ChromaBlocks.TILEMODELLED2,
        TileEntityEssentiaRelay.class,
        14,
        "RenderEssentiaRelay"
    ),
    INSERTER(
        "chroma.inserter", ChromaBlocks.TILEENTITY, TileEntityItemInserter.class, 15
    ),
    ...
    PLANTACCEL(
        "chroma.plantaccel", ChromaBlocks.DECOPLANT, TileEntityAccelerationPlant.class, 3
    ),
    CROPSPEED(
        "chroma.cropspeed", ChromaBlocks.DECOPLANT, TileEntityCropSpeedPlant.class, 4
    ),
    CHROMACRAFTER(
        "chroma.chcrafter",
        ChromaBlocks.TILEMODELLED2,
        TileEntityChromaCrafter.class,
        15,
        "RenderChromaCrafter"
    ),
    WEAKREPEATER(
        "chroma.weakrepeater",
        ChromaBlocks.PYLON,
        TileEntityWeakRepeater.class,
        9,
        "RenderWeakRepeater"
    ),
    ENCHANTDECOMP(
        "chroma.enchantdecomp",
        ChromaBlocks.TILEMODELLED3,
        TileEntityEnchantDecomposer.class,
        0,
        "RenderEnchantDecomposer"
    ),
    LUMENWIRE(
        "chroma.lumenwire",
        ChromaBlocks.TILEMODELLED3,
        TileEntityLumenWire.class,
        1,
        "RenderLumenWire"
    ),
    PARTICLES(
        "chroma.particles",
        ChromaBlocks.TILEMODELLED3,
        TileEntityParticleSpawner.class,
        2,
    ...
    WIRELESS(
        "chroma.wireless",
        ChromaBlocks.TILEMODELLED3,
        TileEntityWirelessSource.class,
        3,
        "RenderWirelessSource"
    ),
    HOVERPAD(
        "chroma.hoverpad",
        ChromaBlocks.TILEENTITY2,
        TileEntityHoverPad.class,
        6 /*, "RenderHoverPad"*/
    ),
    METEOR(
        "chroma.meteor",
        ChromaBlocks.TILEMODELLED3,
        TileEntityMeteorTower.class,
        5,
        "RenderMeteorTower"
    ),
    FLUIDDISTRIBUTOR(
        ...
        6,
        "RenderFluidDistributor"
    ),
    FLUXMAKER(
        "chroma.taintmaker",
        ChromaBlocks.TILEMODELLED3,
        TileEntityFluxMaker.class,
        7,
        "RenderFluxMaker",
        ModList.THAUMCRAFT
    ),
    ...
    FLUIDRELAY(
        "chroma.fluidrelay",
        ChromaBlocks.TILEMODELLED3,
        TileEntityFluidRelay.class,
        10,
        "RenderFluidRelay"
    ),
    IONOSPHERIC(
        "chroma.atmospheric", ChromaBlocks.PYLON, TileEntityAtmosphericRelay.class, 10
    ),
    BOOKDECOMP(
        "chroma.bookdecomp",
        ChromaBlocks.TILEMODELLED3,
        TileEntityPageExtractor.class,
        11,
        "RenderPageExtractor",
        ModList.MYSTCRAFT
    ),
    HARVESTPLANT(
        "chroma.harvestplant", ChromaBlocks.DECOPLANT, TileEntityHarvesterPlant.class, 5
    ),
    BRIDGE("chroma.bridge", ChromaBlocks.TILEENTITY2, TileEntityConduitBridge.class, 0),
    AVOLASER(
        "chroma.avolaser",
        ChromaBlocks.TILEMODELLED3,
        TileEntityAvoLaser.class,
        12,
        "RenderAvoLaser"
    ),
    ALVEARY(
    ...
    SKYPEATER(
        "chroma.skypeater",
        ChromaBlocks.PYLON,
        TileEntitySkypeater.class,
        11,
        "RenderSkypeater"
    ),
    FUNCTIONRELAY(
        "chroma.funcrelay",
        ChromaBlocks.TILEMODELLED4,
        TileEntityFunctionRelay.class,
        0,
        "RenderFunctionRelay"
    ),
    MULTIBUILDER(
        "chroma.multibuilder",
        ChromaBlocks.TILEMODELLED4,
        TileEntityMultiBuilder.class,
        1,
        "RenderMultiBuilder"
    ),
    EXPLOSIONSHIELD(
        "chroma.explosionshield",
        ChromaBlocks.TILEENTITY2,
        TileEntityExplosionShield.class,
        3
    ),
    PROGRESSLINK(
        "chroma.progresslink",
        ChromaBlocks.TILEMODELLED4,
        TileEntityProgressionLinker.class,
        2,
        "RenderProgressionLinker"
    ),
    MANABOOSTER(
        "chroma.manabooster",
        ChromaBlocks.TILEMODELLED4,
        TileEntityManaBooster.class,
        3,
        "RenderManaBooster",
        ModList.BOTANIA
    ),
    DEATHFOG(
        "chroma.deathfog",
        ChromaBlocks.TILEENTITY2,
        TileEntityDeathFogEmitter.class,
        4,
        ModList.VOIDMONSTER
    ),
    OPTIMIZER(
        "chroma.optimizer",
        ChromaBlocks.TILEMODELLED4,
        TileEntityNetworkOptimizer.class,
        4,
        "RenderNetworkOptimizer"
    ),
    LANDMARK(
        "chroma.landmark",
        ChromaBlocks.TILEMODELLED4,
        TileEntityFloatingLandmark.class,
        5,
        "RenderFloatingLandmark",
        ModList.BUILDCRAFT
    ),
    INJECTOR(
        "chroma.injector", ChromaBlocks.TILEENTITY2, TileEntityCastingInjector.class, 5
    ),
    VOIDTRAP(
        "chroma.voidtrap",
        ChromaBlocks.TILEMODELLED4,
        TileEntityVoidMonsterTrap.class,
        6,
        "RenderVoidMonsterTrap",
        ModList.VOIDMONSTER
    ),
    PLAYERINFUSER(
        "chroma.playerinfuser",
        ChromaBlocks.TILEMODELLED4,
        TileEntityPlayerInfuser.class,
        7,
        "RenderInfuser3"
    ),
    SMELTERYDISTRIBUTOR(
        "chroma.smeltery",
        ChromaBlocks.TILEMODELLED4,
        TileEntitySmelteryDistributor.class,
        8,
        "RenderSmelteryDistributor",
        ModList.TINKERER
    ),
    LAUNCHPAD(
        "chroma.launchpad",
        ChromaBlocks.TILEENTITY2,
        TileEntityLaunchPad.class,
        7,
        "RenderLaunchPad"
    ),
    TOOLSTORAGE(
    ...
    NETWORKITEM(
        "chroma.networkitem",
        ChromaBlocks.TILEMODELLED4,
        TileEntityNetworkItemTransporter.class,
        10,
        "RenderItemNetwork"
    );
    ...
    private ChromaTiles(
        String n, ChromaBlocks b, Class<? extends TileEntityChromaticBase> c, int meta
    ) {
    ...
    private ChromaTiles(
        String n,
        ChromaBlocks b,
        Class<? extends TileEntityChromaticBase> c,
        int meta,
        String r
    ) {
    ...
    public TileEntity createTEInstanceForRender(int offset) {
        ...
        if (renderInstance == null) {
            try {
                ...
                throw new RegistrationException(
                    ...
                    "Could not create TE instance to render " + this,
                    e
                );
            }
        }
        ...
        if (this == FOCUSCRYSTAL && renderInstance != null) {
            ((TileEntityFocusCrystal) renderInstance)
                .setDataFromItemStackTag(CrystalTier.tierList[offset].getCraftedItem());
        }
    ...
    public static TileEntity createTEFromIDAndMetadata(Block id, int meta) {
        ...
        if (index == null) {
            ChromatiCraft.logger.logError(
                "ID " + id + " and metadata " + meta
                + " are not a valid tile identification pair!"
            );
            Thread.dumpStack();
            return null;
        }
        if (index.hasPrerequisite() && !index.getPrerequisite().isLoaded()
            && !ReikaObfuscationHelper.isDeObfEnvironment()) {
            ChromatiCraft.logger.logError(
                "The tile " + index + " is dependent on " + index.getPrerequisite()
                + " and should not attempt to be loaded without it!"
            );
            Thread.dumpStack();
            return null;
        }
        ...
        try {
            ...
            throw new RegistrationException(
                ChromatiCraft.instance,
                "ID " + id + " and Metadata " + meta
                    + " failed to instantiate its TileEntity of " + TEClass
            );
            ...
            throw new RegistrationException(
                ChromatiCraft.instance,
                "ID " + id + " and Metadata " + meta
                    + " failed; illegally accessed a member its TileEntity of " + TEClass
            );
        } catch (LinkageError e) {
            ChromatiCraft.logger.logError(
                "ID " + id + " and Metadata " + meta
                + " failed to instantiate its TileEntity of " + TEClass
                + "; class could not be loaded properly"
            );
            e.printStackTrace();
            return null;
        }
    ...
    public static void loadMappings() {
        for (int i = 0; i < TEList.length; i++) {
            ...
            if (chromaMappings.containsKey(id, meta))
                throw new RegistrationException(
                    ChromatiCraft.instance,
                    "ID/Meta conflict @ " + id + "/" + meta + ": " + r + " & "
                        + chromaMappings.get(id, meta)
                );
    ...
    public double getMinX(TileEntityChromaticBase te) {
        switch (this) {
            ...
            case ASPECTJAR:
                return 0.1875;
            case WINDOW:
                return ((TileEntityTransportWindow) te).getFacing().offsetX == 0 ? 0
                                                                                 : 0.4375;
            case TURRET:
                return 0.25;
            case ITEMRIFT:
                return ((TileEntityItemRift) te).getFacing() == ForgeDirection.EAST
                    ? 0.6875
                    : 0;
            default:
                return 0;
    ...
    public double getMinY(TileEntityChromaticBase te) {
        switch (this) {
            case ITEMRIFT:
                return ((TileEntityItemRift) te).getFacing() == ForgeDirection.UP ? 0.6875
                                                                                  : 0;
            default:
                return 0;
        }
    ...
    public double getMinZ(TileEntityChromaticBase te) {
        switch (this) {
            ...
            case ASPECTJAR:
                return 0.1875;
            case WINDOW:
                return ((TileEntityTransportWindow) te).getFacing().offsetZ == 0 ? 0
                                                                                 : 0.4375;
            case TURRET:
                return 0.25;
            case ITEMRIFT:
                return ((TileEntityItemRift) te).getFacing() == ForgeDirection.SOUTH
                    ? 0.6875
                    : 0;
            default:
                return 0;
    ...
    public double getMaxX(TileEntityChromaticBase te) {
        switch (this) {
            ...
            case ASPECTJAR:
                return 0.8125;
            case WINDOW:
                return ((TileEntityTransportWindow) te).getFacing().offsetX == 0 ? 1
                                                                                 : 0.5625;
            case TURRET:
                return 0.75;
            case ITEMRIFT:
                return ((TileEntityItemRift) te).getFacing() == ForgeDirection.WEST
                    ? 0.3125
                    : 1;
            default:
                return 1;
    ...
    public double getMaxY(TileEntityChromaticBase te) {
        switch (this) {
            ...
            case NETWORKITEM:
                return 0.875;
            case ITEMRIFT:
                return ((TileEntityItemRift) te).getFacing() == ForgeDirection.DOWN
                    ? 0.3125
                    : 1;
            default:
                return 1;
    ...
    public double getMaxZ(TileEntityChromaticBase te) {
        switch (this) {
            ...
            case ASPECTJAR:
                return 0.8125;
            case WINDOW:
                return ((TileEntityTransportWindow) te).getFacing().offsetZ == 0 ? 1
                                                                                 : 0.5625;
            case TURRET:
                return 0.75;
            case ITEMRIFT:
                return ((TileEntityItemRift) te).getFacing() == ForgeDirection.NORTH
                    ? 0.3125
                    : 1;
            default:
                return 1;
    ...
    public boolean hasBlockRender() {
        return !this.hasRender() || this == TANK || this == TABLE || this == CONSOLE
            || this == ALVEARY || this == PYLONLINK || this == LAUNCHPAD
            || this == TOOLSTORAGE;
    }

    public boolean isPlant() {
        return this.getBlock() instanceof BlockChromaPlantTile
            || this.getBlock() instanceof BlockDecoPlant;
    }
    ...
    public boolean isRotateableRepeater() {
        return this.isRepeater() && TileEntityCrystalRepeater.class.isAssignableFrom(tile)
            && this != BROADCAST;
    }

    public boolean isTurbochargeableRepeater() {
        return this.isRepeater() && this != WEAKREPEATER && this != IONOSPHERIC
            && this != SKYPEATER;
    }
