...
public enum ExtraChromaIDs implements IDRegistry {
    ...
    MOUNTAIN(
        "Dimension Biome IDs", "Crystal Mountains Biome ID", 105, BiomeGenBase.class
    ),
    ...
    GLOWCRACKS(
        "Dimension Biome IDs", "Radiant Fissures Biome ID", 111, BiomeGenBase.class
    ),
    MONUMENT("Dimension Biome IDs", "Monument Field Biome ID", 112, BiomeGenBase.class),
