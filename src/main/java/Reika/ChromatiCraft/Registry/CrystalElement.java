...
public enum CrystalElement
    implements IconEnum, OverlayColor, ProgressAccess, CrystalElementProxy {
    ...
    public void setIcons(IIconRegister ico) {
        glowIcon
            = ico.registerIcon("chromaticraft:runes/glow/tile" + this.ordinal() + "_0");
        animatedFace = ico.registerIcon(
            "chromaticraft:runes/frontpng/tile" + this.ordinal() + "_0"
        );
        engraving = ico.registerIcon(
            "chromaticraft:runes/engraved/tile" + this.ordinal() + "_0"
        );
        outline = ico.registerIcon(
            "chromaticraft:runes/outline/tile" + this.ordinal() + "_0"
        );
        overbright = ico.registerIcon(
            "chromaticraft:crystal/overbright/bloom_"
            + this.name().toLowerCase(Locale.ENGLISH)
        );
        //overlay =
        //ico.registerIcon("chromaticraft:runes/overlay/tile"+this.ordinal()+"_0");
    }
