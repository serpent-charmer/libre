...
public enum ChromaResearch implements ProgressElement, ProgressAccess {
    ...
    ENERGY(
        ...
        ResearchLevel.ENERGY,
        ProgressStage.ALLCOLORS,
        ProgressStage.CHARGE
    ),
    ELEMENTS(
        "Crystal Elements",
        ChromaItems.ELEMENTAL.getStackOf(CrystalElement.BLUE),
        ResearchLevel.BASICCRAFT,
        ProgressStage.ALLCOLORS
    ),
    CRYSTALS(
        "Crystals",
        ChromaBlocks.CRYSTAL.getStackOfMetadata(4),
        ResearchLevel.ENTRY,
        ProgressStage.CRYSTALS
    ),
    PYLONS(
        "Pylons",
    ...
    ENCHANTS(
        "Enchantments",
        ChromaTiles.ENCHANTER.getCraftedProduct(),
        ResearchLevel.BASICCRAFT
    ),
    CRAFTING2(
        "Casting II",
        ChromaTiles.TABLE.getCraftedProduct(),
        ResearchLevel.RUNECRAFT,
        ProgressStage.RUNEUSE
    ),
    BALLLIGHTNING(
        "Ball Lightning",
        ChromaStacks.auraDust,
        ResearchLevel.ENERGY,
        ProgressStage.BALLLIGHTNING
    ),
    APIRECIPES("Other Recipes", new ItemStack(Blocks.dirt), ResearchLevel.BASICCRAFT),
    LEYLINES(
        "Ley Lines",
        ChromaTiles.REPEATER.getCraftedProduct(),
        ResearchLevel.NETWORKING,
        ProgressStage.REPEATER
    ),
    USINGRUNES(
        "Crafting With Runes",
        ChromaBlocks.RUNE.getStackOfMetadata(1),
        ResearchLevel.RUNECRAFT,
        ProgressStage.RUNEUSE
    ),
    DIMENSION(
        "Another World",
        ChromaBlocks.PORTAL.getStackOf(),
        ResearchLevel.ENDGAME,
        ProgressionManager.instance.getPrereqsArray(ProgressStage.DIMENSION)
    ),
    DIMENSION2(
        "A Volatile World",
        ChromaBlocks.GLOWSAPLING.getStackOf(),
        ResearchLevel.ENDGAME,
        ProgressStage.DIMENSION
    ),
    FARLANDS(
        "The Far Regions",
        DimDecoTypes.FLOATSTONE.getItem(),
        ResearchLevel.ENDGAME,
        ProgressStage.FARLANDS
    ),
    TURBO(
        "Turbocharging",
        ChromaStacks.elementUnit,
        ResearchLevel.ENDGAME,
        ProgressionManager.instance.getPrereqsArray(ProgressStage.TURBOCHARGE)
    ),
    TURBOREPEATER(
        "Repeater Turbocharging",
        ChromaStacks.turboRepeater,
        ResearchLevel.ENDGAME,
        ProgressStage.TURBOCHARGE
    ),
    TURBOREPEATER2(
        "Maximized Networking",
        StoneTypes.RESORING.getItem(),
        ResearchLevel.CTM,
        ProgressStage.TURBOCHARGE
    ),
    PACKCHANGES("Modpack Changes", new ItemStack(Blocks.dirt), ResearchLevel.ENTRY),
    NODENET(
        "Networking Aura Nodes",
        new ItemStack(Blocks.dirt),
        ResearchLevel.CTM,
        ProgressStage.CTM
    ),
    ...
    ENCHANTING(
        ...
        ResearchLevel.MULTICRAFT,
        ProgressStage.MULTIBLOCK
    ),
    STRUCTUREPASSWORDS(
        "Structure Keys",
        ChromaBlocks.DIMDATA.getStackOfMetadata(1),
        ResearchLevel.ENDGAME,
        ProgressStage.STRUCTCOMPLETE
    ),
    DIMTUNING(
        "Portal Tuning",
    ...
    CASTTUNING(
        ...
        ResearchLevel.NETWORKING,
        ProgressionManager.instance.getPrereqsArray(ProgressStage.TUNECAST)
    ),
    MULTIBLOCKS(
        "Functional Construction", StoneTypes.COLUMN.getItem(), ResearchLevel.BASICCRAFT
    ),
    PYLONLINK(
        "Interconnected Energy",
        ChromaTiles.PYLONLINK.getCraftedProduct(),
        ResearchLevel.ENERGY,
        ProgressStage.PYLONLINK
    ),
    ITEMBURNER(
        "Item Decomposition",
        new ItemStack(Blocks.dirt),
    ...
    MONUMENT(
        ...
        ChromaTiles.AURAPOINT.getCraftedProduct(),
        ResearchLevel.CTM,
        ProgressStage.CTM
    ),
    MUD("Magical Residue",
        ChromaBlocks.MUD.getStackOf(),
        ResearchLevel.RAWEXPLORE,
        ProgressStage.MUDHINT),
    ITEMCHARGE(
        "Passive Charging",
        new ItemStack(Blocks.dirt),
        ResearchLevel.BASICCRAFT,
    ...
    ITEMBUFFERLINK(
        "Lumen Buffer Connection",
        new ItemStack(Blocks.dirt),
        ResearchLevel.PYLONCRAFT,
        ProgressStage.CHARGE
    ),
    SKYPEATER(
        ChromaTiles.SKYPEATER.getName(),
        ChromaTiles.SKYPEATER.getCraftedProduct(),
        ResearchLevel.ENERGY,
        ProgressStage.GLOWCLIFFS
    ),
    FRAGMENTSELECT(
        "Fragment Decoding",
        new ItemStack(Blocks.dirt),
        ResearchLevel.BASICCRAFT,
        ProgressStage.CHROMA
    ),
    ...
    MINER(
        ChromaTiles.MINER, ResearchLevel.CTM, ProgressStage.MINE, ProgressStage.FARLANDS
    ),
    ...
    BIOMEPAINT(
        ChromaTiles.BIOMEPAINTER, ResearchLevel.ENDGAME, ProgressStage.RAINBOWFOREST
    ),
    ...
    WEAKREPEATER(
        ChromaTiles.WEAKREPEATER,
        ResearchLevel.ENERGY,
        ProgressStage.PYLON,
        ProgressStage.MAKECHROMA
    ),
    ENCHANTDECOMP(
        ChromaTiles.ENCHANTDECOMP, ResearchLevel.ENERGY, ProgressStage.MAKECHROMA
    ),
    ...
    VILLAGEREPAIR(
        ChromaTiles.VILLAGEREPAIR, ResearchLevel.MULTICRAFT, ProgressStage.VILLAGECASTING
    ),
    ...
    PLANTHARVEST(
        ChromaTiles.HARVESTPLANT, ResearchLevel.RUNECRAFT, ProgressStage.HARVEST
    ),
    ...
    FOCUSCRYSTALS(
        ChromaTiles.FOCUSCRYSTAL, ResearchLevel.ENERGY, ProgressStage.FOCUSCRYSTAL
    ),
    FLUXMAKER(ChromaTiles.FLUXMAKER, ResearchLevel.ENERGY),
    FUNCRELAY(ChromaTiles.FUNCTIONRELAY, ResearchLevel.RUNECRAFT),
    CHROMACRAFTER(
        ChromaTiles.CHROMACRAFTER, ResearchLevel.PYLONCRAFT, ProgressStage.ALLOY
    ),
    ...
    HOVERPAD(
        ChromaTiles.HOVERPAD, ResearchLevel.RUNECRAFT /*, TieredOres.TELEPORT.level*/
    ),
    DEATHFOG(ChromaTiles.DEATHFOG, ResearchLevel.RUNECRAFT, ProgressStage.VOIDMONSTER),
    VOIDTRAP(
        ChromaTiles.VOIDTRAP,
        ResearchLevel.PYLONCRAFT,
        ProgressStage.VOIDMONSTERDIE,
        ProgressStage.CHARGECRYSTAL
    ),
    PLAYERINFUSER(
        ChromaTiles.PLAYERINFUSER, ResearchLevel.MULTICRAFT, ProgressStage.INFUSE
    ),
    ...
    RUNES(
        ChromaBlocks.RUNE,
        CrystalElement.LIGHTBLUE.ordinal(),
        ResearchLevel.BASICCRAFT,
        ProgressStage.ALLCOLORS
    ),
    ...
    LUMENLEAVES(
        ChromaBlocks.POWERTREE,
        CrystalElement.LIME.ordinal(),
        ResearchLevel.ENDGAME,
        ProgressStage.POWERCRYSTAL
    ),
    DYELEAVES(
        ChromaBlocks.DYELEAF,
        CrystalElement.BROWN.ordinal(),
        ResearchLevel.ENTRY,
        ProgressStage.DYETREE
    ),
    RAINBOWLEAVES(
        ChromaBlocks.RAINBOWLEAF, 3, ResearchLevel.RAWEXPLORE, ProgressStage.RAINBOWLEAF
    ),
    LAMPAUX(
        ChromaBlocks.LAMPBLOCK, CrystalElement.WHITE.ordinal(), ResearchLevel.RUNECRAFT
    ),
    CRYSTALLAMP(
        ChromaBlocks.LAMP, CrystalElement.YELLOW.ordinal(), ResearchLevel.RAWEXPLORE
    ),
    SUPERLAMP(
        ChromaBlocks.SUPER,
        CrystalElement.MAGENTA.ordinal(),
        ResearchLevel.PYLONCRAFT,
        ProgressStage.POTION
    ),
    ...
    COLORALTAR(
        ChromaBlocks.COLORALTAR, CrystalElement.WHITE.ordinal(), ResearchLevel.ENERGY
    ),
    ...
    MUSICTRIGGER(
        ChromaBlocks.MUSICTRIGGER, ResearchLevel.BASICCRAFT, ProgressStage.ANYSTRUCT
    ),
    ...
    REPEATERLAMP(
        ChromaBlocks.REPEATERLAMP, ResearchLevel.NETWORKING, ProgressStage.REPEATER
    ),
    ...
    //SPAWNERCONTROL(	ChromaBlocks.SPAWNERCONTROL,
    //ResearchLevel.RAWEXPLORE,	ProgressStage.BREAKSPAWNER),
    ...
    ENCRUSTED(
        ChromaBlocks.ENCRUSTED,
        CrystalElement.RED.ordinal(),
        ResearchLevel.RAWEXPLORE,
        ProgressStage.PYLON
    ),
    INJECTORAUX(ChromaBlocks.INJECTORAUX, ResearchLevel.MULTICRAFT),
    HOVERPADAUX(
        ChromaBlocks.PAD, ResearchLevel.RUNECRAFT /*,	TieredOres.TELEPORT.level*/
    ),
    ...
    STRUCTFIND(
        ChromaItems.STRUCTUREFINDER,
        ResearchLevel.RUNECRAFT,
        ProgressStage.RUNEUSE,
        ProgressStage.ANYSTRUCT
    ),
    MOBSONAR(
        ChromaItems.MOBSONAR,
        ResearchLevel.RUNECRAFT,
        ProgressStage.KILLMOB,
        ProgressStage.CHARGE
    ),
    CAVEEXIT(ChromaItems.CAVEPATHER, ResearchLevel.BASICCRAFT, ProgressStage.DEEPCAVE),
    SPLINEATTACK(
        ChromaItems.SPLINEATTACK, ResearchLevel.RUNECRAFT, ProgressStage.KILLMOB
    ),
    SHIELDEDCELL(
        ChromaItems.SHIELDEDCELL, ResearchLevel.BASICCRAFT, ProgressStage.ARTEFACT
    ),
    BOTTLENECK(ChromaItems.BOTTLENECK, ResearchLevel.NETWORKING, ProgressStage.REPEATER),
    SPAWNERBYPASS(
        ChromaItems.SPAWNERBYPASS, ResearchLevel.ENERGY, ProgressStage.FINDSPAWNER
    ),
    ...
    NETHERKEY(
        ChromaItems.NETHERKEY,
        ResearchLevel.RUNECRAFT,
        ProgressStage.NETHER,
        ProgressStage.ANYSTRUCT
    ),
    RECIPECACHE(
        ChromaItems.RECIPECACHE, ResearchLevel.MULTICRAFT, ProgressStage.MULTIBLOCK
    ),
    ETHERPENDANT(
        ChromaItems.ETHERPENDANT,
        ResearchLevel.MULTICRAFT,
        ProgressStage.LUMA,
        ProgressStage.END
    ),
    STRUCTMAP(
        ChromaItems.STRUCTMAP,
        ResearchLevel.RAWEXPLORE,
        ProgressStage.ANYSTRUCT,
        ProgressStage.TOWER,
        ProgressStage.ARTEFACT
    ),

    RESOURCEDESC("Resources", ""),
    BERRIES(
        "Berries",
        ChromaItems.BERRY.getStackOf(CrystalElement.ORANGE),
        ResearchLevel.RAWEXPLORE,
        ProgressStage.DYETREE
    ),
    SHARDS(
        "Shards", ChromaStacks.redShard, ResearchLevel.RAWEXPLORE, ProgressStage.CRYSTALS
    ),
    ...
    CRYSTALSTONE(
        "Crystal Stone",
        ChromaBlocks.PYLONSTRUCT.getBlockInstance(),
        ResearchLevel.BASICCRAFT
    ),
    SEED(
        "Crystal Seeds",
        ChromaItems.SEED.getStackOf(CrystalElement.MAGENTA),
        ResearchLevel.RUNECRAFT
    ),
    FRAGMENT("Fragments", ChromaItems.FRAGMENT, ResearchLevel.ENTRY),
    AUGMENT(
        "Upgrades",
        ChromaStacks.speedUpgrade,
        ResearchLevel.PYLONCRAFT,
        ProgressStage.STORAGE
    ),
    ALLOYS(
        "Alloying",
        ChromaStacks.chromaIngot,
        ResearchLevel.ENERGY,
        ProgressionManager.instance.getPrereqsArray(ProgressStage.ALLOY)
    ),
    INSCRIPTION(
        "Inscription",
        ChromaItems.DATACRYSTAL.getStackOf(),
        ResearchLevel.RAWEXPLORE,
        ProgressStage.TOWER
    ),
    BEES(
    ...
    TINKERTOOLS(
        "Mix-And-Magic Tools", new ItemStack(Blocks.dirt), ResearchLevel.MULTICRAFT
    ),
    BRANCHES(
        "Magic Branches",
        ItemMagicBranch.BranchTypes.CRYSTAL.getStack(),
        ResearchLevel.ENERGY
    ),
    FERTILITYSEED(
        "Fertility Seeds",
        ChromaItems.FERTILITYSEED.getStackOf(),
        ResearchLevel.RAWEXPLORE,
        ProgressStage.GLOWCLIFFS
    ),
    ARTEFACT(
        "Mysterious Artifacts",
        ChromaItems.ARTEFACT.getStackOf(),
        ResearchLevel.RAWEXPLORE,
        ProgressStage.ARTEFACT
    ),
    PROXESSENCE(
        "Proximal Essence",
        ChromaStacks.bedrockloot,
        ResearchLevel.ENDGAME,
        ProgressStage.DIMENSION
    ),
    VOIDESSENCE(
    ...
    PYLON(
        ChromaStructures.PYLON,
        StoneTypes.FOCUS.ordinal(),
        ResearchLevel.ENERGY,
        ProgressStage.PYLON
    ),
    CASTING1(
        ChromaStructures.CASTING1,
        StoneTypes.SMOOTH.ordinal(),
        ResearchLevel.BASICCRAFT,
        ProgressStage.CRYSTALS
    ),
    CASTING2(
        ChromaStructures.CASTING2,
        StoneTypes.BEAM.ordinal(),
        ResearchLevel.RUNECRAFT,
        ProgressStage.RUNEUSE
    ),
    CASTING3(
        ChromaStructures.CASTING3,
        StoneTypes.COLUMN.ordinal(),
        ResearchLevel.NETWORKING,
        ProgressStage.MULTIBLOCK,
        ProgressStage.BLOWREPEATER
    ),
    RITUAL(
        ChromaStructures.RITUAL,
        StoneTypes.ENGRAVED.ordinal(),
        ResearchLevel.ENERGY,
        ProgressStage.CHARGE
    ),
    INFUSION(
        ChromaStructures.INFUSION,
        StoneTypes.BRICKS.ordinal(),
        ResearchLevel.MULTICRAFT,
        ProgressStage.CHROMA
    ),
    PLAYERINFUSION(
        ChromaStructures.PLAYERINFUSION,
        StoneTypes.BEAM.ordinal(),
        ResearchLevel.MULTICRAFT,
        ProgressStage.INFUSE
    ),
    TREE(
        ChromaStructures.TREE,
        StoneTypes.STABILIZER.ordinal(),
        ResearchLevel.ENDGAME,
        ProgressStage.POWERCRYSTAL
    ),
    TREESEND(
        ChromaStructures.TREE_SENDER,
        StoneTypes.FOCUSFRAME.ordinal(),
        ResearchLevel.ENDGAME,
        ProgressStage.POWERTREE
    ),
    REPEATERSTRUCT(
        ChromaStructures.REPEATER,
        StoneTypes.SMOOTH.ordinal(),
        ResearchLevel.NETWORKING,
        ProgressStage.RUNEUSE,
        ProgressStage.BLOWREPEATER
    ...
    COMPOUNDSTRUCT(
        ChromaStructures.COMPOUND,
        StoneTypes.MULTICHROMIC.ordinal(),
        ResearchLevel.NETWORKING,
        ProgressStage.REPEATER
    ),
    CAVERN(
        ChromaStructures.CAVERN,
        ChromaBlocks.STRUCTSHIELD.getBlockInstance(),
        BlockType.CLOAK.metadata,
        ResearchLevel.RAWEXPLORE,
        ProgressStage.CAVERN
    ),
    BURROW(
        ChromaStructures.BURROW,
        ChromaBlocks.STRUCTSHIELD.getBlockInstance(),
        BlockType.STONE.metadata,
        ResearchLevel.RAWEXPLORE,
        ProgressStage.BURROW
    ),
    OCEAN(
        ChromaStructures.OCEAN,
        ChromaBlocks.STRUCTSHIELD.getBlockInstance(),
        BlockType.MOSS.metadata,
        ResearchLevel.RAWEXPLORE,
        ProgressStage.OCEAN
    ),
    DESERT(
        ChromaStructures.DESERT,
        ChromaBlocks.STRUCTSHIELD.getBlockInstance(),
        BlockType.COBBLE.metadata,
        ResearchLevel.RAWEXPLORE,
        ProgressStage.DESERTSTRUCT
    ),
    SNOW(
        ChromaStructures.SNOWSTRUCT,
        ChromaBlocks.STRUCTSHIELD.getBlockInstance(),
        BlockType.LIGHT.metadata,
        ResearchLevel.RAWEXPLORE,
        ProgressStage.SNOWSTRUCT
    ),
    PORTALSTRUCT(
        ChromaStructures.PORTAL,
        StoneTypes.SMOOTH.ordinal(),
        ResearchLevel.ENDGAME,
        ProgressionManager.instance.getPrereqsArray(ProgressStage.DIMENSION)
    ),
    MINIPYLON(
        ChromaStructures.PERSONAL,
        StoneTypes.FOCUSFRAME.ordinal(),
        ResearchLevel.ENERGY,
        ProgressStage.CHARGE
    ),
    BROADCASTER(
        ChromaStructures.BROADCAST,
        StoneTypes.RESORING.ordinal(),
        ResearchLevel.NETWORKING,
        ProgressStage.MULTIBLOCK,
        ProgressStage.REPEATER
    ),
    CLOAKTOWER(
        ChromaStructures.CLOAKTOWER,
        StoneTypes.GLOWCOL.ordinal(),
        ResearchLevel.MULTICRAFT,
        ProgressStage.KILLMOB
    ),
    BOOSTTREE(
        ChromaStructures.TREE_BOOSTED,
        StoneTypes.STABILIZER.ordinal(),
        ResearchLevel.CTM,
        ProgressStage.TURBOCHARGE
    ),
    BEACONSTRUCT(
        ChromaStructures.PROTECT, StoneTypes.CORNER.ordinal(), ResearchLevel.ENDGAME
    ),
    MINIREPEATER(
        ChromaStructures.WEAKREPEATER,
        Blocks.log,
        0,
        ResearchLevel.ENERGY,
        ProgressStage.PYLON
    ...
    METEOR1(
        ChromaStructures.METEOR1, StoneTypes.BRICKS.ordinal(), ResearchLevel.PYLONCRAFT
    ),
    METEOR2(ChromaStructures.METEOR2, StoneTypes.BRICKS.ordinal(), ResearchLevel.ENDGAME),
    METEOR3(
        ChromaStructures.METEOR3,
        StoneTypes.BRICKS.ordinal(),
        ResearchLevel.ENDGAME,
        ProgressStage.DIMENSION
    ),
    RITUAL2(
        ChromaStructures.RITUAL2,
        StoneTypes.ENGRAVED.ordinal(),
        ResearchLevel.ENDGAME,
        ProgressStage.DIMENSION
    ),
    GATESTRUCT(
        ChromaStructures.TELEGATE,
        StoneTypes.COLUMN.ordinal(),
        ResearchLevel.ENDGAME,
        ProgressStage.END
    ),
    RELAYSTRUCT(
        ChromaStructures.RELAY,
        StoneTypes.FOCUSFRAME.ordinal(),
        ResearchLevel.ENDGAME,
        ProgressStage.POWERCRYSTAL
    ),
    PYLONBROADCAST(
        ChromaStructures.PYLONBROADCAST,
        StoneTypes.FOCUS.ordinal(),
        ResearchLevel.ENDGAME,
        ProgressStage.DIMENSION
    ),
    PYLONTURBORING(
        ChromaStructures.PYLONTURBO,
        StoneTypes.FOCUS.ordinal(),
        ResearchLevel.ENDGAME,
        ProgressionManager.instance.getPrereqsArray(ProgressStage.TURBOCHARGE)
    ),
    WIRELESSPED(
        ChromaStructures.WIRELESSPEDESTAL,
        StoneTypes.MULTICHROMIC.ordinal(),
        ResearchLevel.ENDGAME
    ),
    WIRELESSPED2(
        ChromaStructures.WIRELESSPEDESTAL2,
        StoneTypes.MULTICHROMIC.ordinal(),
        ResearchLevel.CTM
    ),
    DATATOWER(
        ChromaStructures.DATANODE,
        StoneTypes.SMOOTH.ordinal(),
        ResearchLevel.RAWEXPLORE,
        ProgressStage.TOWER
    ),
    PROGLINKSTRUCT(
        ChromaStructures.PROGRESSLINK,
        StoneTypes.CORNER.ordinal(),
        ResearchLevel.BASICCRAFT
    ),
    OPTIMISTRUCT(
        ChromaStructures.OPTIMIZER,
        StoneTypes.RESORING.ordinal(),
        ResearchLevel.ENDGAME,
        TieredOres.LUMA.level
    ),
    VOIDTRAPSTRUCT(
        ChromaStructures.VOIDRITUAL,
    ...
    LAUNCHPADSTRUCT(
        ChromaStructures.LAUNCHPAD,
        StoneTypes.ENGRAVED.ordinal(),
        ResearchLevel.BASICCRAFT
    ),
    BIOMESTRUCT(
        ChromaStructures.BIOMEFRAG,
        ChromaBlocks.COLORLOCK.getBlockInstance(),
        0,
        ResearchLevel.MULTICRAFT,
        ProgressStage.BIOMESTRUCT
    ),
    ;
    ...
    private static final EnumMap<ChromaTiles, ChromaResearch> tileMap
        = new EnumMap(ChromaTiles.class);
    private static final EnumMap<ChromaStructures, ChromaResearch> structureMap
        = new EnumMap(ChromaStructures.class);
    ...
    private ChromaResearch(ChromaTiles r, ResearchLevel rl, ProgressStage... p) {
        ...
        if (rl.ordinal() < ResearchLevel.ENERGY.ordinal() && r.isRelayPowered()) {
            throw new RegistrationException(
                ...
                "Machine fragment " + r + " relay powered but available before relays!"
            );
        }
    }
    ...
    private ChromaResearch(
        ChromaBlocks r, int meta, ResearchLevel rl, ProgressStage... p
    ) {
    ...
    private ChromaResearch(
        String name, ChromaItems i, ResearchLevel rl, ProgressStage... p
    ) {
        this(name, i.getStackOf(), rl, p);
    }

    private ChromaResearch(
        String name, ChromaTiles r, ResearchLevel rl, ProgressStage... p
    ) {
    ...
    private ChromaResearch(
        String name, Block icon, ResearchLevel rl, ProgressStage... p
    ) {
        this(name, new ItemStack(icon), rl, p);
    }

    private ChromaResearch(
        String name, ItemStack icon, ResearchLevel rl, ProgressStage... p
    ) {
        ...
        if (rl == ResearchLevel.PYLONCRAFT) {
            for (ProgressStage ps : p) {
                if (ps.isGatedAfter(ProgressStage.DIMENSION)) {
                    throw new RegistrationException(
                        ChromatiCraft.instance,
                        "Ability fragment " + c + " gated behind " + ps
                            + " but is only level " + rl + "!"
                    );
                }
            }
        }
    ...
    private ChromaResearch(
        ChromaStructures s, int meta, ResearchLevel r, ProgressStage... p
    ) {
        this(s, ChromaBlocks.PYLONSTRUCT.getBlockInstance(), meta, r, p);
    }

    private ChromaResearch(
        ChromaStructures s, Block b, int meta, ResearchLevel r, ProgressStage... p
    ) {
    ...
    public boolean playerCanRead(EntityPlayer ep) {
        return this.playerCanSee(ep)
            || ChromaResearchManager.instance.canPlayerStepTo(ep, this);
    }
    ...
    private ItemStack getTabIcon() {
        if (this == BEES) {
            return CrystalBees.getCrystalBee().getBeeItem(
                Minecraft.getMinecraft().theWorld, EnumBeeType.QUEEN
            );
        }
        if (this == TINKERTOOLS) {
        ...
        if (this == ACCEL) {
            return ChromaItems.ADJACENCY.getStackOfMetadata(
                CrystalElement.LIGHTBLUE.ordinal()
            );
        }
        if (item != null && item.getItemInstance() instanceof PoweredItem) {
            PoweredItem i = (PoweredItem) item.getItemInstance();
            return ToolChargingSystem.instance.getChargedItem(
                (Item & PoweredItem) i, i.getMaxCharge()
            );
        }
        return iconItem;
    }
    ...
    public void drawTabIcon(RenderItem ri, int x, int y) {
        if (this == START) {
            ...
            ReikaTextureHelper.bindTexture(ChromatiCraft.class, var4);
            int c1 = CrystalElement.getBlendedColor(
                ReikaRenderHelper.getSystemTimeAsInt() / 50, 20
            );
            int c2 = CrystalElement.getBlendedColor(
                ReikaRenderHelper.getSystemTimeAsInt() / 32, 20
            );
            int c3 = CrystalElement.getBlendedColor(
                ReikaRenderHelper.getSystemTimeAsInt() / 71, 20
            );
            int c4 = CrystalElement.getBlendedColor(
                ReikaRenderHelper.getSystemTimeAsInt() / 44, 20
            );
            int w = 16;
            int h = 16;
            int d = 0;
            ...
            EntityBallLightning eb
                = new EntityBallLightning(Minecraft.getMinecraft().theWorld);
            eb.isDead = true;
            GL11.glColor4f(1, 1, 1, 1);
            GL11.glPushMatrix();
            double d = 8;
            ...
            double s = 18;
            GL11.glScaled(-s, s, 1);
            ReikaEntityHelper.getEntityRenderer(EntityBallLightning.class)
                .doRender(eb, 0, 0, 0, 0, 0);
            GL11.glPopMatrix();
            return;
            ...
            ReikaGuiAPI.instance.drawTexturedModelRectFromIcon(x-1, y-1,
            ChromaIcons.BIGFLARE.getIcon(), 18, 18); GL11.glPopMatrix();
            GL11.glPopAttrib();
             */
            double s = 18;
            ...
            try {
                ...
                TileEntityRendererDispatcher.instance.renderTileEntityAt(
                    ReikaPlayerAPI.getPlayerHead(
                        Minecraft.getMinecraft().theWorld,
                        ReikaPlayerAPI.getClientProfile()
                    ),
                    0,
                    0,
                    0,
                ...
                ReikaChatHelper.write(
                    "Threw exception rendering fragment " + this + "! Check your console!"
                );
                e.printStackTrace();
            }
            GL11.glPopMatrix();
            ...
            ReikaTextureHelper.bindFinalTexture(
                ChromatiCraft.class, "Textures/infoicons.png"
            );
            Tessellator tessellator = Tessellator.instance;
            tessellator.startDrawingQuads();
            int[] idxs = { 24, 7 };
            ...
            int c = CrystalElement.getBlendedColor(
                ReikaRenderHelper.getSystemTimeAsInt() / 48 + 17 * hash, 30
            );
            int br = ReikaColorAPI.GStoHex((int
            ) (192 + 64 * Math.sin(System.currentTimeMillis() / 271D + hash)));
            float mix = (float
            ) (0.5 + 0.5 * Math.sin(System.currentTimeMillis() / 443D - 13 * hash));
            ...
            ReikaGuiAPI.instance.drawTexturedModelRectFromIcon(
                x - d, y - d, ChromaIcons.LATTICE.getIcon(), 16 + d * 2, 16 + d * 2
            );
            BlendMode.DEFAULT.apply();
            ReikaTextureHelper.bindFinalTexture(
                ChromatiCraft.class, "Textures/fragmentcategories.png"
            );
            Tessellator tessellator = Tessellator.instance;
            ...
            int c1 = ReikaColorAPI.mixColors(
                0xffffff,
                ReikaColorAPI.getShiftedHue(c, 45F * (float) Math.sin(2 * t)),
                0.5F
            );
            int c2 = ReikaColorAPI.mixColors(
                0xffffff,
                ReikaColorAPI.getShiftedHue(c, 45F * (float) Math.sin(5 * t)),
                0.5F
            );
            int c3 = ReikaColorAPI.mixColors(
                0xffffff,
                ReikaColorAPI.getShiftedHue(c, 45F * (float) Math.sin(9 * t)),
                0.5F
            );
            int c4 = ReikaColorAPI.mixColors(
                0xffffff,
                ReikaColorAPI.getShiftedHue(c, 45F * (float) Math.sin(13 * t)),
                0.5F
            );
            tessellator.startDrawingQuads();
            int idx = (int
            ) ((System.currentTimeMillis() / 800) % FragmentCategory.list.length);
            double u = idx % 8 / 8D;
            double v = idx / 8 / 8D;
            double du = u + 1 / 8D;
            double dv = v + 1 / 8D;
            ...
            int ds = 4;
            ReikaGuiAPI.instance.drawTexturedModelRectFromIcon(
                x - ds, y - ds, ChromaIcons.TURBO.getIcon(), 16 + ds * 2, 16 + ds * 2
            );
            ...
            ReikaGuiAPI.instance.drawTexturedModelRectFromIcon(
                x - ds, y - ds, ChromaIcons.RADIATE.getIcon(), 16 + ds * 2, 16 + ds * 2
            );
            GL11.glColor4f(1, 1, 1, 1);
            GL11.glPopMatrix();
            GL11.glPopAttrib();
            ...
            ReikaTextureHelper.bindTexture(
                ChromatiCraft.class, "Textures/warpnode-small.png"
            );
            ...
            Tessellator tessellator = Tessellator.instance;
            tessellator.startDrawingQuads();
            tessellator.setColorOpaque_I(CrystalElement.getBlendedColor(
                Minecraft.getMinecraft().thePlayer.ticksExisted, 10
            ));
            tessellator.addVertexWithUV((x + 0 - d), (y + h + d), 0, u, dv);
            tessellator.setColorOpaque_I(CrystalElement.getBlendedColor(
                Minecraft.getMinecraft().thePlayer.ticksExisted + 5, 10
            ));
            tessellator.addVertexWithUV((x + w + d), (y + h + d), 0, du, dv);
            tessellator.setColorOpaque_I(CrystalElement.getBlendedColor(
                Minecraft.getMinecraft().thePlayer.ticksExisted + 15, 10
            ));
            tessellator.addVertexWithUV((x + w + d), (y + 0 - d), 0, du, v);
            tessellator.setColorOpaque_I(CrystalElement.getBlendedColor(
                Minecraft.getMinecraft().thePlayer.ticksExisted + 10, 10
            ));
            tessellator.addVertexWithUV((x + 0 - d), (y + 0 - d), 0, u, v);
            tessellator.draw();
            GL11.glPopAttrib();
            ...
            ReikaGuiAPI.instance.drawItemStack(
                ri, ChromaItems.DATACRYSTAL.getStackOf(), x, y
            );
            GL11.glPushMatrix();
            GL11.glPushAttrib(GL11.GL_ALL_ATTRIB_BITS);
            GL11.glColor4f(1, 1, 1, 1);
            ...
            GL11.glTranslated(x - d, y - d, 0);
            GL11.glScaled(s, s, 0);
            RenderDataNode.renderFlare(
                Tessellator.instance,
                (float) (0.75 + 0.25 * Math.sin(System.currentTimeMillis() / 500D)),
                false
            );
            GL11.glPopAttrib();
            GL11.glPopMatrix();
            ...
            ReikaTextureHelper.bindTerrainTexture();
            int c = CrystalElement.getBlendedColor(
                Minecraft.getMinecraft().thePlayer.ticksExisted, 30
            );
            GL11.glColor4f(
                ReikaColorAPI.getRed(c) / 255F,
                ReikaColorAPI.getGreen(c) / 255F,
            ...
            ReikaGuiAPI.instance.drawTexturedModelRectFromIcon(
                x, y, ChromaIcons.RADIATE.getIcon(), 16, 16
            );
            ReikaGuiAPI.instance.drawTexturedModelRectFromIcon(
                x, y, ChromaIcons.RADIATE.getIcon(), 16, 16
            );
            ReikaGuiAPI.instance.drawTexturedModelRectFromIcon(
                x - 8, y - 8, ChromaIcons.ROUNDFLARE.getIcon(), 32, 32
            );
            GL11.glColor4f(1, 1, 1, 1);
            ReikaGuiAPI.instance.drawTexturedModelRectFromIcon(
                x, y, ChromaIcons.ROUNDFLARE.getIcon(), 16, 16
            );
            GL11.glPopAttrib();
            return;
            ...
            if (ModList.THAUMCRAFT.isLoaded()) {
                ...
                ico.add(new ItemStack(ThaumItemHelper.BlockEntry.CRYSTAL.getBlock(), 1,
            6)); ico.add(ThaumItemHelper.BlockEntry.ETHEREAL.getItem());
            ...
            for (CastingRecipe cr :
                 RecipesCastingTable.instance.getAllModdedItemRecipes()) {
                if (!ReikaItemHelper.collectionContainsItemStack(ico, cr.getOutput()))
                    ico.add(cr.getOutput());
            }
            if (!ico.isEmpty()) {
                ...
                ReikaGuiAPI.instance.drawItemStack(
                    ri, ReikaItemHelper.getSizedItemStack(ico.get(idx), 1), x, y
                );
            } else {
                ReikaGuiAPI.instance.drawTexturedModelRectFromIcon(
        ...
        if (this.getTabIcon() == null) {
            ReikaChatHelper.write(
                "Error rendering fragment " + this + ": no icon to draw"
            );
            return;
        }
        ...
        if (this == FARLANDS) {
            ...
            int ds = (s - 16) / 2;
            ReikaGuiAPI.instance.drawTexturedModelRectFromIcon(
                x - ds, y - ds, ChromaIcons.PURPLESPIN.getIcon(), s, s
            );
            GL11.glPopAttrib();
            GL11.glPopMatrix();
        }
    ...
    public boolean isUnloadable() {
        if (!ChromatiCraft.instance.isDimensionLoadable()) {
            if (this == DIMENSION || this == DIMENSION2 || this == PORTAL
                || this == PORTALSTRUCT) {
                return true;
            }
        }
    ...
    public String getNotes(int subpage) {
        if (this == PACKCHANGES) {
            return PackModificationTracker.instance
                .getModifications(ChromatiCraft.instance)
                .get(subpage - 1)
                .toString();
        } else if (this == ALVEARY && subpage > 1) {
            StringBuilder sb = new StringBuilder();
            TileEntityLumenAlveary.getSortedEffectList()
                .get(subpage - 2)
                .getLexiconString(sb);
            return sb.toString();
        ...
        if (item != null
            && item.getItemInstance() instanceof DynamicallyGeneratedSubpage) {
            DynamicallyGeneratedSubpage iw
                = (DynamicallyGeneratedSubpage) this.getItem().getItemInstance();
    ...
    public ArrayList<ItemStack> getItemStacks() {
        ...
        if (this == BEES) {
            ...
            for (int i = 0; i < 16; i++) {
                ...
                li.add(
                    CrystalBees.getElementalBee(e).getBeeItem(world, EnumBeeType.PRINCESS)
                );
        ...
        if (this == TANKAUX)
            return ReikaJavaLibrary.makeListFrom(
                ChromaBlocks.TANK.getStackOf(), ChromaBlocks.TANK.getStackOfMetadata(2)
            );
        if (this == FENCEAUX || this == TNT || this == VOIDESSENCE)
            return ReikaJavaLibrary.makeListFrom(iconItem);
        if (this == PROXESSENCE)
            return ReikaJavaLibrary.makeListFrom(
                ChromaStacks.bedrockloot, ChromaStacks.bedrockloot2
            );
        if (block != null) {
    ...
    public boolean isCraftable() {
        ...
        if (!this.isConfigDisabled() && this.isCrafting()) {
            return this.isVanillaRecipe() ? this.getVanillaRecipeCount() > 0
                                          : this.getRecipeCount() > 0;
        }
        return false;
    }
    ...
    public ArrayList<CastingRecipe> getCraftingRecipes() {
        ...
        for (ItemStack is : li) {
            Collection<CastingRecipe> cr
                = RecipesCastingTable.instance.getAllRecipesMaking(is);
    ...
    public int getRecipeIndex(ItemStack is, EntityPlayer ep) {
        if (this == ALLOYS) {
            return new ArrayList(PoolRecipes.instance.getAllPoolRecipesForPlayer(ep))
                .indexOf(PoolRecipes.instance.getPoolRecipeByOutput(is));
        }
    ...
    public ArrayList<IRecipe> getVanillaRecipes() {
        ...
        for (ItemStack is : li) {
            rec.addAll(ReikaRecipeHelper.getAllRecipesByOutput(
                CraftingManager.getInstance().getRecipeList(), is
            ));
        }
        return rec;
    }
    ...
    public boolean isDummiedOut() {
        ...
        //ReikaObfuscationHelper.isDeObfEnvironment()) 	return false;
        if (machine != null)
        ...
        if (this == APIRECIPES && DragonAPICore.hasGameLoaded()) //only hide display
            return RecipesCastingTable.instance.getAllAPIRecipes().isEmpty()
                && RecipesCastingTable.instance.getAllModdedItemRecipes().isEmpty();
        if (this == PACKCHANGES
            && !PackModificationTracker.instance.modificationsExist(ChromatiCraft.instance
            ))
            return true;
        if (this == AUGMENT)
            return true;
    ...
    static {
        ...
        for (int i = 0; i < researchList.length; i++) {
            ...
            if (pre != null)
                throw new RegistrationException(
                    ChromatiCraft.instance,
                    "Two research fragments have the same block/item/ability/etc: " + r
                        + " & " + pre
                );
            ...
            if (!r.isDummiedOut()) {
                try {
                    ...
                    if (dep != null && !(dep instanceof ConfigList)) {
                        ...
                        throw new RegistrationException(
                            ChromatiCraft.instance,
                            "Could not initialize Info Fragment '" + r + "'!",
                            e
                        );
                    }
                }
