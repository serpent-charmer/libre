...
public class RecipesCastingTable implements CastingAPI {
    ...
    private void loadRecipes() {
        ...
        CrystalGroupRecipe redgroup
            = (CrystalGroupRecipe) this.addRecipe(new CrystalGroupRecipe(
                ChromaStacks.redGroup,
                CrystalElement.RED,
                CrystalElement.BLUE,
                CrystalElement.PURPLE,
                CrystalElement.MAGENTA,
                ChromaStacks.auraDust,
                false
            ));
        CrystalGroupRecipe greengroup
            = (CrystalGroupRecipe) this.addRecipe(new CrystalGroupRecipe(
                ChromaStacks.greenGroup,
                CrystalElement.YELLOW,
                CrystalElement.CYAN,
                CrystalElement.LIME,
                CrystalElement.GREEN,
                ChromaStacks.livingEssence,
                false
            ));
        CrystalGroupRecipe orangegroup
            = (CrystalGroupRecipe) this.addRecipe(new CrystalGroupRecipe(
                ChromaStacks.orangeGroup,
        ...
        CrystalGroupRecipe whitegroup
            = (CrystalGroupRecipe) this.addRecipe(new CrystalGroupRecipe(
                ChromaStacks.whiteGroup,
                CrystalElement.BLACK,
                CrystalElement.GRAY,
                CrystalElement.LIGHTGRAY,
                CrystalElement.WHITE,
                ChromaStacks.icyDust,
                false
            ));

        this.addRecipe(new CrystalGroupRecipe(
            ChromaStacks.redGroup,
            CrystalElement.RED,
            CrystalElement.BLUE,
            CrystalElement.PURPLE,
        ...
        this.addRecipe(
            new CrystalClusterRecipe(ChromaStacks.primaryCluster, redgroup, greengroup)
        );
        this.addRecipe(new CrystalClusterRecipe(
            ChromaStacks.secondaryCluster, orangegroup, whitegroup
        ));
        this.addRecipe(
            new CrystalCoreRecipe(ChromaStacks.crystalCore, new ItemStack(Items.diamond))
        );
        CrystalStarRecipe star = new CrystalStarRecipe(
            ChromaStacks.crystalStar, new ItemStack(Items.nether_star)
        );
        this.addRecipe(star);
        ...
        this.addRecipe(
            new LumenChunkRecipe(ChromaStacks.glowChunk, new ItemStack(Items.diamond))
        );
        this.addRecipe(
            new LumenCoreRecipe(ChromaStacks.lumenCore, ChromaStacks.crystalStar)
        );

        this.addRecipe(
            new CrystalLensRecipe(ChromaStacks.crystalLens, new ItemStack(Blocks.glass))
        );

        this.addRecipe(new StorageCrystalRecipe(
            ChromaItems.STORAGE.getStackOf(), ChromaStacks.elementUnit
        ));
        for (int i = 0; i < ChromaItems.STORAGE.getNumberMetadatas() - 1; i++)
            this.addRecipe(new StorageCrystalRecipe(
                ChromaItems.STORAGE.getStackOfMetadata(i + 1),
                ChromaItems.STORAGE.getStackOfMetadata(i)
            ));
        ...
        for (int i = 0; i < 16; i++) {
            ...
            ItemStack block
                = new ItemStack(ChromaBlocks.PYLONSTRUCT.getBlockInstance(), 8, 0);
            ItemStack lamp = new ItemStack(ChromaBlocks.LAMP.getBlockInstance(), 1, i);

            IRecipe sr = new ShapedOreRecipe(
                block, " S ", "SCS", " S ", 'S', "stone", 'C', shard
            );
            ...
            this.addRecipe(
                new LumenLampRecipe(ChromaBlocks.LAMPBLOCK.getStackOfMetadata(i), e)
            );

            this.addRecipe(
                new TintedLensRecipe(e, ChromaStacks.crystalLens, Items.iron_ingot, 1)
            );
            this.addRecipe(
                new TintedLensRecipe(e, ChromaStacks.crystalLens, Items.gold_ingot, 2)
            );
            this.addRecipe(new TintedLensRecipe(
                e, ChromaStacks.crystalLens, ChromaStacks.chromaIngot, 4
            ));

            sr = ReikaRecipeHelper.getShapedRecipeFor(
                lamp, " s ", "sss", "SSS", 's', shard, 'S', ReikaItemHelper.stoneSlab
            );
            ...
            for (int k = 0; k < Bases.baseList.length; k++) {
                ...
                sr = ReikaRecipeHelper.getShapedRecipeFor(
                    glow, "S", "s", 'S', shard, 's', b.ingredient
                );
        ...
        this.addRecipe(new CompoundRelayRecipe(
            ChromaBlocks.RELAY.getStackOfMetadata(16), new ItemStack(Items.diamond)
        ));

        this.addRecipe(new FloatingRelayRecipe(
            ChromaBlocks.FLOATINGRELAY.getStackOf(),
            ChromaBlocks.RELAY.getStackOfMetadata(16)
        ));
        ...
        this.addRecipe(
            new CrystalStoneRecipe(StoneTypes.BRICKS, 4, "SS", "SS", 'S', smooth)
        );
        this.addRecipe(new CrystalStoneRecipe(StoneTypes.BEAM, 2, "SS", 'S', smooth));
        this.addRecipe(new CrystalStoneRecipe(
            StoneTypes.ENGRAVED, 4, " S ", "S S", " S ", 'S', smooth
        ));
        this.addRecipe(new CrystalStoneRecipe(
            StoneTypes.EMBOSSED, 5, " S ", "SSS", " S ", 'S', smooth
        ));
        this.addRecipe(
            new CrystalStoneRecipe(StoneTypes.CORNER, 5, "SSS", "S  ", "S  ", 'S', smooth)
        );
        this.addRecipe(
            new CrystalStoneRecipe(StoneTypes.GROOVE1, 3, "S", "S", "S", 'S', smooth)
        );
        this.addRecipe(new CrystalStoneRecipe(StoneTypes.GROOVE2, 3, "SSS", 'S', smooth));
        this.addRecipe(new CrystalStoneRecipe(
            StoneTypes.STABILIZER,
            4,
            "sSs",
            "ScS",
            "sSs",
            ...
            smooth,
            'c',
            ChromaStacks.chargedWhiteShard,
            's',
            ChromaBlocks.RUNE.getStackOf(CrystalElement.WHITE)
        ));
        this.addRecipe(new CrystalStoneRecipe(
            StoneTypes.RESORING,
            6,
        ...
        this.addRecipe(new CompoundRuneRecipe(
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.MULTICHROMIC.ordinal()
            ),
            ChromaStacks.iridCrystal
        ));

        IRecipe sr = ReikaRecipeHelper.getShapedRecipeFor(
            ChromaItems.OREPICK.getStackOf(),
            "EPE",
            "cSc",
            "cSc",
            'c',
        ...
        sr = ReikaRecipeHelper.getShapedRecipeFor(
            ChromaItems.ORESILK.getStackOf(),
            "EPE",
            "cdc",
            "cSc",
            'c',
        ...
        sr = ReikaRecipeHelper.getShapedRecipeFor(
            ChromaItems.MULTITOOL.getStackOf(),
            "APS",
            "csc",
            "csc",
            'c',
        ...
        this.addRecipe(new GuardianStoneRecipe(
            ChromaTiles.GUARDIAN.getCraftedProduct(), ChromaStacks.crystalStar
        ));
        ...
        sr = new ShapedOreRecipe(
            ...
            Items.cauldron,
            'S',
            ChromaItems.SHARD.getAnyMetaStack()
        );
        ...
        sr = new ShapedOreRecipe(
            ...
            Items.glowstone_dust,
            'e',
            ChromaStacks.teleDust,
            'v',
            ChromaStacks.voidDust,
            'b',
            ChromaStacks.icyDust
        );
        this.addRecipe(new SelectiveGlassRecipe(is, sr, false));
        //sr = new ShapedOreRecipe(is, "GgG", "beb", "GvG", 'G', Blocks.glass, 'g',
        //Blocks.glowstone, 'e', ChromaStacks.enderDust, 'v', ChromaStacks.spaceDust, 'b',
        //ChromaStacks.); this.addRecipe(new SelectiveGlassRecipe(is, sr, true));

        //sr = ReikaRecipeHelper.getShapedRecipeFor(ChromaStacks.crystalMirror, "GWI",
        //"GWI", "GWI", 'G', Blocks.glass, 'I', Items.iron_ingot, 'W',
        //ChromaItems.SHARD.getStackOfMetadata(15));
        this.addRecipe(new CrystalMirrorRecipe(
            ChromaStacks.crystalMirror, new ItemStack(Blocks.glass)
        ));

        this.addRecipe(
            new RiftRecipe(ChromaTiles.RIFT.getCraftedProduct(), ChromaStacks.voidCore)
        );
        this.addRecipe(new CrystalTankRecipe(
            ChromaTiles.TANK.getCraftedProduct(), ChromaStacks.voidCore
        ));
        this.addRecipe(new RecipeTankBlock(
            new ItemStack(ChromaBlocks.TANK.getBlockInstance()),
            new ItemStack(Items.diamond)
        ));
        this.addRecipe(new CrystalFurnaceRecipe(
            ChromaTiles.FURNACE.getCraftedProduct(), ChromaStacks.energyCore
        ));
        this.addRecipe(new CrystalLaserRecipe(
            ChromaTiles.LASER.getCraftedProduct(), ChromaStacks.energyCore
        ));
        this.addRecipe(new CrystalChargerRecipe(
            ChromaTiles.CHARGER.getCraftedProduct(), ChromaStacks.crystalCore
        ));
        ...
        for (int i = 0; i < CrystalElement.elements.length; i++) {
            ...
            ItemStack supercry
                = new ItemStack(ChromaBlocks.SUPER.getBlockInstance(), 1, i);
            ItemStack seed = ChromaItems.SEED.getStackOfMetadata(i);
        ...
        this.addRecipe(
            new CrystalFocusRecipe(ChromaStacks.crystalFocus, ChromaStacks.primaryCluster)
        );
        this.addRecipe(new CrystalMirrorRecipe(
            ChromaStacks.crystalMirror, ChromaStacks.getChargedShard(CrystalElement.WHITE)
        ));

        RecipeCrystalRepeater repeater
            = new RecipeCrystalRepeater(ChromaStacks.crystalCore);
        this.addRecipe(repeater);

        this.addRecipe(new TransitionRecipe(
            ChromaItems.TRANSITION.getStackOf(), ChromaStacks.transformCore
        ));
        this.addRecipe(new ExcavatorRecipe(
            ChromaItems.EXCAVATOR.getStackOf(), ChromaStacks.energyCore
        ));

        this.addRecipe(
            new ElementUnitRecipe(ChromaStacks.elementUnit, ChromaStacks.bindingCrystal)
        );
        ...
        sr = new ShapedOreRecipe(
            ...
            "LSL",
            'L',
            ReikaItemHelper.fern,
            'F',
            "flower",
            'S',
            ChromaStacks.greenShard,
            'B',
            Items.redstone
        );
        ...
        this.addRecipe(new SpawnerReprogrammerRecipe(
            ChromaTiles.REPROGRAMMER.getCraftedProduct(), ChromaStacks.transformCoreHigh
        ));

        this.addRecipe(new TelePumpRecipe(
            ChromaTiles.TELEPUMP.getCraftedProduct(), ChromaStacks.energyCoreHigh
        ));

        this.addRecipe(new CompoundRepeaterRecipe(ChromaStacks.crystalFocus));

        //is = ChromaTiles.FIBER.getCraftedProduct();
        //sr = ReikaRecipeHelper.getShapedRecipeFor(is, "GgG", "GDG", "GgG", 'G',
        //Blocks.glass, 'D', Items.diamond, 'g', Items.glowstone_dust); this.addRecipe(new
        //FiberRecipe(is, sr));

        this.addRecipe(
            new IridescentChunkRecipe(ChromaStacks.iridChunk, ChromaStacks.bindingCrystal)
        );

        this.addRecipe(new IridescentCrystalRecipe(
            ChromaTiles.CRYSTAL.getCraftedProduct(), new ItemStack(Items.diamond)
        ));

        InfuserRecipe ir = new InfuserRecipe(
            ChromaTiles.INFUSER.getCraftedProduct(), ChromaTiles.STAND.getCraftedProduct()
        );
        this.addRecipe(ir);
        this.addRecipe(
            new PlayerInfuserRecipe(ChromaTiles.PLAYERINFUSER.getCraftedProduct(), ir)
        );

        if (ModList.THAUMCRAFT.isLoaded()) {
            this.addRecipe(new AspectFormerRecipe(
                ChromaTiles.ASPECT.getCraftedProduct(), ChromaStacks.transformCore
            ));
            this.addRecipe(new AspectJarRecipe(
                ChromaTiles.ASPECTJAR.getCraftedProduct(), ChromaStacks.voidCore
            ));
        ...
        this.addRecipe(new InventoryLinkRecipe(
            ChromaItems.LINK.getStackOf(), new ItemStack(Items.ender_pearl)
        ));

        this.addRecipe(new LampRecipe(
            ChromaTiles.LAMP.getCraftedProduct(), new ItemStack(Blocks.glowstone)
        ));

        this.addRecipe(new BeaconRecipe(
            ChromaTiles.BEACON.getCraftedProduct(), new ItemStack(Items.nether_star)
        ));
        ...
        this.addRecipe(new BatteryRecipe(
            ChromaTiles.POWERTREE.getCraftedProduct(), ChromaStacks.crystalStar
        ));

        this.addRecipe(new InvTickerRecipe(
            ChromaTiles.TICKER.getCraftedProduct(), new ItemStack(Blocks.chest)
        ));

        this.addRecipe(new MinerRecipe(
            ChromaTiles.MINER.getCraftedProduct(), ChromaStacks.energyCoreHigh
        ));

        this.addRecipe(new FabricatorRecipe(
            ChromaTiles.FABRICATOR.getCraftedProduct(), ChromaStacks.transformCoreHigh
        ));
        ...
        /*
        this.addRecipe(new UpgradeRecipe(ChromaStacks.silkUpgrade, new
        ItemStack(Items.diamond))); this.addRecipe(new
        UpgradeRecipe(ChromaStacks.speedUpgrade, new ItemStack(Items.redstone)));
        this.addRecipe(new UpgradeRecipe(ChromaStacks.efficiencyUpgrade, new
        ItemStack(Items.emerald)));
         */

        if (ChromaOptions.ENDERTNT.getState())
            this.addRecipe(new RecipeEnderTNT(
                ChromaBlocks.TNT.getStackOf(), new ItemStack(Items.nether_star)
            ));

        this.addRecipe(new TeleportWandRecipe(
            ChromaItems.TELEPORT.getStackOf(), ChromaStacks.energyCore
        ));

        this.addRecipe(new BuilderWandRecipe(
            ChromaItems.BUILDER.getStackOf(), ChromaStacks.transformCore
        ));

        this.addRecipe(new CaptureWandRecipe(
            ChromaItems.CAPTURE.getStackOf(), new ItemStack(Blocks.web)
        ));

        this.addRecipe(new GrowthWandRecipe(
            ChromaItems.GROWTH.getStackOf(), new ItemStack(Items.diamond)
        ));

        this.addRecipe(new DuplicationWandRecipe(
            ChromaItems.DUPLICATOR.getStackOf(), ChromaStacks.transformCore
        ));

        if (ModList.APPENG.isLoaded()) {
            this.addRecipe(new VoidStorageRecipe(
                ChromaItems.VOIDCELL.getStackOf(), ChromaStacks.voidCore
            ));
            this.addRecipe(new CrystalCellRecipe(
                ChromaItems.CRYSTALCELL.getStackOf(), ChromaStacks.crystalFocus
            ));
        ...
        for (int i = 0; i < BlockPath.PathType.list.length; i++) {
            ...
            this.addRecipe(new PathRecipe(
                ChromaItems.ELEMENTAL.getStackOf(CrystalElement.LIME), i, p.getBlock()
            ));
        }

        //if (ChromaOptions.BIOMEPAINTER.getState())
        this.addRecipe(new BiomePainterRecipe(
            ChromaTiles.BIOMEPAINTER.getCraftedProduct(), ChromaStacks.transformCoreHigh
        ));

        this.addRecipe(
            new AuraPouchRecipe(ChromaItems.AURAPOUCH.getStackOf(), ChromaStacks.voidCore)
        );

        this.addRecipe(new FarmerRecipe(
            ChromaTiles.FARMER.getCraftedProduct(), ChromaStacks.energyCore
        ));

        this.addRecipe(new RelaySourceRecipe(
            ChromaTiles.RELAYSOURCE.getCraftedProduct(), ChromaStacks.crystalFocus
        ));

        this.addRecipe(new ItemCollectorRecipe(
            ChromaTiles.ITEMCOLLECTOR.getCraftedProduct(), ChromaStacks.voidCore
        ));

        this.addRecipe(new PortalRecipe(
            ChromaBlocks.PORTAL.getStackOf(), ChromaStacks.voidCoreHigh, repeater
        ));

        Object[] metal = new Object[] { Items.iron_ingot,
                                        1,
                                        Items.gold_ingot,
                                        4,
                                        "ingotCopper",
                                        ...
                                        "ingotSilver",
                                        2,
                                        ChromaStacks.conductiveIngot,
                                        6,
                                        ChromaStacks.fieryIngot,
                                        8 };
        for (int i = 0; i < metal.length; i += 2) {
            if (metal[i] instanceof String
                && !ReikaItemHelper.oreItemExists((String) metal[i]))
                continue;
            int n = (int) metal[i + 1];
        ...
        metal = new Object[] { Items.iron_ingot,
                               1,
                               Items.gold_ingot,
                               4,
                               "ingotCopper",
        ...
        for (int i = 0; i < metal.length; i += 2) {
            if (metal[i] instanceof String
                && !ReikaItemHelper.oreItemExists((String) metal[i]))
                continue;
            is = ReikaItemHelper.getSizedItemStack(
                ChromaBlocks.REDSTONEPOD.getStackOf(), (int) metal[i + 1]
            );
            sr = new ShapedOreRecipe(
                is,
                "fbf",
        ...
        metal = new Object[] { Items.iron_ingot,
                               ...
                               "ingotVibrantAlloy",
                               8,
                               "RotaryCraft:ingotTungstenAlloy",
                               12,
                               "ingotSuperconducting",
                               12 };
        for (int i = 0; i < metal.length; i += 2) {
            if (metal[i] instanceof String
                && !ReikaItemHelper.oreItemExists((String) metal[i]))
                continue;
            is = ReikaItemHelper.getSizedItemStack(
                ChromaBlocks.RFPOD.getStackOf(), (int) metal[i + 1]
            );
            sr = new ShapedOreRecipe(
                is,
                "bfb",
        ...
        this.addRecipe(new EnderCrystalRecipe(
            ChromaItems.ENDERCRYSTAL.getStackOf(), ChromaStacks.crystalStar
        ));
        ...
        this.addRecipe(new AutomatorRecipe(
            ChromaTiles.AUTOMATOR.getCraftedProduct(), ChromaStacks.transformCoreHigh
        ));

        this.addRecipe(new ChainGunRecipe(
            ChromaItems.CHAINGUN.getStackOf(), ChromaStacks.crystalCore
        ));
        this.addRecipe(new SplashGunRecipe(
            ChromaItems.SPLASHGUN.getStackOf(), ChromaStacks.crystalCore
        ));
        this.addRecipe(new VacuumGunRecipe(
            ChromaItems.VACUUMGUN.getStackOf(), ChromaStacks.voidCoreHigh
        ));

        if (ModList.APPENG.isLoaded()) {
            this.addRecipe(new MEDistributorRecipe(
                ChromaTiles.MEDISTRIBUTOR.getCraftedProduct(), ChromaStacks.transformCore
            ));
        }

        this.addRecipe(
            new RecipeHoverWand(ChromaItems.HOVERWAND.getStackOf(), ChromaStacks.voidCore)
        );
        ...
        this.addRecipe(new TransportWindowRecipe(
            ChromaTiles.WINDOW.getCraftedProduct(), new ItemStack(Items.diamond)
        ));
        ...
        sr = ReikaRecipeHelper.getShapedRecipeFor(
            ...
            "g  ",
            'g',
            ChromaStacks.grayShard,
            'l',
            ChromaStacks.limeShard,
            's',
            Items.stick
        );
        this.addRecipe(new LinkToolRecipe(is, sr));

        this.addRecipe(new RecipePersonalCharger(
            ChromaTiles.PERSONAL.getCraftedProduct(), ChromaStacks.crystalCore
        ));
        ...
        this.addRecipe(new PylonTurboRecipe(
            ChromaTiles.PYLONTURBO.getCraftedProduct(), ChromaStacks.lumenCore, repeater
        ));
        ...
        sr = ReikaRecipeHelper.getShapedRecipeFor(
            ...
            " b ",
            's',
            ChromaItems.SHARD.getStackOf(CrystalElement.PINK),
            'g',
            Items.glowstone_dust,
            'b',
            new ItemStack(block)
        ...
        this.addRecipe(new CrystalFenceRecipe(
            ChromaTiles.FENCE.getCraftedProduct(), new ItemStack(Blocks.gold_block)
        ));
        ...
        this.addRecipe(new CloakTowerRecipe(
            ChromaTiles.CLOAKING.getCraftedProduct(), ChromaStacks.crystalFocus
        ));
        ...
        sr = ReikaRecipeHelper.getShapedRecipeFor(
            ...
            "sbs",
            's',
            ChromaStacks.blueShard,
            'b',
            ChromaStacks.chromaDust,
            'a',
            ChromaStacks.auraDust,
            'l',
            ChromaBlocks.LAMPBLOCK.getStackOfMetadata(CrystalElement.WHITE.ordinal())
        );
        this.addRecipe(new CaveLighterRecipe(is, sr));

        this.addRecipe(new EnchantmentRecipe(
            ChromaResearch.EXCAVATOR,
            ChromaItems.EXCAVATOR.getStackOf(),
            ChromaStacks.auraDust,
            ChromaStacks.chargedPurpleShard,
            ChromaStacks.chromaDust,
        ...
        this.addRecipe(new EnchantmentRecipe(
            ChromaResearch.EXCAVATOR,
            ChromaItems.EXCAVATOR.getStackOf(),
            ReikaItemHelper.lapisDye.copy(),
            ChromaStacks.chargedPurpleShard,
            ChromaStacks.focusDust,
            Enchantment.fortune,
            5
        ));
        this.addRecipe(new EnchantmentRecipe(
            ChromaResearch.EXCAVATOR,
            ChromaItems.EXCAVATOR.getStackOf(),
            ChromaStacks.enderDust,
            ChromaStacks.chargedLimeShard,
            ChromaStacks.beaconDust,
            ChromaEnchants.AUTOCOLLECT.getEnchantment(),
            1
        ));
        this.addRecipe(new EnchantmentRecipe(
            ChromaResearch.EXCAVATOR,
            ChromaItems.EXCAVATOR.getStackOf(),
            ChromaStacks.energyPowder,
            ChromaStacks.chargedBrownShard,
            new ItemStack(Items.diamond),
            ChromaEnchants.MINETIME.getEnchantment(),
            1
        ));
        this.addRecipe(new EnchantmentRecipe(
            ChromaResearch.EXCAVATOR,
            ChromaItems.EXCAVATOR.getStackOf(),
            ChromaStacks.teleDust,
            ChromaStacks.chargedBlueShard,
            ChromaStacks.lumenGem,
            Enchantment.flame,
            1
        ));
        this.addRecipe(new EnchantmentRecipe(
            ...
            ChromaItems.EXCAVATOR.getStackOf(),
            ChromaStacks.voidDust,
            ChromaStacks.chargedLightBlueShard,
            ChromaStacks.floatstone,
            ChromaEnchants.AIRMINER.getEnchantment(),
            1
        ));

        this.addRecipe(new EnchantmentRecipe(
            ChromaResearch.TRANSITION,
            ChromaItems.TRANSITION.getStackOf(),
            ChromaStacks.bindingCrystal,
            ChromaStacks.chargedGrayShard,
            ChromaStacks.resonanceDust,
            Enchantment.silkTouch,
            1
        ));

        this.addRecipe(new EnchantmentRecipe(
            ChromaResearch.GROWTH,
            ChromaItems.GROWTH.getStackOf(),
            ReikaItemHelper.bonemeal.copy(),
            ChromaStacks.chargedGreenShard,
            ChromaStacks.elementDust,
            Enchantment.power,
            1
        ));
        ...
        sr = ReikaRecipeHelper.getShapedRecipeFor(
            ...
            "iri",
            's',
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.STONE.ordinal()),
            'c',
            ChromaStacks.chromaDust,
            'a',
            ChromaStacks.auraDust,
        ...
        //this.addRecipe(new GlowFireRecipe(ChromaTiles.GLOWFIRE.getCraftedProduct(),
        //ChromaStacks.transformCore));
        ...
        sr = new ShapedOreRecipe(
            ...
            "stickWood",
            'c',
            ChromaItems.BUCKET.getStackOfMetadata(0)
        );
        ...
        sr = new ShapedOreRecipe(
            ...
            Items.glowstone_dust,
            's',
            ChromaItems.SHARD.getStackOf(CrystalElement.BLUE),
            'c',
            "cobblestone"
        );
        this.addRecipe(new LumenWireRecipe(is, sr));

        this.addRecipe(new PurifyCrystalRecipe(
            ChromaItems.PURIFY.getStackOf(), ChromaStacks.iridChunk
        ));
        this.addRecipe(new EfficiencyCrystalRecipe(
            ChromaItems.EFFICIENCY.getStackOf(),
            ChromaBlocks.SUPER.getStackOfMetadata(CrystalElement.BLACK.ordinal())
        ));
        ...
        this.addRecipe(new KillAuraRecipe(
            ChromaItems.KILLAURAGUN.getStackOf(), ChromaStacks.energyCoreHigh
        ));

        for (int i = 0; i < 3; i++)
            this.addRecipe(new MeteorTowerRecipe(i));

        this.addRecipe(new RecipeAreaBreaker(
            ChromaTiles.AREABREAKER.getCraftedProduct(), ChromaStacks.crystalFocus
        ));

        this.addRecipe(new WirelessTransmitterRecipe(
            ChromaTiles.WIRELESS.getCraftedProduct(), ChromaStacks.elementUnit
        ));

        this.addRecipe(new WarpGateRecipe(
            ChromaTiles.TELEPORT.getCraftedProduct(), ChromaStacks.voidCoreHigh
        ));

        this.addRecipe(new FloatstoneBootsRecipe(
            ChromaItems.FLOATBOOTS.getStackOf(), new ItemStack(Items.iron_boots), false
        ));
        if (ModList.ROTARYCRAFT.isLoaded()) {
            this.addRecipe(new FloatstoneBootsRecipe(
                ChromaItems.FLOATBOOTS.getStackOf(),
                ItemRegistry.BEDBOOTS.getStackOf(),
                true
            ));
            this.addRecipe(new FloatstoneBootsRecipe(
                ChromaItems.FLOATBOOTS.getStackOf(),
                ItemRegistry.BEDJUMP.getStackOfMetadata(OreDictionary.WILDCARD_VALUE),
                true
            ));
        }
        ...
        sr = ReikaRecipeHelper.getShapedRecipeFor(
            ...
            "li",
            'e',
            ChromaItems.ELEMENTAL.getStackOf(CrystalElement.LIME),
            'g',
            ChromaStacks.limeShard,
            'l',
            ChromaStacks.lightBlueShard,
        ...
        Object root = ModList.BOTANIA.isLoaded()
            ? ReikaItemHelper.lookupItem(ModList.BOTANIA, "manaResource", 6)
            : null;
        if (root == null)
            root = Items.redstone;
        ItemStack in = ModList.BOTANIA.isLoaded()
            ? ReikaItemHelper.lookupBlock(ModList.BOTANIA, "specialFlower", 0)
            : null;
        if (in != null) {
        ...
        this.addRecipe(new GlowFireRecipe(
            ChromaTiles.GLOWFIRE.getCraftedProduct(), ChromaStacks.transformCore
        ));

        this.addRecipe(
            new AvoLampRecipe(ChromaBlocks.AVOLAMP.getStackOf(), ChromaStacks.avolite)
        );

        this.addRecipe(new AvoLaserRecipe(
            ChromaTiles.AVOLASER.getCraftedProduct(), ChromaStacks.avolite
        ));

        this.addRecipe(new RelayFilterRecipe(
            ChromaBlocks.RELAYFILTER.getStackOf(), ChromaItems.LENS.getAnyMetaStack()
        ));

        this.addRecipe(
            new RouterNodeRecipe(ChromaBlocks.ROUTERNODE.getStackOfMetadata(0), false)
        );
        this.addRecipe(
            new RouterNodeRecipe(ChromaBlocks.ROUTERNODE.getStackOfMetadata(1), true)
        );

        this.addRecipe(new RouterHubRecipe(
            ChromaTiles.ROUTERHUB.getCraftedProduct(), ChromaStacks.elementUnit
        ));

        this.addRecipe(new FocusCrystalRecipes.FlawedFocusCrystalRecipe());
        DefaultFocusCrystalRecipe fr
            = new FocusCrystalRecipes.DefaultFocusCrystalRecipe();
        this.addRecipe(fr);
        ...
        this.addRecipe(new ChromaCrafterRecipe(
            ChromaTiles.CHROMACRAFTER.getCraftedProduct(), ChromaStacks.transformCoreHigh
        ));
        ...
        sr = ReikaRecipeHelper.getShapedRecipeFor(
            ...
            Items.iron_ingot,
            's',
            ChromaStacks.whiteShard,
            'a',
            ChromaStacks.blueShard,
            'b',
            ChromaStacks.pinkShard
        );
        ...
        this.addRecipe(new MultiBuilderRecipe(
            ChromaTiles.MULTIBUILDER.getCraftedProduct(), ChromaStacks.elementUnit
        ));

        this.addRecipe(new ExplosionShieldRecipe(
            ChromaTiles.EXPLOSIONSHIELD.getCraftedProduct(), ChromaStacks.crystalStar
        ));

        this.addRecipe(new BottleneckFinderRecipe(
            ChromaItems.BOTTLENECK.getStackOf(), ChromaStacks.auraIngot
        ));
        ...
        sr = ReikaRecipeHelper.getShapedRecipeFor(
            ...
            "CPC",
            'P',
            ChromaBlocks.CRYSTAL.getStackOfMetadata(CrystalElement.PURPLE.ordinal()),
            'C',
            ChromaBlocks.PYLONSTRUCT.getStackOf(),
            'd',
            Items.diamond,
            'a',
            ChromaStacks.auraDust,
        ...
        if (ModList.BOTANIA.isLoaded())
            this.addRecipe(
                new ManaBoosterRecipe(ChromaTiles.MANABOOSTER.getCraftedProduct())
            );

        this.addRecipe(new NetworkOptimizerRecipe(
            ChromaTiles.OPTIMIZER.getCraftedProduct(), ChromaStacks.lumenCore
        ));
        ...
        //sr = ReikaRecipeHelper.getShapedRecipeFor(is, "fef", "ege", "rgr", 'f',
        //ChromaStacks.bindingCrystal, 'g', Blocks.glowstone, 'r', Blocks.redstone_block,
        //'e', Items.emerald); this.addRecipe(new SpawnerShutdownRecipe(is, sr));
        ...
        this.addRecipe(new EnderEyeRecipe(
            ChromaItems.ENDEREYE.getCraftedProduct(3), new ItemStack(Items.emerald)
        ));
        ...
        sr = ReikaRecipeHelper.getShapedRecipeFor(
            ...
            "ccc",
            'c',
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(0),
            'm',
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.MULTICHROMIC.ordinal()
            ),
            'b',
        ...
        this.addRecipe(new CastingInjectorFocusRecipe(
            is, sr, redgroup, greengroup, orangegroup, whitegroup, star
        ));
        ...
        sr = ReikaRecipeHelper.getShapedRecipeFor(
            ...
            ChromaStacks.auraDust,
            'g',
            ChromaBlocks.PYLONSTRUCT.getStackOfMetadata(StoneTypes.ENGRAVED.ordinal())
        );
        this.addRecipe(new LaunchPadRecipe(is, sr));

        this.addRecipe(new TeleGateLockRecipe(
            ChromaItems.TELEGATELOCK.getStackOf(), ChromaStacks.resocrystal
        ));
        ...
        sr = ReikaRecipeHelper.getShapedRecipeFor(
            ...
            "wsw",
            'a',
            ModList.APPENG.isLoaded() ? AppEngHandler.getInstance().get16KStorage()
                                      : ReikaTreeHelper.OAK.getLog(),
            'q',
            Items.quartz,
            'g',
            Blocks.glowstone,
        ...
        this.addRecipe(new WideCollectorRecipe(
            ChromaItems.WIDECOLLECTOR.getStackOf(),
            ChromaTiles.FUNCTIONRELAY.getCraftedProduct()
        ));

        this.addRecipe(new NetworkTransportRecipe(
            ChromaTiles.NETWORKITEM.getCraftedProduct(), ChromaStacks.transformCore
        ));
        ...
        sr = ReikaRecipeHelper.getShapedRecipeFor(
            ...
            ChromaStacks.chromaDust,
            'q',
            ReikaItemHelper.quartzPillar.asItemStack(),
            'r',
            Items.redstone,
            'l',
            Blocks.redstone_lamp,
        ...
        sr = ReikaRecipeHelper.getShapedRecipeFor(
            ...
            "bab",
            'c',
            ReikaItemHelper.quartz.asItemStack(),
            'a',
            Blocks.obsidian,
            'b',
            ChromaStacks.auraDust
        ...
        this.addRecipe(new RecipeCacheRecipe(
            ChromaItems.RECIPECACHE.getStackOf(), new ItemStack(Blocks.obsidian)
        ));

        this.addRecipe(new EtherealPendantRecipe(
            ChromaItems.ETHERPENDANT.getStackOf(), ChromaStacks.voidCore
        ));
    ...
    private void addSpecialRecipes() {
        ...
        this.addRecipe(
            new ChargedItemPlayerBufferConnectionRecipe(ChromaItems.PROBE.getStackOf(), 1)
        );
        this.addRecipe(new ChargedItemPlayerBufferConnectionRecipe(
            ChromaItems.NETHERKEY.getStackOf(), 3
        ));
        this.addRecipe(new ChargedItemPlayerBufferConnectionRecipe(
            ChromaItems.SPAWNERBYPASS.getStackOf(), 2
        ));
        this.addRecipe(new ChargedItemPlayerBufferConnectionRecipe(
            ChromaItems.OREPICK.getStackOf(), 4
        ));
        this.addRecipe(new ChargedItemPlayerBufferConnectionRecipe(
            ChromaItems.STRUCTUREFINDER.getStackOf(), 1
        ));
        this.addRecipe(new ChargedItemPlayerBufferConnectionRecipe(
            ChromaItems.PURIFY.getStackOf(), 10
        ));
        for (int i = 0; i < 16; i++)
            this.addRecipe(new ChargedItemPlayerBufferConnectionRecipe(
                ChromaItems.PENDANT3.getStackOfMetadata(i), 15
            ));
    ...
    public void addPostLoadRecipes() {
        if (ModList.THAUMCRAFT.isLoaded()) {
            ItemStack is = ReikaItemHelper.getSizedItemStack(
                ThaumItemHelper.BlockEntry.ANCIENTROCK.getItem(), 32
            );
            IRecipe sr = new ShapedOreRecipe(
                is,
                "SdS",
            ...
            sr = ReikaRecipeHelper.getShapedRecipeFor(
                ...
                "lll",
                'b',
                ThaumItemHelper.ItemEntry.DEFUNCTBRAIN.getItem(),
                'l',
                ChromaStacks.lifegel
            );
        ...
        if (ModList.FORESTRY.isLoaded()) {
            ...
            if (is2 != null && is2.getItem() != null) {
                IRecipe sr = ReikaRecipeHelper.getShapedRecipeFor(
                    ...
                    is,
                    'W',
                    ForestryHandler.CraftingMaterials.WOVENSILK.getItem()
                );
            ...
            IRecipe sr = ReikaRecipeHelper.getShapedRecipeFor(
                ...
                ChromaStacks.lightBlueShard,
                'f',
                ForestryHandler.ItemEntry.IMPREGFRAME.getItem()
            );
            ...
            this.addRecipe(new LumenAlvearyRecipe(
                ChromaTiles.ALVEARY.getCraftedProduct(), new ItemStack(ctr)
            ));
            ...
            sr = new ShapedOreRecipe(
                ...
                'p',
                ModList.APPENG.isLoaded() ? AppEngHandler.getInstance().get64KStorage()
                                          : "ingotBronze",
                'a',
                g2,
                'g',
                g,
                'c',
                ChromaTiles.TOOLSTORAGE.getCraftedProduct(),
                'w',
                "ingotBronze"
            );
    ...
    private void addLandmarkRecipe() {
        ...
        IRecipe sr = ReikaRecipeHelper.getShapelessRecipeFor(
            is,
            ChromaStacks.beaconDust,
            ChromaStacks.beaconDust,
            new ItemStack(Items.redstone),
            ChromaStacks.auraDust,
            new ItemStack(BuildCraftCore.markerBlock),
    ...
    private CastingRecipe addModRecipe(CastingRecipe r) {
        ...
        Collections.sort(
            moddedItemRecipes,
            (r1, r2) -> ReikaItemHelper.comparator.compare(r1.getOutput(), r2.getOutput())
        );
        return r;
    }
    ...
    private CastingRecipe addRecipe(CastingRecipe r) {
        ...
        if (conflict != null && !APIrecipes.contains(conflict) && !conflict.equals(r)) {
            throw new RuntimeException(
                "Recipe " + r + " has a recipe ID which conflicts with " + conflict
            );
        }
    ...
    getRecipe(TileEntityCastingTable table, ArrayList<RecipeType> type) {
        ...
        for (ArrayList<CastingRecipe> ir : recipes.values()) {
            for (CastingRecipe r : ir) {
                if (!(r instanceof EnchantmentRecipe)) {
                    if (ReikaItemHelper.matchStacks(result, r.getOutput())
                        && (result.stackTagCompound == null
                            || ItemStack.areItemStackTagsEqual(result, r.getOutput())))
                        li.add(r);
                }
            }
        }
    ...
    public final void loadCustomRecipeFiles() {
        CustomRecipeList crl
            = new CustomRecipeList(ChromatiCraft.instance, "castingtable");
        if (crl.load()) {
            for (LuaBlock lb : crl.getEntries()) {
                ...
                if (flag) {
                    ChromatiCraft.logger.log(
                        "Loaded custom casting recipe '" + lb.getString("type") + "'"
                    );
                } else {
                    ChromatiCraft.logger.logError(
                        "Could not load custom casting recipe '" + lb.getString("type")
                        + "'"
                    );
                    if (e != null)
                        e.printStackTrace();
    ...
    private CastingRecipe addCustomRecipe(LuaBlock lb, CustomRecipeList crl)
        throws Exception {
        ItemStack out = crl.parseItemString(
            lb.getString("output"), lb.getChild("output_nbt"), false
        );
        ...
        int typical = lb.containsKey("typical_crafted_amount")
            ? lb.getInt("typical_crafted_amount")
            : 1;
        ItemStack leftover = lb.containsKey("central_leftover") ? crl.parseItemString(
                                 lb.getString("central_leftover"),
                                 lb.getChild("central_leftover_nbt"),
                                 true
                             )
                                                                : null;
        float autocost = lb.containsKey("automation_cost_factor")
            ? (float) lb.getDouble("automation_cost_factor")
            : 1;
        float xp = lb.containsKey("experience_factor")
            ? MathHelper.clamp_float((float) lb.getDouble("experience_factor"), 0, 1)
            : 1;
        boolean stack = true;
        ...
        if (lb.hasChild("runes")) {
            for (LuaBlock entry : lb.getChild("runes").getChildren()) {
                ...
                CrystalElement e = CrystalElement.valueOf(
                    entry.getString("color").toUpperCase(Locale.ENGLISH)
                );
                runes.put(c, e);
            }
        }
        ...
        if (lvl.equals("basic") || lvl.equals("rune")) {
            ...
            if (lvl.equals("rune")) {
                return this.addCustomRecipe(new ConfigRecipe.Rune(
                    ir, duration, typical, leftover, autocost, xp, runes, progress
                ));
            } else {
                return this.addCustomRecipe(new ConfigRecipe.Basic(
                    ir, duration, typical, leftover, autocost, xp, progress
                ));
            }
        } else if (lvl.equals("multi") || lvl.equals("pylon")) {
            LuaBlock recipe = lb.getChild("recipe");
            ItemStack center = crl.parseItemString(
                recipe.getString("center"), recipe.getChild("center_nbt"), false
            );
            ...
            if (lvl.equals("pylon")) {
                if (!setStack)
                    stack = false;
                return this.addCustomRecipe(new ConfigRecipe.Pylon(
                    out,
                    center,
                    duration,
                    typical,
                ...
                return this.addCustomRecipe(new ConfigRecipe.Multi(
                    out,
                    center,
                    duration,
                    typical,
    ...
    @Override
    public RuneTempleRecipe
    addTempleCastingRecipe(IRecipe ir, Map<List<Integer>, CrystalElementProxy> runes) {
    ...
    @Override
    public MultiRecipe addMultiBlockCastingRecipe(
        ItemStack out,
        ItemStack ctr,
        Map<List<Integer>, CrystalElementProxy> runes,
        Map<List<Integer>, ItemStack> items
    ) {
    ...
    @Override
    public LumenRecipe addPylonCastingRecipe(
        ItemStack out,
        ItemStack ctr,
        Map<List<Integer>, CrystalElementProxy> runes,
        Map<List<Integer>, ItemStack> items,
        Map<CrystalElementProxy, Integer> energy
    ) {
