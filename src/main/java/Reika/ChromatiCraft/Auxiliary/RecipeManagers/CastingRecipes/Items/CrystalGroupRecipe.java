...
public class CrystalGroupRecipe
    extends TempleCastingRecipe implements ShardGroupingRecipe {
    private static final int CHARGED_YIELD_BOOST = 4;

    private static final List<HashSet<CrystalElement>> groupMixes = new ArrayList();
    private static final int[] elementGroupIndexes
        = ReikaArrayHelper.getArrayOf(-1, CrystalElement.elements.length);

    private final boolean isChargedShards;

    public CrystalGroupRecipe(
        ItemStack out,
        CrystalElement e1,
        CrystalElement e2,
        CrystalElement e3,
    ...
    private static IRecipe getRecipe(
        ItemStack out,
        CrystalElement e1,
        CrystalElement e2,
        CrystalElement e3,
    ...
    public int getExperience() {
        return isChargedShards ? CHARGED_YIELD_BOOST * super.getExperience()
                               : super.getExperience();
    }
    ...
    public int getTypicalCraftedAmount() {
        return isChargedShards ? this.getTypicalCraftedAmount() / CHARGED_YIELD_BOOST
                               : super.getTypicalCraftedAmount();
    }
