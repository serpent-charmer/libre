...
public abstract class HighCoreRecipe
    extends PylonCastingRecipe implements ShardGroupingRecipe {
    protected HighCoreRecipe(
        ItemStack out,
        CrystalElement primary,
        CrystalElement secondary,
        Coordinate rune1,
        Coordinate rune2,
        ItemStack dust
    ) {
