...
public class AdjacencyRecipe extends PylonCastingRecipe {
    private static final Item[] upgrade
        = { Items.iron_ingot, Items.iron_ingot, Items.gold_ingot, Items.gold_ingot,
    ...
    public AdjacencyRecipe(CrystalElement e, int n) {
        ...
        ItemStack corner
            = tier == 0 ? new ItemStack(Items.diamond) : new ItemStack(upgrade[tier - 1]);
