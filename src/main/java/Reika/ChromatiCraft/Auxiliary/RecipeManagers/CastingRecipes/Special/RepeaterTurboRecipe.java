...
public class RepeaterTurboRecipe
    extends PylonCastingRecipe implements EnergyLinkingRecipe {
        ...
        for (int i = 0; i < 3; i++) {
            ...
            EntityFloatingSeedsFX fx1
                = (EntityFloatingSeedsFX) new EntityCCFloatingSeedsFX(
                      ...
                      .setScale(s)
                      .setColor(CrystalElement.randomElement().getColor())
                      .setLife(l);
            fx1.particleVelocity *= 2;
            EntityBlurFX fx2 = new EntityCCBlurFX(te.worldObj, x, y, z)
