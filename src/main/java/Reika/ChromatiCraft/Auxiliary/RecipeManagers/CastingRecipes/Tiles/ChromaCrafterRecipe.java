...
public class ChromaCrafterRecipe extends PylonCastingRecipe {
    public ChromaCrafterRecipe(ItemStack out, ItemStack main) {
        ...
        this.addAuxItem(
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.GLASS.ordinal()), 0, -4
        );
        this.addAuxItem(
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.GLASS.ordinal()), 2, -4
        );
        this.addAuxItem(
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.GLASS.ordinal()),
            -2,
        ...
        this.addAuxItem(
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.GLASS.ordinal()), 2, -2
        );
        this.addAuxItem(
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.GLASS.ordinal()), -2, 0
        );
        this.addAuxItem(
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.GLASS.ordinal()), 2, 0
        );
        ...
        this.addAuxItem(
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.GLASS.ordinal()), 0, 2
        );
        this.addAuxItem(
            ChromaBlocks.STRUCTSHIELD.getStackOfMetadata(BlockType.GLASS.ordinal()), 2, 2
        );
