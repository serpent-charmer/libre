...
public class CompoundRuneRecipe extends MultiBlockCastingRecipe {
    public CompoundRuneRecipe(ItemStack out, ItemStack main) {
        ...
        this.addAuxItem(
            new ItemStack(ChromaBlocks.RUNE.getBlockInstance(), 1, 0), -4, -4
        );
        this.addAuxItem(
            new ItemStack(ChromaBlocks.RUNE.getBlockInstance(), 1, 1), -2, -4
        );
        ...
        this.addAuxItem(
            new ItemStack(ChromaBlocks.RUNE.getBlockInstance(), 1, 11), -2, 4
        );
        this.addAuxItem(
            new ItemStack(ChromaBlocks.RUNE.getBlockInstance(), 1, 12), -4, 4
        );
        this.addAuxItem(
            new ItemStack(ChromaBlocks.RUNE.getBlockInstance(), 1, 13), -4, 2
        );
        this.addAuxItem(
            new ItemStack(ChromaBlocks.RUNE.getBlockInstance(), 1, 14), -4, 0
        );
        this.addAuxItem(
            new ItemStack(ChromaBlocks.RUNE.getBlockInstance(), 1, 15), -4, -2
        );
    }
