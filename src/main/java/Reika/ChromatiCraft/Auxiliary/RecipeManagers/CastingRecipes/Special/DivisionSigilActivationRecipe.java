...
public class DivisionSigilActivationRecipe extends MultiBlockCastingRecipe {
    private static final Item sigil
        = GameRegistry.findItem(ModList.EXTRAUTILS.modLabel, "divisionSigil");
    ...
    public ItemStack getContainerItem(ItemStack in, ItemStack normal) {
        return in != null && in.getItem() == sigil ? null
                                                   : super.getContainerItem(in, normal);
    }
