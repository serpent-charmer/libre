...
public class IridescentCrystalRecipe extends PylonCastingRecipe {
    ...
    private void doParticleFX(TileEntityCastingTable te, int tick, int dur) {
        ...
        EntityBlurFX fx
            = new EntityCCBlurFX(te.worldObj, px, te.yCoord + 1, pz, vx, vy, vz)
                  .setIcon(ChromaIcons.CHROMA)
                  .setBasicBlend()
                  .setGravity(g);
        ...
        if (t % 18 == 0) {
            ...
            for (int i = 0; i < 64; i++) {
                ...
                fx = new EntityCCBlurFX(te.worldObj, px, te.yCoord + 1, pz, vx, vy, vz)
            ...
            ReikaSoundHelper.playClientSound(
                ChromaSounds.BUFFERWARNING_EMPTY,
                te.xCoord + 0.5,
                te.yCoord + 0.5,
                te.zCoord + 0.5,
                1,
