...
public class BatteryRecipe extends PylonCastingRecipe {
    ...
    private final MusicKey[] melody = {
        MusicKey.C4, MusicKey.E4, MusicKey.G4, MusicKey.C5, MusicKey.G4, MusicKey.E4,
        MusicKey.C4, MusicKey.E4, MusicKey.G4, MusicKey.B4, MusicKey.D5, MusicKey.B4,
        MusicKey.G4, MusicKey.D4, MusicKey.G4, MusicKey.B4, MusicKey.D5, MusicKey.A4,
        MusicKey.F4, MusicKey.A4, MusicKey.D5, MusicKey.F5, MusicKey.D5, MusicKey.A4,
        MusicKey.F4, MusicKey.C4, MusicKey.F5, MusicKey.A4, MusicKey.C5, MusicKey.A4,
        MusicKey.F4, MusicKey.A4, MusicKey.C5, MusicKey.E5, MusicKey.C5, MusicKey.A4,
        MusicKey.E4, MusicKey.A4, MusicKey.C5, MusicKey.A4, MusicKey.E4, MusicKey.G4,
        MusicKey.B4, MusicKey.G4, MusicKey.E4, MusicKey.G4, MusicKey.B4, MusicKey.G4,
    };
    ...
    private void playKey(TileEntityCastingTable te, MusicKey m, ChromaSounds s) {
        ...
        ReikaSoundHelper.playClientSound(
            s, te.xCoord + 0.5, te.yCoord + 0.5, te.zCoord + 0.5, 1, f
        );
    }
    ...
    private void spawnParticles(TileEntityCastingTable te, CrystalElement e, int idx) {
        ...
        for (double d = 0; d < r; d += 0.125) {
            ...
            EntityFX fx = new EntityCCBlurFX(te.worldObj, dx, dy, dz, 0, vy, 0)
                              .setLife(60)
                              .setGravity(g)
                              .setColor(e.getColor())
                              .setScale(1.5F);
