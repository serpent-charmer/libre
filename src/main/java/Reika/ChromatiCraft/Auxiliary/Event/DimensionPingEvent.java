...
public class DimensionPingEvent extends ScheduledSoundEvent {
    ...
    public DimensionPingEvent(
        ChromaSounds s, float p, EntityPlayer ep, double dist, double ang
    ) {
        super(s, ep, 1, p);
        distance = dist;
        angle = ang;
    ...
    public static class StructurePingEvent extends DimensionPingEvent {
        ...
        public StructurePingEvent(
            CrystalElement e, EntityPlayer ep, double dist, double ang
        ) {
            super(
                ChromaSounds.DING,
