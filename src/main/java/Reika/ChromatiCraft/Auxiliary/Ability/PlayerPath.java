    ...
    public void render() {
        if (maxLength > 0) {
            ...
            for (DecimalPosition d : points) {
                if (i < points.size() - 8) {
                    int c = f >= 0.5F
                        ? ReikaColorAPI.mixColors(0xffffff, 0x00ffff, (f - 0.5F) * 2)
                        : ReikaColorAPI.mixColors(0x00ffff, 0x0000ff, f * 2);
                    ...
                    GL11.glTranslated(
                        d.xCoord - RenderManager.renderPosX,
                        d.yCoord - RenderManager.renderPosY,
                        d.zCoord - RenderManager.renderPosZ
                    );
                    //GL11.glTranslated(-271-RenderManager.renderPosX,
                    //8-RenderManager.renderPosY, 157-RenderManager.renderPosZ);
                    ...
                    /*
                    Tessellator.instance.addVertexWithUV(d.xCoord-s, d.yCoord, d.zCoord-s,
                    u, v); Tessellator.instance.addVertexWithUV(d.xCoord+s, d.yCoord,
                    d.zCoord-s, du, v); Tessellator.instance.addVertexWithUV(d.xCoord+s,
                    d.yCoord, d.zCoord+s, du, dv);
                    Tessellator.instance.addVertexWithUV(d.xCoord-s, d.yCoord, d.zCoord+s,
                    u, dv);

                    Tessellator.instance.addVertexWithUV(d.xCoord, d.yCoord-s, d.zCoord-s,
                    u, v); Tessellator.instance.addVertexWithUV(d.xCoord, d.yCoord-s,
                    d.zCoord+s, du, v); Tessellator.instance.addVertexWithUV(d.xCoord,
                    d.yCoord+s, d.zCoord+s, du, dv);
                    Tessellator.instance.addVertexWithUV(d.xCoord, d.yCoord+s, d.zCoord-s,
                    u, dv);
                     */
                }
