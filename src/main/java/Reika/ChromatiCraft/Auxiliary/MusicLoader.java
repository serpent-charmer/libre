...
public class MusicLoader {
    ...
    private static final String hashURL
        = "https://cache.techjargaming.com/reika/list.php?dir=ccmusic/";
    //private static final String musicURL = "https://cache.techjargaming.com";

    public static final File musicPath
        = new File(mcDir, "mods/Reika/ChromatiCraft/Music");
