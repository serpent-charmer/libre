...
public class AdjacencyUpgradeAPIImpl implements AdjacencyUpgradeAPI {
    ...
    y, int z) { Map<CrystalElement, Integer> map =
    TileEntityAdjacencyUpgrade.getAdjacentUpgrades(world, x, y, z);
    ...
    CrystalElementProxy e) { Integer get = this.getAdjacentUpgrades(world, x, y,
    z).get(e); return get != null ? get.intValue() : 0;
    }
     */
