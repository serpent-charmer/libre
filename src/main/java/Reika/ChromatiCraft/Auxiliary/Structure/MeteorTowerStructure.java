...
public class MeteorTowerStructure extends ChromaStructureBase {
    ...
    public FilledBlockArray getArray(World world, int x, int y, int z) {
        ...
        for (int j = 12; j <= 14; j++) {
            ...
            for (int i = -2; i <= 2; i++) {
                int ml = j == 13 ? StoneTypes.RESORING.ordinal()
                                 : StoneTypes.GROOVE1.ordinal();
                int mc
                    = j == 13 ? StoneTypes.COLUMN.ordinal() : StoneTypes.CORNER.ordinal();
                array.setBlock(
                    x - 2, dy, z + i, crystalstone, Math.abs(i) == 2 ? mc : ml
                );
                array.setBlock(
                    x + 2, dy, z + i, crystalstone, Math.abs(i) == 2 ? mc : ml
                );
                array.setBlock(
                    x + i, dy, z - 2, crystalstone, Math.abs(i) == 2 ? mc : ml
                );
                array.setBlock(
                    x + i, dy, z + 2, crystalstone, Math.abs(i) == 2 ? mc : ml
                );
        ...
        for (int j = 2; j <= 11; j++) {
            ...
            for (int a = 0; a < cols.length; a++) {
                ...
                int dx = x + col[0];
                int dz = z + col[1];
                int m = j == 4 || j == 7 || j == 11 ? StoneTypes.BRICKS.ordinal()
        ...
        for (int i = -1; i <= 1; i++) {
            array.setBlock(
                x - 2, y - 1, z + i, crystalstone, StoneTypes.BRICKS.ordinal()
            );
            array.setBlock(
                x + 2, y - 1, z + i, crystalstone, StoneTypes.BRICKS.ordinal()
            );
            array.setBlock(
                x + i, y - 1, z - 2, crystalstone, StoneTypes.BRICKS.ordinal()
            );
            array.setBlock(
                x + i, y - 1, z + 2, crystalstone, StoneTypes.BRICKS.ordinal()
            );
        ...
        array.setTile(
            ...
            y,
            z,
            ChromaTiles.METEOR.getBlock(),
            ChromaTiles.METEOR.getBlockMetadata(),
            te,
            "tier"
        );
        ...
        for (int j = 1; j <= 2; j++) {
            ...
            for (int i = -1; i <= 1; i += 2) {
                for (int k = -1; k <= 1; k += 2) {
                    int dx = x + i;
                    int dz = z + k;
                    int m = j == 1 ? StoneTypes.COLUMN.ordinal()
                                   : (tier == 0 ? StoneTypes.SMOOTH.ordinal()
        ...
        if (tier > 0) {
            for (int j = h[0]; j <= h[1]; j++) {
                int dy = y - j;
                int m = j == h[0] || j == h[1] ? StoneTypes.SMOOTH.ordinal()
