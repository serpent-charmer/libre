...
public class BoostedLumenTreeStructure extends LumenTreeStructure {
    ...
    public FilledBlockArray getArray(World world, int x, int y, int z) {
        ...
        for (int i = 13; i <= 16; i++) {
            int dy = y - i;
            int meta
                = i <= 14 ? StoneTypes.SMOOTH.ordinal() : StoneTypes.COLUMN.ordinal();
        ...
        array.setBlock(
            x - 2, y - 13, z + 1, crystalstone, StoneTypes.STABILIZER.ordinal()
        );
        array.setBlock(
            x - 1, y - 13, z + 2, crystalstone, StoneTypes.STABILIZER.ordinal()
        );

        array.setBlock(
            x - 2, y - 13, z - 2, crystalstone, StoneTypes.STABILIZER.ordinal()
        );
        array.setBlock(
            x - 1, y - 13, z - 3, crystalstone, StoneTypes.STABILIZER.ordinal()
        );

        array.setBlock(
            x + 3, y - 13, z + 1, crystalstone, StoneTypes.STABILIZER.ordinal()
        );
        array.setBlock(
            x + 2, y - 13, z + 2, crystalstone, StoneTypes.STABILIZER.ordinal()
        );
        ...
        array.setBlock(
            x + 3, y - 13, z - 2, crystalstone, StoneTypes.STABILIZER.ordinal()
        );
        array.setBlock(
            x + 2, y - 13, z - 3, crystalstone, StoneTypes.STABILIZER.ordinal()
        );
