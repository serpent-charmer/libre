...
public class DataTowerStructure extends GeneratedStructureBase {
    ...
    public FilledBlockArray getArray(World world, int x, int y, int z) {
        ...
        for (int i = -1; i <= 1; i++) {
            for (int k = -1; k <= 1; k++) {
                array.setBlock(
                    ...
                    z + k,
                    shield,
                    r.nextInt(3) == 0 ? BlockType.MOSS.metadata : BlockType.STONE.metadata
                );
            }
        }
        ...
        array.setBlock(
            ...
            y + 1,
            z,
            ChromaTiles.DATANODE.getBlock(),
            ChromaTiles.DATANODE.getBlockMetadata()
        );
        ...
        for (int i = 0; i < 4; i++) {
            ...
            array.setTile(
                ...
                y + 2 + i,
                z,
                ChromaBlocks.DUMMYAUX.getBlockInstance(),
                0,
                te,
                "loc",
                "flags"
