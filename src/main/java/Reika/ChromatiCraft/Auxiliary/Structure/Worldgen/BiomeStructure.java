...
public class BiomeStructure extends FragmentStructureWithBonusLoot {
    ...
    public BiomeStructure() {
        ...
        for (int i = 0; i < 32; i++) {
            ...
            int max = charge ? 6 : 24;
            this.addBonusItem(
                ChromaItems.SHARD.getStackOfMetadata(i), min, max, charge ? 2 : 6
            );
        }
    ...
    public FilledBlockArray getArray(World world, int x, int y, int z) {
        ...
        for (int j = 6; j <= 9; j++) {
            for (int d = -4; d <= 4; d++) {
                ...
                array.setBlock(
                    ...
                    z + 4,
                    b,
                    b == Blocks.stone_brick_stairs ? this.getStairMeta(d, j, 4) : m
                );
                array.setBlock(
                    x + d,
                    y + j,
                ...
                array.setBlock(
                    ...
                    z + d,
                    b,
                    b == Blocks.stone_brick_stairs ? this.getStairMeta(4, j, d) : m
                );
                array.setBlock(
                    x - 4,
                    y + j,
        ...
        for (int j = 5; j <= 8; j++) {
            for (int d = -6; d <= 6; d++) {
                ...
                array.setBlock(
                    ...
                    z + 7,
                    b,
                    b == Blocks.stone_brick_stairs ? this.getStairMeta(d, j, 7) : m
                );
                array.setBlock(
                    x + d,
                    y + j,
                ...
                array.setBlock(
                    ...
                    z + d,
                    b,
                    b == Blocks.stone_brick_stairs ? this.getStairMeta(7, j, d) : m
                );
                array.setBlock(
                    x - 7,
                    y + j,
        ...
        for (int i = -4; i <= 4; i++) {
            for (int k = -4; k <= 4; k++) {
                ...
                if (i == 0 && Math.abs(k) == 2)
                    ...
                    m = BlockType.COBBLE.metadata;
                array.setBlock(
                    x + i, y + 10, z + k, ChromaBlocks.STRUCTSHIELD.getBlockInstance(), m
                );
            }
        }
        for (int i = -1; i <= 1; i++) {
        ...
        for (int i = 2; i < 6; i++) {
            ...
            for (int a = 3; a <= 5; a++) {
                for (int b = 4; b <= 5; b++) {
                    array.setBlock(
                        x + dir.offsetX * b + left.offsetX * a,
                        y,
                        z + left.offsetZ * a + dir.offsetZ * b,
                        ChromaBlocks.STRUCTSHIELD.getBlockInstance(),
