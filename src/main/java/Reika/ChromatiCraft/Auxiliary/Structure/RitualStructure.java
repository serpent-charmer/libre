...
public class RitualStructure extends ChromaStructureBase {
    ...
    public FilledBlockArray getArray(World world, int x, int y, int z) {
        ...
        for (int i = -4; i <= 4; i++) {
            if (requireEnhance) {
                array.setBlock(
                    x - 4, y + 1, z + i, crystalstone, StoneTypes.GLOWBEAM.ordinal()
                );
                array.setBlock(
                    x + 4, y + 1, z + i, crystalstone, StoneTypes.GLOWBEAM.ordinal()
                );
                array.setBlock(
                    x + i, y + 1, z - 4, crystalstone, StoneTypes.GLOWBEAM.ordinal()
                );
                array.setBlock(
                    x + i, y + 1, z + 4, crystalstone, StoneTypes.GLOWBEAM.ordinal()
                );
        ...
        if (requireEnhance) {
            array.setBlock(
                x + 2, y + 2, z + 2, crystalstone, StoneTypes.GLOWCOL.ordinal()
            );
            array.setBlock(
                x - 2, y + 2, z + 2, crystalstone, StoneTypes.GLOWCOL.ordinal()
            );
        ...
        array.setBlock(
            ...
            y + 2,
            z,
            ChromaTiles.RITUAL.getBlock(),
            ChromaTiles.RITUAL.getBlockMetadata()
        );
