...
public class NetworkOptimizerStructureV2 extends ChromaStructureBase {
    ...
    public FilledBlockArray getArray(World world, int x, int y, int z) {
        ...
        array.setBlock(
            i + 1, j + 1, k + 3, crystalstone, StoneTypes.MULTICHROMIC.ordinal()
        );
        ...
        array.setBlock(
            i + 3, j + 1, k + 7, crystalstone, StoneTypes.MULTICHROMIC.ordinal()
        );
        ...
        array.setBlock(
            i + 4, j + 5, k + 4, crystalstone, StoneTypes.STABILIZER.ordinal()
        );
        ...
        array.setBlock(
            i + 5, j + 1, k + 1, crystalstone, StoneTypes.MULTICHROMIC.ordinal()
        );
        ...
        array.setBlock(
            i + 7, j + 1, k + 5, crystalstone, StoneTypes.MULTICHROMIC.ordinal()
        );
