...
public final class PylonDamage extends DamageSource {
    ...
    public final IChatComponent func_151519_b(EntityLivingBase e) {
        ...
        String sg = e.getCommandSenderName() + " died to pylon energy";
        if (color != null) {
            switch (color) {
                case BLACK:
                ...
                case BLUE:
                    ...
                    break;
                case PURPLE:
                    sg = "Apparently " + e.getCommandSenderName()
                        + " felt death was an improvement";
                    break;
                case CYAN:
                    sg = e.getCommandSenderName() + " drowned in energy";
                    break;
                case LIGHTGRAY:
                    sg = "A Crystal Pylon tricked " + e.getCommandSenderName()
                        + " into dying";
                    break;
                case GRAY:
                    sg = e.getCommandSenderName()
                        + " experienced change...in the form of death";
                    break;
                case PINK:
                    sg = e.getCommandSenderName()
                        + " got in a fight with a Crystal Pylon and lost";
                    break;
                case LIME:
                ...
                case LIGHTBLUE:
                    sg = e.getCommandSenderName()
                        + " accelerated everything, including dying";
                    break;
                case MAGENTA:
