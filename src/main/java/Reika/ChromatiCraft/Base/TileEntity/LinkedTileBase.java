...
public abstract class LinkedTileBase
    extends TileEntityChromaticBase implements SneakPop, LinkedTile {
    ...
    public final boolean linkTo(WorldLocation loc) {
        return !loc.equals(worldObj, xCoord, yCoord, zCoord)
            && this.linkTo(loc.getWorld(), loc.xCoord, loc.yCoord, loc.zCoord);
    }
