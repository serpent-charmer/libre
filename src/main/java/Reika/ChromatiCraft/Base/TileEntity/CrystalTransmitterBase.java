...
public abstract class CrystalTransmitterBase
    extends TileEntityCrystalBase implements CrystalTransmitter {
    ...
    private void spawnParticle(World world, int x, int y, int z) {
        ...
        for (int i = 0; i < 360; i += 90) {
            ...
            Minecraft.getMinecraft().effectRenderer.addEffect(new EntityFlareFX(color,
    world, loc, target, rx, ry, rz));
        }
    }*/
