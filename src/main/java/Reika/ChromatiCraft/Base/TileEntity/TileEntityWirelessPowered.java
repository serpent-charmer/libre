...
public abstract class TileEntityWirelessPowered
    ...
    protected final boolean requestEnergy(CrystalElement e, int amt) {
        ...
        if (TileEntityAuraPoint.hasAuraPoints(placerUUID))
            r *= 1.5;
        Collection<WirelessSource> c = CrystalNetworker.instance.getNearTilesOfType(
            worldObj, xCoord, yCoord, zCoord, WirelessSource.class, r
        );
            ...
            if (s.canConduct() && s.canTransmitTo(this)) {
                ...
                if (ret > 0) {
                    ...
                    ReikaPacketHelper.sendDataPacketWithRadius(
                        ...
                        ChromaPackets.WIRELESS.ordinal(),
                        this,
                        64,
                        s.getX(),
                        s.getY(),
    ...
    public final void doEnergyRequestClient(
        World world,
        int x,
        int y,
        int z,
