...
public abstract class RenderLocusPoint extends ChromaRenderBase {
    private final RemoteSourcedAsset texture
        = ChromaClient.dynamicAssets.createAsset("Textures/aurapoint2-grid.png");
    ...
    private void renderCore(
        ...
        for (int i = 0; i < 3; i++) {
            ...
            int tick = (int
            ) ((System.currentTimeMillis() / 250) % 80
            ); //(tile.getTicksExisted()*(i*3+1))%80;//+par8;
        ...
        GL11.glTranslated(-d, -d, -d);
            ...
            int color = ReikaColorAPI.getColorWithBrightnessMultiplier(
                tile.getRenderColor(), alpha / 255F
            );
        ...
        /*
        ReikaTextureHelper.bindTexture(ChromatiCraft.class, "Textures/Dimension Bump
        Maps/gray.png");
    ...
    private void renderStaticTexture(double par2, double par4, double par6, float ptick) {
        ...
        //v5.setColorRGBA_F(e.getRed()*f7/255F, e.getGreen()*f7/255F, e.getBlue()*f7/255F,
        //1);
