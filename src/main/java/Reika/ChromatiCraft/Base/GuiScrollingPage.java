...
public abstract class GuiScrollingPage extends ChromaBookGui {
    ...
    protected GuiScrollingPage(
        ChromaGuis g, EntityPlayer ep, int x, int y, int w, int h
    ) {
        super(g, ep, x, y);
        paneWidth = w;
        paneHeight = h;
    ...
    public static void resetOffset() {
        if (ChromaBookGui.lastGui == null) {
            ...
            //goTo(ChromaBookGui.saveLocation.gui, ChromaBookGui.saveLocation.page,
            //Minecraft.getMinecraft().thePlayer);
        }
    }

    public static void
    saveLocation(/*ChromaGuis g, ChromaResearch r, int s*/ GuiBookSection gui) {
