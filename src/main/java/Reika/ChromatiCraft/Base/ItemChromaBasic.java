...
public abstract class ItemChromaBasic extends Item implements MultisheetItem {
    ...
    public final String getItemStackDisplayName(ItemStack is) {
        ...
        if (Thread.currentThread()
                ...
                .contains("client"
                )) { //not effective side, since CC calls from own thread that tricks FML
    ...
    private boolean obfuscate(ItemStack is) {
        ...
        if (this instanceof TieredItem) {
            ...
            Collection<ChromaResearch> rs
                = ((ResearchDependentName) this).getRequiredResearch(is);
            if (rs != null) {
        ...
        if (this instanceof ItemCrystalBasic || this instanceof ItemColoredModInteract) {
            ...
            if (!ProgressionManager.instance.hasPlayerDiscoveredColor(
