...
public abstract class RenderDistributorBase extends ChromaRenderBase {
    ...
    protected final void renderHalo(
        TileEntityChromaticBase te, double par2, double par4, double par6, float ptick
    ) {
        ...
        if (s > 0) {
            ...
            for (int i = 0; i < 6; i++) {
                out[i] = a
                    + a
                        * Math.sin(
                            Math.toRadians((te.getTicksExisted() + ptick) * s + i * 60D)
                        );
            }

            v5.addVertexWithUV(
                0 - out[ForgeDirection.WEST.ordinal()],
                1 + out[ForgeDirection.UP.ordinal()],
                0 - out[ForgeDirection.NORTH.ordinal()],
                u,
                dv
            );
            v5.addVertexWithUV(
                1 + out[ForgeDirection.EAST.ordinal()],
                1 + out[ForgeDirection.UP.ordinal()],
                0 - out[ForgeDirection.NORTH.ordinal()],
                du,
                dv
            ...
            v5.addVertexWithUV(
                1 + out[ForgeDirection.EAST.ordinal()],
                0 - out[ForgeDirection.DOWN.ordinal()],
                0 - out[ForgeDirection.NORTH.ordinal()],
                du,
                v
            );
            ...
            v5.addVertexWithUV(
                0 - out[ForgeDirection.WEST.ordinal()],
                1 + out[ForgeDirection.UP.ordinal()],
                1 + out[ForgeDirection.SOUTH.ordinal()],
                u,
                dv
            );
            v5.addVertexWithUV(
