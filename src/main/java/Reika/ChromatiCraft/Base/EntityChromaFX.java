...
public abstract class EntityChromaFX extends EntityFX {
    ...
    public EntityChromaFX(World world, double x, double y, double z, double vx, double vy,
    double vz) { this(CrystalElement.WHITE, world, x, y, z, vx, vy, vz);
    }*/

    public EntityChromaFX(
        CrystalElement e,
        World world,
        double x,
        double y,
