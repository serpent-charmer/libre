...
public abstract class CrystalTypeBlock extends Block {
    ...
    public static void
    ding(World world, int x, int y, int z, CrystalElement e, float pitch) {
        ChromaSounds.DING.playSoundAtBlock(
            world, x, y, z, (float) ReikaRandomHelper.getRandomPlusMinus(1, 0.2), pitch
        );
    }
    ...
    private static float getRandomPitch(CrystalElement e
    ) { //Generates a major or minor chord
