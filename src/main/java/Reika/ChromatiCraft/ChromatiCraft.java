...
@Mod(
    ...
    dependencies = "required-after:DragonAPI;before:climatecontrol"
)

public class ChromatiCraft extends DragonAPIMod {
    public static final String packetChannel = "ChromaData";

    public static final TabChromatiCraft tabChroma
        = new TabChromatiCraft("ChromatiCraft");
    public static final TabChromatiCraft tabChromaDeco
        = new TabChromatiCraft("ChromatiCraft Deco");
    public static final TabChromatiCraft tabChromaGen
        = new TabChromatiCraft("ChromatiCraft Worldgen");
    public static final TabChromatiCraft tabChromaTools
        = new TabChromatiCraft("ChromatiCraft Tools");
    public static final TabChromatiCraft tabChromaItems
        = new TabChromatiCraft("ChromatiCraft Items");
    public static final FragmentTab tabChromaFragments
        = new FragmentTab("CC Info Fragments");

    public static final ArmorMaterial FLOATSTONE = EnumHelper.addArmorMaterial(
        "Floatstone",
        65536,
        new int[] { 0, 0, 0, 0 },
        ArmorMaterial.GOLD.getEnchantability() * 3 / 2
    );
    ...
    public static final EnhancedFluid chroma = (EnhancedFluid) new EnhancedFluid("chroma")
                                                   .setColor(0x00aaff)
                                                   .setViscosity(300)
                                                   .setTemperature(288)
                                                   .setDensity(300)
                                                   .setLuminosity(15);
    //public static final EnhancedFluid activechroma = (EnhancedFluid)new
    //EnhancedFluid("activechroma").setColor(0x00aaff).setViscosity(300).setTemperature(500).setDensity(300);
    public static EnhancedFluid crystal
        = (EnhancedFluid) new EnhancedFluid("potion crystal")
              .setColor(0x66aaff)
              .setLuminosity(15)
              .setTemperature(500)
              .setUnlocalizedName("potioncrystal")
              .setViscosity(1500);
    public static final Fluid ender = new Fluid("ender")
                                          .setViscosity(2000)
                                          .setDensity(1500)
                                          .setTemperature(270)
                                          .setUnlocalizedName("endere")
                                          .setLuminosity(4);
    public static final Fluid luma
        = new Fluid("luma").setViscosity(50).setDensity(1).setTemperature(250);
    public static final Fluid lumen = new Fluid("lumen")
                                          .setViscosity(500)
                                          .setDensity(300)
                                          .setTemperature(300)
                                          .setLuminosity(15);
    //public static final Fluid lifewater = new
    //Fluid("lifewater").setViscosity(400).setDensity(700).setTemperature(300);
    ...
    public static final Enchantment[] enchants
        = new Enchantment[ChromaEnchants.enchantmentList.length];
    ...
    public static EnumCreatureType glowCloudType = EnumHelper.addCreatureType(
        "glowcloud", EntityGlowCloud.class, 24, Material.air, true, false
    );

    @Instance("ChromatiCraft")
    public static ChromatiCraft instance = new ChromatiCraft();

    public static final ChromaConfig config
        = new ChromaConfig(instance, ChromaOptions.optionList, ExtraChromaIDs.idList);
    ...
    @SidedProxy(
        clientSide = "Reika.ChromatiCraft.ChromaClient",
        serverSide = "Reika.ChromatiCraft.ChromaCommon"
    )
    ...
    public void preload(FMLPreInitializationEvent evt) {
        ...
        if (FMLCommonHandler.instance().getEffectiveSide() == Side.CLIENT) {
            ...
            FMLCommonHandler.instance().bus().register(
                ChromaClientEventController.instance
            );
        ...
        IDCollisionTracker.instance
            .addPotionID(instance, id, PotionBetterSaturation.class);
        ...
        IDCollisionTracker.instance.addBiomeID(
            instance, ExtraChromaIDs.RAINBOWFOREST.getValue(), BiomeRainbowForest.class
        );
        IDCollisionTracker.instance.addBiomeID(
            instance, ExtraChromaIDs.ENDERFOREST.getValue(), BiomeEnderForest.class
        );
        IDCollisionTracker.instance.addBiomeID(
            instance, ExtraChromaIDs.LUMINOUSCLIFFS.getValue(), BiomeGlowingCliffs.class
        );

        //ChromaResearch.loadCache();

        ReikaPacketHelper.registerPacketHandler(
            instance, packetChannel, new ChromatiPackets()
        );

        proxy.registerKeys();

        tabChroma.setIcon(ChromaItems.RIFT.getStackOf());
        tabChromaDeco.setIcon(
            ChromaBlocks.COLORALTAR.getStackOfMetadata(CrystalElement.BLUE.ordinal())
        );
        ...
        CreativeTabSorter.instance.registerCreativeTabAfter(
            tabChromaFragments, tabChroma
        );
        ...
        //CompatibilityTracker.instance.registerIncompatibility(ModList.CHROMATICRAFT,
        //ModList.OPTIFINE, CompatibilityTracker.Severity.GLITCH, "Optifine is known to
        //break some rendering and cause framerate drops.");
        ...
        FMLInterModComms.sendMessage(
            "zzzzzcustomconfigs",
            "blacklist-mod-as-output",
            this.getModContainer().getModId()
        );
        ...
        RayTracer.addVisuallyTransparentBlock(
            ChromaBlocks.SELECTIVEGLASS.getBlockInstance()
        );
        ...
        RayTracer.addVisuallyTransparentBlock(
            ChromaBlocks.STRUCTSHIELD.getBlockInstance(), BlockType.GLASS.ordinal()
        );
        RayTracer.addVisuallyTransparentBlock(
            ChromaBlocks.STRUCTSHIELD.getBlockInstance(), BlockType.GLASS.metadata
        );
        RayTracer.addVisuallyTransparentBlock(
            ChromaBlocks.SPECIALSHIELD.getBlockInstance(), BlockType.GLASS.ordinal()
        );
        RayTracer.addVisuallyTransparentBlock(
            ChromaBlocks.SPECIALSHIELD.getBlockInstance(), BlockType.GLASS.metadata
        );
    ...
    public void load(FMLInitializationEvent event) {
        ...
        if (this.isLocked()) {
            ...
            ReikaJavaLibrary.pConsole(
                "\tBecause this is frequently done to sell access to mod content, which is against the Terms of Use"
            );
            ReikaJavaLibrary.pConsole(
                "\tof both Mojang and the mod, the mod has been functionally disabled. No damage will occur to worlds,"
            );
            ReikaJavaLibrary.pConsole(
                "\tand all machines (including contents) and items already placed or in inventories will remain so,"
            );
            ReikaJavaLibrary.pConsole(
                "\tbut its machines will not function, recipes will not load, and no renders or textures will be present."
            );
            ReikaJavaLibrary.pConsole(
                "\tAll other mods in your installation will remain fully functional."
            );
            ReikaJavaLibrary.pConsole(
                "\tTo regain functionality, unban the ChromatiCraft content, and then reload the game. All functionality"
            );
            ReikaJavaLibrary.pConsole(
                "\twill be restored. You may contact Reika for further information on his forum thread."
            );
            ReikaJavaLibrary.pConsole(
                "\t====================================================================================================="
            );
        ...
        BiomeManager.addBiome(
            BiomeType.WARM,
            new BiomeEntry(rainbowforest, ChromaOptions.getRainbowForestWeight())
        );
        BiomeManager.addBiome(
            BiomeType.COOL,
            new BiomeEntry(rainbowforest, ChromaOptions.getRainbowForestWeight())
        ...
        BiomeManager.addBiome(
            BiomeType.COOL,
            new BiomeEntry(enderforest, ChromaOptions.getEnderForestWeight())
        );
        BiomeManager.addBiome(
            BiomeType.WARM,
            new BiomeEntry(enderforest, ChromaOptions.getEnderForestWeight())
        ...
        BiomeDictionary.registerBiomeType(
            enderforest, BiomeDictionary.Type.FOREST, BiomeDictionary.Type.MAGICAL
        );

        glowingcliffs
            = new BiomeGlowingCliffs(ExtraChromaIDs.LUMINOUSCLIFFS.getValue(), true);
        //BiomeManager.addBiome(BiomeType.COOL, new BiomeEntry(glowingcliffs,
        //ChromaOptions.getGlowingCliffsWeight())); BiomeManager.addBiome(BiomeType.WARM,
        //new BiomeEntry(glowingcliffs, ChromaOptions.getGlowingCliffsWeight()));
        ...
        //replace 1/8 of jungle and 1/8 of Mega Taiga, for a total of 4/(16-2) = 28% net
        //spawn rate of either Jungle or MT revised to 1/16th of each for 2/15 = 13% spawn
        //rate
        SpecialBiomePlacementRegistry.instance.registerID(
            this, Category.WARM, 2, glowingcliffs.biomeID
        );
        //SpecialBiomePlacementRegistry.instance.registerID(this, Category.WARM, 3,
        //glowingcliffs.biomeID);
        SpecialBiomePlacementRegistry.instance.registerID(
            this, Category.COOL, 2, glowingcliffs.biomeID
        );
        //SpecialBiomePlacementRegistry.instance.registerID(this, Category.COOL, 3,
        //glowingcliffs.biomeID);
        BiomeDictionary.registerBiomeType(
            glowingcliffs,
        ...
        RetroGenController.instance.addHybridGenerator(
            PylonGenerator.instance, Integer.MIN_VALUE
        );
        RetroGenController.instance.addHybridGenerator(
            DungeonGenerator.instance, Integer.MAX_VALUE
        );
        RetroGenController.instance.addHybridGenerator(
            DataTowerGenerator.instance, Integer.MAX_VALUE
        );
        RetroGenController.instance.addHybridGenerator(
            DataTowerGenerator.instance, Integer.MIN_VALUE
        );
        RetroGenController.instance.addHybridGenerator(
            NetherStructureGenerator.instance, Integer.MAX_VALUE
        );
        RetroGenController.instance.addHybridGenerator(
            EndOverhaulManager.instance, Integer.MIN_VALUE
        );
        RetroGenController.instance.addHybridGenerator(
            GlowingCliffsAuxGenerator.instance, Integer.MIN_VALUE
        );
        RetroGenController.instance.addHybridGenerator(
            SkypeaterGenerator.instance, Integer.MAX_VALUE
        );
        //RetroGenController.instance.addHybridGenerator(UnknownArtefactGenerator.instance,
        //Integer.MIN_VALUE);
        RetroGenController.instance.addHybridGenerator(
            WarpNodeGenerator.instance, Integer.MAX_VALUE
        );
        ...
        //ReikaEntityHelper.overrideEntity(EntityChromaEnderCrystal.class, "EnderCrystal",
        //0);
        ...
        if (!this.isLocked())
            IntegrityChecker.instance.addMod(
                instance, ChromaBlocks.blockList, ChromaItems.itemList
            );
        ...
        if (!this.isLocked()) {
            ...
            if (ModList.VOIDMONSTER.isLoaded()
                ...
                TickRegistry.instance.registerTickHandler(
                    VoidMonsterRitualClientEffects.instance
                );
        }
        ...
        for (int i = 0; i < 16; i++) {
            ...
            ItemStack used = ChromaOptions.isVanillaDyeMoreCommon(i)
                ? dye.getStackOf()
                : ChromaItems.DYE.getStackOfMetadata(i);
            ItemStack sapling
                = new ItemStack(ChromaBlocks.DYESAPLING.getBlockInstance(), 1, i);
            ItemStack flower
                = new ItemStack(ChromaBlocks.DYEFLOWER.getBlockInstance(), 1, i);
            ...
            if (!ReikaItemHelper.matchStacks(used, ReikaItemHelper.lapisDye))
                GameRegistry.addRecipe(
                    new ItemStack(ChromaBlocks.DYE.getBlockInstance(), 1, i),
                    "ddd",
                    "ddd",
                    "ddd",
                    'd',
            ...
            OreDictionary.registerOre(
                dye.getOreDictName(), ChromaItems.DYE.getStackOfMetadata(i)
            );
        ...
        FurnaceFuelRegistry.instance.registerItemSimple(
            ChromaStacks.thermiticCrystal, 32
        );
        ...
        if (ModList.BLUEPOWER.isLoaded(
            )) { //prevent what is nearly an exploit by uncrafting gold apples
        ...
        SuggestedModsTracker.instance.addSuggestedMod(
            instance,
            ModList.FORESTRY,
            "Access to crystal bees which have valuable genetics"
        );
        SuggestedModsTracker.instance.addSuggestedMod(
            instance,
            ModList.TWILIGHT,
            "Dense crystal generation and other worldgen hooks"
        );
        SuggestedModsTracker.instance.addSuggestedMod(
            instance,
            ModList.THAUMCRAFT,
            "High crystal aspect values and extensive mod interaction"
        );

        FMLInterModComms.sendMessage(
            "aura", "lootblacklist", ChromaItems.FRAGMENT.getStackOf()
        );
        FMLInterModComms.sendMessage(
            "aura", "lootblacklist", ChromaItems.SHARD.getStackOf()
        );

        FMLInterModComms.sendMessage(
            ModList.ARSMAGICA.modLabel,
            "dsb",
            "EntityDryad|" + ExtraChromaIDs.DIMID.getValue()
        );
        FMLInterModComms.sendMessage(
            ModList.ARSMAGICA.modLabel,
            "dwg",
            String.valueOf(ExtraChromaIDs.DIMID.getValue())
        );

        FMLInterModComms.sendMessage(
            "Randomod", "blacklist", this.getModContainer().getModId()
        );
        ...
        if (ModList.THAUMCRAFT.isLoaded()) {
            ...
            ); //init to register the two aspects
        }

        for (int i = 0; i < ChromaItems.itemList.length; i++) {
            ChromaItems ir = ChromaItems.itemList[i];
            if (!ir.isDummiedOut() && ir != ChromaItems.TOOL) {
                SensitiveItemRegistry.instance.registerItem(
                    this, ir.getItemInstance(), false
                );
            }
        }
        ...
        for (int i = 0; i < ChromaBlocks.blockList.length; i++) {
            ...
            SensitiveItemRegistry.instance.registerItem(
                this, ir.getBlockInstance(), false
            );
        }

        if (MTInteractionManager.isMTLoaded()) {
            MTInteractionManager.instance.blacklistRecipeRemovalFor(
                ChromaTiles.TABLE.getCraftedProduct()
            );

            MTInteractionManager.instance.blacklistOreDictTagsFor(
                ChromaItems.SHARD.getItemInstance()
            );
            MTInteractionManager.instance.blacklistOreDictTagsFor(
                ChromaItems.TIERED.getItemInstance()
            );
            MTInteractionManager.instance.blacklistOreDictTagsFor(
        ...
        if (ModList.APPENG.isLoaded()) {
            MESystemReader.registerMESystemEffect(
                UABombingEffects.instance.createMESystemEffect()
            );
        }
    ...
    public void postload(FMLPostInitializationEvent evt) {
            ...
            if (a.isImplemented()) {
                try {
                    ...
                    throw new RegistrationException(
                        instance, "Could not initialize adjacency handlers for " + a, e
                    );
                }
            }
        }
        ...
        ReikaDispenserHelper.addDispenserAction(
            ChromaItems.TOOL, new ManipulatorDispenserAction()
        );
        ReikaDispenserHelper.addDispenserAction(
            ChromaItems.BUCKET, new BucketDispenserAction()
        );
        ...
        if (ModList.BLOODMAGIC.isLoaded()
            && BloodMagicHandler.getInstance().soulFrayID != -1) {
            CrystalPotionController.instance.addBadPotionForIgnore(
                Potion.potionTypes[BloodMagicHandler.getInstance().soulFrayID]
            );
        }
        ...
        if (ModList.VOIDMONSTER.isLoaded()) {
            ...
            DimensionAPI.setDimensionRuleForSpawning(
                ExtraChromaIDs.DIMID.getValue(), false
            );
        ...
        if (ModList.TINKERER.isLoaded()
            && (Pulses.TOOLS.isLoaded() || Pulses.WEAPONS.isLoaded())) {
    ...
    public static boolean isRainbowForest(BiomeGenBase b) {
        return b instanceof BiomeRainbowForest
            || (ModList.MYSTCRAFT.isLoaded()
                && ReikaMystcraftHelper.getMystParentBiome(b)
                        instanceof BiomeRainbowForest);
    }

    public static boolean isEnderForest(BiomeGenBase b) {
        return b instanceof BiomeEnderForest
            || (ModList.MYSTCRAFT.isLoaded()
                && ReikaMystcraftHelper.getMystParentBiome(b) instanceof BiomeEnderForest
            );
    }

    public static boolean isCCBiome(BiomeGenBase b) {
        return isRainbowForest(b) || isEnderForest(b)
            || BiomeGlowingCliffs.isGlowingCliffs(b);
    }
    ...
    public void registerCommands(FMLServerStartingEvent evt) {
        ...
        if (MinecraftServer.getServer() != null
            && !MinecraftServer.getServer().isServerInOnlineMode()) {
            isOfflineMode = true;
            PopupWriter.instance.addMessage(
                "ChromatiCraft does not properly work in offline mode! Ownership data is not properly read/saved and some things will not work!"
            );
        } else {
            isOfflineMode = false;
        }
    ...
    private void setupClassFiles() {
        ...
        ReikaRegistryHelper.instantiateAndRegisterBlocks(
            instance, ChromaBlocks.blockList, blocks
        );
        ReikaRegistryHelper.instantiateAndRegisterItems(
            instance, ChromaItems.itemList, items
        );
        ReikaRegistryHelper.instantiateAndRegisterEnchantments(
            instance, ChromaEnchants.enchantmentList, enchants
        );
        ...
        //Items.itemsList[b.blockID] = new
        //ItemNBTSpawner(b.blockID).setUnlocalizedName(Items.itemsList[b.blockID].getUnlocalizedName());
    }
    ...
    private static void setupLiquidContainers() {
        ...
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(chroma, FluidContainerRegistry.BUCKET_VOLUME),
            ChromaItems.BUCKET.getStackOf(),
            new ItemStack(Items.bucket)
        );
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(luma, FluidContainerRegistry.BUCKET_VOLUME),
            ChromaItems.BUCKET.getStackOfMetadata(3),
            new ItemStack(Items.bucket)
        );
        if (!ModList.THERMALFOUNDATION.isLoaded())
            FluidContainerRegistry.registerFluidContainer(
                new FluidStack(ender, FluidContainerRegistry.BUCKET_VOLUME),
                ChromaItems.BUCKET.getStackOfMetadata(1),
                new ItemStack(Items.bucket)
            );
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(crystal, FluidContainerRegistry.BUCKET_VOLUME),
            ChromaItems.BUCKET.getStackOfMetadata(2),
            new ItemStack(Items.bucket)
        );
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(lumen, FluidContainerRegistry.BUCKET_VOLUME),
            ChromaItems.BUCKET.getStackOfMetadata(4),
            new ItemStack(Items.bucket)
        );
        //FluidContainerRegistry.registerFluidContainer(new FluidStack(lifewater,
        //FluidContainerRegistry.BUCKET_VOLUME), ChromaItems.BUCKET.getStackOfMetadata(5),
        //new ItemStack(Items.bucket));
    }
    ...
    public void setupExtraIcons(TextureStitchEvent.Pre event) {
        if (!this.isLocked()) {
            ...
            if (event.map.getTextureType() == 0) {
                ...
                IIcon ficon
                    = event.map.registerIcon("ChromatiCraft:fluid/chroma_flowing");
                ...
                luma.setIcons(
                    ico.registerIcon("ChromatiCraft:fluid/aether/aether_full"),
                    ico.registerIcon("ChromatiCraft:fluid/aether/aether_flow2")
                );
                //aether.setFlowingIcon(ico.registerIcon("ChromatiCraft:fluid/flowingender"));

                //lifewater.setIcons(ico.registerIcon("ChromatiCraft:fluid/lifewater_still_trans"),
                //ico.registerIcon("ChromatiCraft:fluid/lifewater_flow_trans"));
    ...
    public static Block getEnderBlockToGenerate() {
        if (ModList.THERMALFOUNDATION.isLoaded()
            && ThermalHandler.getInstance().enderID != null) {
            ...
            if (cs != null) {
                for (int k = 0; k < cs.length; k++) {
                    ...
                    if (TileEntity.class.isAssignableFrom(in)
                        && (in.getModifiers() & Modifier.ABSTRACT) == 0) {
