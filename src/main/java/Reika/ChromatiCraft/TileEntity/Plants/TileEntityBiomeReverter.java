...
public class TileEntityBiomeReverter
    extends TileEntityMagicPlant implements ComplexAOE /* implements LocationCached*/ {
    private StepTimer timer = new StepTimer(40);

    private static double[][] randomDistrib = {
        { 0, 0, 0, 1, 2, 1, 0, 0, 0 },    { 0, 0, 1, 2, 5, 2, 1, 0, 0 },
        { 0, 1, 3, 5, 7, 5, 3, 1, 0 },    { 1, 2, 5, 8, 10, 8, 5, 2, 1 },
        { 2, 5, 7, 10, 10, 10, 7, 5, 2 }, { 1, 2, 5, 8, 10, 8, 5, 2, 1 },
        { 0, 1, 3, 5, 7, 5, 3, 1, 0 },    { 0, 0, 1, 2, 5, 2, 1, 0, 0 },
        { 0, 0, 0, 1, 2, 1, 0, 0, 0 },
    };
    ...
    private void revertBiome(World world, int x, int y, int z, boolean large) {
        ...
        BiomeGenBase nat
            = ReikaWorldHelper.getNaturalGennedBiomeAt(world, c.xCoord, c.zCoord);
        if (b != nat && nat != null) {
