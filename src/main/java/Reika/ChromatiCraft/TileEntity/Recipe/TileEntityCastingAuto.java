...
public class TileEntityCastingAuto extends CrystalReceiverBase
    ...
    public TileEntityCastingInjector getInjector(TileEntityCastingTable te) {
        ...
        return te2 instanceof TileEntityCastingInjector ? (TileEntityCastingInjector) te2
                                                        : null;
    }
    ...
    private void
    doConnectionParticles(World world, int x, int y, int z, TileEntityCastingTable te) {
