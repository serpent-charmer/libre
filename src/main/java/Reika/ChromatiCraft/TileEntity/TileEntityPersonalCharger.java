...
public class TileEntityPersonalCharger extends CrystalReceiverBase
    implements ChargingPoint, OwnedTile, ColoredMultiBlockChromaTile {
    ...
    private void doParticles(World world, int x, int y, int z) {
        ...
        float s = 2F;
        EntityFX fx = new EntityCCBlurFX(color, world, px, py, pz, 0, 0, 0)
                          .setScale(s)
                          .setLife(100)
                          .setGravity(g);
        Minecraft.getMinecraft().effectRenderer.addEffect(fx);

        fx = new EntityCCBlurFX(world, px, py, pz, 0, 0, 0)
                 .setScale(s * 0.5F)
                 .setLife(100)
                 .setGravity(g)
                 .setColor(0xffffff);
        ...
        fx = new EntityRuneFX(world, px, py, pz, color)
                 .setScale(2)
                 .setGravity(-0.0625F)
                 .setLife(l);
        Minecraft.getMinecraft().effectRenderer.addEffect(fx);
    ...
    public void validateStructure() {
        ...
        if (m1 == m2 && m1 == m3 && m1 == m4) {
            ...
            FilledBlockArray arr
                = ChromaStructures.PERSONAL.getArray(world, x, y - 6, z, e);
