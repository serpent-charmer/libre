...
public class TileEntityAtmosphericRelay extends CrystalTransmitterBase
    implements CrystalRepeater, SneakPop, OwnedTile, PylonConnector {
    private int depth;
    ...
    public boolean canReceiveFrom(CrystalTransmitter r) {
        return r instanceof TileEntityCrystalPylon
            && ((TileEntityCrystalPylon) r).hasBroadcastUpgrade();
    }
