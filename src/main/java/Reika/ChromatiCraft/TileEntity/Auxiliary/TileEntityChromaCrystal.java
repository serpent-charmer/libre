...
public class TileEntityChromaCrystal extends TileEntityPylonEnhancer {
    ...
    public void updateEntity(World world, int x, int y, int z, int meta) {
        if (world.isRemote && pylonLocation != null)
            ProgressionCatchupHandling.instance.attemptSync(
                this, 9, ProgressStage.POWERCRYSTAL
            );
    ...
    private Coordinate findPylonLocation(World world, int x, int y, int z) {
        ...
        Collection<TileEntityCrystalPylon> c
            = CrystalNetworker.instance.getNearbyPylons(world, x, y, z, e, 8, false);
    ...
    public void destroy() {
        ...
        ReikaPacketHelper.sendDataPacketWithRadius(
            ...
            ChromaPackets.POWERCRYSDESTROY.ordinal(),
            this,
            32
        );
        this.delete();
    ...
    public static void doDestroyParticles(World world, int x, int y, int z) {
        for (int i = 0; i < 24; i++) {
            ...
            EntityFX fx = new EntityChromaFluidFX(world, px, py, pz, vx, vy, vz)
                              .setLife(80)
                              .setGravity(0.25F)
        ...
        for (int i = 0; i < 16; i++) {
            ...
            ) new EntityCCFloatingSeedsFX(world, px, py, pz, 0, 90, ChromaIcons.CHROMA)
                                           .setLife(80);
    ...
    public void breakBlock() {
        if (pylonLocation != null) {
            TileEntityCrystalPylon te
                = (TileEntityCrystalPylon) pylonLocation.getTileEntity(worldObj);
