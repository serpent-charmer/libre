...
public class TileEntityStructControl
    extends InventoriedChromaticBase implements BreakAction, HitAction, InertIInv,
                                                PlayerBreakHook, PlacementExclusionHook {
    private ChromaStructures struct;
    private FilledBlockArray blocks;
    private CrystalElement color;
    private final EnumMap<CrystalElement, Coordinate> crystals
    ...
    public void updateEntity(World world, int x, int y, int z, int meta) {
        if (world.isRemote && struct != null
            && world.getClosestPlayer(x + 0.5, y + 0.5, z + 0.5, 12) != null)
        ...
        if (isMonument && DragonAPICore.debugtest) {
            for (int i = 0; i < 16; i++) {
                Coordinate c
                    = TileEntityDimensionCore.getLocation(CrystalElement.elements[i]);
                c = c.offset(x, y, z);
                c.setBlock(
                    world,
                    ChromaTiles.DIMENSIONCORE.getBlock(),
                    ChromaTiles.DIMENSIONCORE.getBlockMetadata()
                );
                ((TileEntityDimensionCore) c.getTileEntity(world))
                    .setPlacer(world.getClosestPlayer(x, y, z, -1));
                ((TileEntityDimensionCore) c.getTileEntity(world)).prime(true);
                ((TileEntityDimensionCore) c.getTileEntity(world))
                    .setColor(CrystalElement.elements[i]);
            }
        ...
        if (!triggered && struct != null && this.getTicksExisted() % 4 == 0) {
            ...
            for (EntityPlayer ep : li) {
                ...
                if (!world.isRemote
                    && ep.getDistanceSq(x + 0.5, y + 0.5, z + 0.5) <= 64 * 64
                    && ChromaItems.STRUCTUREFINDER.matchWith(ep.getCurrentEquippedItem()
                    )) {
        ...
        if (struct != null) {
            switch (struct) {
                ...
                case BURROW:
                    break;
                case OCEAN:
                    if ((y == yCoord || y == yCoord - 1) && Math.abs(x - xCoord) <= 3
                        && Math.abs(z - zCoord) <= 3)
        ...
        switch (struct) {
            ...
            case BURROW:
                world.setBlockMetadataWithNotify(
                    x + 2, y + 1, z, BlockStructureShield.BlockType.CRACK.metadata, 3
                );
            ...
            case OCEAN:
                ...
                for (int i = 0; i < blocks.getSize(); i++) {
                    ...
                    int dz = c.zCoord;
                    world.setBlockMetadataWithNotify(
                        dx, dy, dz, BlockType.CRACKS.metadata, 3
                    );
                }
                int r = 1;
                for (int i = -r; i <= r; i++) {
                    for (int k = -r; k <= r; k++) {
                        ReikaSoundHelper.playBreakSound(
                            world, x + i, y + 1, z + k, Blocks.stone
                        );
                        if (world.isRemote) {
                            ReikaRenderHelper.spawnDropParticles(
                                world,
            ...
            case DESERT:
                ...
                world.setBlockMetadataWithNotify(
                    x + 12, y + 5, z + 6, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 12, y + 5, z + 7, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 12, y + 5, z + 8, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 12, y + 6, z + 7, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 11, y + 5, z + 6, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 11, y + 5, z + 7, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 11, y + 5, z + 8, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 8, y + 5, z + 11, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 8, y + 5, z + 12, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 8, y + 5, z + 2, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 8, y + 5, z + 3, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 7, y + 5, z + 11, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 7, y + 5, z + 12, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 2, y + 5, z + 6, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 2, y + 5, z + 7, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 2, y + 5, z + 8, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 2, y + 6, z + 7, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 3, y + 5, z + 6, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 3, y + 5, z + 7, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 3, y + 5, z + 8, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 3, y + 6, z + 7, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 6, y + 5, z + 2, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 6, y + 5, z + 3, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 6, y + 5, z + 11, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 6, y + 5, z + 12, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 7, y + 5, z + 2, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 7, y + 5, z + 3, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 7, y + 6, z + 2, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 7, y + 6, z + 3, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 7, y + 6, z + 11, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 7, y + 6, z + 12, BlockType.CRACK.metadata, 3
                );
                world.setBlockMetadataWithNotify(
                    x + 11, y + 6, z + 7, BlockType.CRACK.metadata, 3
                );
                break;
            case SNOWSTRUCT:
                for (Coordinate c : SnowStructure.getCrackToCenter()) {
                    ...
                    int dz = z + c.zCoord - 6;
                    world.setBlockMetadataWithNotify(
                        dx, dy, dz, BlockStructureShield.BlockType.CRACKS.metadata, 3
                    );
                ...
                for (Coordinate c : SnowStructure.getRoofCracks(rand2)) {
                    ...
                    int dz = z + c.zCoord - 6;
                    world.setBlockMetadataWithNotify(
                        dx, dy, dz, BlockStructureShield.BlockType.CRACK.metadata, 3
                    );
                    ReikaSoundHelper.playBreakSound(world, dx, dy, dz, Blocks.stone);
                    if (world.isRemote)
                        ReikaRenderHelper.spawnDropParticles(
                ...
                for (Coordinate c : SnowStructure.getCenterAccess(dir)) {
                    ...
                    int dz = z + c.zCoord - 6;
                    world.setBlockMetadataWithNotify(
                        dx, dy, dz, Passability.getHiddenPassability(dir).ordinal(), 3
                    );
                }
                break;
            default:
                    ...
                    for (int i = 0; i < blocks.getSize(); i++) {
                        ...
                        if (y > yCoord
                            ...
                            worldObj.setBlockMetadataWithNotify(
                                x, y, z, worldObj.getBlockMetadata(x, y, z) % 8, 3
                            );
                            ReikaSoundHelper.playBreakSound(
                                worldObj, x, y, z, Blocks.stone
                            );
                        }
                    }
                }
                //worldObj.setBlockMetadataWithNotify(xCoord+7, yCoord, zCoord,
                //worldObj.getBlockMetadata(xCoord+7, yCoord, zCoord)%8, 3);
                //worldObj.setBlockMetadataWithNotify(xCoord+7, yCoord-1, zCoord,
                //worldObj.getBlockMetadata(xCoord+7, yCoord-1, zCoord)%8, 3);
                break;
            case BURROW:
                if (blocks != null) {
                    for (int i = 0; i < blocks.getSize(); i++) {
    ...
    public void onFirstTick(World world, int x, int y, int z) {
        if (struct != null) {
            ...
            this.calcCrystals(world, x, y, z);
            if (this.regenerate())
                DungeonGenerator.instance.onGenerateStructure(
                    struct, (FragmentStructureBase) struct.getStructure(), world, this
                );
        }
        if (auxData != null)
    ...
    private void initArray(World world, int x, int y, int z) {
        ...
        switch (struct) {
            ...
            case BURROW:
                ...
                if (hasFurnaceRoom) {
                    blocks.addAll(((BurrowStructure
                                   ) ChromaStructures.BURROW.getStructure())
                                      .getFurnaceRoom(world, x, y, z));
                }
                if (hasLootRoom) {
                    blocks.addAll(((BurrowStructure
                                   ) ChromaStructures.BURROW.getStructure())
                                      .getLootRoom(world, x, y, z));
                }
                break;
            case OCEAN:
            ...
            case SNOWSTRUCT:
                ...
                break;
            case BIOMEFRAG:
                ((BiomeStructure) struct.getStructure())
                    .setPuzzle((BiomeStructurePuzzle) auxData);
    ...
    private boolean checkExclusionZone(World world, int x, int y, int z) {
        ...
        WorldLocation loc = DungeonGenerator.instance.getNearestStructure(struct, world,
    x+0.5, y+0.5, z+0.5, dist, src); if (loc != null) {
            ChromatiCraft.logger.logError("Found a "+this+" @ "+this+" only
    "+loc.getDistanceTo(src)+" blocks away, inside the "+dist+" limit!"); boolean placed =
    false; for (Coordinate c : blocks.keySet()) { Block b = c.getBlock(world); if (b ==
    ChromaBlocks.LOOTCHEST.getBlockInstance()) { placed = true; TileEntityLootChest te =
    (TileEntityLootChest)c.getTileEntity(world); te.clear(); c.setBlock(world,
    Blocks.air);
                }
            }
            if (placed) {
    ...
    private void spawnParticles(World world, int x, int y, int z) {
        switch (struct) {
            case CAVERN:
                for (int i = -1; i <= 1; i += 2) {
                    if (!crystals.isEmpty()) {
                        CrystalElement e = ReikaJavaLibrary.getRandomListEntry(
                            rand,
                            (ArrayList<CrystalElement>) new ArrayList(crystals.keySet())
                        );
                        ...
                        //ReikaJavaLibrary.pConsole(vx, e == CrystalElement.BROWN && x ==
                        //24 && z == 383);
                        c = c.offset(x, y, z);
                        EntityCenterBlurFX fx = new EntityCenterBlurFX(
                            e,
                            world,
                            c.xCoord + 0.5,
                            c.yCoord + 0.5,
            ...
            case BURROW:
                if (world.getBlock(x, y - 2, z) == ChromaBlocks.LAMP.getBlockInstance()) {
                    ...
                    EntityCenterBlurFX fx = new EntityCenterBlurFX(
                                                color, world, dx, y - 2 + 0.5, dz, 0, 0, 0
                    )
                                                .setGravity(-0.05F);
                    Minecraft.getMinecraft().effectRenderer.addEffect(fx);
                }
    ...
    public void generate(ChromaStructures s, CrystalElement e) {
        if (!s.isNatural())
            throw new IllegalArgumentException(
                "You cannot generate a structure control in the wrong structure!"
            );
        struct = s;
        color = e;
        WeightedRandomChestContent[] loot
            = ChestGenHooks.getItems(ChestGenHooks.STRONGHOLD_LIBRARY, rand);
        WeightedRandomChestContent.generateChestContents(
            rand,
            loot,
            this,
            ChestGenHooks.getCount(ChestGenHooks.STRONGHOLD_LIBRARY, rand)
        );
    ...
    private void calcCrystals(World world, int x, int y, int z) {
        if (blocks != null) {
            for (int i = 0; i < blocks.getSize(); i++) {
                ...
                if (worldObj.getBlock(c1.xCoord, c1.yCoord, c1.zCoord)
                    == ChromaBlocks.CRYSTAL.getBlockInstance()) {
                    Coordinate c = new Coordinate(
                        c1.xCoord - xCoord, c1.yCoord - yCoord, c1.zCoord - zCoord
                    );
                    CrystalElement e = CrystalElement.elements[worldObj.getBlockMetadata(
                        c1.xCoord, c1.yCoord, c1.zCoord
                    )];
                    crystals.put(e, c);
                    //ReikaJavaLibrary.pConsole(c+":"+world.isRemote, e ==
                    //CrystalElement.RED && x == 24 && z == 383);
                }
            }
        }
    }
    ...
    public void breakBlock() {
        if (struct != null) {
            EntityPlayer ep
                = worldObj.getClosestPlayer(xCoord + 0.5, yCoord + 0.5, zCoord + 0.5, 12);
            if (ep != null) {
                switch (struct) {
                    case CAVERN:
                        if (blocks != null) {
                        ...
                        worldObj.setBlockMetadataWithNotify(
                            ...
                            yCoord,
                            zCoord,
                            worldObj.getBlockMetadata(xCoord + 7, yCoord, zCoord) % 8,
                            3
                        );
                        worldObj.setBlockMetadataWithNotify(
                            xCoord + 7,
                            yCoord - 1,
                            zCoord,
                            worldObj.getBlockMetadata(xCoord + 7, yCoord - 1, zCoord) % 8,
                            3
                        );
                        break;
                    case BURROW:
                        ...
                        if (blocks != null) {
                            for (int i = 0; i < blocks.getSize(); i++) {
                                ...
                                if (b == ChromaBlocks.STRUCTSHIELD.getBlockInstance())
                                    ...
                                    worldObj.setBlockMetadataWithNotify(
                                        x, y, z, Passability.BREAKABLE.ordinal(), 3
                                    );
                                }
                            }
                        }
                        ...
                        if (blocks != null) {
                            for (int i = 0; i < blocks.getSize(); i++) {
                                ...
                                if (b == ChromaBlocks.STRUCTSHIELD.getBlockInstance())
                                    ...
                                    //Passability.BREAKABLE.ordinal(), 3);
    ...
    public int getBrightness() {
        return struct == ChromaStructures.BURROW || struct == ChromaStructures.DESERT ? 15
                                                                                      : 0;
    }
        ...
        if (NBT.hasKey("auxDataType")) {
            try {
                ...
                ChromatiCraft.logger.logError(
                    "Could not reload aux struture data: " + e.toString()
                );
                e.printStackTrace();
            }
        }
    ...
    public boolean isVisible() {
        return true; //ProgressionManager.instance.isPlayerAtStage(Minecraft.getMinecraft().thePlayer,
    ...
    public void endMonumentRitual() {
        if (triggeredMonument) {
            ...
            ReikaPacketHelper.sendDataPacketWithRadius(
                ...
                ChromaPackets.MONUMENTEND.ordinal(),
                this,
                Integer.MAX_VALUE
            );
        }
    ...
    public boolean triggerMonument(EntityPlayer ep) {
        ...
        if (monument.doChecks()) {
            ReikaPacketHelper.sendDataPacketWithRadius(
                ChromatiCraft.packetChannel,
                ChromaPackets.MONUMENTSTART.ordinal(),
                this,
                128
            );
            monument.start();
    ...
    public static class LootChestWatcher {
        ...
        private void cache(TileEntityStructControl te) {
            ...
            WorldChunk wc = new WorldChunk(
                te.worldObj, te.worldObj.getChunkFromBlockCoords(te.xCoord, te.zCoord)
            );
        ...
        public void onAccess(LootChestAccessEvent evt) {
            ...
            for (int i = -r; i <= r; i++) {
                for (int j = -r; j <= r; j++) {
                    ...
                    int dz = z + i * 16;
                    WorldChunk wc = new WorldChunk(
                        evt.world, evt.world.getChunkFromBlockCoords(dx, dz)
                    );
    ...
    public boolean breakByPlayer(EntityPlayer ep) {
        if (struct == ChromaStructures.OCEAN) {
            return ep != null
                && ep.getDistance(xCoord + 0.5, yCoord + 0.5, zCoord + 0.5) <= 2.5;
        }
        if (struct == ChromaStructures.BURROW) {
            if (hasLootRoom && !this.isLootDoorOpen())
                return false;
            if (hasFurnaceRoom
                && worldObj.getBlock(xCoord + 2, yCoord, zCoord + 2)
                    == ChromaBlocks.STRUCTSHIELD.getBlockInstance())
                return false;
        }
        return true;
    ...
    public boolean skipPlacement(Coordinate c, BlockCheck bc) {
        return c.equals(xCoord, yCoord, zCoord)
            || (c.getBlock(worldObj) == ChromaBlocks.STRUCTSHIELD.getBlockInstance()
                && c.getBlockMetadata(worldObj) >= 8)
            || bc.asBlockKey().blockID == ChromaBlocks.LOOTCHEST.getBlockInstance();
    }
    ...
    public void
    onDelegatedTileAdded(World world, int x, int y, int z, InteractionDelegateTile te) {
        if (auxData != null)
            auxData.handleTileAdd(world, x, y, z, te, this);
    }

    public void
    onDelegatedTileRemoved(World world, int x, int y, int z, InteractionDelegateTile te) {
        if (auxData != null)
            auxData.handleTileRemove(world, x, y, z, te, this);
    }

    public void onDelegatedTileInteract(
        World world, int x, int y, int z, InteractionDelegateTile te, EntityPlayer ep
    ) {
        if (auxData != null)
    ...
    public void onMusicTrigger(
        World world, int x, int y, int z, CrystalElement e, MusicKey mk, EntityPlayer ep
    ) {
        if (auxData != null)
    ...
    public static interface FragmentStructureData {
        ...
        void handleTileAdd(
            ...
            int y,
            int z,
            InteractionDelegateTile te,
            TileEntityStructControl root
        );
        void handleTileRemove(
            World world,
            int x,
            int y,
            int z,
