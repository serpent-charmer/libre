...
public class TileEntityDeathFogEmitter
    extends InventoriedChromaticBase implements OneSlotMachine {
    @Override
    ...
    public void updateEntity(World world, int x, int y, int z, int meta) {
        if (!world.isRemote && ReikaWorldHelper.isRadiusLoaded(world, x, z, 2)) {
            ...
            EntityDeathFog e = new EntityDeathFog(
                world, x + 0.5, y + 0.5, z + 0.5, vel[0], vel[1], vel[2], flag
            );
