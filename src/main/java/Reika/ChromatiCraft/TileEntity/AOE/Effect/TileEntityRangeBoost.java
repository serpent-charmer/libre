...
public class TileEntityRangeBoost extends TileEntityAdjacencyUpgrade {
    private static double[] factors = { 1.03125, 1.0625, 1.125, 1.25, 1.5, 2, 3, 4 };
    ...
    public static void
    addBasicHandling(Class<? extends RangeUpgradeable> c, ItemStack... items) {
        ...
        for (ItemStack is : items) {
            AdjacencyEffectDescription adj
                = TileEntityAdjacencyUpgrade.registerEffectDescription(
                    CrystalElement.LIME, basicRangeUpgradeable.getDescription()
                );
            adj.addItems(items);
        }
    }
    ...
    private static class CustomRangeEffect extends RangeEffect {
        ...
        protected CustomRangeEffect(CustomRangeUpgrade e) {
            ...
            AdjacencyEffectDescription adj
                = TileEntityAdjacencyUpgrade.registerEffectDescription(
                    CrystalElement.LIME, this.getDescription()
                );
