...
public final class CrystalLink {
    ...
    private void recalculateLOS() {
        ...
        //ReikaJavaLibrary.pConsole("Recalculating LOS for "+this+"
        //(#"+System.identityHashCode(this)+"): "+hasLOS);
    }
    ...
    public final boolean equals(Object o) {
        if (o instanceof CrystalLink) {
            ...
            return (l.loc1.equals(loc1) && l.loc2.equals(loc2))
                || (l.loc1.equals(loc2) && l.loc2.equals(loc1)); //order irrelevant
        }
        return false;
    }
    ...
    final boolean hasLineOfSight() {
        if (needsCalculation)
            this.recalculateLOS();
        //ReikaJavaLibrary.pConsole("Returning LOS for "+this+"
        //(#"+System.identityHashCode(this)+"): "+hasLOS);
        return hasLOS;
    }
    ...
    public CrystalNetworkTile getOtherEnd(CrystalNetworkTile te) {
        return PylonFinder.getNetTileAt(
            loc1.equals(te.getWorld(), te.getX(), te.getY(), te.getZ()) ? loc2 : loc1,
            true
        );
    }
}
