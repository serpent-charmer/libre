...
class NetworkSorters {
    ...
    static class TransmitterDistanceSorter implements Comparator<CrystalTransmitter> {
        ...
        public int compare(CrystalTransmitter o1, CrystalTransmitter o2) {
            return (int
            ) (o1.getDistanceSqTo(location.xCoord, location.yCoord, location.zCoord)
               - o2.getDistanceSqTo(location.xCoord, location.yCoord, location.zCoord));
        }
    }
        ...
        public int compare(CrystalTransmitter o1, CrystalTransmitter o2) {
            if (o1 instanceof CrystalSource && o2 instanceof CrystalSource) {
                return -Integer.compare(
                    PylonFinder.getSourcePriority((CrystalSource) o1, color),
                    PylonFinder.getSourcePriority((CrystalSource) o2, color)
                );
