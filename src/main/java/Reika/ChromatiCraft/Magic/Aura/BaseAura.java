...
public class BaseAura {
    private static final HashMap<BiomeGenBase, ElementTagCompound> biomeAura
        = new HashMap();
    ...
    private static void
    addBiomeAura(CrystalElement e, int amt, BiomeDictionary.Type type) {
