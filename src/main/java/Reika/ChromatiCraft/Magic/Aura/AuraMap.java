...
public class AuraMap {
    ...
    public ArrayList<AuraLocation>
    getAuraSourcesWithinDOfXYZ(World world, int x, int y, int z, double maxdist) {
    ...
    public static class AuraLocation {
        ...
        private int calculateStrength(int base, double dist) {
            return (int
            ) (base * source.getCoefficient() / Math.pow(dist, source.getDistancePower())
            );
        }
        ...
        public boolean equals(Object o) {
            if (o instanceof AuraLocation) {
                ...
                return a.source == source && a.xCoord == xCoord && a.yCoord == yCoord
                    && a.zCoord == zCoord && a.dimensionID == dimensionID;
            }
            return false;
        }
    }
