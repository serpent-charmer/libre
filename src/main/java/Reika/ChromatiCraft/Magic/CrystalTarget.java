...
public class CrystalTarget {
    ...
    public CrystalTarget(
        WorldLocation src, WorldLocation target, CrystalElement color, double w
    ) {
        this(src, target, color, 0, 0, 0, w, w);
    }

    public CrystalTarget(
        CrystalNetworkTile src, WorldLocation target, CrystalElement color, double w
    ) {
        this(PylonFinder.getLocation(src), target, color, 0, 0, 0, w, w);
    }

    public CrystalTarget(
        CrystalNetworkTile src,
    ...
    public static CrystalTarget readFromNBT(String name, NBTTagCompound NBT) {
        ...
        return loc != null && src != null && e != null
            ? new CrystalTarget(src, loc, e, dx, dy, dz, w, maxw)
            : null;
    }
    ...
    public String toString() {
        return color.name() + ": " + location.getTileEntity() + " {" + offsetX + ","
            + offsetY + "," + offsetZ + "}";
    }
