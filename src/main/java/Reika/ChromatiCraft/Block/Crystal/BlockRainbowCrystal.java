...
public class BlockRainbowCrystal
    extends BlockCrystalTileNonCube implements CrystalRenderedBlock {
    ...
    public final IIcon getIcon(IBlockAccess iba, int x, int y, int z, int s) {
        return ((TileEntityChromaCrystal) iba.getTileEntity(x, y, z)).isConnected()
            ? blockIcon
            : inertIcon;
    }
    ...
    public void randomDisplayTick(World world, int x, int y, int z, Random rand) {
        double[] v
            = ReikaDyeHelper.getRandomColor().getRedstoneParticleVelocityForColor();
