...
public class BlockCrystalFence extends Block {
        ...
        for (int k = 1; k < 12; k++) {
            for (int i = 2; i < 6; i++) {
                ...
                if (c == ChromaTiles.FENCE) {
                    this.addToFence(te, (TileEntityCrystalFence)world.getTileEntity(dx, y,
    dz)); return;
                }
                else if (world.getBlock(dx, y, dz) == this) {
                    this.addToFence(te, ((CrystalFenceAuxTile)world.getTileEntity(dx, y,
    dz)).getFenceController());
                }
            }
        }
    }
    ...
    public static class CrystalFenceAuxTile extends TileEntity {
        ...
        public TileEntityCrystalFence getFenceController() {
            ...
            return te instanceof TileEntityCrystalFence ? (TileEntityCrystalFence)te :
        null;
        }
         */
        @Override
