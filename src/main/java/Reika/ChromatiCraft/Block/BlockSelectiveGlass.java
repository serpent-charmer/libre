...
public class BlockSelectiveGlass extends Block implements ConnectedTextureGlass {
    ...
    { AxisAlignedBB ret = null; Coordinate c = new Coordinate(x, y, z); Entity e =
    collidingEntities.get(c); if (e == null || !this.canEntityPass(world, x, y, z, e)) {
    ...
    @Override
    public void addCollisionBoxesToList(World world, int x, int y, int z, AxisAlignedBB
    box, List li, Entity e) { if (this.canEntityPass(world, x, y, z, e)) {
    ...
    vec1, Vec3 vec2) { Coordinate c = new Coordinate(x, y, z); Entity e =
    collidingEntities.get(c); if (e != null && this.canEntityPass(world, x, y, z, e)) {
            return null;
        }
        collidingEntities.remove(c);
