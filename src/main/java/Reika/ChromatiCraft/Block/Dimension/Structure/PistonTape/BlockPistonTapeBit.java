...
public class BlockPistonTapeBit
    extends BlockDimensionStructure implements SemiUnbreakable, LaserPulseEffect {
    ...
    public boolean onRightClicked(
        ...
        ReikaSoundHelper.playSoundAtBlock(
            world, x, y, z, "random.click", 1, meta % 2 == 1 ? 0.875F : 0.75F
        );
        return true;
    }
