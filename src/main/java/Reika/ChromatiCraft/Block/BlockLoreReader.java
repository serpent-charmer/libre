...
public class BlockLoreReader extends BlockContainer {
    ...
    public boolean onBlockActivated(
        ...
        //if (!ChromaItems.DATACRYSTAL.matchWith(ep.getCurrentEquippedItem()) &&
        //((TileEntityLoreReader)world.getTileEntity(x, y, z)).hasCrystal() &&
    ...
    public void breakBlock(World world, int x, int y, int z, Block b, int meta) {
        ...
        if (te.hasCrystal) {
            ReikaItemHelper.dropItem(
                world, x + 0.5, y + 0.5, z + 0.5, ChromaItems.DATACRYSTAL.getStackOf()
            );
        }
