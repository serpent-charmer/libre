...
public class BlockTempleLifewater extends BlockFluidFinite {
    ...
    public boolean displaceIfPossible(World world, int x, int y, int z) {
        return this.canDisplace(world, x, y, z) ? super.displaceIfPossible(world, x, y, z)
                                                : false;
    }
    ...
    public IIcon getIcon(IBlockAccess iba, int x, int y, int z, int s) {
        ...
        boolean trans = true; //mat == Material.ground || mat == Material.grass || mat ==
                              //Material.clay || mat == Material.sand;
