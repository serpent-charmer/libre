...
public class BlockNetherBypassGate extends BlockAir {
        ...
        public void doEffect(EntityPlayer ep) {
            ...
            switch (this) {
                ...
                case PUSH3:
                    ...
                    break;
                case HURT1:
                    ReikaEntityHelper.doSetHealthDamage(
                        ep, DamageSource.outOfWorld, 0.25F
                    );
                    PUSH3.doEffect(ep);
                    break;
                case HURT2:
                ...
                case KILL:
                    ReikaEntityHelper.doSetHealthDamage(
                        ep, DamageSource.outOfWorld, Integer.MAX_VALUE
                    );
                    break;
                default:
                    break;
    ...
    public void onEntityCollidedWithBlock(World world, int x, int y, int z, Entity e) {
        if (e instanceof EntityPlayer && e.isEntityAlive()
            && e.getEntityData().getLong("lastGateEffect") < world.getTotalWorldTime()) {
