...
public class BlockAvoLamp extends BlockContainer implements SidedBlock {
    ...
    public static class TileEntityAvoLamp extends TileEntity {
        ...
        public AxisAlignedBB getBoundingBox() {
            double mx = direction == ForgeDirection.EAST ? 0
                : direction == ForgeDirection.WEST       ? 0.5
                                                         : 0.25;
            double my = direction == ForgeDirection.UP ? 0
                : direction == ForgeDirection.DOWN     ? 0.5
                                                       : 0.25;
            double mz = direction == ForgeDirection.SOUTH ? 0
                : direction == ForgeDirection.NORTH       ? 0.5
                                                          : 0.25;
            double px = direction == ForgeDirection.WEST ? 1
                : direction == ForgeDirection.EAST       ? 0.5
                                                         : 0.75;
            double py = direction == ForgeDirection.DOWN ? 1
                : direction == ForgeDirection.UP         ? 0.5
                                                         : 0.75;
            double pz = direction == ForgeDirection.NORTH ? 1
                : direction == ForgeDirection.SOUTH       ? 0.5
                                                          : 0.75;
