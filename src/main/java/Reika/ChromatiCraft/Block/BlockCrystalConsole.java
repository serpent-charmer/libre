...
public class BlockCrystalConsole extends BlockContainer implements ConnectedTextureGlass {
    ...
    public boolean onBlockActivated(
        ...
        TileEntityCrystalConsole te
            = (TileEntityCrystalConsole) world.getTileEntity(x, y, z);
    ...
    private int
    getClickedButton(TileEntityCrystalConsole te, ForgeDirection dir, float a, float c) {
        ...
        if (ReikaMathLibrary.isValueInsideBoundsIncl(0.15625, 0.34375, d)) {
            ...
            if (pos) {
                ...
                if (te2 instanceof TileEntityCrystalConsole
                    && ((TileEntityCrystalConsole) te2).getSlotCount() == 4) {
                    return 200;
                }
            } else {
