...
public class ItemPurifyCrystal extends ItemPoweredChromaTool {
    ...
    public static final int MAX_CHARGE
        = 216000 * 12; //3h in the Nether, 36h in the overworld
    ...
    private void doHeldFX(ItemStack is, Entity e) {
        if (itemRand.nextInt(2 * 4) == 0) {
            ...
            double raan = 0; //(e.ticksExisted%2 == 0 ? 180 :
                             //0)+RenderManager.instance.playerViewY;
            Orbit o = new Orbit(r, ec, i, raan, 0, 0);
            OrbitMotionController p
                = new OrbitMotionController(o, e.posX, e.posY, e.posZ).trackEntity(e);
            ...
            EntityFX fx = new EntityCCBlurFX(e.worldObj, e.posX, e.posY, e.posZ)
