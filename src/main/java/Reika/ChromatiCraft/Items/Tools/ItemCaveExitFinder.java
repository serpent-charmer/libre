...
public class ItemCaveExitFinder extends ItemChromaTool {
    ...
    private static final PropagationCondition pathFinder = new PropagationCondition() {
        ...
        public boolean isValidLocation(
            ...
            return b.isAir(world, x, y, z) || b == ChromaBlocks.HOVER.getBlockInstance()
                || b == Blocks.wooden_door || b == Blocks.iron_door
                || b == Blocks.iron_bars || b == ChromaBlocks.TRAIL.getBlockInstance()
    ...
    public ItemStack onItemRightClick(ItemStack is, World world, EntityPlayer ep) {
        ...
        if (deep) {
            ...
            b.recursiveAddCallbackWithBounds(
                world,
                x,
                y,
                z,
        ...
        if (!li.isEmpty()) {
            ...
            for (int i = 0; i < li2.size(); i++) {
                ...
                if (c.getBlock(world).isAir(
                        world, c.xCoord, c.yCoord, c.zCoord
                    )) { //do not overwrite liquids, leaves, etc
