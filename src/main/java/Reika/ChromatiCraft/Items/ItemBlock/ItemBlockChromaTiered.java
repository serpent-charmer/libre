...
public class ItemBlockChromaTiered extends ItemBlock implements TieredItem {
            ...
            if (movingobjectposition.typeOfHit
                ...
                if (world.getBlock(i, j, k).getMaterial() == Material.water
                    ...
                    if (ForgeEventFactory
                            .onPlayerBlockPlace(ep, blocksnapshot, ForgeDirection.UP)
                            .isCanceled()) {
    ...
    private BlockKey getWaterPlaced(ItemStack is) {
        if (field_150939_a == ChromaBlocks.TIEREDPLANT.getBlockInstance()
            && TieredPlants.list[is.getItemDamage()].isWaterPlaced()) {
    ...
    private String getDisguiseName(ItemStack is, String name) {
        ...
        boolean tier = bc.getProgressStage(is.getItemDamage())
                           .isPlayerAtStage(Minecraft.getMinecraft().thePlayer);
    ...
    public boolean placeBlockAt(
        ...
        boolean flag = field_150939_a instanceof BlockTieredPlant
            ? ((BlockTieredPlant) field_150939_a).canPlaceAt(world, x, y, z, stack)
            : true;
        return flag
            && super.placeBlockAt(
