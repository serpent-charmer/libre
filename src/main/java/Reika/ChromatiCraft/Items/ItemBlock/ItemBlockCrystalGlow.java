...
public class ItemBlockCrystalGlow extends ItemBlockDyeTypes {
    ...
    public boolean onItemUse(
        ...
        return ((BlockCrystalGlow) field_150939_a).canPlaceOn(world, x, y, z, side)
            && super.onItemUse(stack, ep, world, x, y, z, side, hitX, hitY, hitZ);
    }
    ...
    public boolean placeBlockAt(
        ...
        if (world.getBlock(x, y, z) == field_150939_a) {
            ((BlockCrystalGlow) field_150939_a)
                .setSide(world, x, y, z, ForgeDirection.VALID_DIRECTIONS[side]);
