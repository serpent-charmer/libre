...
public class ChromaClient extends ChromaCommon {
    public static final MultiSheetItemRenderer items
        = new MultiSheetItemRenderer(ChromatiCraft.instance, ChromatiCraft.class);

    //public static final ItemMachineRenderer machineItems = new ItemMachineRenderer();

    private static final HashMap<ChromaItems, ForcedTextureArmorModel> armorTextures
        = new HashMap();
    ...
    public void registerRenderers() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(
            EntityBallLightning.class, new RenderBallLightning()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityAbilityFireball.class, new RenderFireball(2)
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityGluon.class, new RenderGluon()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityChainGunShot.class, new RenderChainGunShot()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntitySplashGunShot.class, new RenderSplashGunShot()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityVacuum.class, new RenderVacuum()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityChromaEnderCrystal.class, new RenderEnderCrystal()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityMeteorShot.class, new RenderMeteorShot()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityAurora.class, new RenderAurora()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityThrownGem.class, new RenderThrownGem()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityLaserPulse.class, new RenderLaserPulse()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityPistonSpline.class, new RenderPistonSpline()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityTNTPinball.class, new RenderTNTPinball()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityDimensionFlare.class, new RenderDimensionFlare()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityLumaBurst.class, new RenderLumaBurst()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityParticleCluster.class, new RenderParticleCluster()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityNukerBall.class, new RenderNukerBall()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityGlowCloud.class, new RenderGlowCloud()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityDataCrystal.class, new RenderDataCrystal()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityOverloadingPylonShock.class, new RenderOverloadingPylonShock()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityMonsterBait.class, new RenderMonsterBait()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityTunnelNuker.class, new RenderTunnelNuker()
        );
        if (ModList.BOTANIA.isLoaded())
            RenderingRegistry.registerEntityRenderingHandler(
                EntityChromaManaBurst.class, new RenderChromaManaBurst()
            );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityLightShot.class, new RenderLightShot()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityDeathFog.class, new RenderDeathFog()
        );
        ...
        MinecraftForgeClient.registerItemRenderer(
            ChromaItems.DATACRYSTAL.getItemInstance(), new DataCrystalRenderer()
        );
        MinecraftForgeClient.registerItemRenderer(
            ChromaItems.STRUCTMAP.getItemInstance(), new StructureMapRenderer(items)
        );

        RenderSlime slimeRenderer
            = (RenderSlime) RenderManager.instance.entityRenderMap.get(EntitySlime.class);
    ...
    public void registerKeys() {
        if (ChromaOptions.KEYBINDABILITY.getState()) {
            key_ability
                = new KeyBinding("Use Ability", -98, "ChromatiCraft"); //Middle mouse
        ...
        for (int i = 0; i < AbilityHotkeys.SLOTS; i++) {
            AbilityHotkeys.keys[i] = new KeyBinding(
                "Fire Ability " + i, Keyboard.KEY_NUMPAD1 + i, "ChromatiCraft"
            ); //defaults to numpad 1,2,3,0
    ...
    public void addArmorRenders() {
        ...
        addArmorTexture(
            ChromaItems.FLOATBOOTS, "/Reika/ChromatiCraft/Textures/Misc/floatboots.png"
        );
    }
    ...
    private static void addArmorTexture(ChromaItems item, String tex) {
        ...
        armorTextures.put(
            item,
            new ForcedTextureArmorModel(ChromatiCraft.class, tex, item.getArmorType())
        );
        String[] s = tex.split("/");
    ...
    public void loadModels() {
        for (int i = 0; i < ChromaTiles.TEList.length; i++) {
            ...
            if (m.hasRender()) {
                ChromaRenderBase render
                    = (ChromaRenderBase) ChromaRenderList.instantiateRenderer(m);
                    ...
                    for (int k = 0; k < 16; k++) {
                        if (AdjacencyUpgrades.upgrades[k].isImplemented()) {
                            ClientRegistry.bindTileEntitySpecialRenderer(
                                AdjacencyUpgrades.upgrades[k].getTileClass(), render
                            );
                        }
                    }
                }
        ...
        ClientRegistry.bindTileEntitySpecialRenderer(
            TileEntityCrystalPlant.class, new CrystalPlantRenderer()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TileEntityLootChest.class, new RenderLootChest()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TileEntityCrystalPortal.class, new RenderCrystalPortal()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TileEntityVoidRift.class, new RenderVoidRift()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TileEntityColoredAltar.class, altarRenderer
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            AntKeyTile.class, new RenderAntKey()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TargetTile.class, new RenderLaserTarget()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TileBouncePad.class, new RenderBouncePad()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            GravityTile.class, new RenderGravityTile()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TileEntityAvoLamp.class, new RenderAvoLamp()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TileEntityRotatingLock.class, new RenderWaterLock()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TileGlowingCracks.class, new RenderGlowingCracks()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TilePolyCrystal.class, new RenderPolyCrystal()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TilePistonDisplay.class, new RenderPistonDisplay()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TileEntityWarpNode.class, new RenderWarpNode()
        );

        MinecraftForgeClient.registerItemRenderer(
            ChromaItems.PLACER.getItemInstance(),
            ChromatiCraft.instance.isLocked() ? null : placer
        );
        MinecraftForgeClient.registerItemRenderer(
            ChromaItems.RIFT.getItemInstance(),
            ChromatiCraft.instance.isLocked() ? null : placer
        );
        MinecraftForgeClient.registerItemRenderer(
            ChromaItems.ADJACENCY.getItemInstance(),
            ChromatiCraft.instance.isLocked() ? null : placer
        );

        if (!ChromatiCraft.instance.isLocked())
            ReikaRegistryHelper.instantiateAndRegisterISBRHs(
                ChromatiCraft.instance, ChromaISBRH.values()
            );

        //ClientRegistry.bindTileEntitySpecialRenderer(TileEntityGuardianStone.class, new
        //GuardianStoneRenderer());
        //ClientRegistry.bindTileEntitySpecialRenderer(TileEntityCrystalPlant.class, new
        //CrystalPlantRenderer());
        //ClientRegistry.bindTileEntitySpecialRenderer(TileEntityAccelerator.class, new
        //AcceleratorRenderer());

        //MinecraftForgeClient.registerItemRenderer(ChromaBlocks.GUARDIAN.getItem(),
        //teibr);
        //MinecraftForgeClient.registerItemRenderer(ChromaBlocks.ACCELERATOR.getItem(),
        //teibr);

        MinecraftForgeClient.registerItemRenderer(
            ChromaItems.ENDERCRYSTAL.getItemInstance(), csr
        );

        MinecraftForgeClient.registerItemRenderer(
            ChromaBlocks.PORTAL.getItem(), new PortalItemRenderer()
        );
        MinecraftForgeClient.registerItemRenderer(
            ChromaBlocks.COLORALTAR.getItem(), new AltarItemRenderer()
        );
        MinecraftForgeClient.registerItemRenderer(
            ChromaBlocks.LOOTCHEST.getItem(), new LootChestRenderer()
        );
        MinecraftForgeClient.registerItemRenderer(
            ChromaBlocks.AVOLAMP.getItem(), new TESRItemRenderer()
        );
    }
    ...
    private void registerSpriteSheets() {
        for (int i = 0; i < ChromaItems.itemList.length; i++) {
            ...
            if (!c.isPlacer() && c != ChromaItems.POTION && c != ChromaItems.MANIPFOCUS
                && c != ChromaItems.ABILITYFOCUS)
                MinecraftForgeClient.registerItemRenderer(
                    ChromaItems.itemList[i].getItemInstance(), items
                );
        }
    }
        ...
        for (Donator s : donators) {
            if (s.ingameName != null)
                PlayerSpecificRenderer.instance.registerRenderer(
                    s.ingameName, DonatorPylonRender.instance
                );
            else
