...
public class EntityGluon extends Entity implements IEntityAdditionalSpawnData {
    ...
    private void addBoltElement() {
        ...
        bolt.add(Vec3.createVectorHelper(last.xCoord+v.getXProjection(),
    last.yCoord+v.getYProjection(), last.zCoord+v.getZProjection()));
    }

    private boolean isComplete() {
        return !bolt.isEmpty() &&
    this.getBoltTerminusPos().distanceTo(Vec3.createVectorHelper(targetID.posX,
    targetID.posY, targetID.posZ)) < 0.125;
    }
