...
public class EntityTNTPinball extends ParticleEntity {
    ...
    public EntityTNTPinball(
        World world, int x, int y, int z, ForgeDirection dir, double speed
    ) {
    ...
    public void bounce(boolean state) {
        ForgeDirection dir = state ? ReikaDirectionHelper.getRightBy90(direction)
                                   : ReikaDirectionHelper.getLeftBy90(direction);
        this.setDirection(dir, true);
    }
