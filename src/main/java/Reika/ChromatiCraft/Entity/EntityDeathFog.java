...
public class EntityDeathFog
    extends InertEntity implements IEntityAdditionalSpawnData, DestroyOnUnload {
    ...
    public void onUpdate() {
        ...
        if (!worldObj.isRemote) {
            ...
            List<AxisAlignedBB> li2 = worldObj.getCollidingBoundingBoxes(
                this, ReikaAABBHelper.getEntityCenteredAABB(this, 0.3)
            );
            while (!li2.isEmpty()) {
                this.setPosition(posX, posY + 0.1, posZ);
                li2 = worldObj.getCollidingBoundingBoxes(
                    this, ReikaAABBHelper.getEntityCenteredAABB(this, 0.3)
                );
            ...
            AxisAlignedBB box
                = ReikaAABBHelper.getEntityCenteredAABB(this, enhanced ? 4 : 2.5);
            List<EntityLivingBase> li = worldObj.getEntitiesWithinAABBExcludingEntity(
                this, box, ReikaEntityHelper.hostileSelector
            );
    ...
    private void doAttack() {
        ...
        List<EntityLivingBase> li = worldObj.getEntitiesWithinAABB(EntityLivingBase.class,
    box); while (r < 24 && li.isEmpty()) { r++; box =
    ReikaAABBHelper.getEntityCenteredAABB(this, r); li =
