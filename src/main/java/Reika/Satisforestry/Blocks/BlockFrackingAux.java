...
public class BlockFrackingAux
    ...
    public static class TileFrackingAux extends TileEntity /* implements IFluidHandler*/ {
            ...
            if (isPressurized) {
                ...
                if (worldObj.isRemote) {
                    if (worldObj.getBlock(xCoord, yCoord + 1, zCoord)
                        ...
                        TileFrackingNode.fluidFountainParticles(
                            worldObj,
                            xCoord,
                            yCoord,
                            zCoord,
                    ...
                    if (peaceful && !res.worksOnPeaceful())
                        return;
                    tank.addLiquid(res.generateRandomFluid(
                        this.getPurity(), peaceful, te.getOverclock()
                    ));
                }
            } else {
                tank.empty();
        ...
        public TileFrackingNode getMaster() {
            TileEntity te = worldObj == null || masterLocation == null
                ? null
                : masterLocation.getTileEntity(worldObj);
        ...
        public boolean hasExtractor() {
            ...
            return te instanceof TileFrackingExtractor
