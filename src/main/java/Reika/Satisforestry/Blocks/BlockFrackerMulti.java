...
public class BlockFrackerMulti extends BlockSFMultiBase<Boolean> {
    ...
    public boolean hasTileEntity(int meta) {
        ...
        return mb == FrackerBlocks.HUB || mb == FrackerBlocks.POWER
            || mb == FrackerBlocks.FLUIDIN;
    }
    ...
    public Boolean checkForFullMultiBlock(
        ...
        return te instanceof TileFrackingPressurizer
            && FrackerStructure
                   .getFrackerStructure(world, te.xCoord, te.yCoord, te.zCoord)
                   .matchInWorld(call);
    }
    ...
    public static class TileFrackerFluidPort
        extends TileMinerConnection<TileFrackingPressurizer> implements IFluidHandler {
        @Override
