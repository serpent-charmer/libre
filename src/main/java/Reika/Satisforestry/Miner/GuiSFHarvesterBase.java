...
public abstract class GuiSFHarvesterBase<T extends TileResourceHarvesterBase>
    ...
    protected void drawGuiContainerForegroundLayer(int a, int b) {
        ...
        if (api.isMouseInBox(j+23, j+32, k+20, k+76)) {
            ...
            api.drawTooltipAt(fontRendererObj, String.format("%d/%d", grin.getLevel(),
        grin.MAXLUBE), mx-j, my-k);
        }*/
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        ReikaTextureHelper.bindTexture(
            Satisforestry.class,
            "/Reika/Satisforestry/Textures/" + this.getTextureName() + ".png"
        );
        ...
        for (int i = 0; i <= o; i++) {
            ...
            if (i > 0 && tile.getUpgradeSlot(i) == null) {
                this.drawTexturedModalRect(
                    j + 80 + 25 * (i - 1), k + 104, 79, 220, 16, 16
                );
            }
        }
        ...
        fontRendererObj.drawString(
            SFBlocks.getFromID(tile.getBlockType()).getBasicName(), j + 6, k + 5, 0xffffff
        );
        ...
        ReikaGuiAPI.instance.drawCenteredStringNoShadow(
            fontRendererObj,
            tile.getOperationPowerCost(true),
            (j + 90) * 2,
            (k + 39) * 2,
            0xFA9549
        );
        ...
        if (te != null) {
            ...
            ReikaGuiAPI.instance.drawCenteredStringNoShadow(
                fontRendererObj, ri.getDisplayName(), j + 90, k + 76, 0x646464
            );
            ReikaGuiAPI.instance.drawCenteredStringNoShadow(
                fontRendererObj,
                baseyield + "/min Base",
                j + 90,
                k + 76 + fontRendererObj.FONT_HEIGHT,
                0x646464
            );

            fontRendererObj.drawString(
                String.format("%.0f%s", tile.getOverclockingLevel(true) * 100, "%"),
                j + 27,
                k + 103,
                0xFA9549
            );
            ...
            fontRendererObj.drawString(
                "/min", j + 27 + fontRendererObj.getStringWidth(s), k + 114, 0x646464
            );
        }
    }
