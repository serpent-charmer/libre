...
public class GuiCrashSite extends GuiContainer implements CustomSoundGui {
    ...
    protected void actionPerformed(GuiButton b) {
        ...
        ReikaPacketHelper.sendPacketToServer(
            Satisforestry.packetChannel, SFPackets.CRASHUNLOCK.ordinal(), tile
        );
    }
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        if (r != null) {
            ReikaGuiAPI.instance.drawCenteredStringNoShadow(
                fontRendererObj, r.getDisplayName(), j + 53, k + 23, 0xFA9549
            );
            GL11.glPushMatrix();
            ...
            if (r.unlockPower != null)
                ReikaGuiAPI.instance.drawCenteredStringNoShadow(
                    fontRendererObj,
                    "Requires " + r.unlockPower.getDisplayString(),
                    (j + 53) * 2,
                    (k + 32) * 2,
                    0x646464
                );
            ...
            if (is != null)
                ReikaGuiAPI.instance.drawCenteredStringNoShadow(
                    fontRendererObj,
                    "Requires " + is.stackSize + " " + is.getDisplayName(),
                    (j + 53) * 2,
                    (k + 38) * 2,
                    0x646464
                );
            ...
            ReikaGuiAPI.instance.drawCenteredStringNoShadow(
                fontRendererObj, s, (j + 53) * 2, (k + 53) * 2, 0x646464
            );
            GL11.glPopMatrix();
        } else {
    ...
    private class CrashSiteButton extends CustomSoundImagedGuiButton {
        public CrashSiteButton(
            int par1, int par2, int par3, int par4, int par5, int par7, int par8
        ) {
            super(
                par1,
                par2,
