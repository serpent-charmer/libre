...
public class EntityAISlowlyBackFromPlayer extends EntityAIBase {
    ...
    public boolean shouldExecute() {
        ...
        Vec3 vec3 = Vec3.createVectorHelper(
            dx, dy, dz
        ); //RandomPositionGenerator.findRandomTargetBlockAwayFrom(doggo, 8, 2,
           //Vec3.createVectorHelper(closestPlayer.posX, closestPlayer.posY,
           //closestPlayer.posZ));
    ...
    public void updateTask() {
        ...
        doggo.rotationYawHead = -(float) Math.toDegrees(
            Math.atan2(doggo.posX - closestPlayer.posX, doggo.posZ - closestPlayer.posZ)
        );
    }
}