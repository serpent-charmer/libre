...
public class SFClient extends SFCommon {
    ...
    public void registerRenderers() {
        ...
        RenderingRegistry.registerEntityRenderingHandler(
            SFEntities.ELITESTINGER.getObjectClass(), new RenderEliteStinger()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            SFEntities.MANTA.getObjectClass(), new RenderFlyingManta()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            SFEntities.SPITTER.getObjectClass(), new RenderSpitter()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            SFEntities.DOGGO.getObjectClass(), RenderLizardDoggo.instance
        );

        RenderingRegistry.registerEntityRenderingHandler(
            SFEntities.SPITTERFIRE.getObjectClass(), RenderSpitterFire.instance
        );
        RenderingRegistry.registerEntityRenderingHandler(
            SFEntities.SPITTERSPLITFIRE.getObjectClass(), RenderSpitterFire.instance
        );

        RenderingRegistry.registerEntityRenderingHandler(
            SFEntities.STINGERPOISON.getObjectClass(), NullEntityRender.instance
        );

        ClientRegistry.bindTileEntitySpecialRenderer(
            TileNodeHarvester.class, new SFMinerRenderer()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TileFrackingPressurizer.class, new SFFrackerRenderer()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TileFrackingExtractor.class, new SFFrackerAuxRenderer()
        );
        ClientRegistry.bindTileEntitySpecialRenderer(
            TilePowerSlug.class, new PowerSlugRenderer()
        );
        MinecraftForgeClient.registerItemRenderer(
            SFBlocks.HARVESTER.getItem(), new SFMinerItemRenderer()
        );
        MinecraftForgeClient.registerItemRenderer(
            SFBlocks.FRACKER.getItem(), new SFFrackerItemRenderer()
        );
        MinecraftForgeClient.registerItemRenderer(
            SFBlocks.SLUG.getItem(), new PowerSlugItemRenderer()
        );
        ...
        SFParticleEngine = new ParticleEngine() {
            ...
            protected void registerClasses() {
                //ThrottleableEffectRenderer.getRegisteredInstance().registerDelegateRenderer(EntitySlugStreakFX.class,
                //this); //commented because render() noop
                ThrottleableEffectRenderer.getRegisteredInstance()
                    .registerDelegateRenderer(SpitterFireParticle.class, this);
                ThrottleableEffectRenderer.getRegisteredInstance()
                    .registerDelegateRenderer(EntityMinerFX.class, this);
            }
        };
