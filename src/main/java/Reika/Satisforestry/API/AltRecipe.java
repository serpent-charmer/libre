...
/**
 * Implemented by alternate recipes. This extends {@link IRecipe} and acts as a read-only
 * view onto the internal recipe.
 */
public interface AltRecipe extends IRecipe {
    ...
    /**
     * A description of the required unlock power, if any. Will be <b>null</b> and not
    ...
    /**
     * Whether this recipe is craftable as a normal crafting recipe. False for flag-only
     * recipes (see {@link AltRecipeHandler.addAltRecipe} and {@link
     * UncraftableAltRecipe})
     */
    ...
    public static abstract class UncraftableAltRecipeWithNEI
        implements UncraftableAltRecipe {
        /**
         * A standard 3x3 grid. Supply nulls for empty slots. Items may be Item, Block,
         * ItemStack, ItemStack[], or List of ItemStack.
         */
    ...
    public static final UncraftableAltRecipe defaultDummyRecipe
        = new UncraftableAltRecipe() {
              @Override
