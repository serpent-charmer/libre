...
public class SFMinerRenderer extends TileEntityRenderBase {
    //private final WavefrontObject model = new
    //WavefrontObject(DirectResourceManager.getResource("Reika/Satisforestry/Render/miner.obj"));
    ...
    public void renderTileEntityAt(
        ...
        if (te.isInWorld() || te.forceRenderer) {
            ...
            if (this.doRenderModel(te)) {
                ...
                renderOverlaidCube(
                    te,
                    SFBlocks.MINERMULTI.getBlockInstance().getIcon(
                        1, MinerBlocks.DRILL.ordinal()
                    )
                );
                Tessellator.instance.addTranslation(-3, 0, 1);
                GL11.glPopMatrix();
    ...
    public static void renderOverlaidCube(TileResourceHarvesterBase te, IIcon base) {
        ...
        switch (MinecraftForgeClient.getRenderPass()) {
            ...
            case 1:
                ...
                o = 0.002;
                ico = te.getBlockType().getIcon(
                    1, te.worldObj.getBlockMetadata(te.xCoord, te.yCoord, te.zCoord)
                );
                break;
        }
        if (ico != null) {
            ...
            BaseBlockRenderer.faceBrightnessColor(
                ForgeDirection.UP,
                v5,
                1,
                1,
