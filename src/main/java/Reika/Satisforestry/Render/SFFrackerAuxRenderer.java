...
public class SFFrackerAuxRenderer extends TileEntityRenderBase {
    private final ModelSFFrackerAux model
        = new ModelSFFrackerAux("Render/ModelFrackerAux.obj");
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel(te)) {
            ReikaTextureHelper.bindTexture(
                Satisforestry.class, "Textures/FrackerAuxTex.png"
            );
            GL11.glPushMatrix();
            if (te.isInWorld()) {
            ...
            if (MinecraftForgeClient.getRenderPass() == 0
                ...
                IIcon ico = SFBlocks.FRACKERMULTI.getBlockInstance().getIcon(
    ...
    protected boolean doRenderModel(TileEntityBase te) {
        ...
        return !te.isInWorld()
            || (MinecraftForgeClient.getRenderPass() == 0
                && ((TileFrackingExtractor) te).hasStructure());
    }
