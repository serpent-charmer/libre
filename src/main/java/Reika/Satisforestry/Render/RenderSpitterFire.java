...
public class RenderSpitterFire extends Render {
    ...
    @Override
    public void
    doRender(Entity e, double par2, double par4, double par6, float f, float ptick) {
        ...
        icon = IconPrefabs.FADE_GENTLE.getIcon();
        float u2 = icon.getMinU();
        float v2 = icon.getMinV();
        float du2 = icon.getMaxU();
        float dv2 = icon.getMaxV();
        ...
        double d = 0.001;
        double s2 = s1 * 1.4;
        int c1 = eb.getRenderColor(0);
        int c2 = eb.getRenderColor(1);
        ...
        v5.addVertexWithUV(-s2, -s2, 0, u2, v2);
        v5.addVertexWithUV(s2, -s2, 0, du2, v2);
        v5.addVertexWithUV(s2, s2, 0, du2, dv2);
        v5.addVertexWithUV(-s2, s2, 0, u2, dv2);
        v5.draw();
        GL11.glPopMatrix();
        GL11.glPopAttrib();
