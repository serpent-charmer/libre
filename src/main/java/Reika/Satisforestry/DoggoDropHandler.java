...
public class DoggoDropHandler extends TemplateRecipeHandler {
    ...
    public void loadTransferRects() {
        transferRects.add(
            new RecipeTransferRect(new Rectangle(0, 3, 165, 52), "doggodrops")
        );
    }
    ...
    public void drawExtras(int recipe) {
        ...
        if (r instanceof DoggoEntry) {
            ...
            String counts = wc.minCount == wc.maxCount
                ? wc.minCount + "x"
                : wc.minCount + "x - " + wc.maxCount + "x";
            ...
            if (!li.isEmpty()) {
                ...
                for (Condition c : li) {
                    ...
                    dy += (fr.FONT_HEIGHT + 2)
                        * fr.listFormattedStringToWidth(s, 135).size();
                }
                dy += fr.FONT_HEIGHT + 2;
            }
