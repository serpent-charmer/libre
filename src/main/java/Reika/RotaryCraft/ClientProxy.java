...
public class ClientProxy extends CommonProxy {
    private static final ItemSpriteSheetRenderer[] items = {
        new ItemSpriteSheetRenderer(
            RotaryCraft.instance, RotaryCraft.class, "Textures/Items/items.png"
        ),
        new ItemSpriteSheetRenderer(
            RotaryCraft.instance, RotaryCraft.class, "Textures/Items/items2.png"
        ),
        new ItemSpriteSheetRenderer(
            RotaryCraft.instance, RotaryCraft.class, "Textures/Items/items3.png"
        ),
        new ItemSpriteSheetRenderer(
            RotaryCraft.instance, RotaryCraft.class, "Textures/Items/items4.png"
        ),
    };
    ...
    //public static final ItemSpriteSheetRenderer terrain = new
    //ItemSpriteSheetRenderer(RotaryCraft.class, "Textures/GUI/mobradargui.png",
    //RotaryAux.terrainpng);
    ...
    //public static final ForcedTextureArmorModel bed1 = new
    //ForcedTextureArmorModel(RotaryCraft.class,
    //"/Reika/RotaryCraft/Textures/Misc/bedrock_1.png"); public static final
    //ForcedTextureArmorModel bed2 = new ForcedTextureArmorModel(RotaryCraft.class,
    //"/Reika/RotaryCraft/Textures/Misc/bedrock_2.png"); public static final
    //ForcedTextureArmorModel hsla1 = new ForcedTextureArmorModel(RotaryCraft.class,
    //"/Reika/RotaryCraft/Textures/Misc/steel_1.png"); public static final
    //ForcedTextureArmorModel hsla2 = new ForcedTextureArmorModel(RotaryCraft.class,
    //"/Reika/RotaryCraft/Textures/Misc/steel_2.png"); public static final
    //ForcedTextureArmorModel io = new ForcedTextureArmorModel(RotaryCraft.class,
    //"/Reika/RotaryCraft/Textures/Misc/IOGoggles.png"); public static final
    //ForcedTextureArmorModel nvg = new ForcedTextureArmorModel(RotaryCraft.class,
    //"/Reika/RotaryCraft/Textures/Misc/NVGoggles.png"); public static final
    //ForcedTextureArmorModel nvh = new ForcedTextureArmorModel(RotaryCraft.class,
    //"/Reika/RotaryCraft/Textures/Misc/NVHelmet.png"); public static final
    //ForcedTextureArmorModel jet = new ForcedTextureArmorModel(RotaryCraft.class,
    //"/Reika/RotaryCraft/Textures/Misc/jet.png"); public static final
    //ForcedTextureArmorModel bedjet = new ForcedTextureArmorModel(RotaryCraft.class,
    //"/Reika/RotaryCraft/Textures/Misc/bedrock_jet.png");
    ...
    public void registerRenderers() {
        if (heatRipple == null)
            heatRipple = ShaderRegistry
                             ...
                             .setEnabled(false);
        //heatGlow = ShaderRegistry.createShader(RotaryCraft.instance, "heatglow",
        //RotaryCraft.class, "Shaders/", ShaderDomain.TESR).setEnabled(false);
        ...
        if (DragonOptions.NORENDERS.getState()) {
            RotaryCraft.logger.log(
                "Disabling all machine renders for FPS and lag profiling."
            );
        } else {
            this.loadModels();
        }
        ...
        RenderingRegistry.registerEntityRenderingHandler(
            EntityRailGunShot.class, new RenderRailGunShot()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityExplosiveShell.class, new RenderRailGunShot()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityFreezeGunShot.class, new RenderFreezeGunShot()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityFlakShot.class, new RenderFlakShot()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityGatlingShot.class, new RenderGatlingShot()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityFlameTurretShot.class, new RenderFlameTurretShot()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityIceBlock.class, new RenderIceBlock()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntitySonicShot.class, new RenderSonicShot()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityLiquidBlock.class, new RenderLiquidBlock()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityDischarge.class, new RenderDischarge()
        );
        RenderingRegistry.registerEntityRenderingHandler(
            EntityCustomTNT.class, new RenderTNTPrimed()
        );
        ...
        MinecraftForgeClient.registerItemRenderer(
            ItemRegistry.SPAWNER.getItemInstance(), spawner
        );
        MinecraftForgeClient.registerItemRenderer(
            Item.getItemFromBlock(BlockRegistry.DECOTANK.getBlockInstance()), decotank
        );
    }
    ...
    public void addArmorRenders() {
        ...
        addArmorTexture(
            ItemRegistry.BEDPACK, "/Reika/RotaryCraft/Textures/Misc/bedrock_jet.png"
        );
        addArmorTexture(
            ItemRegistry.STEELPACK, "/Reika/RotaryCraft/Textures/Misc/hsla_jet.png"
        );
        addArmorTexture(ItemRegistry.JUMP, "/Reika/RotaryCraft/Textures/Misc/jump.png");
        addArmorTexture(
            ItemRegistry.BEDJUMP, "/Reika/RotaryCraft/Textures/Misc/bedrock_jump.png"
        );
        addArmorTexture(
            ItemRegistry.NVG, "/Reika/RotaryCraft/Textures/Misc/NVGoggles.png"
        );
        //addArmorTexture(ItemRegistry.NVH,
        //"/Reika/RotaryCraft/Textures/Misc/NVHelmet.png");
        addArmorTexture(
            ItemRegistry.IOGOGGLES, "/Reika/RotaryCraft/Textures/Misc/IOGoggles.png"
        );
        addArmorTexture(
            ItemRegistry.BEDHELM, "/Reika/RotaryCraft/Textures/Misc/bedrock_1.png"
        );
        addArmorTexture(
            ItemRegistry.BEDREVEAL, "/Reika/RotaryCraft/Textures/Misc/bedreveal.png"
        );
        addArmorTexture(
            ItemRegistry.BEDCHEST, "/Reika/RotaryCraft/Textures/Misc/bedrock_1.png"
        );
        addArmorTexture(
            ItemRegistry.BEDBOOTS, "/Reika/RotaryCraft/Textures/Misc/bedrock_1.png"
        );
        addArmorTexture(
            ItemRegistry.BEDLEGS, "/Reika/RotaryCraft/Textures/Misc/bedrock_2.png"
        );
        addArmorTexture(
            ItemRegistry.STEELBOOTS, "/Reika/RotaryCraft/Textures/Misc/steel_1.png"
        );
        addArmorTexture(
            ItemRegistry.STEELHELMET, "/Reika/RotaryCraft/Textures/Misc/steel_1.png"
        );
        addArmorTexture(
            ItemRegistry.STEELCHEST, "/Reika/RotaryCraft/Textures/Misc/steel_1.png"
        );
        addArmorTexture(
            ItemRegistry.STEELLEGS, "/Reika/RotaryCraft/Textures/Misc/steel_2.png"
        );
    }
    ...
    private static void addArmorTexture(ItemRegistry item, String tex) {
        ...
        armorTextures.put(
            item, new ForcedTextureArmorModel(RotaryCraft.class, tex, item.getArmorType())
        );
        String[] s = tex.split("/");
    ...
    public void loadModels() {
        ...
        for (int i = 0; i < ItemRegistry.itemList.length; i++) {
            ...
            if (ir.isPlacer()) {
                MinecraftForgeClient.registerItemRenderer(
                    ir.getItemInstance(),
                    RotaryCraft.instance.isLocked() ? null : machineItems
                );
            }
        }

        //MachineISBRH.renderID = RenderingRegistry.getNextAvailableRenderId();
        //RenderingRegistry.registerBlockHandler(MachineISBRH.renderID, new
        //MachineISBRH());
    }
    ...
    private void registerSpriteSheets() {
        for (int i = 0; i < ItemRegistry.itemList.length; i++) {
            //ReikaJavaLibrary.pConsole("Registering Item Spritesheet for
            //"+ItemRegistry.itemList[i].name()+" at ID
            //"+(ItemRegistry.itemList[i].getItemInstance()+256)+" with sheet
            //"+ItemRegistry.itemList[i].getTextureSheet());
            ItemRegistry ir = ItemRegistry.itemList[i];
            if (!ir.isPlacer() && ir != ItemRegistry.SCREWFOCUS) {
                if (RotaryCraft.instance.isLocked()) {
                    ...
                    if (ir.isMultiSheet()) {
                        MinecraftForgeClient.registerItemRenderer(
                            ir.getItemInstance(), multisheets[-ir.getTextureSheet()]
                        );
                    } else {
                        MinecraftForgeClient.registerItemRenderer(
                            ir.getItemInstance(), items[ir.getTextureSheet()]
                        );
                    }
                }
            }
    ...
    public void initClasses() {
        ...
        SettingInterferenceTracker.instance.registerSettingHandler(
            SettingInterferenceTracker.muteInterference
        );
    }
    ...
    public void loadDonatorRender() {
        ...
        for (Donator s : donators) {
            if (s.ingameName != null)
                PlayerSpecificRenderer.instance.registerRenderer(
                    s.ingameName, DonatorGearRender.instance
                );
            else
                RotaryCraft.logger.logError(
                    "Donator " + s.displayName
                    + " UUID could not be found! Cannot give special render!"
                );
        }
    }
}
