...
public class DecoTankSettingsRecipe implements IRecipe {
    ...
    static {
        RecipeSorter.register(
            "rotarycraft:decotank",
            DecoTankSettingsRecipe.class,
            Category.SHAPELESS,
            "after:minecraft:shaped after:minecraft:shapeless"
        );
    }
    ...
    public ItemStack getCraftingResult(InventoryCrafting ics) {
        ...
        is.stackTagCompound = tank.stackTagCompound != null
            ? (NBTTagCompound) tank.stackTagCompound.copy()
            : new NBTTagCompound(); //Keep fluids
