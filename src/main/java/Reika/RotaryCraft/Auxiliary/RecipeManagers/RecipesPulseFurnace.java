...
public class RecipesPulseFurnace extends RecipeHandler implements PulseFurnaceManager {
    ...
    private RecipesPulseFurnace() {
        ...
        this.addSmelting(
            Blocks.obsidian,
            BlockRegistry.BLASTGLASS.getCraftedProduct(1),
            850,
            RecipeLevel.CORE
        );
        this.addSmelting(
            Items.iron_ingot,
            ReikaItemHelper.getSizedItemStack(ItemStacks.steelingot, 2),
            900,
            RecipeLevel.CORE
        );
        ...
        this.addSmelting(
            ItemStacks.redgolddust, ItemStacks.redgoldingot, RecipeLevel.CORE
        );

        //addSmelting(RotaryCraft.shaftcraft, 10, new ItemStack(Items.iron_ingot, 1, 0));
        ////scrap addSmelting(RotaryCraft.shaftcraft, 9, new
        //ItemStack(RotaryCraft.shaftcraft, 1, 1));	//Iron scrap
    }
    ...
    private void addRecycling() {
        ...
        this.addRecycling(
            Items.iron_boots, new ItemStack(Items.iron_ingot, 4, 0), RecipeLevel.PROTECTED
        );

        this.addRecycling(
            Items.iron_hoe, new ItemStack(Items.iron_ingot, 2, 0), RecipeLevel.PROTECTED
        );
        this.addRecycling(
            Items.iron_shovel,
        ...
        this.addRecycling(
            Items.iron_axe, new ItemStack(Items.iron_ingot, 3, 0), RecipeLevel.PROTECTED
        );
        this.addRecycling(
            Items.iron_pickaxe,
            new ItemStack(Items.iron_ingot, 3, 0),
        ...
        this.addRecycling(
            Items.iron_sword, new ItemStack(Items.iron_ingot, 2, 0), RecipeLevel.PROTECTED
        );
        ...
        this.addRecycling(
            Items.golden_axe, new ItemStack(Items.gold_ingot, 3, 0), RecipeLevel.PROTECTED
        );
        this.addRecycling(
            Items.golden_sword,
        ...
        this.addRecycling(
            Items.golden_hoe, new ItemStack(Items.gold_ingot, 2, 0), RecipeLevel.PROTECTED
        );
        ...
        this.addRecycling(
            Items.diamond_boots, new ItemStack(Items.diamond, 4, 0), RecipeLevel.PROTECTED
        );

        this.addRecycling(
            Items.diamond_axe, new ItemStack(Items.diamond, 3, 0), RecipeLevel.PROTECTED
        );
        this.addRecycling(
            Items.diamond_sword, new ItemStack(Items.diamond, 2, 0), RecipeLevel.PROTECTED
        );
        this.addRecycling(
        ...
        this.addRecycling(
            Items.diamond_hoe, new ItemStack(Items.diamond, 2, 0), RecipeLevel.PROTECTED
        );
        ...
        this.addRecycling(
            Items.bucket, new ItemStack(Items.iron_ingot, 3, 0), RecipeLevel.PROTECTED
        );
        this.addRecycling(
            Items.water_bucket,
            new ItemStack(Items.iron_ingot, 3, 0),
        ...
        this.addRecycling(
            Items.minecart, new ItemStack(Items.iron_ingot, 5, 0), RecipeLevel.PROTECTED
        );
        this.addRecycling(
            Items.iron_door, new ItemStack(Items.iron_ingot, 6, 0), RecipeLevel.PROTECTED
        );
        this.addRecycling(
            Items.cauldron, new ItemStack(Items.iron_ingot, 7, 0), RecipeLevel.PROTECTED
        );
        if (!Loader.isModLoaded("DragonRealmCore"))
            this.addRecycling(
                Items.hopper_minecart,
                new ItemStack(Items.iron_ingot, 10, 0),
                RecipeLevel.PROTECTED
            );

        this.addRecycling(
            ItemRegistry.STEELHELMET.getItemInstance(),
            this.getSizedSteel(5),
            RecipeLevel.PROTECTED
        );
        this.addRecycling(
            ItemRegistry.STEELBOOTS.getItemInstance(),
            this.getSizedSteel(4),
            RecipeLevel.PROTECTED
        );
        this.addRecycling(
            ItemRegistry.STEELCHEST.getItemInstance(),
            this.getSizedSteel(8),
            RecipeLevel.PROTECTED
        );
        this.addRecycling(
            ItemRegistry.STEELLEGS.getItemInstance(),
            this.getSizedSteel(7),
            RecipeLevel.PROTECTED
        );
        this.addRecycling(
            ItemRegistry.STEELAXE.getItemInstance(),
            this.getSizedSteel(3),
            RecipeLevel.PROTECTED
        );
        this.addRecycling(
        ...
        this.addRecycling(
            ...
            this.getSizedSteel(1),
            RecipeLevel.PROTECTED
        );
        this.addRecycling(
            ItemRegistry.STEELHOE.getItemInstance(),
            this.getSizedSteel(2),
            RecipeLevel.PROTECTED
        );
        this.addRecycling(
            ItemRegistry.STEELSHEARS.getItemInstance(),
            this.getSizedSteel(2),
            RecipeLevel.PROTECTED
        );
        this.addRecycling(
            ItemRegistry.STEELSICKLE.getItemInstance(),
            this.getSizedSteel(3),
            RecipeLevel.PROTECTED
        );
        this.addRecycling(
            ItemRegistry.STEELSWORD.getItemInstance(),
            this.getSizedSteel(2),
            RecipeLevel.PROTECTED
        );
        ...
        if (!ModList.RAILCRAFT.isLoaded()) { //exploit fix; he changes recipes
            this.addRecycling(
                ...
                new ItemStack(Items.iron_ingot, 1, 0),
                RecipeLevel.PERIPHERAL
            ); //1 ingot per block of rail
            this.addRecycling(
                Blocks.golden_rail,
                new ItemStack(Items.gold_ingot, 1, 0),
                RecipeLevel.PERIPHERAL
    ...
    private void addRecycling(ItemStack in, ItemStack out, RecipeLevel rl) {
        if (in.getItem() instanceof ItemSword || in.getItem() instanceof ItemTool
            || in.getItem() instanceof ItemArmor) {
            in = in.copy();
            in.setItemDamage(OreDictionary.WILDCARD_VALUE);
        }
        List<IRecipe> li = ReikaRecipeHelper.getAllRecipesByOutput(
            CraftingManager.getInstance().getRecipeList(), in
        );
        if (li != null && li.size() > 1) {
            RotaryCraft.logger.log(
                "Skipping recycling of " + this.fullID(in) + " to " + this.fullID(out)
                + " due to multiple production recipes"
            );
            return;
        }
    ...
    private void
    addSmelting(ItemStack in, ItemStack itemstack, int temp, RecipeLevel rl) {
        PulseJetRecipe rec = new PulseJetRecipe(in, itemstack, temp);
        this.createRecipe(rec, rl);
    }

    private PulseJetRecipe
    addSmelting(ItemStack in, ItemStack itemstack, RecipeLevel rl) {
    ...
    private void addSmelting(Block b, ItemStack itemstack, RecipeLevel rl) {
        this.addSmelting(
            new ItemStack(b, 1, OreDictionary.WILDCARD_VALUE), itemstack, rl
        );
    }

    private void addSmelting(Block b, ItemStack itemstack, int temp, RecipeLevel rl) {
        this.addSmelting(
            new ItemStack(b, 1, OreDictionary.WILDCARD_VALUE), itemstack, temp, rl
        );
    }

    private void addSmelting(Item i, ItemStack itemstack, RecipeLevel rl) {
        this.addSmelting(
            new ItemStack(i, 1, OreDictionary.WILDCARD_VALUE), itemstack, rl
        );
    }

    private void addSmelting(Item i, ItemStack itemstack, int temp, RecipeLevel rl) {
        this.addSmelting(
            new ItemStack(i, 1, OreDictionary.WILDCARD_VALUE), itemstack, temp, rl
        );
    }
    ...
    public void addPostLoadRecipes() {
        if (ModList.THERMALFOUNDATION.isLoaded()) {
            ItemStack enderdust = GameRegistry.findItemStack(
                ModList.THERMALFOUNDATION.modLabel, "dustEnderium", 1
            );
            ItemStack enderingot = GameRegistry.findItemStack(
        ...
        if (ModList.ARSENAL.isLoaded()) {
            ...
            if (fluxdust == null || fluxingot == null)
                RotaryCraft.logger.logError(
                    "No item found for Redstone Arsenal fluxed ingot crafting!"
                );
            else
        ...
        if (ModList.IC2.isLoaded()) {
            ...
            for (int i = 0; i < items.length; i++) {
                if (items[i] != null) {
                    this.addRecycling(
                        items[i].getItem(),
                        ReikaItemHelper.getSizedItemStack(out, n[i]),
                        RecipeLevel.MODINTERACT
                    );
                }
            }
        }
        ...
        if (ModList.RAILCRAFT.isLoaded()) {
            Object[] items = { "tool.steel.pickaxe", "tool.steel.axe",
                               "tool.steel.sword",   "tool.steel.hoe",
                               "tool.steel.shovel",  "armor.steel.helmet",
                               "armor.steel.plate",  "armor.steel.legs",
                               "armor.steel.boots",  "tool.steel.shears",
                               "tool.crowbar",       "tool.crowbar.reinforced" };

            int[] n = { 3, 3, 2, 2, 1, 5, 8, 7, 4, 2, 3, 3 };

            for (int i = 0; i < items.length; i++) {
                items[i]
                    = ReikaItemHelper.lookupItem(ModList.RAILCRAFT, (String) items[i], 0);
            }
            ...
            for (int i = 0; i < items.length; i++) {
                if (items[i] != null) {
                    ...
                    this.addRecycling(
                        ((ItemStack) items[i]).getItem(),
                        ReikaItemHelper.getSizedItemStack(outb, n[i]),
                        RecipeLevel.MODINTERACT
                    );
                }
            }
        ...
        if (ModList.ENDERIO.isLoaded()) {
            Object[] items = {
                "item.darkSteel_pickaxe",    "item.darkSteel_axe",
                "item.darkSteel_sword",      "item.darkSteel_helmet",
                "item.darkSteel_chestplate", "item.darkSteel_leggings",
                "item.darkSteel_boots",      "item.darkSteel_shears",
            };

            int[] n = { 3, 3, 2, 5, 8, 7, 4, 2 };

            for (int i = 0; i < items.length; i++) {
                items[i]
                    = ReikaItemHelper.lookupItem(ModList.ENDERIO, (String) items[i], 0);
            }
        ...
        if (ModList.THAUMCRAFT.isLoaded()) {
            Object[] items
                = { "ItemPickThaumium",       "ItemAxeThaumium",     "ItemSwordThaumium",
                    "ItemHoeThaumium",        "ItemShovelThaumium",  "ItemHelmetThaumium",
                    "ItemChestplateThaumium", "ItemLeggingsThaumium" };

            int[] n = { 3, 3, 2, 2, 1, 5, 8, 7 };

            for (int i = 0; i < items.length; i++) {
                items[i] = ReikaItemHelper.lookupItem(
                    ModList.THAUMCRAFT, (String) items[i], 0
                );
            }
            ...
            for (Materials m : Materials.values()) {
                ...
                for (Tools t : Tools.values()) {
                    ...
                    if (i != null) {
                        this.addRecycling(
                            i,
                            ReikaItemHelper.getSizedItemStack(out, t.getNumberIngots(m)),
                            RecipeLevel.MODINTERACT
                        );
                    }
                }
    ...
    @Override
    protected boolean addCustomRecipe(String n, LuaBlock lb, CustomRecipeList crl)
        throws Exception {
        ItemStack in
            = crl.parseItemString(lb.getString("input"), lb.getChild("input_nbt"), false);
        ...
        if (lb.containsKey("required_temperature")) {
            ...
            if (temp <= 200) {
                ...
                throw new IllegalArgumentException(
                    "Recipe is impossible - temperature exceeds maximum"
                );
            }
        }
    ...
    private static int getDefaultMeltingTemp(ItemStack is) {
        ...
        return MathHelper.clamp_int(
            ItemMaterialController.instance.getMeltingPoint(is) / 2, 400, 850
        );
    }
}
