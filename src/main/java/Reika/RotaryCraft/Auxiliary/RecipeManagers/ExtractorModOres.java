...
public class ExtractorModOres {
    public static void registerRCIngots() {
        for (int i = 0; i < ModOreList.oreList.length; i++) {
            OreDictionary.registerOre(
                ModOreList.oreList[i].getProductOreDictName(),
                ItemRegistry.MODINGOTS.getStackOfMetadata(i)
            );
        }
        ...
        if (ModOreList.ENDIUM.existsInGame())
            OreDictionary.registerOre(
                "ingotHeeEndium",
                ItemRegistry.MODINGOTS.getStackOfMetadata(ModOreList.ENDIUM.ordinal())
            );
    ...
    public static void addSmelting() {
        for (int i = 0; i < ModOreList.oreList.length; i++) {
            ...
            ItemStack in
                = ItemRegistry.MODEXTRACTS.getStackOfMetadata(getFlakesIndex(ore));
            ItemStack out = ReikaItemHelper.getSizedItemStack(
                getSmeltedIngot(ore), ore.getDropCount()
            );
            ReikaRecipeHelper.addSmelting(
                in,
                out,
                ore.rarity == OreRarity.RARE             ? 1
                    : ore.rarity == OreRarity.EVERYWHERE ? 0.5F
                                                         : 0.7F
            );
        }
    }
    ...
    public static void addCustomSmelting() {
        ...
        for (int i = 0; i < li.size(); i++) {
            ...
            ReikaRecipeHelper.addSmelting(
                in,
                out,
                e.rarity == OreRarity.RARE             ? 1
                    : e.rarity == OreRarity.EVERYWHERE ? 0.5F
                                                       : 0.7F
            );
        }
    }
    ...
    public static boolean isOreFlake(ItemStack is) {
        if (ItemRegistry.EXTRACTS.matchItem(is)) {
            return ReikaMathLibrary.isValueInsideBoundsIncl(
                ItemStacks.coaloreflakes.getItemDamage(),
                ItemStacks.tungstenflakes.getItemDamage(),
                is.getItemDamage()
            );
    ...
    public static OreType getOreFromExtract(ItemStack is) {
        if (is.getItem() instanceof AutoOreItem)
            ...
            return ReikaOreHelper
                .oreList[is.getItemDamage() % ReikaOreHelper.oreList.length];
        } else if (ItemRegistry.MODEXTRACTS.matchItem(is)) {
    ...
    public static ItemStack getSmeltedIngot(ModOreList ore) {
        switch (ore) {
            ...
            case NETHERCOPPER:
                return ItemRegistry.MODINGOTS.getStackOfMetadata(
                    ModOreList.COPPER.ordinal()
                );
            case NETHERDIAMOND:
            ...
            case NETHERNICKEL:
                return ItemRegistry.MODINGOTS.getStackOfMetadata(
                    ModOreList.NICKEL.ordinal()
                );
            case NETHERNIKOLITE:
                return ItemRegistry.MODINGOTS.getStackOfMetadata(
                    ModOreList.NIKOLITE.ordinal()
                );
            case NETHERREDSTONE:
                return new ItemStack(Items.redstone);
            case NETHERSILVER:
                return ItemRegistry.MODINGOTS.getStackOfMetadata(
                    ModOreList.SILVER.ordinal()
                );
            case NETHERTIN:
            ...
            case NETHERPLATINUM:
                return ItemRegistry.MODINGOTS.getStackOfMetadata(
                    ModOreList.PLATINUM.ordinal()
                );
            case NETHERURANIUM:
                return ItemRegistry.MODINGOTS.getStackOfMetadata(
                    ModOreList.URANIUM.ordinal()
                );
            case NETHERIRIDIUM:
                return ItemRegistry.MODINGOTS.getStackOfMetadata(
                    ModOreList.IRIDIUM.ordinal()
                );
            case NETHERSULFUR:
                return ItemRegistry.MODINGOTS.getStackOfMetadata(
                    ModOreList.SULFUR.ordinal()
                );
            case NETHERTITANIUM:
                return ItemRegistry.MODINGOTS.getStackOfMetadata(
                    ModOreList.TITANIUM.ordinal()
                );
            case NETHEROSMIUM:
                return ItemRegistry.MODINGOTS.getStackOfMetadata(
                    ModOreList.OSMIUM.ordinal()
                );
            case NETHERSALTPETER:
                return ItemRegistry.MODINGOTS.getStackOfMetadata(
                    ModOreList.SALTPETER.ordinal()
                );
            default:
