...
public class RecipesGrinder extends RecipeHandler implements GrinderManager {
    ...
    private RecipesGrinder() {
        ...
        this.addRecipe(
            Blocks.stone, new ItemStack(Blocks.cobblestone), RecipeLevel.PERIPHERAL
        );
        this.addRecipe(
            Blocks.cobblestone, new ItemStack(Blocks.gravel), RecipeLevel.PERIPHERAL
        );
        ...
        this.addRecipe(
            Blocks.sandstone, new ItemStack(Blocks.sand), RecipeLevel.PERIPHERAL
        );
        this.addRecipe(
            Blocks.sandstone_stairs,
            new ItemStack(Blocks.sand, 6, 0),
        ...
        this.addRecipe(
            Blocks.stonebrick, new ItemStack(Blocks.cobblestone), RecipeLevel.PERIPHERAL
        );
        this.addRecipe(
            Blocks.furnace,
            new ItemStack(Blocks.cobblestone, 8, 0),
            RecipeLevel.PERIPHERAL
        );
        this.addRecipe(
            Blocks.brick_block,
        ...
        this.addRecipe(
            Blocks.clay, new ItemStack(Items.clay_ball, 4, 0), RecipeLevel.PERIPHERAL
        );
        this.addRecipe(
            Blocks.brick_stairs,
            new ItemStack(Items.clay_ball, 6, 0),
            RecipeLevel.PERIPHERAL
        );
        this.addRecipe(
            Items.brick, new ItemStack(Items.clay_ball), RecipeLevel.PERIPHERAL
        );
        this.addRecipe(
            Blocks.stone_stairs,
        ...
        this.addRecipe(
            Items.wheat,
            ReikaItemHelper.getSizedItemStack(ItemStacks.flour, 3),
            RecipeLevel.PERIPHERAL
        );

        this.addRecipe(
            ItemStacks.bedingot.copy(),
            ReikaItemHelper.getSizedItemStack(ItemStacks.bedrockdust, 4),
            RecipeLevel.PROTECTED
        );
        this.addRecipe(
            ItemStacks.aluminumingot.copy(),
            ItemStacks.aluminumpowder.copy(),
            RecipeLevel.PROTECTED
        );

        this.addRecipe(
            Items.reeds, new ItemStack(Items.sugar, 3), RecipeLevel.PROTECTED
        ); //, ReikaItemHelper.getSizedItemStack(ItemStacks.mulch,
           //PlantMaterials.SUGARCANE.getPlantValue()));
        this.addRecipe(
            Items.bone, new ItemStack(Items.dye, 9, 15), RecipeLevel.PROTECTED
        );
        this.addRecipe(
            Items.blaze_rod,
            new ItemStack(Items.blaze_powder, 6, 0),
            RecipeLevel.PROTECTED
        );
        this.addRecipe(
            Blocks.ice, new ItemStack(Items.snowball, 4, 0), RecipeLevel.PROTECTED
        );

        for (int i = 0; i < ReikaTreeHelper.treeList.length; i++) {
            ReikaTreeHelper tree = ReikaTreeHelper.treeList[i];
            this.addRecipe(
                tree.getLog().asItemStack(),
                this.getSizedSawdust(16),
                RecipeLevel.PERIPHERAL
            );
            this.addRecipe(
                new ItemStack(Blocks.planks, 1, tree.ordinal()),
                this.getSizedSawdust(4),
                RecipeLevel.PERIPHERAL
            );
        }
        this.addRecipe(
            Blocks.noteblock, this.getSizedSawdust(32), RecipeLevel.PERIPHERAL
        );
        ...
        this.addRecipe(
            Blocks.oak_stairs, this.getSizedSawdust(6), RecipeLevel.PERIPHERAL
        );
        this.addRecipe(
            Blocks.birch_stairs, this.getSizedSawdust(6), RecipeLevel.PERIPHERAL
        );
        this.addRecipe(
            Blocks.spruce_stairs, this.getSizedSawdust(6), RecipeLevel.PERIPHERAL
        );
        this.addRecipe(
            Blocks.jungle_stairs, this.getSizedSawdust(6), RecipeLevel.PERIPHERAL
        );
        this.addRecipe(
            Blocks.acacia_stairs, this.getSizedSawdust(6), RecipeLevel.PERIPHERAL
        );
        this.addRecipe(
            Blocks.dark_oak_stairs, this.getSizedSawdust(6), RecipeLevel.PERIPHERAL
        );
        this.addRecipe(Blocks.chest, this.getSizedSawdust(32), RecipeLevel.PERIPHERAL);
        this.addRecipe(
            Blocks.crafting_table, this.getSizedSawdust(16), RecipeLevel.PERIPHERAL
        );
        this.addRecipe(Blocks.ladder, this.getSizedSawdust(4), RecipeLevel.PERIPHERAL);
        this.addRecipe(
            Blocks.wooden_pressure_plate, this.getSizedSawdust(8), RecipeLevel.PERIPHERAL
        );
        this.addRecipe(
        ...
        this.addRecipe(
            Items.bowl,
            this.getSizedSawdust(ModList.GREGTECH.isLoaded() ? 4 : 12),
            RecipeLevel.PERIPHERAL
        );
        this.addRecipe(
            Items.wooden_door, this.getSizedSawdust(24), RecipeLevel.PERIPHERAL
        );
        ...
        this.addRecipe(
            Blocks.fence_gate, this.getSizedSawdust(16), RecipeLevel.PERIPHERAL
        );
        ...
        this.addOreDictRecipe(
            "plankWood", this.getSizedSawdust(4), RecipeLevel.PERIPHERAL
        );
        this.addOreDictRecipe(
            "logWood", this.getSizedSawdust(16), RecipeLevel.PERIPHERAL
        );
    }
    ...
    private static class GrinderRecipe {
        ...
        public ItemStack[] getOutputs() {
            return output2 != null ? new ItemStack[]{output1.copy(), output2.copy()} : new
    ItemStack[]{output1.copy()};
        }

        public boolean makesItem(ItemStack is) {
            return ReikaItemHelper.matchStacks(is, output1) || (output2 != null &&
    ReikaItemHelper.matchStacks(is, output2));
        }
    ...
    public void addDualOreDictRecipe(String in, String out, int numout, RecipeLevel rl) {
        ItemStack isout = ReikaItemHelper.oreItemExists(out)
            ? OreDictionary.getOres(out).get(0)
            : null;
        if (isout != null) {
            this.addOreDictRecipe(
                in, ReikaItemHelper.getSizedItemStack(isout, numout), rl
            );
        }
    }
    ...
    public ItemStack getGrindingResult(ItemStack item) {
        GrinderRecipe ret
            = item != null && item.getItem() != null ? recipes.get(item) : null;
    ...
    public void addPostLoadRecipes() {
        ...
        if (ModList.APPENG.isLoaded()) {
            ...
            if (cry != null && dust != null) {
                ...
                RotaryCraft.logger.logError(
                    "Could not add certus quartz grinding; null itemstack " + cry + ", "
                    + dust
                );
            }
            ...
            if (fluix != null && fluixdust != null) {
                ...
                RotaryCraft.logger.logError(
                    "Could not add certus quartz grinding; null itemstack " + fluix + ", "
                    + fluixdust
                );
            }
        }
        ...
        if (!obsididust.isEmpty())
            this.addRecipe(
                Blocks.obsidian,
                ReikaItemHelper.getSizedItemStack(obsididust.get(0), 6),
        ...
        if (ModList.BOTANIA.isLoaded()) {
            ...
            for (int i = 0; i < 16; i++) {
                ...
                int tallm = i % 8;
                this.addRecipe(
                    new ItemStack(flower, 1, i),
                    new ItemStack(petal, 6, i),
                    RecipeLevel.MODINTERACT
                );
                this.addRecipe(
                    new ItemStack(tall, 1, tallm),
                    new ItemStack(petal, 12, i),
                    RecipeLevel.MODINTERACT
                );
                this.addRecipe(
                    new ItemStack(petal, 1, i),
                    new ItemStack(dye, 3, i),
                    RecipeLevel.MODINTERACT
                );
            }
        }
        ...
        if (ReikaItemHelper.oreItemExists("dustEnderPearl"))
            this.addRecipe(
                Items.ender_pearl,
                OreDictionary.getOres("dustEnderPearl").get(0),
                RecipeLevel.MODINTERACT
            );
        else if (ReikaItemHelper.oreItemExists("dustEnder"))
            this.addRecipe(
                Items.ender_pearl,
                OreDictionary.getOres("dustEnder").get(0),
                RecipeLevel.MODINTERACT
            );
        ...
        if (ModList.HARVESTCRAFT.isLoaded()) {
            ...
            if (corn != null && fla != null)
                this.addRecipe(
                    corn,
                    ReikaItemHelper.getSizedItemStack(fla, 3),
                    RecipeLevel.MODINTERACT
                );
        }
        ...
        if (ModList.GEOSTRATA.isLoaded()) {
            this.addOreDictRecipe(
                "seedCreepvine", ItemStacks.compost, RecipeLevel.MODINTERACT
            );
        }
        ...
        this.addOreDictRecipe(
            ...
            ReikaItemHelper.getSizedItemStack(
                ExtractorModOres.getSmeltedIngot(ModOreList.CINNABAR), 3
            ),
            RecipeLevel.MODINTERACT
        );
    }
    ...
    private void addMulchRecipes() {
        ...
        for (ItemStack is : mulches) {
            if (is.getItem() != Items.reeds) {
                ...
                this.addRecipe(is, ReikaItemHelper.getSizedItemStack(ItemStacks.mulch,
    num)); RotaryCraft.logger.log("Adding grinder mulching recipe for "+is+", makes
    "+num);
            }
        }
    }
    ...
    private void addOreRecipes() {
        for (int i = 0; i < ReikaOreHelper.oreList.length; i++) {
            ...
            for (ItemStack is : li) {
                if (recipes.containsKey(is)) {
                    ReikaOreHelper mod
                        = ReikaOreHelper.oreList[recipes.get(is).output.getItemDamage()];
                    RotaryCraft.logger.log(
                        "Ore " + is.getDisplayName()
                        + " is being skipped for grinder registration as " + ore
                        + " as it is already registered to " + mod
                    );
                } else {
                    ItemStack flake = ItemRegistry.EXTRACTS.getCraftedMetadataProduct(
                        ore_rate, 24 + ore.ordinal()
                    );
                    this.addRecipe(
                        is,
                        ReikaItemHelper.getSizedItemStack(flake, ore_rate),
                        RecipeLevel.CORE
                    );
                    int n = ore_rate;
                    if (ore.getRarity() == OreRarity.RARE)
                        n *= 3;
                    RotaryCraft.logger.log(
                        "Adding " + n + "x grinder recipe for " + ore + " ore " + is
                    );
                }
            }
        }
        ...
        for (int i = 0; i < ModOreList.oreList.length; i++) {
            ...
            for (ItemStack is : li) {
                if (recipes.containsKey(is)) {
                    OreType mod
                        = ExtractorModOres.getOreFromExtract(recipes.get(is).output);
                    RotaryCraft.logger.log(
                        "Ore " + is.getDisplayName()
                        + " is being skipped for grinder registration as " + ore
                        + " as it is already registered to " + mod
                    ...
                    this.addRecipe(
                        is, ReikaItemHelper.getSizedItemStack(flake, n), RecipeLevel.CORE
                    );
                    RotaryCraft.logger.log(
                        "Adding " + (n) + "x grinder recipe for " + ore + " ore " + is
                    );
    ...
    private void loadGTOres() {
        for (CounterpartOres ore : CounterpartOres.oreList) {
            for (ItemStack is : ore.getAllOreBlocks()) {
                ...
                ItemStack flake = base instanceof ReikaOreHelper
                    ? ItemRegistry.EXTRACTS.getCraftedMetadataProduct(
                        n, 24 + base.ordinal()
                    )
                    : ExtractorModOres.getFlakeProduct((ModOreList) base);
                flake.stackSize = n;
                this.addRecipe(
                    is, ReikaItemHelper.getSizedItemStack(flake, n), RecipeLevel.CORE
                );
                RotaryCraft.logger.log(
                    "Adding " + (n) + "x grinder recipe for GT ore " + ore
                );
            }
        }
    }
        ...
        if (ore != null && !ore.isEmpty() && !ore.startsWith("[NULL")) {
            ...
            if (c.isEmpty()) {
                throw new IllegalArgumentException(
                    "Ore tag '" + ore + "' does not map to any existing OreDict tag!"
                );
            }
            for (ItemStack in : c) {
