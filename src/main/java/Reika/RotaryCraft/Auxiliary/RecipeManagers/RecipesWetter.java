...
public class RecipesWetter extends RecipeHandler implements WetterManager {
    ...
    private void addRecipe(
        ItemStack in, String s, int amount, ItemStack out, int time, RecipeLevel rl
    ) {
    ...
    private void addRecipe(
        ItemStack in, Fluid f, int amount, ItemStack out, int time, RecipeLevel rl
    ) {
    ...
    public static class WettingRecipe implements MachineRecipe {
        ...
        public String getUniqueID() {
            return fluid.getFluid().getName() + ":" + fluid.amount + "+" + fullID(input)
                + ">" + fullID(output) + "#" + duration;
        }

        @Override
        public String getAllInfo() {
            return "Mixing " + fluid.amount + " of " + fluid.getLocalizedName() + " into "
                + fullID(input) + " for " + fullID(output) + " over " + duration
                + " ticks";
        }
