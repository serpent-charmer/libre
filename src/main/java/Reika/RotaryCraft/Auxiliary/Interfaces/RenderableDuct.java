...
/**
 * Make your TE implement this to be able to use the RotaryCraft pipe renderer classes on
 * your own pipe.
 */
public interface RenderableDuct {
    ...
    /**
     * The block type used for most of the solid texture; usually also the main crafting
     * ingredient
     */
    ...
    /**
     * Is the pipe connected to something that is not another pipe of this type, on the
     * given side (relative to the pipe)
     */
