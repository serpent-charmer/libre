...
public class HeatRippleRenderer implements ShaderHook {
    ...
    public boolean addHeatRippleEffectIfLOS(
        TileEntity tile,
        double x,
        double y,
        double z,
        ...
        return this.addHeatRippleEffectIfLOS(
            tile, x, y, z, ep, dist, f, fac, scale, centerFade
        );
    }
    ...
    public boolean addHeatRippleEffectIfLOS(
        ...
        if (LOS.isClearLineOfSight(tile)) {
            HeatRippleRenderer.instance.addHeatRippleEffect(
                tile, dist, f, fac, scale, centerFade
            );
            return true;
        }
        return false;
    ...
    public void addHeatRippleEffect(
        TileEntity tile, double dist, float f, float fac, float scale, float centerFade
    ) {
