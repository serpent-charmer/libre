            ...
            if (r1 == r2) {
                ...
                switch (r1) {
                    case GEARBOX: {
                        ...
                        return g1.compareTo(g2) * 50
                            + Integer.compare(is1.getItemDamage(), is2.getItemDamage());
                    }
                    case SHAFT: {
                        ...
                        MaterialRegistry m1
                            = MaterialRegistry.getMaterialFromShaftItem(is1);
                        MaterialRegistry m2
                            = MaterialRegistry.getMaterialFromShaftItem(is2);
