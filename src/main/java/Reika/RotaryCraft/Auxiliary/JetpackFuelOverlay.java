                ...
                if (ir != null) {
                    if (ir.isJetpack()) {
                        ...
                        ReikaTextureHelper.bindTexture(
                            RotaryCraft.class, "Textures/GUI/overlays.png"
                        );
                        ...
                        float u = w;
                        if (fluid != null
                            && fluid.equals(FluidRegistry.getFluid("rc jet fuel")))
                            u += w;
                        ...
                        Minecraft.getMinecraft().fontRenderer.drawString(
                            String.format("%d%s", Math.round(frac * 100), "%"),
                            1,
                            height / 2 - 40,
                            0xffffff
                        );
                        Minecraft.getMinecraft().fontRenderer.drawString(
                            String.format("%dmB", fuel), 1, height / 2 + 33, 0xffffff
                        );
