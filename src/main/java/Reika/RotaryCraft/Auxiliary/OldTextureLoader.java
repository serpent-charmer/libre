...
public class OldTextureLoader {
    ...
    private final EnumMap<MachineRegistry, IconSide> machineIcons
    ...
    private OldTextureLoader() {
        machineIcons.put(
            MachineRegistry.SHAFT,
            new IconSide(8).addSideTexture(2, 9).addSideTexture(3, 9)
        );
        machineIcons.put(
            MachineRegistry.GEARBOX,
            new IconSide(8)
                .addSideTexture(0, 10)
                .addSideTexture(1, 10)
                .addSideTexture(2, 9)
        ...
        machineIcons.put(
            ...
            new IconSide(1).addSideTexture(2, 2).addSideTexture(3, 3).addSideTexture(1, 4)
        );
        machineIcons.put(
            MachineRegistry.FERMENTER,
            new IconSide(20).addSideTexture(2, 21).addSideTexture(3, 22)
        );
        machineIcons.put(
            MachineRegistry.CLUTCH,
            new IconSide(25).addSideTexture(2, 26).addSideTexture(3, 26)
        );
        machineIcons.put(
            MachineRegistry.BEVELGEARS,
            new IconSide(27).addSideTexture(3, 28).addSideTexture(5, 28).addSideTexture(
                1, 28
            )
        );
        machineIcons.put(
            MachineRegistry.FLOODLIGHT,
            new IconSide(29)
                .addSideTexture(3, 31)
                .addSideTexture(4, 30)
                .addSideTexture(5, 30)
        ...
        machineIcons.put(
            ...
            new IconSide(49).addSideTexture(2, 50).addSideTexture(3, 51)
        );
        machineIcons.put(MachineRegistry.HEATRAY, new IconSide(53).addSideTexture(2, 54));
        machineIcons.put(
            MachineRegistry.BORER,
            new IconSide(57).addSideTexture(2, 58).addSideTexture(3, 59)
        );
        machineIcons.put(
            MachineRegistry.FLYWHEEL, new IconSide(23).addSideTexture(2, 24)
        );
        machineIcons.put(
            MachineRegistry.ENGINE,
            new IconSide(1).addSideTexture(2, 14).addSideTexture(3, 15)
        );
        machineIcons.put(
            MachineRegistry.DYNAMOMETER,
            new IconSide(34).addSideTexture(2, 35).addSideTexture(3, 35)
        );
    ...
    public int getIndex(Block b, int meta, int side) {
        ...
        int index = ics == null                  ? -1
            : ics.sideTextures.containsKey(side) ? ics.sideTextures.get(side)
                                                 : ics.fallback;
    ...
    public String getMagnetostaticName() {
        return magnetoNames.get((int
               ) ((System.currentTimeMillis() / 4000) % magnetoNames.size()))
            + " Engine";
    }
