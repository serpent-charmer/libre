...
public class DonatorGearRender implements PlayerRenderObj {
    ...
    public void render(EntityPlayer ep, float ptick, PlayerRotationData dat) {
        ...
        //GL11.glRotated(RenderManager.instance.playerViewY-ep.rotationYawHead-45, 0, 1,
        //0);
        Reika.RotaryCraft.ClientProxy.getSpritesheetRenderer(0).renderItem(
            ItemRenderType.ENTITY,
            ItemStacks.steelgear,
            new InertItem(ep.worldObj, ItemStacks.steelgear)
        );
        GL11.glPopMatrix();
    }
