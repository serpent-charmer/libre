        ...
        try {
            switch (pack) {
                ...
                case SPAWNERTIMER: {
                    //ModLoader.getMinecraftInstance().thePlayer.addChatMessage(String.format("%d
                    //%d", control, data));
                    TileEntitySpawnerController spawner
                        = (TileEntitySpawnerController) te;
                    if (data[0] == -1) {
                ...
                case MUSICNOTE: {
                    ...
                    Note n = new Note(
                        NoteLength.values()[data[2]],
                        data[0],
                        Instrument.values()[data[3]]
                    );
                    for (int i = 0; i < 3; i++)
                        ; //n.play(world, x, y, z);
                ...
                case CONTAINMENT:
                    ...
                    break;
                case ITEMCANNON:
                    ((TileEntityItemCannon) te)
                        .selectNewTarget(data[0], data[1], data[2], data[3]);
                    break;
                case MIRROR:
                ...
                case MUSICPARTICLE:
                    world.spawnParticle(
                        "note",
                        x + 0.2 + rand.nextDouble() * 0.6,
                        y + 1.2,
                        z + 0.2 + rand.nextDouble() * 0.6,
                        rand.nextDouble(),
                        0.0D,
                        0.0D
                    ); //activeNote/24D
                ...
                case MULTISIDE:
                    ...
                    break;
                case TERRAFORMER:
                    ((TileEntityTerraformer) te)
                        .setTarget(BiomeGenBase.biomeList[data[0]]);
                    break;
                case CONVERTERPOWER:
                ...
                case POWERBUS:
                    ...
                    break;
                case PARTICLES:
                    ((TileEntityParticleEmitter) te).particleType
                        = ReikaParticleHelper.particleList[data[0]];
                    break;
                case BLOWERWHITELIST:
                    ((TileEntityBlower) te).isWhitelist
                        = !((TileEntityBlower) te).isWhitelist;
                    break;
                case BLOWERMETA:
                    ((TileEntityBlower) te).checkMeta
                        = !((TileEntityBlower) te).checkMeta;
                    break;
                case BLOWERNBT:
                    ...
                    break;
                case BLOWEROREDICT:
                    ((TileEntityBlower) te).useOreDict
                        = !((TileEntityBlower) te).useOreDict;
                    break;
                case DEFOLIATOR:
                    ((TileEntityDefoliator) te)
                        .onBlockBreak(world, data[0], data[1], data[2]);
                    break;
                case GPR:
                ...
                case CRAFTPATTERNMODE:
                    ItemCraftPattern.setMode(
                        ep.getCurrentEquippedItem(), RecipeMode.list[data[0]]
                    );
                    break;
                case CRAFTPATTERNLIMIT:
                    ItemCraftPattern.changeStackLimit(
                        ep.getCurrentEquippedItem(), data[0]
                    );
                    break;
                case FILTERSETTING:
                    ...
                    break;
                case SPRINKLER:
                    ((TileEntitySprinkler) te)
                        .doParticle(world, data[0], data[1], data[2], data[3] > 0);
                    break;
                case BLASTLEAVEONE:
                ...
                case SPARKLOC:
                    if (data[4] > 0) {
                        EMPSparkRenderer.instance.addSparkingLocation(
                            new WorldLocation(data[0], data[1], data[2], data[3])
                        );
                    } else {
                        EMPSparkRenderer.instance.removeSparkingLocation(
                            new WorldLocation(data[0], data[1], data[2], data[3])
                        );
                    }
                    break;
                case DISTRIBCLUTCH:
                    ((TileEntityDistributionClutch) te)
                        .setSideEnabled(
                            ForgeDirection.VALID_DIRECTIONS[data[0] + 2], data[1] > 0
                        );
                    break;
            ...
            RotaryCraft.logger.logError(
                "Machine/item was deleted before its packet " + pack
                + " could be received, or was not present at all!"
            );
