...
public class IOAPI {
    ...
    static {
        try {
            io = Class.forName(
                "Reika.RotaryCraft.Auxiliary.IORenderer",
                false,
                IOAPI.class.getClassLoader()
            );
            render = io.getMethod(
                "renderIO", TileEntity.class, double.class, double.class, double.class
            );
     ...
     * @param par2 The "par2" passed in the "renderTileEntityAt"; related to
     *     x-displacement
     * @param par4 The "par4" passed in the "renderTileEntityAt"; related to
     *     y-displacement
     * @param par6 The "par6" passed in the "renderTileEntityAt"; related to
     *     z-displacement
     */
    public static void
    renderIO(ShaftMachine machine, double par2, double par4, double par6) {
        try {
