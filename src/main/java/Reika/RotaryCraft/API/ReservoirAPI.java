...
/**
 * Use this to register custom reservoir handlers, so that a reservoir can perform
 * specialized actions such as special recipe types.
 */
public class ReservoirAPI {
    ...
    public static interface TankHandler {
        /**
         * Returns the amount of liquid to drain. Do not drain the liquidstack directly,
         * but you can modify it in other ways.
         */
    ...
    static {
        try {
            Class c = Class.forName(
                "Reika.RotaryCraft.TileEntities.Storage.TileEntityReservoir"
            );
