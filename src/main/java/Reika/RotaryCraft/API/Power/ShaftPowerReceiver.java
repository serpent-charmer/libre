...
/**
 * This is for basic RC power compatibility. Results with a machine that accepts power
 * from multiple sides is undefined unless you specifically handle for it; for such cases
 * the use of {@link AdvancedShaftPowerReceiver} is recommended instead.
 *
