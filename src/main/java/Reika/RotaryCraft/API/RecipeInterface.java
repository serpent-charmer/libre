...
public class RecipeInterface {
    ...
    public static interface CompactorManager extends RecipeManager {
        public void
        addAPIRecipe(ItemStack in, ItemStack out, int pressure, int temperature);
    }
    ...
    public static interface CentrifugeManager extends RecipeManager {
        public void
        addAPIRecipe(ItemStack in, FluidStack fout, float chanceout, Object... items);
    }
    ...
    public static interface RockMelterManager extends RecipeManager {
        public void
        addAPIRecipe(ItemStack in, FluidStack out, int temperature, long energy);
    }

    public static interface WetterManager extends RecipeManager {
        public void
        addAPIRecipe(ItemStack in, Fluid f, int amount, ItemStack out, int time);
    }
    ...
    public static interface BlastFurnaceManager extends RecipeManager {
        /**
         * The first nine arguments are for the 3 slots on the left - three groups of
         * ItemStack, chance-to-consume, and number-to-consume. To ignore a slot, supply
         * an empty collection, NOT null.
         *
         * The other arguments control the rest of the recipe. 'Main' is the main grid
         * item (like iron for HSLA), 'req' is how many of it are required (supply -1 for
         * "any"), 'bonus' is whether and how much bonus output amounts can be given (>0
         * to give any, with the actual value as a multiplier).
         */
        ...
        /**
         * For adding 3x3 crafting recipes like bedrock tool crafting. 'Speed' works
         * inversely; higher values mean slower recipes.
         */
        public void
    ...
    public static interface MagnetizerManager extends RecipeManager {
        /**
         * Null is acceptable for an action, in which case it will use the native NBT
         * "magnet" behavior.
         */
        public void addAPIRecipe(
            ItemStack in,
            int minSpeed,
            int reqSpeedPerMicroTesla,
            int timeFactor,
            boolean allowStacks,
            MagnetizationAction a
        );
