...
/**
 * Implement this to make your crop have special compatibility with fans that goes beyond
 * the raw harvesting already implemented.
 */
@Deprecated
public interface BlowableCrop {
    ...
    /**
     * Similar to and often returns the value of world.getBlock(x, y, z).getDrops(world,
     * x, y, z, world.getBlockMetadata(), 0)
     */
