...
/**
 * Implement this on a block class that is supposed to act as an environmental heat
 * source or sink (eg ice, lava, water, plasma)
 */
public interface EnvironmentalHeatSource {
    /**
     * Returns the general type of thermal source the object is. Informs the approximate
     * temperature.
     */
    ...
    public static enum SourceType {
        ...
        public static SourceType getByTemperature(int temp) {
            ...
            return temp - colder.getKey() < hotter.getKey() - temp ? colder.getValue()
                                                                   : hotter.getValue();
        }
