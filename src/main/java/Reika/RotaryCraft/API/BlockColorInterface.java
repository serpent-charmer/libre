...
/**
 * This is used to add block color codes to the GPR (Ground Penetrating Radar) map.
 * Without doing this, your blocks will be the same shade of purple in the GUI as MCEdit
 * uses for unknown blocks.
 */
public class BlockColorInterface {
    ...
    public static void
    addGPRBlockMimic(Block blockID, int metadata, Block mimic, int mimicM) {
    ...
    public static void
    addGPRBlockColor(Block blockID, int metadata, int red, int green, int blue) {
