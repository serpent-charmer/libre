...
public class EntityFreezeGunShot extends EntityTurretShot {
    ...
    public void onImpact(MovingObjectPosition mov) {
        ...
        AxisAlignedBB splash
            = AxisAlignedBB.getBoundingBox(x, y, z, x, y, z).expand(2, 2, 2);
    ...
    protected void applyAttackEffectsToEntity(World world, Entity el) {
        ...
        if (el instanceof EntityLivingBase)
            ((EntityLivingBase) el)
                .addPotionEffect(TileEntityFreezeGun.getFreezeEffect(60000));
    }
    ...
    public void onUpdate() {
        ...
        hit
            = (mobs.size() > 0
               || (m != MachineRegistry.FREEZEGUN && id != Blocks.air
