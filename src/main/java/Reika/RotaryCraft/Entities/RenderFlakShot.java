...
public class RenderFlakShot extends Render {
    ...
    public void renderTheFlakShot(
        EntityFlakShot e, double par2, double par4, double par6, float par8, float par9
    ) {
        GL11.glPushMatrix();
        ...
        ClientProxy.getSpritesheetRenderer(0).renderItem(
            ItemRenderType.ENTITY,
            ItemStacks.scrap,
            new Object[] { new RenderBlocks(), e }
        );
