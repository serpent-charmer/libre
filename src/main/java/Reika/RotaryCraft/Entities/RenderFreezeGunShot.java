...
public class RenderFreezeGunShot extends Render {
    ...
    public void renderTheFreezeGunShot(
        EntityFreezeGunShot par1EntityFreezeGunShot,
        double par2,
        double par4,
        double par6,
        float par8,
        ...
        ReikaTextureHelper.bindTexture(
            RotaryCraft.class, "/Reika/RotaryCraft/Textures/Entity/freezegun.png"
        );
    ...
    public void doRender(
        ...
        this.renderTheFreezeGunShot(
            (EntityFreezeGunShot) par1Entity, par2, par4, par6, par8, par9
        );
    }
