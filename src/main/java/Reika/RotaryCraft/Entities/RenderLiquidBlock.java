...
public class RenderLiquidBlock extends Render {
    ...
    public void renderLiquidBlock(
        EntityLiquidBlock e, double par2, double par4, double par6, float par8, float par9
    ) {
    ...
    public void doRender(
        ...
        this.renderLiquidBlock(
            (EntityLiquidBlock) par1Entity, par2, par4, par6, par8, par9
        );
    }
