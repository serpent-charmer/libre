...
public class RenderIceBlock extends Render {
    ...
    public void renderIce(
        EntityIceBlock e, double par2, double par4, double par6, float par8, float par9
    ) {
        GL11.glPushMatrix();
        GL11.glTranslated(par2, par4, par6);
        ReikaTextureHelper.bindTexture(
            RotaryCraft.class, "/Reika/RotaryCraft/Textures/Entity/ice.png"
        );
        ...
        var11.addVertexWithUV(
            -e.xWidth - dd / 2, e.yWidth + dd, -e.zWidth - dd / 2, 0, 1
        );
        ...
        var11.addVertexWithUV(
            -e.xWidth - dd / 2, e.yWidth + dd, -e.zWidth - dd / 2, 0, 0
        );
