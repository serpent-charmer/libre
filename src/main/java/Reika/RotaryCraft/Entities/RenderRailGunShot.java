...
public class RenderRailGunShot extends Render {
    public RenderRailGunShot() {
        shadowSize = 0.15F;
        shadowOpaque = 0.75F;
    }

    public void renderTheRailGunShot(
        ...
        ReikaTextureHelper.bindTexture(
            RotaryCraft.class, "/Reika/RotaryCraft/Textures/Entity/railgun.png"
        );
