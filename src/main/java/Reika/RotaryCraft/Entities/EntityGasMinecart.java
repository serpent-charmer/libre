...
public class EntityGasMinecart extends EntityMinecart {
    ...
    protected void func_145821_a(
        int par1, int par2, int par3, double par4, double par6, Block par8, int par9
    ) {
    ...
    public boolean interactFirst(EntityPlayer par1EntityPlayer) {
        if (MinecraftForge.EVENT_BUS.post(
                new MinecartInteractEvent(this, par1EntityPlayer)
            )) {
            return true;
        }
    ...
    public void applyEntityCollision(Entity par1Entity) {
        ...
        if (!worldObj.isRemote) {
            ...
            if (par1Entity instanceof EntityMinecart) {
                ...
                if (((EntityMinecart) par1Entity).isPoweredCart()
                    && !this.isPoweredCart()) {
