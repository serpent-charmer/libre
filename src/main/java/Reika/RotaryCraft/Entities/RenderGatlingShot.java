...
public class RenderGatlingShot extends Render {
    public RenderGatlingShot() {
        shadowSize = 0.15F;
        shadowOpaque = 0.75F;
    }

    public void renderTheGatlingShot(
        EntityTurretShot par1EntityTurretShot,
        double par2,
        double par4,
        double par6,
        float par8,
        ...
        ReikaTextureHelper.bindTexture(
            RotaryCraft.class, "/Reika/RotaryCraft/Textures/Entity/gatling.png"
        );
        Tessellator var11 = Tessellator.instance;
        float var16 = 1.0F;
        float var17 = 0.5F;
        float var18 = 0.25F;
        int var19 = par1EntityTurretShot.getBrightnessForRender(par9);
    ...
    public void doRender(
        ...
        this.renderTheGatlingShot(
            (EntityTurretShot) par1Entity, par2, par4, par6, par8, par9
        );
    }
