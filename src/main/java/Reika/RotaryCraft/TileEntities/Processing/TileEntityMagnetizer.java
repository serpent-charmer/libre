...
public class TileEntityMagnetizer extends InventoriedPowerReceiver
    implements OneSlotMachine, DiscreteFunction, ConditionalOperation, MagnetizationCore {
    ...
    public boolean isItemValidForSlot(int slot, ItemStack is) {
        ...
        return rec != null
            && ((inv[0] == null && is.stackSize == 1) || rec.allowStacking);
    }
    ...
    public void breakBlock() {
        ...
        if (this.hasLodestoneUpgrade()) {
            ReikaItemHelper.dropItem(
                ...
                yCoord + 0.5,
                zCoord + 0.5,
                ItemRegistry.UPGRADE.getStackOfMetadata(Upgrades.LODESTONE.ordinal())
            );
        }
    }

    public boolean hasCore() {
        return ReikaItemHelper.matchStacks(inv[0], ItemStacks.shaftcore)
            || ReikaItemHelper.matchStacks(inv[0], ItemStacks.tungstenshaftcore);
    }
}
