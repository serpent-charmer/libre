...
public class TileEntitySteamEngine extends TileEntityEngine {
        ...
        if (water.isEmpty() && temperature >= 100) {
            ...
            if (dryTicks > 900 && !water.isEmpty()) {
                ...
                worldObj.createExplosion(
                    null, xCoord + 0.5, yCoord + 0.5, zCoord + 0.5, 6, false
                );
            }
            dryTicks = 0;
        }
    ...
    playSounds(World world, int x, int y, int z, float pitchMultiplier, float volume) {
        ...
        SoundRegistry.STEAM.playSoundAtBlock(
            world, x, y, z, 0.7F * volume, 1F * pitchMultiplier
        );
    }
    ...
    public void overheat(World world, int x, int y, int z) {
        ...
        ReikaWorldHelper.overheat(
            world, x, y, z, ItemStacks.scrap.copy(), 0, 17, false, 1F, false, true, 2F
        );
