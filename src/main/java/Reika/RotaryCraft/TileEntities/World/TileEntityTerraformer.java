...
public class TileEntityTerraformer
    extends InventoriedPowerLiquidReceiver implements SelectableTiles, DiscreteFunction {
    ...
    public void updateEntity(World world, int x, int y, int z, int meta) {
        ...
        //ReikaJavaLibrary.pConsoleSideOnly(String.format("Tick %2d: ", tickcount)+coords,
        //Side.SERVER);
        ...
        //ReikaJavaLibrary.pConsole(String.format("Tick %2d: ",
        //tickcount)+this.getOperationTime(), Side.SERVER);
    ...
    private boolean setBiome(World world, int x, int z) {
        if (!world.isRemote
            && !ReikaPlayerAPI.playerCanBreakAt(
                (WorldServer) world, x, yCoord, z, this.getServerPlacer()
            ))
            return false;
    ...
    public boolean modifyBlocks() {
        return ConfigRegistry.BIOMEBLOCKS.getState()
            && ReikaInventoryHelper.checkForItem(Items.diamond, inv);
    }
    ...
    private void addCoordinate(int x, int z, boolean sort) {
        ...
        if (coords.add(x, z)) {
            RotaryCraft.logger.debug(
                "Added coordinate " + x + "x, " + z + "z to " + this
            );
            if (sort)
                coords.sort(positionComparator);
        }
    ...
    private boolean
    getReqsForTransform(BiomeGenBase from, BiomeGenBase to) { //test and consume resources
        BiomeStep li = new BiomeStep(from, to);
    ...
    private static void addBiomeTransformation(
        BiomeGenBase from, BiomeGenBase to, int power, FluidStack liq, ItemReq... items
    ) {
    ...
    static {
        addBiomeTransformation(
            BiomeGenBase.desert,
            BiomeGenBase.savanna,
            65536,
            FluidRegistry.getFluidStack("water", 30),
            new ItemReq(Blocks.tallgrass, 1, 0.5F),
            new ItemReq(Blocks.sapling, 4, 0.05F)
        );
        addBiomeTransformation(
            BiomeGenBase.savanna,
            BiomeGenBase.plains,
            32768,
            FluidRegistry.getFluidStack("water", 20),
            new ItemReq(Blocks.tallgrass, 1, 0.3F)
        );
        addBiomeTransformation(
            BiomeGenBase.plains,
            BiomeGenBase.forest,
            ...
            new ItemReq(Blocks.sapling, 0, 0.5F),
            new ItemReq(Blocks.sapling, 2, 0.2F)
        );
        addBiomeTransformation(
            BiomeGenBase.forest,
            BiomeGenBase.jungle,
            262144,
            FluidRegistry.getFluidStack("water", 50),
            new ItemReq(Blocks.sapling, 0, 0.4F),
            new ItemReq(Blocks.sapling, 0, 0.6F),
            new ItemReq(Blocks.tallgrass, 2, 0.3F)
        );
        ...
        addBiomeTransformation(
            ...
            new ItemReq(Blocks.sapling, 0, 0.1F),
            new ItemReq(Blocks.red_mushroom, 0.05F),
            new ItemReq(Blocks.brown_mushroom, 0.15F)
        );
        addBiomeTransformation(
            BiomeGenBase.swampland,
            BiomeGenBase.ocean,
        ...
        addBiomeTransformation(
            ...
            65536,
            null,
            new ItemReq(Blocks.sapling, 0, 0.05F)
        );
        ...
        addBiomeTransformation(
            ...
            524288,
            null,
            new ItemReq(Blocks.tallgrass, 1, 0.7F)
        );
        ...
        addBiomeTransformation(
            ...
            1048576,
            null,
            new ItemReq(Blocks.dirt, 1),
            new ItemReq(Blocks.mycelium, 1),
            new ItemReq(Blocks.red_mushroom, 0.9F),
            new ItemReq(Blocks.brown_mushroom, 0.9F)
        ); //?
        ...
        addBiomeTransformation(
            ...
            262144,
            null,
            new ItemReq(Blocks.grass, 0.125F),
            new ItemReq(Blocks.sapling, 0, 0.05F),
            new ItemReq(Blocks.tallgrass, 1, 0.25F)
        ); //?
        ...
        addBiomeTransformation(
            ...
            131072,
            null,
            new ItemReq(Blocks.sapling, 1, 0.25F)
        );
        addBiomeTransformation(
            BiomeGenBase.forest,
        ...
        addBiomeTransformation(
            ...
            65536,
            FluidRegistry.getFluidStack("water", 40),
            new ItemReq(Blocks.sapling, 5, 0.5F)
        );
        addBiomeTransformation(
            BiomeGenBase.forest,
            ...
            32768,
            null,
            new ItemReq(Blocks.sapling, 2, 0.25F)
        );
        ...
        addBiomeTransformation(
            ...
            null,
            new ItemReq(Blocks.sapling, 0, 0.4F),
            new ItemReq(Blocks.sapling, 2, 0.1F)
        );
        addBiomeTransformation(
            BiomeGenBase.taiga,
            ...
            32768,
            FluidRegistry.getFluidStack("water", 20),
            new ItemReq(Blocks.sapling, 1, 0.1F)
        );
        ...
        addBiomeTransformation(
            ...
            65536,
            null,
            new ItemReq(Blocks.sand, 1),
            new ItemReq(Blocks.sandstone, 0.5F),
            new ItemReq(Blocks.cactus, 0.1F)
        );
        addBiomeTransformation(
            BiomeGenBase.forest,
            BiomeGenBase.plains,
            262144,
            null,
            new ItemReq(Blocks.tallgrass, 1, 0.8F)
        );
        addBiomeTransformation(
            BiomeGenBase.jungle,
            BiomeGenBase.forest,
        ...
        addBiomeTransformation(
            BiomeGenBase.frozenOcean, BiomeGenBase.ocean, 524288, null
        );
        addBiomeTransformation(
            BiomeGenBase.extremeHills,
            BiomeGenBase.plains,
            262144,
            null,
            new ItemReq(Blocks.tallgrass, 1, 0.6F)
        );
        ...
        addBiomeTransformation(
            ...
            65536,
            null,
            new ItemReq(Blocks.sapling, 1, 0.4F)
        );
        addBiomeTransformation(
            BiomeGenBase.frozenOcean,
            BiomeGenBase.icePlains,
        ...
        addBiomeTransformation(
            ...
            32768,
            null,
            new ItemReq(Blocks.clay, 0.2F)
        );
        addBiomeTransformation(
            BiomeGenBase.ocean,
            BiomeGenBase.deepOcean,
            1024,
            FluidRegistry.getFluidStack("water", 200)
        );
        ...
        addBiomeTransformation(
            ...
            16384,
            null,
            new ItemReq(Blocks.sand, 0.5F),
            new ItemReq(Blocks.sandstone, 0.1F)
        );
    ...
    public static final class BiomeTransform {
        ...
        private BiomeTransform(
            BiomeStep step, long power, FluidStack fs, Collection<ItemReq> li
        ) {
            change = step;
            this.power = power;
            fluid = fs;
