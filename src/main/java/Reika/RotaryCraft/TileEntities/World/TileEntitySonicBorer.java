...
public class TileEntitySonicBorer extends TileEntityPowerReceiver implements PressureTE {
    ...
    public void overpressure(World world, int x, int y, int z) {
        ...
        world.createExplosion(
            null, x + 0.5, y + 1.5, z + 0.5, f, ConfigRegistry.BLOCKDAMAGE.getState()
        );
        world.createExplosion(
            null, x + 0.5, y - 0.5, z + 0.5, f, ConfigRegistry.BLOCKDAMAGE.getState()
        );
        ...
        world.createExplosion(
            null, x + 1.5, y + 0.5, z + 0.5, f, ConfigRegistry.BLOCKDAMAGE.getState()
        );
        world.createExplosion(
            null, x - 0.5, y + 0.5, z + 0.5, f, ConfigRegistry.BLOCKDAMAGE.getState()
        );
        ...
        world.createExplosion(
            null, x + 0.5, y + 0.5, z + 1.5, f, ConfigRegistry.BLOCKDAMAGE.getState()
        );
        world.createExplosion(
            null, x + 0.5, y + 0.5, z - 0.5, f, ConfigRegistry.BLOCKDAMAGE.getState()
        );
