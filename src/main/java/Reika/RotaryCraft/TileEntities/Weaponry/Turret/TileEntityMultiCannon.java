...
public class TileEntityMultiCannon extends TileEntityInventoriedCannon {
    ...
    public boolean isItemValidForSlot(int slot, ItemStack is) {
        return slot == LOAD_SLOT
            && ReikaItemHelper.matchStacks(is, ItemStacks.ballbearing);
    }
    ...
    public void fire(World world, double[] xyz) {
        ...
        if (!world.isRemote) {
            ...
            world.spawnEntityInWorld(new EntityGatlingShot(
                world, xCoord + 0.5 + dx, y, zCoord + 0.5 + dz, v[0], v[1], v[2], this
            ));
        }
