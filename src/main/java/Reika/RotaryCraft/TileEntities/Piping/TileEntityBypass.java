...
public class TileEntityBypass extends TileEntityPiping {
    ...
    public boolean canConnectToPipe(MachineRegistry m, ForgeDirection side) {
        return m.isStandardPipe() || m == MachineRegistry.FUELLINE
            ...
            || (m == this.getTile() && forcedConnection[side.ordinal()]);
    }
    ...
    protected void readSyncTag(NBTTagCompound NBT) {
        ...
        forcedConnection
            = ReikaArrayHelper.booleanFromByteBitflags(NBT.getByte("fconn"), 6);
    ...
    public void writeToNBT(NBTTagCompound NBT) {
        ...
        NBT.setByte(
            "tfconn", ReikaArrayHelper.booleanToByteBitflags(tryForcedConnection)
        );
    }
    ...
    public void readFromNBT(NBTTagCompound NBT) {
        ...
        tryForcedConnection
            = ReikaArrayHelper.booleanFromByteBitflags(NBT.getByte("tfconn"), 6);
