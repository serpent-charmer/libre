...
public class TileEntityObsidianMaker extends InventoriedPowerReceiver
    implements TemperatureTE, PipeConnector, IFluidHandler, MultiOperational,
               ProcessingMachine {
    public int mixTime;
    ...
    private ItemStack getProducedItem() {
        if (ReikaMathLibrary.isValueInsideBoundsIncl(
                MIN_OBSIDIAN_TEMP_100, MAX_OBSIDIAN_TEMP_100, temperature
            ))
            ...
            if (temperature > MAX_OBSIDIAN_TEMP_0) {
                ...
                float f = (temperature - MAX_OBSIDIAN_TEMP_100)
                    / (float) (MAX_OBSIDIAN_TEMP_0 - MAX_OBSIDIAN_TEMP_100);
                return ReikaRandomHelper.doWithChance(1 - f)
            ...
            if (temperature < MIN_OBSIDIAN_TEMP_0) {
                ...
                float f = (MIN_OBSIDIAN_TEMP_100 - temperature)
                    / (float) (MIN_OBSIDIAN_TEMP_100 - MIN_OBSIDIAN_TEMP_0);
                return ReikaRandomHelper.doWithChance(1 - f)
                    ? new ItemStack(Blocks.obsidian)
                    : new ItemStack(Blocks.cobblestone);
            }
