...
public class TileEntitySmokeDetector
    extends TileEntitySpringPowered implements RangedEffect, OneSlotMachine {
    //public static int MINPOWER = 16; //runs off of 4AAA's (max power = 4W) , so 16W (one
    //DC engine can run 64, or 8 at max range) public static int BASESPEED = 0;
    ...
    public void updateEntity(World world, int x, int y, int z, int meta) {
        ...
        //ReikaChatHelper.write(ReikaWorldHelper.findNearBlock(world, x, y, z, 8,
        //Blocks.fire.blockID));
