...
public class TileEntityCCTV extends RemoteControlMachine {
    ...
    public void updateEntity(World world, int x, int y, int z, int meta) {
        ...
        //ReikaJavaLibrary.pConsole(String.format("%f,  %f, %f", ep.posX, ep.posY,
        //ep.posZ)+" on "+FMLCommonHandler.instance().getEffectiveSide());
        ...
        //ReikaJavaLibrary.pConsole("X: "+e.posX+"  Y: "+e.posY+"  Z: "+e.posZ+"  Y:
        //"+e.rotationYaw+"  P: "+e.rotationPitch); ReikaJavaLibrary.pConsole("X:
        //"+playerCam[0]+"  Y: "+playerCam[1]+"  Z: "+playerCam[2]+"  Y: "+playerCam[3]+"
        //P: "+playerCam[4]); ReikaJavaLibrary.pConsole("X: "+cameraPos[0]+"  Y:
        //"+cameraPos[1]+"  Z: "+cameraPos[2]+"  Y: "+cameraPos[3]+"  P: "+cameraPos[4]);
        ...
        if (!cameraIsMoved)
            return;
        if (!Keyboard.isKeyDown(Keyboard.KEY_BACKSLASH) && inv[0] != null
            && inv[0].getItem() == ItemRegistry.SPRING.getItemInstance()
            && inv[0].getItemDamage() > 0)
            return;
        tickcount = 0;
    ...
    /**
     * Writes a tile entity to NBT.  Maybe was not saving inv since seems to be acting
     * like extends TileEntityPowerReceiver, NOT InventoriedPowerReceiver
     */
    @Override
