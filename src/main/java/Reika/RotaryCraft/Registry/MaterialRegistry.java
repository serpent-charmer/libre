...
public enum MaterialRegistry {
    WOOD(
        -1,
        ReikaEngLibrary.Ewood,
        ReikaEngLibrary.Gwood,
        ReikaEngLibrary.Twood,
        ReikaEngLibrary.Swood,
        ReikaEngLibrary.rhowood
    ),
    STONE(
        0,
        ReikaEngLibrary.Estone,
        ReikaEngLibrary.Gstone,
        ReikaEngLibrary.Tstone,
        ReikaEngLibrary.Sstone,
        ReikaEngLibrary.rhorock
    ),
    STEEL(
        1,
        ReikaEngLibrary.Esteel,
        ReikaEngLibrary.Gsteel,
        ReikaEngLibrary.Tsteel,
        ReikaEngLibrary.Ssteel,
        ReikaEngLibrary.rhoiron
    ),
    TUNGSTEN(
        1,
        ReikaEngLibrary.Etungsten,
        ReikaEngLibrary.Gtungsten,
        ReikaEngLibrary.Ttungsten,
        ReikaEngLibrary.Stungsten,
        RotaryAux.tungstenDensity
    ),
    DIAMOND(
        2,
        ReikaEngLibrary.Ediamond,
        ReikaEngLibrary.Gdiamond,
        ReikaEngLibrary.Tdiamond,
        ReikaEngLibrary.Sdiamond,
    ...
    public String getName() {
        return StatCollector.translateToLocal(
            "material." + this.name().toLowerCase(Locale.ENGLISH)
        );
    }
    ...
    public ItemStack getShaftUnitItem() {
        ...
        return ItemRegistry.GEARCRAFT.getStackOfMetadata(
            GearboxTypes.getFromMaterial(this).metaOffset * 16
        );
    }
