...
public enum MobBait {
    ...
    ZOMBIE(
        EntityZombie.class, 54, Items.golden_apple, 0, Items.potionitem, 8197
    ...
    SPIDER(
        ...
        52,
        Items.dye,
        ReikaItemHelper.cocoaBeans.getItemDamage(),
        Blocks.fence,
        -1
    ),
    ...
    IRONGOLEM(
        ...
        99,
        Blocks.wool,
        ReikaItemHelper.redWool.metadata,
        Items.lava_bucket,
        -1
    ),
    ...
    private MobBait(
        Class<? extends EntityLivingBase> cl, int id, Block a, int am, Item r, int rm
    ) {
        this(cl, id, Item.getItemFromBlock(a), am, r, rm);
    }

    private MobBait(
        Class<? extends EntityLivingBase> cl, int id, Item a, int am, Block r, int rm
    ) {
        this(cl, id, a, am, Item.getItemFromBlock(r), rm);
    }

    private MobBait(
        Class<? extends EntityLivingBase> cl, int id, Block a, int am, Block r, int rm
    ) {
        this(cl, id, Item.getItemFromBlock(a), am, Item.getItemFromBlock(r), rm);
    }

    private MobBait(
        Class<? extends EntityLivingBase> cl, int id, ItemStack a, ItemStack r
    ) {
        this(cl, id, a.getItem(), a.getItemDamage(), r.getItem(), r.getItemDamage());
    }

    private MobBait(
        Class<? extends EntityLivingBase> cl, int id, Item a, int am, Item r, int rm
    ) {
        entityClass = cl;
        attractorID = a;
        repellentID = r;
    ...
    public static MobBait getEntryFromEntity(EntityLivingBase e) {
        ...
        //ReikaChatHelper.write("Entity "+e.getCommandSenderName()+" has no mapped bait
        //items!");
    ...
    public static void addBait(
        String name,
        Class<? extends EntityLivingBase> type,
        int id,
        Item attract,
        Item repel
    ) {
    ...
    public static void addBait(
        ...
        Class[] types
            = new Class[] { Class.class, int.class, ItemStack.class, ItemStack.class };
