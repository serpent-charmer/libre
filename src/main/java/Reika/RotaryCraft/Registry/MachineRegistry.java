...
public enum MachineRegistry implements TileEnum {
    BEDROCKBREAKER(
        "machine.bedrock",
        BlockDMMachine.class,
        TileEntityBedrockBreaker.class,
        0,
        "RenderBedrockBreaker"
    ),
    ENGINE(
        "machine.engine", BlockEngine.class, TileEntityEngine.class, 0, "RenderSEngine"
    ),
    FLYWHEEL(
        "machine.flywheel",
        BlockFlywheel.class,
        TileEntityFlywheel.class,
        0,
        "RenderFlywheel"
    ),
    SHAFT("machine.shaft", BlockShaft.class, TileEntityShaft.class, 0, "RenderShaft"),
    BEVELGEARS(
        "machine.bevel", BlockTrans.class, TileEntityBevelGear.class, 0, "RenderBevel"
    ),
    GEARBOX(
        "machine.gearbox", BlockGearbox.class, TileEntityGearbox.class, 0, "RenderGearbox"
    ),
    SPLITTER(
        "machine.splitter",
        BlockTrans.class,
        TileEntitySplitter.class,
        1,
        "RenderSplitter"
    ),
    ...
    FLOODLIGHT(
        "machine.floodlight",
        BlockDMMachine.class,
        TileEntityFloodlight.class,
        1,
        "RenderLamp"
    ),
    CLUTCH("machine.clutch", BlockTrans.class, TileEntityClutch.class, 2, "RenderClutch"),
    DYNAMOMETER(
        "machine.dyna", BlockTrans.class, TileEntityMonitor.class, 3, "RenderMonitor"
    ),
    GRINDER(
        "machine.grinder",
        BlockDMIMachine.class,
        TileEntityGrinder.class,
        0,
        "RenderGrinder"
    ),
    HEATRAY(
        "machine.heatray", BlockDMMachine.class, TileEntityHeatRay.class, 2, "RenderHRay"
    ),
    ...
    RESERVOIR(
        "machine.reservoir",
        BlockMMachine.class,
        TileEntityReservoir.class,
        0,
        "RenderReservoir"
    ),
    AEROSOLIZER(
        "machine.aerosolizer",
        BlockMIMachine.class,
        TileEntityAerosolizer.class,
        0,
        "RenderAerosolizer"
    ),
    EXTRACTOR(
    ...
    COMPACTOR(
        "machine.compactor",
        BlockDMIMachine.class,
        TileEntityCompactor.class,
        1,
        "RenderCompactor"
    ),
    FAN("machine.fan", BlockDMMachine.class, TileEntityFan.class, 5, "RenderFan"),
    FUELLINE(
        "machine.fuelline", BlockPiping.class, TileEntityFuelLine.class, 2, "PipeRenderer"
    ),
    FRACTIONATOR(
        "machine.fractionator",
        BlockMIMachine.class,
        TileEntityFractionator.class,
        3,
        "RenderFraction"
    ),
    ...
    PILEDRIVER(
        "machine.piledriver",
        BlockDMMachine.class,
        TileEntityPileDriver.class,
        6,
        "RenderPileDriver"
    ),
    VACUUM(
        "machine.vacuum", BlockMIMachine.class, TileEntityVacuum.class, 5, "RenderVacuum"
    ),
    ...
    WOODCUTTER(
        "machine.woodcutter",
        BlockDMMachine.class,
        TileEntityWoodcutter.class,
        7,
        "RenderWoodcutter"
    ),
    SPAWNERCONTROLLER(
        "machine.spawnercontroller",
        BlockMMachine.class,
        TileEntitySpawnerController.class,
        2,
        "RenderSpawner"
    ),
    PLAYERDETECTOR(
        "machine.playerdetector",
        BlockMMachine.class,
        TileEntityPlayerDetector.class,
        3,
        "RenderDetector"
    ),
    HEATER(
        "machine.heater", BlockMIMachine.class, TileEntityHeater.class, 6, "RenderHeater"
    ),
    BAITBOX(
        "machine.baitbox",
        BlockMIMachine.class,
        TileEntityBaitBox.class,
        7,
        "RenderBaitBox"
    ),
    AUTOBREEDER(
        "machine.breeder",
        BlockMIMachine.class,
        TileEntityAutoBreeder.class,
        8,
        "RenderBreeder"
    ),
    ECU("machine.ecu", BlockMachine.class, TileEntityEngineController.class, 0),
    SMOKEDETECTOR(
        "machine.smokedetector",
        BlockMIMachine.class,
        TileEntitySmokeDetector.class,
        9,
        "RenderSmokeDetector"
    ),
    MOBRADAR(
        "machine.mobradar",
        BlockMMachine.class,
        TileEntityMobRadar.class,
        4,
        "RenderMobRadar"
    ),
    WINDER(
        "machine.winder", BlockDMIMachine.class, TileEntityWinder.class, 2, "RenderWinder"
    ),
    ADVANCEDGEARS(
        "machine.advgear",
        BlockAdvGear.class,
        TileEntityAdvancedGear.class,
        0,
        "RenderAdvGear"
    ),
    TNTCANNON(
    ...
    SONICWEAPON(
        "machine.sonicweapon",
        BlockMMachine.class,
        TileEntitySonicWeapon.class,
        5,
        "RenderSonic"
    ),
    BLASTFURNACE(
        "machine.blastfurnace", BlockIMachine.class, TileEntityBlastFurnace.class, 2
    ),
    FORCEFIELD(
        "machine.forcefield",
        BlockMMachine.class,
        TileEntityForceField.class,
        6,
        "RenderForceField"
    ),
    ...
    MOBHARVESTER(
        "machine.mobharvester",
        BlockMMachine.class,
        TileEntityMobHarvester.class,
        8,
        "RenderHarvester"
    ),
    ...
    WEATHERCONTROLLER(
        "machine.weather",
        BlockMIMachine.class,
        TileEntityWeatherController.class,
        13,
        "RenderIodide"
    ),
    ...
    SCALECHEST(
        "machine.chest",
        BlockDMIMachine.class,
        TileEntityScaleableChest.class,
        4,
        "RenderScaleChest"
    ),
    ...
    CONTAINMENT(
        "machine.containment",
        BlockMMachine.class,
        TileEntityContainment.class,
        10,
        "RenderProtectionDome"
    ),
    SCREEN(
        "machine.screen",
        BlockDMIMachine.class,
        TileEntityScreen.class,
        6,
        "RenderCCTVScreen"
    ),
    ...
    BLOCKCANNON(
        "machine.blockcannon",
        BlockMIMachine.class,
        TileEntityBlockCannon.class,
        17,
        "RenderCannon"
    ),
    BUCKETFILLER(
        "machine.bucketfiller", BlockIMachine.class, TileEntityBucketFiller.class, 5
    ),
    MIRROR("machine.mirror", BlockSolar.class, TileEntityMirror.class, 0, "RenderMirror"),
    SOLARTOWER(
        "machine.solartower", BlockSolar.class, TileEntitySolar.class, 1, "RenderSolar"
    ),
    SPYCAM(
        "machine.spycam", BlockMIMachine.class, TileEntitySpyCam.class, 18, "RenderSpyCam"
    ),
    SELFDESTRUCT(
        "machine.selfdestruct", BlockMachine.class, TileEntitySelfDestruct.class, 3
    ),
    COOLINGFIN(
        "machine.coolingfin",
        BlockDMMachine.class,
        TileEntityCoolingFin.class,
        9,
        "RenderFin"
    ),
    ...
    COMPRESSOR(
        "machine.compressor",
        BlockModEngine.class,
        TileEntityAirCompressor.class,
        0,
        "RenderCompressor",
        PowerTypes.PNEUMATIC
    ),
    PNEUENGINE(
        "machine.pneuengine",
        BlockModEngine.class,
        TileEntityPneumaticEngine.class,
        1,
        "RenderPneumatic",
        PowerTypes.PNEUMATIC
    ),
    ...
    MULTICLUTCH(
        "machine.multiclutch",
        BlockTrans.class,
        TileEntityMultiClutch.class,
        4,
        "RenderMultiClutch"
    ),
    TERRAFORMER(
        "machine.terraformer", BlockMachine.class, TileEntityTerraformer.class, 6
    ),
    SORTING("machine.sorting", BlockDMachine.class, TileEntitySorting.class, 2),
    FUELENHANCER(
        "machine.fuelenhancer",
        BlockMMachine.class,
        TileEntityFuelConverter.class,
        13,
        "RenderFuelConverter"
    ),
    ARROWGUN("machine.arrowgun", BlockDMachine.class, TileEntityMachineGun.class, 1),
    BOILER(
        "machine.frictionboiler",
        BlockMMachine.class,
    ...
    STEAMTURBINE(
        "machine.steamturbine",
        BlockDMMachine.class,
        TileEntitySteam.class,
        10,
        "RenderSteam",
        PowerTypes.STEAM
    ),
    ...
    ELECTRICMOTOR(
        "machine.electricmotor",
        BlockModEngine.class,
        TileEntityElectricMotor.class,
        3,
        "RenderElecMotor",
        PowerTypes.EU
    ),
    ...
    BYPASS(
        "machine.bypass", BlockPiping.class, TileEntityBypass.class, 5, "PipeRenderer"
    ),
    SEPARATION(
        "machine.separation",
        BlockPiping.class,
        TileEntitySeparatorPipe.class,
        6,
        "PipeRenderer"
    ),
    AGGREGATOR(
        "machine.aggregator",
        BlockMMachine.class,
        TileEntityAggregator.class,
        16,
        "RenderAggregator"
    ),
    AIRGUN(
        "machine.airgun", BlockDMMachine.class, TileEntityAirGun.class, 12, "RenderAirGun"
    ),
    SONICBORER(
        "machine.sonicborer",
        BlockDMMachine.class,
        TileEntitySonicBorer.class,
        13,
        "RenderSonicBorer"
    ),
    FUELENGINE(
        "machine.fuelengine",
        BlockModEngine.class,
        TileEntityFuelEngine.class,
        4,
        "RenderFuelEngine",
        ModList.BCENERGY
    ),
    FILLINGSTATION(
        "machine.fillingstation",
        BlockDMIMachine.class,
        TileEntityFillingStation.class,
        8,
        "RenderFillingStation"
    ),
    BELT("machine.belt", BlockDMMachine.class, TileEntityBeltHub.class, 14, "RenderBelt"),
    VANDEGRAFF(
        "machine.vandegraff",
        BlockMMachine.class,
        TileEntityVanDeGraff.class,
        17,
        "RenderVanDeGraff"
    ),
    DEFOLIATOR(
    ...
    CRYSTALLIZER(
        "machine.crystal",
        BlockDMIMachine.class,
        TileEntityCrystallizer.class,
        9,
        "RenderCrystal"
    ),
    BUSCONTROLLER(
        "machine.buscontroller", BlockDMachine.class, TileEntityBusController.class, 3
    ),
    ...
    LAWNSPRINKLER(
        "machine.lawnsprinkler",
        BlockMMachine.class,
        TileEntityLawnSprinkler.class,
        19,
        "RenderLawnSprinkler"
    ),
    GRINDSTONE(
    ...
    GASTANK(
        "machine.gastank",
        BlockMMachine.class,
        TileEntityFluidCompressor.class,
        20,
        "RenderGasCompressor"
    ),
    ...
    COMPOSTER(
        "machine.composter",
        BlockMIMachine.class,
        TileEntityComposter.class,
        23,
        "RenderComposter"
    ),
    ANTIAIR(
        "machine.antiair", BlockMIMachine.class, TileEntityAAGun.class, 24, "RenderAAGun"
    ),
    PIPEPUMP(
        "machine.pipepump",
        BlockDMMachine.class,
        TileEntityPipePump.class,
        16,
        "RenderPipePump"
    ),
    CHAIN(
    ...
    DRYING(
        "machine.drying",
        BlockMIMachine.class,
        TileEntityDryingBed.class,
        26,
        "RenderDryingBed"
    ),
    WETTER(
        "machine.wetter", BlockMIMachine.class, TileEntityWetter.class, 27, "RenderWetter"
    ),
    ...
    HYDRATOR(
        "machine.hydrator",
        BlockMMachine.class,
        TileEntityGroundHydrator.class,
        21,
        "RenderHydrator"
    ),
    ...
    BUNDLEDBUS(
        "machine.bundledbus",
        BlockDMachine.class,
        TileEntityBundledBus.class,
        5,
        ModList.APPENG,
        ModList.PROJRED
    ),
    DISTRIBCLUTCH(
        "machine.distribclutch",
        BlockTrans.class,
        TileEntityDistributionClutch.class,
        5,
        "RenderDistribClutch"
    ),
    SPLITBELT(
    ...
    private MachineRegistry(
        ...
        if (block == null) {
            throw new RegistrationException(
                ...
                "Machine " + this.name() + " registered with a null block!"
            );
        }
    ...
    public static TileEntity createTEFromIDAndMetadata(Block id, int metad) {
        ...
        if (index == -1) {
            RotaryCraft.logger.logError(
                "ID " + id + " and metadata " + metad
                + " are not a valid machine identification pair!"
            );
            return null;
        }
        ...
        try {
            ...
            throw new RegistrationException(
                RotaryCraft.instance,
                "ID " + id + " and metadata " + metad
                    + " failed to instantiate their TileEntity of " + TEClass
            );
            ...
            throw new RegistrationException(
                RotaryCraft.instance,
                "ID " + id + " and metadata " + metad
                    + " failed illegally accessed their TileEntity of " + TEClass
            );
        }
    }
    ...
    public String getRenderer() {
        if (!hasRender)
            throw new RuntimeException(
                "Machine " + this.getName() + " has no render to call!"
            );
    ...
    public String getRenderPackage() {
        if (this.hasPrerequisite() || BlockModEngine.class.isAssignableFrom(blockClass)) {
            if (EnergyToPowerBase.class.isAssignableFrom(te)
                || RCToModConverter.class.isAssignableFrom(te))
    ...
    public static MachineRegistry
    getMachine(IBlockAccess world, double x, double y, double z) {
        return getMachine(
    ...
    public String getName() {
        if (FMLCommonHandler.instance().getEffectiveSide() == Side.CLIENT
            && DragonAPICore.hasGameLoaded()
            && OldTextureLoader.instance.loadOldTextures() && this == MAGNETIC) {
            return OldTextureLoader.instance.getMagnetostaticName();
        }
        //return
        //LanguageRegistry.instance().getStringLocalization("rcmachine."+this.name().toLowerCase());
    ...
    public float getMinY(RotaryCraftTileEntity tile) {
        ...
        if (this == CCTV && tile.getBlockMetadata() == 1)
            return 0.5F
                - 0.5F * (float) Math.sin(Math.toRadians(((TileEntityCCTV) tile).theta));
        return 0;
    }
    ...
    public String getMultiName(RotaryCraftTileEntity tile) {
        if (!this.isMultiNamed())
            throw new RuntimeException(
                "Machine " + this.getName()
                + " has no multi name and yet was called for it!"
            );
        if (this == GEARBOX) {
            TileEntityGearbox gbx = (TileEntityGearbox) tile;
            GearboxTypes type = gbx.getGearboxType();
            return type != null ? type.getLocalizedGearboxName(gbx.getRatio())
                                : this.getName();
        }
        if (this == ENGINE) {
            TileEntityEngine eng = (TileEntityEngine) tile;
            return eng.getEngineType() != null
                ? RotaryNames.getEngineName(eng.getEngineType().ordinal())
                : this.getName();
        }
        if (this == SHAFT) {
            TileEntityShaft sha = (TileEntityShaft) tile;
            return StatCollector.translateToLocal(sha.getShaftType().getShaftUnlocName())
                + this.getName();
        }
        if (this == FLYWHEEL) {
        ...
        throw new RegistrationException(
            RotaryCraft.instance,
            "Machine " + this.getName() + " has an unspecified multi name!"
        );
    }
    ...
    public ItemStack getCraftedProduct(TileEntity te) {
        ...
        if (this == GEARBOX) {
            is = ((TileEntityGearbox) te)
                     .getGearboxType()
                     .getGearboxItem(((TileEntityGearbox) te).getRatio());
        }
    ...
    public boolean isAvailableInCreativeInventory() {
        ...
        if (this.isIncomplete()
            && !(DragonAPICore.isReikasComputer() || DragonOptions.DEBUGMODE.getState()))
            return false;
    ...
    public void addRecipe(IRecipe ir) {
        if (this.isCraftable()) {
            WorktableRecipes.getInstance().addRecipe(
                ir, this.isCrucial() ? RecipeLevel.CORE : RecipeLevel.PROTECTED
            );
    ...
    public void addSizedOreRecipe(int size, Object... obj) {
        if (this.isCraftable()) {
            ShapedOreRecipe ir = new ShapedOreRecipe(
                ReikaItemHelper.getSizedItemStack(this.getCraftedProduct(), size), obj
            );
            WorktableRecipes.getInstance().addRecipe(
                ir, this.isCrucial() ? RecipeLevel.CORE : RecipeLevel.PROTECTED
            );
    ...
    public void addMetaOreRecipe(int meta, Object... obj) {
        if (this.isCraftable()) {
            ShapedOreRecipe ir
                = new ShapedOreRecipe(this.getCraftedMetadataProduct(meta), obj);
            WorktableRecipes.getInstance().addRecipe(
                ir, this.isCrucial() ? RecipeLevel.CORE : RecipeLevel.PROTECTED
            );
            if (ConfigRegistry.TABLEMACHINES.getState()) {
        ...
        if (this.isCraftable()) {
            ShapedOreRecipe ir = new ShapedOreRecipe(
                ReikaItemHelper.getSizedItemStack(
                    this.getCraftedMetadataProduct(meta), size
                ),
                obj
            );
            WorktableRecipes.getInstance().addRecipe(
    ...
    public void addRecipe(ItemStack is, Object... obj) {
        if (this.isCraftable()) {
            WorktableRecipes.getInstance().addRecipe(
                is, this.isCrucial() ? RecipeLevel.CORE : RecipeLevel.PROTECTED, obj
            );
            if (ConfigRegistry.TABLEMACHINES.getState()) {
    ...
    public void addCrafting(Object... obj) {
        if (this.isCraftable()) {
            WorktableRecipes.getInstance().addRecipe(
                this.getCraftedProduct(),
                this.isCrucial() ? RecipeLevel.CORE : RecipeLevel.PROTECTED,
                obj
            );
            if (ConfigRegistry.TABLEMACHINES.getState()) {
    ...
    public void addSizedNBTCrafting(NBTTagCompound NBT, int num, Object... obj) {
        if (this.isCraftable()) {
            ItemStack is
                = ReikaItemHelper.getSizedItemStack(this.getCraftedProduct(), num);
            is.stackTagCompound = (NBTTagCompound) NBT.copy();
            WorktableRecipes.getInstance().addRecipe(
                is, this.isCrucial() ? RecipeLevel.CORE : RecipeLevel.PROTECTED, obj
            );
        ...
        if (this.isCraftable()) {
            ...
            if (ConfigRegistry.TABLEMACHINES.getState()) {
                GameRegistry.addRecipe(
                    ReikaItemHelper.getSizedItemStack(this.getCraftedProduct(), num), obj
                );
            }
        }
        //this.addSizedOreRecipe(num, obj);
    ...
    public void addMetaCrafting(int metadata, Object... obj) {
        if (this.isCraftable()) {
            WorktableRecipes.getInstance().addRecipe(
                this.getCraftedMetadataProduct(metadata),
                this.isCrucial() ? RecipeLevel.CORE : RecipeLevel.PROTECTED,
                obj
            );
            if (ConfigRegistry.TABLEMACHINES.getState()) {
    ...
    public void addSizedMetaCrafting(int num, int metadata, Object... obj) {
        if (this.isCraftable()) {
            WorktableRecipes.getInstance().addRecipe(
                ReikaItemHelper.getSizedItemStack(
                    this.getCraftedMetadataProduct(metadata), num
                ),
                this.isCrucial() ? RecipeLevel.CORE : RecipeLevel.PROTECTED,
                obj
            );
    ...
    public TileEntity createTEInstanceForRender(int offset) {
        ...
        try {
            ...
            throw new RegistrationException(
                RotaryCraft.instance,
                this + " failed to instantiate its TileEntity of " + te
            );
        } catch (IllegalAccessException e) {
            throw new RegistrationException(
                RotaryCraft.instance,
    ...
    /**
     * Is the machine crucial to the mod (i.e. the techtree, realism, usability, or
     * balance is damaged by its removal)
     */
    ...
    public boolean canDoMultiPerTick() {
        return this == EXTRACTOR
            || MultiOperational.class.isAssignableFrom(this.getTEClass());
    }
    ...
    public boolean isCreativeTabValid(CreativeTabs tab) {
        if (this == BELT || this == CHAIN || this == SPLITBELT || this == POWERBUS
            || this == BUSCONTROLLER
            || TileEntityTransmissionMachine.class.isAssignableFrom(te))
    ...
    public static MultiMap<MachineRegistry, Enchantment> getEnchantableMachineList() {
        MultiMap<MachineRegistry, Enchantment> li
            = new MultiMap().setNullEmpty().setOrdered(new Comparator<Enchantment>() {
                  @Override
        ...
        for (int i = 0; i < MachineRegistry.machineList.length; i++) {
            ...
            if (m.isEnchantable()) {
                for (Enchantment e :
                     ((EnchantableMachine) (m.createTEInstanceForRender(0)))
    ...
    static {
        for (int i = 0; i < machineList.length; i++) {
            ...
            if (machineMappings.containsKey(id, meta))
                throw new RegistrationException(
                    RotaryCraft.instance,
                    "ID/Meta conflict @ " + id + "/" + meta + ": " + m + " & "
                        + machineMappings.get(id, meta)
                );
