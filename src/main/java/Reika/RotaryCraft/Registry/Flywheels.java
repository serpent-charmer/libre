...
public enum Flywheels {
    ...
    STONE(
        128, 5, ReikaEngLibrary.rhorock, 0.9 * ReikaEngLibrary.Tstone
    ), // rho 3	-> 4	-> 8
    IRON(
        512, 15, ReikaEngLibrary.rhoiron, 5 * ReikaEngLibrary.Tiron
    ), // rho 8	-> 8	-> 32
    GOLD(
        4096, 40, ReikaEngLibrary.rhogold, ReikaEngLibrary.Tgold
    ), // rho 19.3	-> 32	-> 256
    ...
    BEDROCK(
        Integer.MAX_VALUE, 200, 1.75 * ReikaEngLibrary.rhoiron, Double.POSITIVE_INFINITY
    );
    ...
    public String getName() {
        return StatCollector.translateToLocal(
            "flywheel." + this.name().toLowerCase(Locale.ENGLISH)
        );
    }
