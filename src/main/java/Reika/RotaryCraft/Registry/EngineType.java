...
public enum EngineType {
    ...
    HYDRO(32, 16384, EngineClass.KINETIC, TileEntityHydroEngine.class), //double speed,
                                                                        //add new lava
                                                                        //engine as 524kW?
                                                                        //no
     ...
     * Steam Engine 40-50Nm @ 5000 rpm (524 rad/s)					-> 20.96kW - 26.2kW
     * (best) Standard Combustion = 100Nm @ 5500-7000 rpm (576 - 733 rad/s)-> 57.6kW
     * - 73.3kW (Standard car)
     * AC Engine = ~300Nm @ max 3600 rpm (377 rad/s)				-> 113.1 kW
     * Sport Combustion = 200Nm @ 9400-10600 rpm (984 - 1110 rad/s) -> 196.8kW - 222kW
     * (sports car) Microturbine 5Nm @ 200 krpm (52356 rad/s)					-> 1MW Gas
     * Turbine 700-1400 Nm @ 50-100 krpm (5236 - 10471 rad/s)	-> 70 MW (Boeing 767
     * engines)
     * @author Reika
     */
    ...
    public boolean hasGui() {
        return this == STEAM || this == GAS || this == AC || this == SPORT
            || this == MICRO || this == JET;
    }

    public boolean burnsFuel() {
        return this == STEAM || this == GAS || this == SPORT || this == MICRO
            || this == JET;
    }
    ...
    public TileEntityEngine newTileEntity() {
        try {
            ...
            throw new RegistrationException(
                ...
                "Engine type " + this + " has a noninstantiable class!"
            );
        } catch (IllegalAccessException e) {
            e.printStackTrace();
            throw new RegistrationException(
                RotaryCraft.instance,
                "Engine type " + this + " has an inaccessible class!"
            );
        }
    }
