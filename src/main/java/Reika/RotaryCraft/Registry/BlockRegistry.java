...
public enum BlockRegistry implements BlockEnum {
    ...
    private BlockRegistry(
        Class cl, Class<? extends ItemBlock> item, int offset, String name
    ) {
        block = cl;
        itemBlock = item;
        this.offset = offset;
    ...
    public String getBasicName() {
        return this.isMachine()
            ? "(TECHNICAL BLOCK) " + block.getSimpleName() + ":" + this.ordinal()
        ...
        switch (this) {
            ...
            default:
                throw new RegistrationException(
                    RotaryCraft.instance, "No multiname for " + this + "!"
                );
        }
    }
