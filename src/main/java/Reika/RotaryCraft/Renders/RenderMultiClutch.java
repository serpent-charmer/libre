...
public class RenderMultiClutch extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityMultiClutchAt(
        TileEntityMultiClutch tile, double par2, double par4, double par6, float par8
    ) {
        ModelMultiClutch var14;
        var14 = MultiClutchModel;

        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/Transmission/multiclutchtex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityMultiClutchAt(
                (TileEntityMultiClutch) tile, par2, par4, par6, par8
            );
