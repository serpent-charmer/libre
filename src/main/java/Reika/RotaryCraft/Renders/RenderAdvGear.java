...
public class RenderAdvGear extends RotaryTERenderer {
    ...
    public void renderTileEntityAdvancedGearAt(
        TileEntityAdvancedGear tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
            ...
            switch (itemMetadata) {
                case 1:
                    this.bindTextureByName(
                        "/Reika/RotaryCraft/Textures/TileEntityTex/Transmission/Shaft/shafttex.png"
                    );
                    var14.renderAll(tile, null);
                    break;
                case 2:
                    this.bindTextureByName(
                        "/Reika/RotaryCraft/Textures/TileEntityTex/Transmission/cvttex.png"
                    );
                ...
                case 3:
                    if (tile.isBedrockCoil())
                        this.bindTextureByName(
                            "/Reika/RotaryCraft/Textures/TileEntityTex/Transmission/coiltex_bed.png"
                        );
                    else
                        this.bindTextureByName(
                            "/Reika/RotaryCraft/Textures/TileEntityTex/Transmission/coiltex.png"
                        );
                    var16.renderAll(tile, null);
                    break;
                case 4:
                    this.bindTextureByName(
                        "/Reika/RotaryCraft/Textures/TileEntityTex/Transmission/highgeartex.png"
                    );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityAdvancedGearAt(
                (TileEntityAdvancedGear) tile, par2, par4, par6, par8
            );
