...
public class RenderSpawner extends RotaryTERenderer {
     ...
     */
    public void renderTileEntitySpawnerControllerAt(
        TileEntitySpawnerController tile,
        double par2,
        double par4,
        double par6,
        float par8
        ...
        if (!tile.isInWorld()) {
            ...
            var14.renderAll(
                tile,
                ReikaJavaLibrary.makeListFrom(tile.isValidLocation(
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntitySpawnerControllerAt(
                (TileEntitySpawnerController) tile, par2, par4, par6, par8
            );
