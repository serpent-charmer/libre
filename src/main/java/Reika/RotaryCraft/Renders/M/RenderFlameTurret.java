...
public class RenderFlameTurret extends RotaryTERenderer {
    ...
    public void renderTileEntityFlameTurretAt(
        TileEntityFlameTurret tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/flameturrettex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityFlameTurretAt(
                (TileEntityFlameTurret) tile, par2, par4, par6, par8
            );
