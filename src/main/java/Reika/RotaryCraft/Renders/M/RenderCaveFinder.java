...
public class RenderCaveFinder extends RotaryTERenderer {
    ...
    public void renderTileEntityCaveFinderAt(
        TileEntityCaveFinder tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityCaveFinderAt(
                (TileEntityCaveFinder) tile, par2, par4, par6, par8
            );
                ...
                for (int k = -range; k <= range; k++) {
                    if (te.hasPointAt(i + range, j + range, k + range)) {
                        ...
                        if (y >= 0 && y < 256) {
                            ...
                            GL11.glVertex3d(
                                te.xCoord + i + dx, te.yCoord + j + dy, te.zCoord + k + dz
                            );
                        }
                    }
                }
