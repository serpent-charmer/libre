...
public class RenderHydrator extends RotaryTERenderer {
    ...
    public void renderTileEntityGroundHydratorAt(
        TileEntityGroundHydrator tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
    ...
    private void
    renderOverlay(TileEntityGroundHydrator te, double par2, double par4, double par6) {
        ...
        for (int i = -r; i <= r; i++) {
            for (int k = -r; k <= r; k++) {
                ...
                int meta = te.worldObj.getBlockMetadata(
                    te.xCoord + i, te.yCoord, te.zCoord + k
                );
    ...
    private void
    renderCover(TileEntityGroundHydrator tr, double par2, double par4, double par6) {
        GL11.glTranslated(par2, par4, par6);
        ReikaTextureHelper.bindTerrainTexture();
    ...
    private void
    renderLiquid(TileEntityGroundHydrator tr, double par2, double par4, double par6) {
        GL11.glTranslated(par2, par4, par6);
        Fluid f = tr.getFluid();
        if (f != null) {
