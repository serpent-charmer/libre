...
public class RenderGasCompressor extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityGasCompressorAt(
        TileEntityFluidCompressor tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/gascompressortex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityGasCompressorAt(
                (TileEntityFluidCompressor) tile, par2, par4, par6, par8
            );
    }
