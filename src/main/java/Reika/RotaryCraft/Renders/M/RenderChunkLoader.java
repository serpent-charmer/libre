...
public class RenderChunkLoader extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityChunkLoaderAt(
        TileEntityChunkLoader tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/chunkloadertex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityChunkLoaderAt(
                (TileEntityChunkLoader) tile, par2, par4, par6, par8
            );
