...
public class RenderEMP extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityEMPAt(
        TileEntityEMP tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
    ...
    protected void
    renderEffect(TileEntityEMP te, double x, double y, double z, float ptick) {
    ...
    private void
    renderSphere(TileEntityEMP te, double x, double y, double z, double r, int color) {
    ...
    public void renderTileEntityAt(
        ...
        if (((RotaryCraftTileEntity) tile).isInWorld()
            ...
            if (((TileEntityEMP) tile).effectRender != null)
                this.renderEffect(
                    (TileEntityEMP) tile, par2 + 0.5, par4 + 0.5, par6 + 0.5, par8
                );
