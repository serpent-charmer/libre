...
public class PipeRenderer extends RotaryTERenderer {
    protected void renderLiquid(
        RenderableDuct tile, double par2, double par4, double par6, ForgeDirection dir
    ) {
    ...
    private void
    renderFace(RenderableDuct tile, double x, double y, double z, ForgeDirection dir) {
        float size = 0.75F / 2F;
        float window = 0.5F / 2F;
        float dl = size - window;
        float dd = 0.5F - size;
