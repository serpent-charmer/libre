...
public class RenderSplitter extends RotaryTERenderer {
     ...
     */
    public void renderTileEntitySplitterAt(
        TileEntitySplitter tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/Transmission/" + s + ".png"
        );
        ...
        if (meta < 4 || (meta >= 8 && meta < 12))
            var14.renderAll(
                tile, ReikaJavaLibrary.makeListFrom(tile.failed), -tile.phi * dir, 0
            );
        else
            var15.renderAll(
                tile, ReikaJavaLibrary.makeListFrom(tile.failed), -tile.phi * dir, 0
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntitySplitterAt(
                (TileEntitySplitter) tile, par2, par4, par6, par8
            );
