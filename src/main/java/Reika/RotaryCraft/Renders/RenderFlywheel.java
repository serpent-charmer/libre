...
public class RenderFlywheel extends RotaryTERenderer {
    ...
    public void renderTileEntityFlywheelAt(
        TileEntityFlywheel tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            this.getTextureFolder() + this.getFlywheelTextureName(tile.getTypeOrdinal())
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityFlywheelAt(
                (TileEntityFlywheel) tile, par2, par4, par6, par8
            );
