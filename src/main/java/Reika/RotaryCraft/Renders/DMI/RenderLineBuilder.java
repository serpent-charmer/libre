...
public class RenderLineBuilder extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityLineBuilderAt(
        TileEntityLineBuilder tile, double par2, double par4, double par6, float par8
    ) {
        ModelRam var14;
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityLineBuilderAt(
                (TileEntityLineBuilder) tile, par2, par4, par6, par8
            );
