...
public class RenderWinder extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityWinderAt(
        TileEntityWinder tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        boolean hasSpring = tile.getStackInSlot(0) != null
            && tile.getStackInSlot(0).getItem() instanceof ItemCoil;
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityWinderAt(
                (TileEntityWinder) tile, par2, par4, par6, par8
            );
