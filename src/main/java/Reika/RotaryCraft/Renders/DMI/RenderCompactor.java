...
public class RenderCompactor extends RotaryTERenderer {
    ...
    public void renderTileEntityCompactorAt(
        TileEntityCompactor tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/compactortex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityCompactorAt(
                (TileEntityCompactor) tile, par2, par4, par6, par8
            );
