...
public class RenderFridge extends RotaryTERenderer {
    ...
    public void renderTileEntityRefrigeratorAt(
        TileEntityRefrigerator tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityRefrigeratorAt(
                (TileEntityRefrigerator) tile, par2, par4, par6, par8
            );
