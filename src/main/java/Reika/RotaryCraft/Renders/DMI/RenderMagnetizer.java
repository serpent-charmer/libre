...
public class RenderMagnetizer extends RotaryTERenderer {
    ...
    public void renderTileEntityMagnetizerAt(
        TileEntityMagnetizer tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityMagnetizerAt(
                (TileEntityMagnetizer) tile, par2, par4, par6, par8
            );
