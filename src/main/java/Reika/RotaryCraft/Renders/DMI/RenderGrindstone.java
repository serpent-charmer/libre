...
public class RenderGrindstone extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityGrindstoneAt(
        TileEntityGrindstone tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/grindstonetex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityGrindstoneAt(
                (TileEntityGrindstone) tile, par2, par4, par6, par8
            );
    ...
    private void
    renderTool(TileEntityGrindstone tile, double par2, double par4, double par6) {
        ...
        IItemRenderer iir
            = MinecraftForgeClient.getItemRenderer(is, ItemRenderType.INVENTORY);
        if (item instanceof IndexedItemSprites && !(item instanceof ItemBlockPlacer)) {
            ...
            ReikaTextureHelper.bindTexture(
                iis.getTextureReferenceClass(), iis.getTexture(is)
            );
