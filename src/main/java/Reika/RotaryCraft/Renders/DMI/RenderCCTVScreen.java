...
public class RenderCCTVScreen extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityScreenAt(
        TileEntityScreen tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        if (!tile.isInWorld()) {
            ...
            {
                //((BlockCCTVScreenBlock1)var10).unifyAdjacentChests(tile.worldObj,
        ...
        if (true) {
            ...
            this.bindTextureByName(
                "/Reika/RotaryCraft/Textures/TileEntityTex/screentex.png"
            );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityScreenAt(
                (TileEntityScreen) tile, par2, par4, par6, par8
            );
