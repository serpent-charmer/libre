...
public class RenderClutch extends RotaryTERenderer {
    ...
    public void renderTileEntityClutchAt(
        TileEntityClutch tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        if (tile.getBlockMetadata() < 4)
            ...
            var15.renderAll(
                tile, null, tile.getBlockMetadata() == 5 ? tile.phi : -tile.phi, 0
            );
        }
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityClutchAt(
                (TileEntityClutch) tile, par2, par4, par6, par8
            );
