...
public class RenderShaft extends RotaryTERenderer {
    ...
    public void renderTileEntityShaftAt(
        TileEntityShaft tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/Transmission/Shaft/"
            + this.getImageFileName(tile)
        );
        ...
        if (tile.isCross()) {
            this.bindTextureByName(
                "/Reika/RotaryCraft/Textures/TileEntityTex/Transmission/Shaft/crosstex.png"
            ); // has own tex
            switch (tile.getBlockMetadata()) {
                case 0:
                    var16.renderAll(
                        tile, null, -tile.crossphi2, tile.crossphi1
                    ); //4-way symmetry, really, so no need to change direction
                    break;
                case 6:
                    var16.renderAll(
                        tile, null, -tile.crossphi2, tile.crossphi1
