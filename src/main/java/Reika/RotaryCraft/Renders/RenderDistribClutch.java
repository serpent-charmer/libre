...
import Reika.RotaryCraft.Models.Animated.ModelDistribClutch;
...
public class RenderDistribClutch extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityDistributionClutchAt(
        TileEntityDistributionClutch tile,
        double par2,
        double par4,
        double par6,
        float par8
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/Transmission/distribclutchtex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityDistributionClutchAt(
                (TileEntityDistributionClutch) tile, par2, par4, par6, par8
            );
        if (((RotaryCraftTileEntity) tile).isInWorld()
            && MinecraftForgeClient.getRenderPass() == 1) {
            IORenderer.renderIO(tile, par2, par4, par6);
            //this.renderFaceColors((TileEntityDistributionClutch)tile, par2, par4, par6);
        }
    }
