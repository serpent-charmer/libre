...
public class RenderMirror extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityMirrorAt(
        TileEntityMirror tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        var14.renderAll(
            tile, ReikaJavaLibrary.makeListFrom(tile.broken), -tile.phi, -tile.theta / 2
        );
        GL11.glScaled(1, var11, 1);
        GL11.glTranslated(0, -var12, 0);
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityMirrorAt(
                (TileEntityMirror) tile, par2, par4, par6, par8
            );
