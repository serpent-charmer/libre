...
public class RenderFan extends RotaryTERenderer {
    ...
    public void renderTileEntityFanAt(
        TileEntityFan tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
    ...
    public void renderTileEntityAt(
        ...
        if (te.isInWorld() && MinecraftForgeClient.getRenderPass() == 1) {
            ...
            ReikaAABBHelper.renderAABB(
                te.wideAreaHarvest ? wide.offset(0, 1, 0) : box,
                par2,
                par4,
                par6,
                te.xCoord,
