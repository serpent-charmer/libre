...
public class RenderPipePump extends RotaryTERenderer {
    ...
    public void renderTileEntityPipePumpAt(
        TileEntityPipePump tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName("/Reika/RotaryCraft/Textures/TileEntityTex/pipepumptex.png"
        );
        ...
        if (tile.isInWorld()) {
            ...
            if (tile.getBlockMetadata() <= 3)
                ...
                GL11.glTranslatef(tile.getBlockMetadata() == 5 ? -1 : 1, -1F, 0);
            }
        }
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityPipePumpAt(
                (TileEntityPipePump) tile, par2, par4, par6, par8
            );
