...
public class RenderPump extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityPumpAt(
        TileEntityPump tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        pars[1]
            = (tile.shouldRenderInPass(0) && MinecraftForgeClient.getRenderPass() == 0)
            || !tile.isInWorld();
