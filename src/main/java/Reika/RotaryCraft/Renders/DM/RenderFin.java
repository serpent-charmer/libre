...
public class RenderFin extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityCoolingFinAt(
        TileEntityCoolingFin tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        var14.renderAll(
            tile,
            ReikaJavaLibrary.makeListFrom(tile.isInWorld(), tile.setting),
            -tile.phi,
            0
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityCoolingFinAt(
                (TileEntityCoolingFin) tile, par2, par4, par6, par8
            );
    ...
    private void
    renderTarget(TileEntityCoolingFin tile, double par2, double par4, double par6) {
        int[] xyz = tile.getTarget();
        AxisAlignedBB box
            = AxisAlignedBB
                  .getBoundingBox(
                      xyz[0], xyz[1], xyz[2], xyz[0] + 1, xyz[1] + 1, xyz[2] + 1
                  )
                  .expand(0.03125, 0.03125, 0.03125);
