...
public class RenderBelt extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityBeltAt(
        TileEntityBeltHub tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/Transmission/belttex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        //ReikaAABBHelper.renderAABB(tile.getRenderBoundingBox(), par2, par4, par6, 0, 0,
        //0, 127, 255, 255, 0, true);
    }

    private void
    drawBelt2(TileEntityBeltHub tile, double par2, double par4, double par6, float par8) {
        ...
        v5.setColorOpaque_I(tile.getBeltColor());
    ...
    private void
    drawBelt3(TileEntityBeltHub tile, double par2, double par4, double par6, float par8) {
        int meta = tile.getBlockMetadata();
    ...
    private void
    drawBelt(TileEntityBeltHub tile, double par2, double par4, double par6, float par8) {
        int meta = tile.getBlockMetadata();
