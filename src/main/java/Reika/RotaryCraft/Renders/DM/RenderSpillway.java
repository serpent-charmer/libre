...
public class RenderSpillway extends RotaryTERenderer {
     ...
     */
    public void renderTileEntitySpillwayAt(
        TileEntitySpillway tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntitySpillwayAt(
                (TileEntitySpillway) tile, par2, par4, par6, par8
            );
