...
public class RenderLamp extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityFloodlightAt(
        TileEntityFloodlight tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        if (tile.isInWorld() && tile.getBlockMetadata() > 3)
            this.bindTextureByName(
                "/Reika/RotaryCraft/Textures/TileEntityTex/LampVertical.png"
            );
        else
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityFloodlightAt(
                (TileEntityFloodlight) tile, par2, par4, par6, par8
            );
