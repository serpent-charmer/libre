...
public class RenderAirGun extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityAirGunAt(
        TileEntityAirGun tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityAirGunAt(
                (TileEntityAirGun) tile, par2, par4, par6, par8
            );
