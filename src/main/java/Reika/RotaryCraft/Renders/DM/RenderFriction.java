...
public class RenderFriction extends RotaryTERenderer {
    ...
    public void renderTileEntityFurnaceHeaterAt(
        TileEntityFurnaceHeater tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/Friction/frictiontex.png"
        );
        ...
        if (tile.isInWorld()) {
            if (tile.getTemperature() >= 1600) {
                this.bindTextureByName(
                    "/Reika/RotaryCraft/Textures/TileEntityTex/Friction/frictiontex-5.png"
                );
            } else if (tile.getTemperature() >= 1300) {
                this.bindTextureByName(
                    "/Reika/RotaryCraft/Textures/TileEntityTex/Friction/frictiontex-4.png"
                );
            } else if (tile.getTemperature() >= 1000) {
                this.bindTextureByName(
                    "/Reika/RotaryCraft/Textures/TileEntityTex/Friction/frictiontex-3.png"
                );
            } else if (tile.getTemperature() >= 700) {
                this.bindTextureByName(
                    "/Reika/RotaryCraft/Textures/TileEntityTex/Friction/frictiontex-2.png"
                );
            } else if (tile.getTemperature() >= 400) {
                this.bindTextureByName(
                    "/Reika/RotaryCraft/Textures/TileEntityTex/Friction/frictiontex-1.png"
                );
            }
        }
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityFurnaceHeaterAt(
                (TileEntityFurnaceHeater) tile, par2, par4, par6, par8
            );
    ...
    private void
    renderHotSide(TileEntityFurnaceHeater tile, double par2, double par4, double par6) {
        if (!tile.hasFurnace())
            return;
