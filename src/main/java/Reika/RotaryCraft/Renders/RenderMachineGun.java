...
public class RenderMachineGun extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityMachineGunAt(
        TileEntityMachineGun tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/machineguntex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityMachineGunAt(
                (TileEntityMachineGun) tile, par2, par4, par6, par8
            );
