...
public class RenderBigFurnace extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityBigFurnaceAt(
        TileEntityBigFurnace tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityBigFurnaceAt(
                (TileEntityBigFurnace) tile, par2, par4, par6, par8
            );
    ...
    private void
    renderLiquid(TileEntityBigFurnace tr, double par2, double par4, double par6) {
