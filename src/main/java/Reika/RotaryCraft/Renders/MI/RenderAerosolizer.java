...
public class RenderAerosolizer extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityAerosolizerAt(
        TileEntityAerosolizer tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        if (!tile.isInWorld()) {
            ...
            {
                //((BlockAerosolizerBlock1)var10).unifyAdjacentChests(tile.worldObj,
        ...
        if (true) {
            ...
            //float var12 = tile.prevLidAngle + (tile.lidAngle - tile.prevLidAngle) *
            //par8;
            float var13; /*
            ...
            var14.renderAll(
                tile, /*ReikaJavaLibrary.makeListFrom(/*liqlevel > 0*/ /*false)*/ null
            );
            // else
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityAerosolizerAt(
                (TileEntityAerosolizer) tile, par2, par4, par6, par8
            );
    ...
    private void
    drawPotionLevels(TileEntityAerosolizer tile, double par2, double par4, double par6) {
        GL11.glPushMatrix();
