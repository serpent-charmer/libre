...
public class RenderRockMelter extends RotaryTERenderer {
    ...
    public void renderTileEntityLavaMakerAt(
        TileEntityLavaMaker tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/lavamakertex.png"
        );
        ...
        var14.renderAll(
            tile, ReikaJavaLibrary.makeListFrom(tile.hasStone()), -tile.phi, 0
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityLavaMakerAt(
                (TileEntityLavaMaker) tile, par2, par4, par6, par8
            );
