...
public class RenderBreeder extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityAutoBreederAt(
        TileEntityAutoBreeder te, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/emptybreedertex.png"
        );
        if (ReikaInventoryHelper.checkForItem(Items.wheat, te))
            this.bindTextureByName(
                "/Reika/RotaryCraft/Textures/TileEntityTex/breedertex.png"
            );
        GL11.glPushMatrix();
        ...
        var14.renderAll(
            te, ReikaJavaLibrary.makeListFromArray(this.getConditions(te)), 0, 0
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityAutoBreederAt(
                (TileEntityAutoBreeder) tile, par2, par4, par6, par8
            );
