...
public class RenderSmokeDetector extends RotaryTERenderer {
     ...
     */
    public void renderTileEntitySmokeDetectorAt(
        TileEntitySmokeDetector tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        if (!tile.isInWorld()) {
            ...
            {
                //((BlockSmokeDetectorBlock1)var10).unifyAdjacentChests(tile.worldObj,
        ...
        if (true) {
            ...
            this.bindTextureByName(
                "/Reika/RotaryCraft/Textures/TileEntityTex/smokedetectortex.png"
            );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntitySmokeDetectorAt(
                (TileEntitySmokeDetector) tile, par2, par4, par6, par8
            );
        //if (tile.isInWorld())
