...
public class RenderWetter extends RotaryTERenderer {
    ...
    public void renderTileEntityWetterAt(
        TileEntityWetter tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile)) {
            this.renderTileEntityWetterAt(
                (TileEntityWetter) tile, par2, par4, par6, par8
            );
    ...
    private void
    renderItem(TileEntityWetter te, double par2, double par4, double par6, float par8) {
    ...
    private void
    renderLiquid(TileEntityWetter te, double par2, double par4, double par6, float par8) {
        if (te.getContainedFluid() != null) {
            ...
            int[] displayList
                = ReikaLiquidRenderer.getGLLists(liquid, te.worldObj, false);
            ...
            ) (amount / ((double) te.getCapacity()) * (ReikaLiquidRenderer.LEVELS - 1))]);
            ...
            int b = te.getContainedFluid().getLuminosity() >= 12 ? 240 :
            te.getBlockType().getMixedBrightnessForBlock(te.worldObj, te.xCoord,
            te.yCoord, te.zCoord); v5.setBrightness(b); v5.addVertexWithUV(0, h, 1, u,
            dv); v5.addVertexWithUV(1, h, 1, du, dv); v5.addVertexWithUV(1, h, 0, du, v);
