...
public class RenderItemCannon extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityItemCannonAt(
        TileEntityItemCannon tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/itemcannontex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityItemCannonAt(
                (TileEntityItemCannon) tile, par2, par4, par6, par8
            );
