...
public class RenderMultiCannon extends RotaryTERenderer {
    ...
    public void renderTileEntityMultiCannonAt(
        TileEntityMultiCannon tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/multicannontex.png"
        );
        ...
        var14.renderAll(
            tile,
            ReikaJavaLibrary.makeListFrom(tile.getSpinAngle() / 3D),
            -tile.phi,
            a * tile.theta
        );
        GL11.glScaled(1, var11, 1);
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityMultiCannonAt(
                (TileEntityMultiCannon) tile, par2, par4, par6, par8
            );
