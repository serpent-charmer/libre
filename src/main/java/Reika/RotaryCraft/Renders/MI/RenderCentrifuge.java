...
public class RenderCentrifuge extends RotaryTERenderer {
    ...
    public void renderTileEntityCentrifugeAt(
        TileEntityCentrifuge tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/centrifugetex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityCentrifugeAt(
                (TileEntityCentrifuge) tile, par2, par4, par6, par8
            );
