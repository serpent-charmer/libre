...
public class RenderHeater extends RotaryTERenderer {
    ...
    public void renderTileEntityHeaterAt(
        TileEntityHeater tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/Heater/heatertex.png"
        );
        if (tile.temperature >= 200)
            this.bindTextureByName(
                "/Reika/RotaryCraft/Textures/TileEntityTex/Heater/heatertex200C.png"
            );
        if (tile.temperature >= 400)
            this.bindTextureByName(
                "/Reika/RotaryCraft/Textures/TileEntityTex/Heater/heatertex400C.png"
            );
        if (tile.temperature >= 600)
            this.bindTextureByName(
                "/Reika/RotaryCraft/Textures/TileEntityTex/Heater/heatertex600C.png"
            );
        if (tile.temperature >= 800)
            this.bindTextureByName(
                "/Reika/RotaryCraft/Textures/TileEntityTex/Heater/heatertex800C.png"
            );
        if (tile.temperature >= 900)
            this.bindTextureByName(
                "/Reika/RotaryCraft/Textures/TileEntityTex/Heater/heatertex900C.png"
            );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityHeaterAt(
                (TileEntityHeater) tile, par2, par4, par6, par8
            );
