...
public class RenderObsidian extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityObsidianAt(
        TileEntityObsidianMaker tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        GL11.glColor4f(
            1.0F + tile.overred, 1.0F + tile.overgreen, 1.0F + tile.overblue, 1.0F
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityObsidianAt(
                (TileEntityObsidianMaker) tile, par2, par4, par6, par8
            );
    ...
    private void renderInternalTexture(
        TileEntityObsidianMaker te, double par2, double par4, double par6
    ) {
        int i = 0;
        double h = 0;
        double maxh = 0.6875;
        ...
        switch (i) {
            ...
            case 3:
                this.bindTextureByName(
                    "/Reika/RotaryCraft/Textures/TileEntityTex/obsidiantex.png"
                );
                u = 78 / 128F;
                v = 0;
                du = u + 14 / 128F;
        ...
        v5.setBrightness(te.getBlockType().getMixedBrightnessForBlock(
