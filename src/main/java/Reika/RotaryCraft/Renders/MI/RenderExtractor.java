...
public class RenderExtractor extends RotaryTERenderer {
    ...
    public void renderTileEntityExtractorAt(
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/extractortex.png"
        );
        ...
        var14.renderAll(
            tile,
            ReikaJavaLibrary.makeListFrom(MinecraftForgeClient.getRenderPass() == 1),
            0,
            0
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityExtractorAt(
                (TileEntityExtractor) tile, par2, par4, par6, par8
            );
