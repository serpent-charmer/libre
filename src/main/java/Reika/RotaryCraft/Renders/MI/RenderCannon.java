...
public class RenderCannon extends RotaryTERenderer {
    ...
    public void renderTileEntityLaunchCannonAt(
        TileEntityLaunchCannon tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        if (tile instanceof TileEntityTNTCannon)
            this.bindTextureByName(
                "/Reika/RotaryCraft/Textures/TileEntityTex/tntcannontex.png"
            );
        if (tile instanceof TileEntityBlockCannon)
            this.bindTextureByName(
                "/Reika/RotaryCraft/Textures/TileEntityTex/blockcannontex.png"
            );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityLaunchCannonAt(
                (TileEntityLaunchCannon) tile, par2, par4, par6, par8
            );
    ...
    private void
    renderMarker(TileEntityLaunchCannon tile, double par2, double par4, double par6) {
        ...
        v5.setColorRGBA(0, 255, 0, 255);
        v5.addVertex(
            par2 + dx - width * 0.71, par4 + dy + height, par6 + dz - width * 0.71
        );
        v5.addVertex(par2 + dx, par4 + dy, par6 + dz);
        v5.addVertex(
            par2 + dx + width * 0.71, par4 + dy + height, par6 + dz + width * 0.71
