...
public class RenderDryingBed extends RotaryTERenderer {
    ...
    public void renderTileEntityDryingBedAt(
        TileEntityDryingBed tile, double par2, double par4, double par6, float par8
    ) {
        ModelDryingBed var14;
        var14 = model;

        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/dryingbedtex.png"
        );
    ...
    private void renderItem(TileEntityDryingBed te) {
        ...
        if (is != null) {
            ...
            //int col = 0;
            //int row = 0;
            //ItemRenderer.renderItemIn2D(v5, 0.0625F+0.0625F*col, 0.0625F*row,
            //0.0625F*col, 0.0625F+0.0625F*row, 256, 256, thick);
            ...
            if (item instanceof IndexedItemSprites) {
                ...
                if (Minecraft.getMinecraft().gameSettings.fancyGraphics)
                    ...
                    v5.addVertexWithUV(
                        1, 0, 0, 0.0625F + 0.0625F * col, 0.0625F + 0.0625F * row
                    );
