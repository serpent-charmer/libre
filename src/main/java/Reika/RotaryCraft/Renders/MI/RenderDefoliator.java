...
public class RenderDefoliator extends RotaryTERenderer {
    ...
    public void renderTileEntityDefoliatorAt(
        TileEntityDefoliator tile, double par2, double par4, double par6, float par8
    ) {
        ModelDefoliator var14;
        var14 = DefoliatorModel;

        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/defoliatortex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityDefoliatorAt(
                (TileEntityDefoliator) tile, par2, par4, par6, par8
            );
