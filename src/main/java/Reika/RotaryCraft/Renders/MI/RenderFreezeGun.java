...
public class RenderFreezeGun extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityFreezeGunAt(
        TileEntityFreezeGun tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/freezeguntex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityFreezeGunAt(
                (TileEntityFreezeGun) tile, par2, par4, par6, par8
            );
    ...
    private void renderIce(TileEntityFreezeGun tile, double par2, double par4, double
    par6) { if (tile == null) return; if (!tile.isInWorld()) return; if (tile.frozen ==
    null) return;
