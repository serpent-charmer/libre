...
public class RenderFraction extends RotaryTERenderer implements StaticModelRenderer {
     ...
     */
    public void renderTileEntityFractionatorAt(
        TileEntityFractionator tile, double par2, double par4, double par6, float par8
    ) {
        ModelFraction var14;
        var14 = FractionModel;
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityFractionatorAt(
                (TileEntityFractionator) tile, par2, par4, par6, par8
            );
