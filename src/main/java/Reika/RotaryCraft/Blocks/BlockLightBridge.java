...
public class BlockLightBridge extends BlockBasic {
    ...
    @Override
    public boolean
    shouldSideBeRendered(IBlockAccess iba, int par2, int par3, int par4, int par5) {
        return par5 == 1 ? true
                         : super.shouldSideBeRendered(iba, par2, par3, par4, par5)
                && iba.getBlock(par2, par3, par4) != this;
    }
