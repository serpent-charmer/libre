...
public class BlockBeam extends BlockBasic {
    ...
    public int getBlockTextureFromSideAndMetadata(int s, int dmg) {
        // We want the texture next to our default texture from this block for the bottom
        // and top side so we just add 1 when the side is 0 or 1 else we return the
        // default one
    ...
    /**
     * If this block doesn't render as an ordinary block it will return False (examples:
    ...
    /**
     * Returns whether this block is collideable based on the arguments passed in Args:
     * blockMetaData, unknownFlag
     */
    @Override
