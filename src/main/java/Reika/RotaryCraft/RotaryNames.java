...
public class RotaryNames {
    private static final String[] engineNames
        = { "engine.dc",    "engine.wind",  "engine.steam", "engine.gas", "engine.ac",
            "engine.sport", "engine.hydro", "engine.micro", "engine.jet" };
    ...
    private static final String[] liquidNames = { "fluid.rc lubricant",
                                                  "fluid.rc jet fuel",
                                                  "fluid.rc ethanol",
                                                  "fluid.rc liquid nitrogen",
                                                  "fluid.molten hsla" };

    private static final String[] canolaNames
        = { "canola.seed", "canola.dense", "canola.husk" };

    public static final String[] enginePartNames = { "crafting.impeller",
                                                     "crafting.compressor",
                                                     "crafting.turbine",
                                                     "crafting.diffuser",
                                                     "crafting.combustor",
                                                     ...
                                                     "crafting.ignition",
                                                     "",
                                                     "crafting.compoundcompress",
                                                     "crafting.alucylinder",
                                                     "crafting.highcombustor" };

    public static final String[] shaftPartNames = { "crafting.panel",
                                                    "crafting.ingot",
                                                    "",
                                                    "crafting.mount",
                                                    "",
    ...
    public static final String[] miscPartNames
        = { "crafting.barrel",   "crafting.lens",       "crafting.power",
            "crafting.heatcore", "crafting.lim",        "crafting.prop",
            "crafting.hub",      "crafting.mirror",     "crafting.generator",
            "crafting.accel",    "crafting.turretbase", "crafting.aiming",
            "crafting.compound", "crafting.bedcoil",    "crafting.chain",
            "crafting.beddrill" };

    public static final String[] borerPartNames = {
        "crafting.drill", "crafting.pressure",    "crafting.radar",
        "crafting.sonar", "crafting.pcb",         "crafting.screen",
        "crafting.mixer", "crafting.saw",         "",
        "crafting.belt",  "crafting.ballbearing", "crafting.brake",
        "crafting.coil",
    };

    public static final String[] blockNames
        = { "block.steel",  "block.anthra",       "block.lonsda",
            "block.shield", "block.bedrockingot", "block.coke" };

    public static final String[] powderNames
        = { "misc.netherdust",  "misc.tar",     "misc.sludge",      "misc.sawdust",
            "misc.beddust",     "misc.salt",    "misc.nh4",         "misc.agi",
            "misc.alum",        "misc.flour",   "misc.coaldust",    "misc.dryice",
            "misc.redgolddust", "misc.compost", "misc.silicondust", "misc.mulch",
            "misc.cleansludge" };

    public static final String[] interfaceNames = {
        "interface.slipperycomb", "interface.slipperypropolis", "interface.gearcast",
        "interface.panelcast",    "interface.shaftcast",        "interface.propcast",
        "interface.drillcast",
    };

    public static final String[] extractNames
        = { "extract.coaldust",     "extract.irondust",      "extract.golddust",
            "extract.reddust",      "extract.bluedust",      "extract.diadust",
            "extract.greendust",    "extract.quartzdust",

            "extract.coalslurry",   "extract.ironslurry",    "extract.goldslurry",
            "extract.redslurry",    "extract.blueslurry",    "extract.diaslurry",
            "extract.greenslurry",  "extract.quartzslurry",

            "extract.coalsolu",     "extract.ironsolu",      "extract.goldsolu",
            "extract.redsolu",      "extract.bluesolu",      "extract.diasolu",
            "extract.greensolu",    "extract.quartzsolu",

            "extract.coalflakes",   "extract.ironflakes",    "extract.goldflakes",
            "extract.redflakes",    "extract.blueflakes",    "extract.diaflakes",
            "extract.greenflakes",  "extract.quartzflakes",

            "extract.silverflakes", "extract.tungstenflakes" };

    public static final String[] compactNames
        = { "misc.anthra",   "misc.prisma",      "misc.lonsda",       "misc.bedingot",
            "misc.alingot",  "misc.wingot",      "misc.redgoldingot", "misc.agingot",
            "misc.coke",     "misc.springingot", "misc.silicon",      "misc.alualloy",
            "misc.tungalloy" };

    public static final String[] pipeNames
        = { "machine.hose",  "machine.pipe",   "machine.fuelline",   "machine.spiller",
            "machine.valve", "machine.bypass", "machine.separation", "machine.bedpipe" };
    ...
    public static String getGearboxName(int i) {
        String mat =
    MaterialRegistry.matList[i%MaterialRegistry.matList.length].getName(); String ratio =
    gearboxRatios[i/5]; String name = MachineRegistry.GEARBOX.getName(); return mat+"
    "+ratio+" "+name;
    }

    @Deprecated
    public static String getGearUnitName(int i) {
        MaterialRegistry[] mats = {MaterialRegistry.WOOD, MaterialRegistry.STONE,
    MaterialRegistry.DIAMOND, MaterialRegistry.BEDROCK}; String mat = mats[i%4].getName();
    ...
    public static String getModIngotName(int dmg) {
        return ModOreList.oreList[dmg].displayName + " "
            + ModOreList.oreList[dmg].getTypeName();
    }
