...
public class RotaryChests {
    ...
    public static void addToChests() {
        ...
        data.addItem(
            2, Location.MINESHAFT, ItemRegistry.SCREWDRIVER.getStackOf(), 1, 1, 1
        );
        ...
        //data.addItem(2, Location.STRONGHOLD_HALLWAY,
        //BlockRegistry.BLASTGLASS.getStackOf(), 1, 6, 15);
        ...
        //data.addItem(2, Location.STRONGHOLD_CROSSING,
        //BlockRegistry.BLASTGLASS.getStackOf(), 1, 6, 15);

        //data.addItem(2, Location.STRONGHOLD_LIBRARY, ItemRegistry.HANDBOOK.getStackOf(),
        //1, 1, 25);
        data.addItem(
            3, Location.STRONGHOLD_LIBRARY, ItemRegistry.METER.getStackOf(), 1, 1, 2
        );
