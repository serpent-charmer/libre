...
public class GuiBasicStorage extends GuiMachine {
    ...
    protected final void drawPowerOnly(int var5, int var6) {
        ...
        this.drawTexturedModalRect(
            xSize + var5 + 5, ySize + var6 - 53 - (ySize - 75), 0, 0, (int) frac, 4
        );
        ...
        //spawnercontroller.power, spawnercontroller.MINPOWER), xSize+var5+16, var6+16,
        //0xff000000);
    }
    ...
    protected void drawPowerTab(int var5, int var6) {
        ...
        long frac = recv.getScaledPower(29);
        this.drawTexturedModalRect(
            xSize + var5 + 5, ySize + var6 + dy - inventoryRows * 18, 0, 0, (int) frac, 4
        );
        dy += spacing;
        ...
        dy = 9;
        ReikaGuiAPI.instance.drawCenteredStringNoShadow(
            fontRendererObj, "Power:", xSize + var5 + 20, var6 + dy, 0xff000000
        );
        dy += spacing;
        ReikaGuiAPI.instance.drawCenteredStringNoShadow(
            fontRendererObj, "Speed:", xSize + var5 + 20, var6 + dy, 0xff000000
        );
        dy += spacing;
        ReikaGuiAPI.instance.drawCenteredStringNoShadow(
            fontRendererObj, "Torque:", xSize + var5 + 20, var6 + dy, 0xff000000
        );
        //this.drawCenteredStringNoShadow(fontRendererObj, String.format("%d/%d",
        //tile.power, tile.MINPOWER), xSize+var5+16, var6+16, 0xff000000);
    }
