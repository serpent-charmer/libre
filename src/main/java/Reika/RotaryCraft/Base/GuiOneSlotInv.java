...
public class GuiOneSlotInv extends GuiMachine {
    ...
    public GuiOneSlotInv(
        EntityPlayer pl, Container par1Container, RotaryCraftTileEntity te
    ) {
    ...
    protected final void drawPowerTab(int j, int k) {
        if (recv != null) {
            ...
            this.drawTexturedModalRect(
                xSize + j + 5, ySize + k - 144, 0, 0, (int) frac, 4
            );
            ...
            if (frac > 29)
                frac = 29;
            this.drawTexturedModalRect(
                xSize + j + 5, ySize + k - 84, 0, 0, (int) frac, 4
            );
            ...
            if (frac > 29)
                frac = 29;
            this.drawTexturedModalRect(
                xSize + j + 5, ySize + k - 24, 0, 0, (int) frac, 4
            );

            api.drawCenteredStringNoShadow(
                fontRendererObj, "Power:", xSize + j + 20, k + 9, 0xff000000
            );
            api.drawCenteredStringNoShadow(
                fontRendererObj, "Speed:", xSize + j + 20, k + 69, 0xff000000
            );
            api.drawCenteredStringNoShadow(
                fontRendererObj, "Torque:", xSize + j + 20, k + 129, 0xff000000
            );
            //this.drawCenteredStringNoShadow(fontRendererObj, String.format("%d/%d",
            //recv.power, recv.MINPOWER), xSize+j+16, k+16, 0xff000000);
        }
    }
