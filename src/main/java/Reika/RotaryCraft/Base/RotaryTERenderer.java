...
public abstract class RotaryTERenderer
    extends TileEntityRenderBase implements TextureFetcher {
    @Override
    ...
    protected void
    renderFaceColors(TileEntityIOMachine te, double p2, double p4, double p6) {
        ...
        v5.setColorRGBA(
            colors[0].getRed(), colors[0].getGreen(), colors[0].getBlue(), alpha
        );
        ...
        v5.setColorRGBA(
            colors[0].getRed(), colors[0].getGreen(), colors[0].getBlue(), alpha / 3
        );
        v5.addVertex(p2 - offset, p4 - offset, p6 - offset);
        v5.addVertex(p2 + 1 + offset, p4 - offset, p6 - offset);
        v5.addVertex(p2 + 1 + offset, p4 - offset, p6 + 1 + offset);
        ...
        v5.startDrawing(GL11.GL_LINE_LOOP);
        v5.setColorRGBA(
            colors[1].getRed(), colors[1].getGreen(), colors[1].getBlue(), alpha
        );
        ...
        v5.startDrawing(GL11.GL_QUADS);
        v5.setColorRGBA(
            colors[1].getRed(), colors[1].getGreen(), colors[1].getBlue(), alpha / 3
        );
        v5.addVertex(p2 - offset, p4 + 1 + offset, p6 + 1 + offset);
        v5.addVertex(p2 + 1 + offset, p4 + 1 + offset, p6 + 1 + offset);
        v5.addVertex(p2 + 1 + offset, p4 + 1 + offset, p6 - offset);
        ...
        v5.startDrawing(GL11.GL_LINE_LOOP);
        v5.setColorRGBA(
            colors[2].getRed(), colors[2].getGreen(), colors[2].getBlue(), alpha
        );
        v5.addVertex(p2 - offset, p4 - offset, p6 - offset);
        v5.addVertex(p2 + 1 + offset, p4 - offset, p6 - offset);
        v5.addVertex(p2 + 1 + offset, p4 + 1 + offset, p6 - offset);
        ...
        v5.startDrawing(GL11.GL_QUADS);
        v5.setColorRGBA(
            colors[2].getRed(), colors[2].getGreen(), colors[2].getBlue(), alpha / 3
        );
        v5.addVertex(p2 - offset, p4 + 1 + offset, p6 - offset);
        v5.addVertex(p2 + 1 + offset, p4 + 1 + offset, p6 - offset);
        v5.addVertex(p2 + 1 + offset, p4 - offset, p6 - offset);
        ...
        v5.startDrawing(GL11.GL_LINE_LOOP);
        v5.setColorRGBA(
            colors[3].getRed(), colors[3].getGreen(), colors[3].getBlue(), alpha
        );
        v5.addVertex(p2 - offset, p4 - offset, p6 + 1 + offset);
        v5.addVertex(p2 + 1 + offset, p4 - offset, p6 + 1 + offset);
        v5.addVertex(p2 + 1 + offset, p4 + 1 + offset, p6 + 1 + offset);
        ...
        v5.startDrawing(GL11.GL_LINE_LOOP);
        v5.setColorRGBA(
            colors[4].getRed(), colors[4].getGreen(), colors[4].getBlue(), alpha
        );
        v5.addVertex(p2 - offset, p4 - offset, p6 - offset);
        v5.addVertex(p2 - offset, p4 - offset, p6 + 1 + offset);
        v5.addVertex(p2 - offset, p4 + 1 + offset, p6 + 1 + offset);
        ...
        v5.startDrawing(GL11.GL_QUADS);
        v5.setColorRGBA(
            colors[4].getRed(), colors[4].getGreen(), colors[4].getBlue(), alpha / 3
        );
        v5.addVertex(p2 - offset, p4 - offset, p6 - offset);
        v5.addVertex(p2 - offset, p4 - offset, p6 + 1 + offset);
        v5.addVertex(p2 - offset, p4 + 1 + offset, p6 + 1 + offset);
        ...
        v5.startDrawing(GL11.GL_LINE_LOOP);
        v5.setColorRGBA(
            colors[5].getRed(), colors[5].getGreen(), colors[5].getBlue(), alpha
        );
        v5.addVertex(p2 + 1 + offset, p4 - offset, p6 - offset);
        v5.addVertex(p2 + 1 + offset, p4 - offset, p6 + 1 + offset);
        v5.addVertex(p2 + 1 + offset, p4 + 1 + offset, p6 + 1 + offset);
        ...
        v5.startDrawing(GL11.GL_QUADS);
        v5.setColorRGBA(
            colors[5].getRed(), colors[5].getGreen(), colors[5].getBlue(), alpha / 3
        );
        v5.addVertex(p2 + 1 + offset, p4 + 1 + offset, p6 - offset);
        v5.addVertex(p2 + 1 + offset, p4 + 1 + offset, p6 + 1 + offset);
        v5.addVertex(p2 + 1 + offset, p4 - offset, p6 + 1 + offset);
        ...
        for (int i = 0; i < 6; i++) {
            ...
            v5.setColorRGBA(
                colors[i].getRed(), colors[i].getGreen(), colors[i].getBlue(), alpha
            );
    ...
    protected void
    setupGL(RotaryCraftTileEntity tile, double par2, double par4, double par6) {
        GL11.glPushMatrix();
        ...
        if (tile.isInWorld() && tile.isFlipped
            && MinecraftForgeClient.getRenderPass() == 0) {
            GL11.glRotated(180, 1, 0, 0);
            GL11.glTranslated(0, -2, 0);
            MachineRegistry m = tile.getTile();
            boolean rot = false;
...
GL11.glColor4f(1.0F, 1.0F, 1.0F, 1.0F);
GL11.glTranslated(te.xCoord-TileEntityRendererDispatcher.staticPlayerX,
te.yCoord-TileEntityRendererDispatcher.staticPlayerY,
te.zCoord-TileEntityRendererDispatcher.staticPlayerZ); v5.startDrawingQuads();
v5.setBrightness(tile.getBlockType().getMixedBrightnessForBlock(tile.worldObj,
tile.xCoord, tile.yCoord, tile.zCoord)); v5.setColorOpaque_I(0xffffff); int n =
RotaryAux.func_39467_b_(m.getBlock(), m.getMachineMetadata(), 0, null); double u =
(n%16)/16D; double v = (n/16)/16D; double du = u+0.0625; double dv = v+0.0625; double ox =
m.getMinX(tile); double oy = m.getMinY(tile); double oz = m.getMinZ(tile); double w =
m.getMaxX(tile); double h = m.getMaxY(tile); double l = m.getMaxZ(tile);
