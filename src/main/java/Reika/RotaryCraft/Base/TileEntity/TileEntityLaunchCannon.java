...
public abstract class TileEntityLaunchCannon
    extends InventoriedPowerReceiver implements DiscreteFunction, ConditionalOperation {
    public int velocity;
    public int phi;
    public int theta;
    ...
    protected abstract boolean fire(World world, int x, int y, int z, int slot);
