...
public abstract class TileEntityProtectionDome
    extends TileEntityPowerReceiver implements RangedEffect, GuiController {
    ...
    public final int getMaxRange() {
        ...
        if (power < MINPOWER)
            return 0;
        int range
            = 2 + (int) ((power - MINPOWER) / this.getFallOff()) + this.getRangeBoost();
