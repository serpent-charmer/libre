...
public abstract class InventoriedPowerLiquidReceiver
    extends PoweredLiquidReceiver implements ISidedInventory {
    ...
    public int[] getAccessibleSlotsFromSide(int var1) {
        ...
        if (this instanceof HiddenInventorySlot)
            return ReikaArrayHelper.getLinearArrayExceptFor(
                this.getSizeInventory(), ((HiddenInventorySlot) this).getHiddenSlots()
            );
