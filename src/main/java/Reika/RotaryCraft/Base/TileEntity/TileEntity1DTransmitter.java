...
public abstract class TileEntity1DTransmitter
    extends TileEntityTransmissionMachine implements SimpleProvider {
    protected int ratio;
    ...
    public void
    getIOSides(World world, int x, int y, int z, int meta, boolean hasVertical) {
        switch (meta) {
            case 0:
