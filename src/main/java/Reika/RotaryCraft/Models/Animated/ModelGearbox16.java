...
public class ModelGearbox16 extends ModelGearboxBase {
    //fields
    ...
    LODModelPart Shape50;
    LODModelPart Shape51;

    public ModelGearbox16() {
        super();

        Shape12 = new LODModelPart(this, 0, 27);
        Shape12.addBox(0F, 0F, 0F, 13, 2, 2);
        Shape12.setRotationPoint(-6.5F, 18F, 3F);
        Shape12.setTextureSize(128, 32);
        Shape12.mirror = true;
        this.setRotation(Shape12, 0F, 0F, 0F);
        Shape12.mirror = false;
        Shape13 = new LODModelPart(this, 0, 27);
        Shape13.addBox(0F, 0F, 0F, 13, 2, 2);
        Shape13.setRotationPoint(-6.5F, 19F, 2.6F);
        ...
        Shape16.setRotationPoint(-2F, 14F, -9.3F);
        ...
        Shape20.addBox(0F, 0F, 0F, 12, 2, 2);
        Shape20.setRotationPoint(-6F, 14F, -6.4F);
        ...
        Shape22.addBox(0F, 0F, 0F, 1, 5, 5);
        Shape22.setRotationPoint(-1F, 16.5F, 1.8F);
        Shape22.setTextureSize(128, 32);
        Shape22.mirror = true;
        this.setRotation(Shape22, 0F, 0F, 0F);
        Shape23 = new LODModelPart(this, 100, 0);
        Shape23.addBox(0F, 0F, 0F, 1, 5, 5);
        Shape23.setRotationPoint(-1F, 19F, 0.5F);
        ...
        Shape37.setRotationPoint(-2F, 11F, -8F);
        ...
        Shape41.addBox(0F, 0F, 0F, 12, 2, 2);
        ...
        Shape42.addBox(0F, 0F, 0F, 4, 2, 2);
        Shape42.setRotationPoint(-8.5F, 15F, -1F);
        Shape42.setTextureSize(128, 32);
        Shape42.mirror = true;
        this.setRotation(Shape42, 0F, 0F, 0F);
        Shape43 = new LODModelPart(this, 0, 27);
        Shape43.addBox(0F, 0F, 0F, 4, 2, 2);
        Shape43.setRotationPoint(-8.5F, 16F, -1.4F);
        Shape43.setTextureSize(128, 32);
        Shape43.mirror = true;
        this.setRotation(Shape43, 0.7853982F, 0F, 0F);
        Shape44 = new LODModelPart(this, 100, 0);
        Shape44.addBox(0F, 0F, 0F, 1, 6, 6);
        Shape44.setRotationPoint(2F, 10F, -4F);
        Shape44.setTextureSize(128, 32);
        Shape44.mirror = true;
        this.setRotation(Shape44, 0F, 0F, 0F);
        Shape45 = new LODModelPart(this, 100, 0);
        Shape45.addBox(0F, 0F, 0F, 1, 6, 6);
        Shape45.setRotationPoint(2F, 13F, -5.3F);
        Shape45.setTextureSize(128, 32);
        Shape45.mirror = true;
        this.setRotation(Shape45, 0.7853982F, 0F, 0F);
        Shape46 = new LODModelPart(this, 0, 27);
        Shape46.addBox(0F, 0F, 0F, 12, 2, 2);
        Shape46.setRotationPoint(-6F, 13F, -2.4F);
        Shape46.setTextureSize(128, 32);
        Shape46.mirror = true;
        this.setRotation(Shape46, 0.7853982F, 0F, 0F);
        Shape47 = new LODModelPart(this, 0, 27);
        Shape47.addBox(0F, 0F, 0F, 12, 2, 2);
        Shape47.setRotationPoint(-6F, 12F, -2F);
        Shape47.setTextureSize(128, 32);
        Shape47.mirror = true;
        this.setRotation(Shape47, 0F, 0F, 0F);
        Shape48 = new LODModelPart(this, 100, 0);
        Shape48.addBox(0F, 0F, 0F, 1, 4, 4);
        Shape48.setRotationPoint(2F, 12.4F, 1.8F);
        Shape48.setTextureSize(128, 32);
        Shape48.mirror = true;
        this.setRotation(Shape48, 0F, 0F, 0F);
        Shape49 = new LODModelPart(this, 100, 0);
        Shape49.addBox(0F, 0F, 0F, 1, 4, 4);
        Shape49.setRotationPoint(2F, 14.5F, 1F);
        Shape49.setTextureSize(128, 32);
        Shape49.mirror = true;
        this.setRotation(Shape49, 0.7853982F, 0F, 0F);
        Shape50 = new LODModelPart(this, 100, 0);
        Shape50.addBox(0F, 0F, 0F, 1, 4, 4);
        Shape50.setRotationPoint(5F, 12.4F, 1.8F);
        Shape50.setTextureSize(128, 32);
        Shape50.mirror = true;
        this.setRotation(Shape50, 0F, 0F, 0F);
        Shape51 = new LODModelPart(this, 100, 0);
        Shape51.addBox(0F, 0F, 0F, 1, 4, 4);
        Shape51.setRotationPoint(5F, 14.5F, 1F);
        Shape51.setTextureSize(128, 32);
        Shape51.mirror = true;
        this.setRotation(Shape51, 0.7853982F, 0F, 0F);
    ...
    public void renderAll(TileEntity te, ArrayList li, float phi, float theta) {
        ...
        Shape50.render(te, f5);
        Shape51.render(te, f5);
        GL11.glTranslated(d1, d2, d3);
        GL11.glRotatef(phi * 2F, 1, 0, 0);
        GL11.glTranslated(-d1, -d2, -d3);
        GL11.glTranslated(0, -0.015125, 0.006125);
