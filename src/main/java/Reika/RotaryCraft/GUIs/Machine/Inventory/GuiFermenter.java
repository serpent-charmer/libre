...
public class GuiFermenter extends GuiMachine {
    ...
    protected void drawGuiContainerForegroundLayer(int a, int b) {
        ...
        if (red) {
            ...
            api.drawItemStack(
                itemRender, fontRendererObj, ItemRegistry.YEAST.getStackOf(), sx, sy
            );
        }
        ...
        if (api.isMouseInBox(sx + j - 1, sx + 16 + j + 1, sy + k - 1, sy + 16 + k + 1)) {
            ...
            api.drawTooltipAt(
                fontRendererObj,
                String.format("Water: %d/%d mB", ferm.getLevel(), ferm.CAPACITY),
                api.getMouseRealX() - j,
                api.getMouseRealY() - k
            );
        }
        ...
        this.drawTexturedModelRectFromIcon(
            sx, sy + 16 - h + dy, FluidRegistry.WATER.getIcon(), 16, h
        );
    }
    ...
    protected void drawPowerTab(int var5, int var6) {
        ...
        this.drawTexturedModalRect(
            xSize + var5 + 5, ySize + var6 - 144, 0, 0, (int) frac, 4
        );
        ...
        if (frac > 29)
            frac = 29;
        this.drawTexturedModalRect(
            xSize + var5 + 5, ySize + var6 - 84, 0, 0, (int) frac, 4
        );
        ...
        if (frac > 29)
            frac = 29;
        this.drawTexturedModalRect(
            xSize + var5 + 5, ySize + var6 - 24, 0, 0, (int) frac, 4
        );
        ...
        api.drawCenteredStringNoShadow(
            fontRendererObj, "Speed:", xSize + var5 + 20, var6 + 69, 0xff000000
        );
        api.drawCenteredStringNoShadow(
            fontRendererObj, "Torque:", xSize + var5 + 20, var6 + 129, 0xff000000
        );
        //this.drawCenteredStringNoShadow(fontRendererObj, String.format("%d/%d",
        //ferm.power, ferm.MINPOWER), xSize+var5+16, var6+16, 0xff000000);
    }
