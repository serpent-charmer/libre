...
public class GuiCCTVScreen extends GuiMachine {
    ...
    protected void drawGuiContainerForegroundLayer(int a, int b) {
        ...
        api.drawCenteredStringNoShadow(
            fontRendererObj, "Camera Select", xSize / 2, 54, 4210752
        );
    }
    ...
    protected void drawPowerTab(int var5, int var6) {
        ...
        this.drawTexturedModalRect(
            xSize + var5 + 5, ySize + var6 - 149 + a, 0, 0, (int) frac, 4
        );
        ...
        if (frac > 29)
            frac = 29;
        this.drawTexturedModalRect(
            xSize + var5 + 5, ySize + var6 - 90 + a, 0, 0, (int) frac, 4
        );
        ...
        if (frac > 29)
            frac = 29;
        this.drawTexturedModalRect(
            xSize + var5 + 5, ySize + var6 - 31 + a, 0, 0, (int) frac, 4
        );

        api.drawCenteredStringNoShadow(
            fontRendererObj, "Power:", xSize + var5 + 20, var6 + 4 + a, 0xff000000
        );
        api.drawCenteredStringNoShadow(
            fontRendererObj, "Speed:", xSize + var5 + 20, var6 + 63 + a, 0xff000000
        );
        api.drawCenteredStringNoShadow(
            fontRendererObj, "Torque:", xSize + var5 + 20, var6 + 122 + a, 0xff000000
        );
    }
