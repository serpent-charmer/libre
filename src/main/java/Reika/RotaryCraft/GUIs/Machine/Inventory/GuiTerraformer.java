...
public class GuiTerraformer extends GuiPowerOnlyMachine {
    ...
    public void initGui() {
        ...
        buttonList.add(new ImagedGuiButton(
            100, j + 11, k + 6, 24, 12, 18, 110, tex, RotaryCraft.class
        ));
        buttonList.add(new ImagedGuiButton(
            101, j + 11, k + ySize - 14, 24, 12, 42, 110, tex, RotaryCraft.class
        ));
    }
    ...
    protected void actionPerformed(GuiButton b) {
        ...
        if (b.id == 100 && offset > 0) {
            ...
            ReikaPacketHelper.sendPacketToServer(
                ...
                PacketRegistry.TERRAFORMER.ordinal(),
                terra,
                biome.biomeID
            );
        }
        ...
        for (int i = 0; i < this.getNumberBiomesOnPage(); i++) {
            ...
            if (liq != null) {
                ...
                api.drawCenteredStringNoShadow(
                    fontRendererObj, String.format("%d", liq.amount), 56, 21 + i * 39, 0
                );
            } else {
