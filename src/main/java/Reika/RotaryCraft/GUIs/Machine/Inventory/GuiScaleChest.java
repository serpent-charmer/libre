...
public class GuiScaleChest extends GuiPowerOnlyMachine {
    ...
    public GuiScaleChest(EntityPlayer p5ep, TileEntityScaleableChest te, int page) {
        ...
        scale = te;
        ySize = var4 + 18 * scale.MAXROWS; //ReikaMathLibrary.extrema(numrows,
                                           //scale.MAXROWS, "min")*18;
        ep = p5ep;
        this.setValues();
        this.page = page;
    }
    ...
    protected void actionPerformed(GuiButton button) {
        ...
        ReikaPacketHelper.sendPacketToServer(
            RotaryCraft.packetChannel, PacketRegistry.CHEST.ordinal(), scale, page
        );
        //ep.closeScreen();
        //this.refresh();
        //this.setValues();
    ...
    protected void drawGuiContainerForegroundLayer(int a, int b) {
        ...
        fontRendererObj.drawString(
            "Page " + String.valueOf(page), xSize - 48, 6, 4210752
        );
        int var3 = 0;
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        this.drawTexturedModalRect(
            var5, var6 + scale.MAXROWS * 18 + 17, 0, 126, xSize, 96
        );
