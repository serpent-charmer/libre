...
public class GuiHeater extends GuiMachine {
    ...
    protected void drawGuiContainerForegroundLayer(int a, int b) {
        ...
        api.drawCenteredStringNoShadow(
            fontRendererObj, tile.getMultiValuedName(), xSize / 2, 5, 4210752
        );
        ...
        if (!input.isFocused()) {
            fontRendererObj.drawString(
                String.format("%d", heater.setTemperature), 140, 59, 0xffffffff
            );
        }
    }
    ...
    protected void drawPowerTab(int var5, int var6) {
        ...
        this.drawTexturedModalRect(
            xSize + var5 + 5, ySize + var6 - 145, 0, 0, (int) frac, 4
        );
        ...
        if (frac > 29)
            frac = 29;
        this.drawTexturedModalRect(
            xSize + var5 + 5, ySize + var6 - 85, 0, 0, (int) frac, 4
        );
        ...
        if (frac > 29)
            frac = 29;
        this.drawTexturedModalRect(
            xSize + var5 + 5, ySize + var6 - 25, 0, 0, (int) frac, 4
        );
        ...
        //heater.power, heater.MINPOWER), xSize+var5+16, var6+16, 0xff000000);
    }
