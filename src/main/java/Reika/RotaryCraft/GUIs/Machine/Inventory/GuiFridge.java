...
public class GuiFridge extends GuiMachine {
    ...
    protected void drawGuiContainerForegroundLayer(int a, int b) {
        ...
        if (api.isMouseInBox(j + 152, j + 167, k + 18, k + 89)) {
            ...
            api.drawTooltipAt(
                fontRendererObj,
                String.format("%d/%d", te.getLevel(), te.getCapacity()),
                mx - j,
                my - k
            );
            if (te.getLevel() > 0) {
    ...
    protected void drawPowerTab(int var5, int var6) {
        ...
        this.drawTexturedModalRect(
            xSize + var5 + 5, ySize + var6 - 166, 0, 0, (int) frac, 4
        );
        ...
        if (frac > 29)
            frac = 29;
        this.drawTexturedModalRect(
            xSize + var5 + 5, ySize + var6 - 106, 0, 0, (int) frac, 4
        );
        ...
        if (frac > 29)
            frac = 29;
        this.drawTexturedModalRect(
            xSize + var5 + 5, ySize + var6 - 46, 0, 0, (int) frac, 4
        );
        ...
        //te.power, te.MINPOWER), xSize+var5+16, var6+16, 0xff000000);
    }
