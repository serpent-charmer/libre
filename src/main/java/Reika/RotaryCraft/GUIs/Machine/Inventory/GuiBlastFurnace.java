...
public class GuiBlastFurnace extends GuiNonPoweredMachine {
    ...
    protected void actionPerformed(GuiButton b) {
        ...
        if (b.id == 0) {
            ...
            ReikaPacketHelper.sendPacketToServer(
                ...
                PacketRegistry.BLASTLEAVEONE.ordinal(),
                blast,
                blast.leaveLastItem ? 1 : 0
            );
            this.initGui();
        }
    }
    ...
    protected void drawGuiContainerForegroundLayer(int a, int b) {
        ...
        api.drawCenteredStringNoShadow(
            fontRendererObj,
            String.valueOf(blast.getTemperature()) + "C",
            17 + c,
            6,
            4210752
        );
    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        for (int i = 0; i < inventorySlots.inventorySlots.size(); i++) {
            ...
            if (s.inventory == blast && s.getClass() == Slot.class) {
                ...
                drawRect(
                    j + s.xDisplayPosition,
                    k + s.yDisplayPosition,
                    j + s.xDisplayPosition + 16,
                    k + s.yDisplayPosition + 16,
                    clr
                );
            }
        }
