...
public class GuiFractionator extends GuiMachine {
    ...
    protected void drawGuiContainerForegroundLayer(int a, int b) {
        ...
        if (api.isMouseInBox(j + 150, j + 159, k + 15, k + 70)) {
            ...
            api.drawTooltipAt(
                fontRendererObj,
                String.format("%d/%d", fct.getOutputLevel(), fct.getOutputCapacity()),
                mx - j,
                my - k
            );
        }
        if (api.isMouseInBox(j + 123, j + 132, k + 15, k + 70)) {
            ...
            api.drawTooltipAt(
                fontRendererObj,
                String.format("%d/%d", fct.getInputLevel(), fct.getInputCapacity()),
                mx - j,
                my - k
            );
        }
        if (api.isMouseInBox(j + 133, j + 136, k + 15, k + 70)) {
            ...
            int my = api.getMouseRealY();
            api.drawTooltipAt(
                fontRendererObj, String.format("%dkPa", fct.getPressure()), mx - j, my - k
            );
        }
    }
    ...
    protected void drawPowerTab(int var5, int var6) {
        ...
        //fct.power, fct.MINPOWER), xSize+var5+16, var6+16, 0xff000000);
    }
