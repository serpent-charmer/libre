    ...
    protected void drawGuiContainerBackgroundLayer(float par1, int par2, int par3) {
        ...
        for (int i = 0; i < 3; i++) {
            for (int j = 0; j < 3; j++) {
                ...
                //%d %d %d %d %d %d %d %d", aero.potionLevel[0], aero.potionLevel[1],
                //aero.potionLevel[2], aero.potionLevel[3], aero.potionLevel[4],
                //aero.potionLevel[5], aero.potionLevel[6], aero.potionLevel[7],
                //aero.potionLevel[8]));
                api.fillBar(
                    var5 + 62 + 18 * j,
                    var6 + 17 + 18 * i,
                ...
                api.drawCenteredStringNoShadow(
                    fontRendererObj,
                    String.format("%d", aero.getPotionLevel(3 * i + j)),
                    var5 + 70 + 18 * j,
                    var6 + 22 + 18 * i,
                    0x000000
                );
