...
public class GuiCompactor extends GuiMachine {
    ...
    protected void drawGuiContainerForegroundLayer(int a, int b) {
        ...
        if (api.isMouseInBox(j + 146, j + 151, k + 15, k + 70)) {
            ...
            api.drawTooltipAt(
                fontRendererObj,
                String.format("%d kPa", comp.getPressure()),
                mx - j,
                my - k
            );
        }
        if (api.isMouseInBox(j + 117, j + 127, k + 15, k + 70)) {
            ...
            int my = api.getMouseRealY();
            api.drawTooltipAt(
                fontRendererObj, String.format("%dC", comp.temperature), mx - j, my - k
            );
        }
    }
    ...
    protected void drawPowerTab(int var5, int var6) {
        ...
        //comp.power, comp.MINPOWER), xSize+var5+16, var6+16, 0xff000000);
    }
