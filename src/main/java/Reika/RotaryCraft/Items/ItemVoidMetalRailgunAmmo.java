...
public class ItemVoidMetalRailgunAmmo extends ItemRailgunAmmoBase {
    ...
    public static class VoidMetalRailGunAmmo implements RailGunAmmoType {
        ...
        private static final BasicRailGunAmmo delegate
            = (BasicRailGunAmmo) ((ItemRailGunAmmo) ItemRegistry.RAILGUN.getItemInstance()
            )
                  .getAmmo(ItemRegistry.RAILGUN.getStackOfMetadata(EQUIVALENT));
        ...
        public Entity getProjectileEntity(
            ...
            EntityRailGunShot e = new EntityRailGunShot(
                world,
                x,
                y,
                z,
