...
@Strippable(
    value = { "thaumcraft.api.nodes.IRevealer",
              "thaumcraft.api.IGoggles",
              "thaumcraft.api.IVisDiscountGear" }
)
public class ItemBedReveal
    extends ItemBedrockArmor implements IRevealer, IGoggles, IVisDiscountGear {
    ...
    public HashMap<Enchantment, Integer> getDefaultEnchantments() {
        return ((ItemBedrockArmor) ItemRegistry.BEDHELM.getItemInstance())
