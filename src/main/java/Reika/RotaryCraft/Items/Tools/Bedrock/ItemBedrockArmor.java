...
public class ItemBedrockArmor extends ItemRotaryArmor implements IArmorApiarist {
    ...
    public static enum HelmetUpgrades {
        ...
        public ItemMatch[] getUpgradeItems() {
            switch (this) {
                ...
                case VISOR:
                    return new ItemMatch[] { new ItemMatch(Blocks.stained_glass),
                                             new ItemMatch(Items.diamond),
                                             new ItemMatch(Blocks.stained_glass) };
                case APIARIST:
                    return ReikaArrayHelper.getArrayOf(
                        new ItemMatch(ForestryHandler.CraftingMaterials.WOVENSILK.getItem(
                        )),
                        8
                    );
                case SLUG1:
    ...
    public void onArmorTick(World world, EntityPlayer ep, ItemStack is) {
        ...
        ep.getEntityAttribute(SharedMonsterAttributes.knockbackResistance)
    ...
    @Override
    public void
    onUpdate(ItemStack is, World world, Entity entity, int par4, boolean par5) {
    ...
    public static boolean isWearingFullSuitOf(EntityLivingBase e) {
        return ReikaEntityHelper.isEntityWearingFullSuitOf(
            e, (ItemStack is) -> isValidBedrockArmorItem(is)
        );
    }
    ...
    public int getItemSpriteIndex(ItemStack item) {
        return this == ItemRegistry.BEDHELM.getItemInstance()
                && HelmetUpgrades.NIGHTVISION.existsOn(item)
            ? 48
            : super.getItemSpriteIndex(item);
    }
    ...
    public boolean protectEntity(
        ...
        return ir != null && ir.isBedrockArmor()
            && HelmetUpgrades.APIARIST.existsOn(head);
    }
