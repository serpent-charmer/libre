...
public class ItemMatchFilter
    extends ItemRotaryTool implements SpriteRenderCallback, CustomMatchingItem {
    ...
    public ItemStack onItemRightClick(ItemStack is, World world, EntityPlayer ep) {
        if (ep.isSneaking()) {
            ...
            ep.openGui(
                RotaryCraft.instance, GuiRegistry.FILTER.ordinal(), world, 0, 0, 0
            );
        }
        return is;
    }
