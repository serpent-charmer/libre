...
public class CrystallizerHandler extends TemplateRecipeHandler {
    ...
    public void loadTransferRects() {
        transferRects.add(
            new RecipeTransferRect(new Rectangle(23, 23, 46, 18), "rccrystall")
        );
    }
    ...
    public void loadCraftingRecipes(String outputId, Object... results) {
        if (outputId != null && outputId.equals("rccrystall")) {
            Collection<CrystallizerRecipe> li
                = RecipesCrystallizer.getRecipes().getAllRecipes();
    ...
    public void loadUsageRecipes(ItemStack ingredient) {
        ...
        if (fs != null) {
            ...
            if (is != null) {
                arecipes.add(new CrystallizerNEIRecipe(
                    RecipesCrystallizer.getRecipes().getRecipe(is)
                ));
            }
        }
    }
    ...
    private void drawFluids(int recipe) {
        ...
        if (fs != null) {
            ...
            //	ReikaGuiAPI.instance.drawTooltip(Minecraft.getMinecraft().fontRenderer,
            //f.getLocalizedName());
            //}
