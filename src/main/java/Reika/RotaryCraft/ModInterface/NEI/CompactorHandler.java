...
public class CompactorHandler extends TemplateRecipeHandler {
    public class CompactorRecipe extends CachedRecipe {
        ...
        public PositionedStack getIngredient() {
            return new PositionedStack(
                ReikaItemHelper.getSizedItemStack(input, 1), 71, 24
            );
        }
    ...
    public void drawBackground(int recipe) {
        ...
        ReikaGuiAPI.instance.drawTexturedModalRectWithDepth(
            0, dy, 5, dy, 166, 75, ReikaGuiAPI.NEI_DEPTH
        );
    }
    ...
    public void loadTransferRects() {
        transferRects.add(
            new RecipeTransferRect(new Rectangle(40, 13, 33, 60), "rccompactor")
        );
    }
    ...
    public void drawExtras(int recipe) {
        ...
        Minecraft.getMinecraft().fontRenderer.drawString(
            String.format("Required Pressure: %d kPa", pressure), 0, 85, 0x333333, false
        );
        Minecraft.getMinecraft().fontRenderer.drawString(
            String.format("Required Temperature: %dC", temperature),
            0,
            95,
            0x333333,
            false
