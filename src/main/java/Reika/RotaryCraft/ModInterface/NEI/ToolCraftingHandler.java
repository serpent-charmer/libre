...
public class ToolCraftingHandler extends TemplateRecipeHandler {
    ...
    public void loadCraftingRecipes(ItemStack result) {
        ...
        if (result.getItemDamage() > 0) {
            ...
            arecipes.add(new CraftingRecipe(
                ir.getEnchantedStack(), ItemRegistry.BEDCHEST.getEnchantedStack(), jet
            ));
            isWorktable = true;
        }
    }
    ...
    public void loadUsageRecipes(ItemStack ingredient) {
        isWorktable = false;
        if (ingredient != null
            && ingredient.getItem() == ItemRegistry.BEDCHEST.getItemInstance()) {
            ItemStack jet = ItemRegistry.JETPACK.getStackOf();
            arecipes.add(new CraftingRecipe(
    ...
    public String getGuiTexture() {
        return isWorktable ? "/Reika/RotaryCraft/Textures/GUI/worktablegui.png"
                           : "/gui/crafting.png";
    }
