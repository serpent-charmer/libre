...
public class WorktableRecipeHandler extends TemplateRecipeHandler {
        ...
        public ArrayList<PositionedStack> getIngredients() {
            ...
            if (in == null) {
                RotaryCraft.logger.logError(
                    "Recipe " + recipe + " has null display array?!"
                );
                return stacks;
            }
            for (int i = 0; i < 3; i++) {
    ...
    public void loadTransferRects(
           ...
           RecipeTransferRect rect = new RecipeTransferRect(new Rectangle(75, 24, 18, 18),
           "item", (Object[])new ItemStack[]{ItemStacks.salt, ItemStacks.aluminumingot});
