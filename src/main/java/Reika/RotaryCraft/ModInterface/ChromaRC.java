...
public class ChromaRC {
    ...
    public static void addAuraPouchItems() {
        ItemAuraPouch.setSpecialEffect(
            ItemAuraPouch.WORKS_IN_POUCH_EFFECT_DESC, ItemRegistry.NVG.getItemInstance()
        );
        ItemAuraPouch.setSpecialEffect(
            ItemAuraPouch.WORKS_IN_POUCH_EFFECT_DESC,
            ItemRegistry.IOGOGGLES.getItemInstance()
        );
        ItemAuraPouch.registerProjectileFiringEffect(
            ItemRegistry.FIREBALL.getItemInstance()
        );
    }
    ...
    public static void addHealingCoreEffects() {
        ...
        AdjacencyEffectDescription eff
        ...
        switch (m) {
            ...
            case FLYWHEEL:
                for (Flywheels mat : Flywheels.list)
                    ChromatiAPI.getAPI().adjacency().addAcceleratorBlacklist(
                        m.getTEClass(), m.getName(), null, BlacklistReason.EXPLOIT
                    );
                break;
            case GEARBOX:
