...
public final class OreForcer {
            ...
            if (mod.isLoaded()) {
                try {
                    ...
                    RotaryCraft.logger.logError(
                        "Could not force compatibility with " + mod + ". Reason: "
                    );
                    e.printStackTrace();
    ...
    private void intercraftDraconium() {
        ItemStack dust
            = ReikaItemHelper.lookupItem(ModList.DRACONICEVO, "draconiumDust", 0);
        if (dust == null)
            throw new ModReflectionException(
                RotaryCraft.instance, ModList.DRACONICEVO, "Null Item for Draconium"
            );
        GameRegistry.addShapelessRecipe(
            dust, ItemStacks.getModOreIngot(ModOreList.DRACONIUM)
        );
    }
    ...
    private void intercraftSilicon() {
        ...
        if (id == null)
            throw new ModReflectionException(
                RotaryCraft.instance, ModList.GALACTICRAFT, "Null Item for Silicon"
            );
        ItemStack silicon = new ItemStack(id, 1, GalacticCraftHandler.siliconMeta);
        GameRegistry.addShapelessRecipe(
            silicon, ItemStacks.getModOreIngot(ModOreList.SILICON)
        );
    }
    ...
    private void intercraftPRGems() {
        ...
        if (ruby != null)
            GameRegistry.addShapelessRecipe(
                ItemStacks.getModOreIngot(ModOreList.RUBY), ruby
            );
        if (sapphire != null)
            GameRegistry.addShapelessRecipe(
                ItemStacks.getModOreIngot(ModOreList.SAPPHIRE), sapphire
            );
        if (peridot != null)
            GameRegistry.addShapelessRecipe(
                ItemStacks.getModOreIngot(ModOreList.PERIDOT), peridot
            );
        RotaryCraft.logger.log(
            "RotaryCraft gems can now be crafted into Project Red gems!"
        );
    }
    ...
    private void intercraftNikolite() {
        ...
        if (is != null)
            GameRegistry.addShapelessRecipe(
                ItemStacks.getModOreIngot(ModOreList.NIKOLITE), is
            );
        RotaryCraft.logger.log(
            "RotaryCraft nikolite can now be crafted into Project Red electrotine!"
        );
    }
    ...
    private ItemStack getPRGem(int meta) {
        return meta < 0
            ? null
            : ReikaItemHelper.lookupItem("ProjRed|Core:projectred.core.part:" + meta);
    }
    ...
    private void intercraftQuantum() {
        if (QuantumOreHandler.getInstance().dustID != null) {
            ...
            GameRegistry.addShapelessRecipe(
                ore, ItemStacks.getModOreIngot(ModOreList.QUANTUM)
            );
            RotaryCraft.logger.log(
                "RotaryCraft quantum dust can now be crafted into QCraft quantum dust!"
            );
        }
    }
    ...
    private void intercraftDarkIron() {
        if (FactorizationHandler.getInstance().ingotID != null) {
            ItemStack ingot
                = new ItemStack(FactorizationHandler.getInstance().ingotID, 1, 0);
            GameRegistry.addShapelessRecipe(
                ingot, ItemStacks.getModOreIngot(ModOreList.DARKIRON)
            );
            RotaryCraft.logger.log(
                "RotaryCraft dark iron ingots can now be crafted into Factorization equivalents!"
            );
        }
    }
    ...
    private void intercraftMimichite() {
        if (MimicryHandler.getInstance().itemID != null) {
            ...
            GameRegistry.addShapelessRecipe(
                ore, ItemStacks.getModOreIngot(ModOreList.MIMICHITE)
            );
            RotaryCraft.logger.log(
                "RotaryCraft mimichite items can now be crafted into Mimicry mimichite!"
            );
        }
    }
    ...
    private void intercraftAmethyst() {
        if (BoPBlockHandler.getInstance().gemItem != null) {
            ...
            GameRegistry.addShapelessRecipe(
                ore, ItemStacks.getModOreIngot(ModOreList.AMETHYST)
            );
            RotaryCraft.logger.log(
                "RotaryCraft amethyst items can now be crafted into BoP amethyst!"
            );
        }
    }
    ...
    private void intercraftEssence() {
        ...
        if (ore != null) {
            GameRegistry.addShapelessRecipe(
                ore, ItemStacks.getModOreIngot(ModOreList.ESSENCE)
            );
            RotaryCraft.logger.log(
                "RotaryCraft essence items can now be crafted into Magic Crops essence!"
            );
        } else {
            RotaryCraft.logger.logError(
                "Could not find essence item, cannot add intercraft recipe!"
            );
        }
    }
    ...
    private void convertUranium() {
        ...
        if (u == null)
            throw new ModReflectionException(
                RotaryCraft.instance, ModList.IC2, "Null ItemStack for Uranium"
            );
        if (IC2Handler.IC2Stacks.IRIDIUM.getItem() == null)
            throw new ModReflectionException(
                RotaryCraft.instance, ModList.IC2, "Null Item for Iridium"
            );
        GameRegistry.addShapelessRecipe(
            IC2Handler.IC2Stacks.IRIDIUM.getItem(),
            ItemStacks.getModOreIngot(ModOreList.IRIDIUM)
        );
        RotaryCraft.logger.log(
            "RotaryCraft iridium ingots can now be crafted into IC2 Iridium items!"
        );
        GameRegistry.addShapelessRecipe(u, ItemStacks.getModOreIngot(ModOreList.URANIUM));
        RotaryCraft.logger.log(
            "RotaryCraft uranium ingots can now be crafted into IC2 purified crushed uranium!"
        );
    }
    ...
    private void intercraftFirestone() {
        ...
        if (item == null)
            throw new ModReflectionException(
                RotaryCraft.instance, ModList.RAILCRAFT, "Null ItemStack for Firestone"
            );
        GameRegistry.addShapelessRecipe(
            new ItemStack(item), ItemStacks.getModOreIngot(ModOreList.FIRESTONE)
        );
        RotaryCraft.logger.log(
            "RotaryCraft firestone can now be crafted into RailCraft firestone!"
        );
    }
        ...
        try {
            ...
            if (i == null)
                throw new ModReflectionException(
                    ...
                    ModList.TRANSITIONAL,
                    "Null ItemStack for Magmanite Drop"
                );
            GameRegistry.addShapelessRecipe(
                new ItemStack(i), ItemStacks.getModOreIngot(ModOreList.MAGMANITE)
            );
            RotaryCraft.logger.log(
                "RotaryCraft magmanite can now be crafted into Transitional Assistance magmanite!"
            );
        } catch (NoSuchFieldException e) {
            RotaryCraft.logger.logError("Transitional Assistance item field not found!");
        } catch (SecurityException e) {
            RotaryCraft.logger.logError(
                "Cannot read Transitional Assistance items (Security Exception)! Magmanite not convertible!"
                + e.getMessage()
            );
            e.printStackTrace();
        } catch (IllegalArgumentException e) {
            RotaryCraft.logger.logError(
                "Illegal argument for reading Transitional Assistance items!"
            );
            e.printStackTrace();
        } catch (IllegalAccessException e) {
            RotaryCraft.logger.logError(
                "Illegal access exception for reading Transitional Assistance items!"
            );
            e.printStackTrace();
        }
    }
            ...
            if (o.isArsMagica()) {
                ...
                if (is == null)
                    throw new ModReflectionException(
                        RotaryCraft.instance,
                        ModList.ARSMAGICA,
                        "Null ItemStack for Ars Magica " + o
                    );
                GameRegistry.addShapelessRecipe(is, ItemStacks.getModOreIngot(o));
                RotaryCraft.logger.log(
                    o.displayName + " can now be crafted with RotaryCraft equivalents!"
                );
            }
        }
    }
    ...
    private void registerOsmium() {
        if (MekanismHandler.getInstance().oreID == null)
            throw new ModReflectionException(
                RotaryCraft.instance, ModList.MEKANISM, "Null Item for Osmium"
            );
        OreDictionary.registerOre(
            "oreOsmium",
            new ItemStack(
                MekanismHandler.getInstance().oreID, 1, MekanismHandler.osmiumMeta
            )
        );
    }
    ...
    private void breakForceWrench() {
        try {
            ...
            for (int i = 0; i < MachineRegistry.machineList.length; i++) {
                ...
                list.add(machine);
                RotaryCraft.logger.log(
                    "Force wrench no longer works on "
                    + MachineRegistry.machineList.get(i).getName() + "!"
                );
            }
            ...
            RotaryCraft.logger.logError(
                "DartAPI class threw security exception! " + e.getMessage()
            );
            e.printStackTrace();
        } catch (IllegalArgumentException e) {
    ...
    private void intercraftDart() {
        GameRegistry.addShapelessRecipe(
            DartOreHandler.getInstance().getForceGem(),
            ItemStacks.getModOreIngot(ModOreList.FORCE)
        );
        RotaryCraft.logger.log(
            "RotaryCraft force gems can now be crafted into DartCraft force gems!"
        );
    }
    ...
    private void intercraftForcicium() {
        try {
            ...
            GameRegistry.addShapelessRecipe(
                forc, ItemStacks.getModOreIngot(ModOreList.MONAZIT)
            );
            RotaryCraft.logger.log(
                "RotaryCraft monazit can now be crafted into MFFS forcicium!"
            );
        } catch (NoSuchFieldException e) {
            RotaryCraft.logger.logError("MFFS item field not found!");
        } catch (SecurityException e) {
            RotaryCraft.logger.logError(
                "Cannot read MFFS items (Security Exception)! Monazit not convertible!"
                + e.getMessage()
            );
            e.printStackTrace();
        } catch (IllegalArgumentException e) {
    ...
    private void intercraftQuartz() {
        ...
        if (quartz == null)
            throw new ModReflectionException(
                RotaryCraft.instance, ModList.APPENG, "Null ItemStack for Certus Quartz"
            );
        GameRegistry.addShapelessRecipe(
            quartz, ItemStacks.getModOreIngot(ModOreList.CERTUSQUARTZ)
        );
        RotaryCraft.logger.log(
            "RotaryCraft certus quartz can now be crafted into AppliedEnergistics certus quartz!"
        );
    }
    ...
    private void intercraftApatite() {
        ...
        if (id == null)
            throw new ModReflectionException(
                RotaryCraft.instance, ModList.FORESTRY, "Null Item for Apatite"
            );
        ItemStack apatite = new ItemStack(id, 1, 0);
        GameRegistry.addShapelessRecipe(
            apatite, ItemStacks.getModOreIngot(ModOreList.APATITE)
        );
        RotaryCraft.logger.log(
            "RotaryCraft apatite can now be crafted into Forestry apatite!"
        );
    }
            ...
            if (o.isThaumcraft()) {
                ...
                if (is == null)
                    throw new ModReflectionException(
                        RotaryCraft.instance,
                        ModList.THAUMCRAFT,
                        "Null ItemStack for Thaumcraft's " + o
                    );
                RotaryCraft.logger.log(
                    o.displayName + " can now be crafted with RotaryCraft equivalents!"
                );
