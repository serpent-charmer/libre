...
public class TileEntityDynamo extends TileEntityPowerReceiver
    implements IEnergyHandler, RCToModConverter, UpgradeableMachine, NBTMachine {
                ...
                if (b.hasTileEntity(metadata)) {
                    ...
                    if (tile instanceof IEnergyHandler) {
                        ...
                        if (rc.canConnectEnergy(facingDir.getOpposite())) {
                            ...
                            float used
                                = rc.receiveEnergy(facingDir.getOpposite(), rf, false);
                        }
    ...
    public int getGenRF() {
        ...
        return (int
        ) (pwr / ReikaRFHelper.getWattsPerRF() * ConfigRegistry.getConverterEfficiency());
    }
