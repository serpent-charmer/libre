...
public class RenderCompressor extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityCompressorAt(
        TileEntityAirCompressor tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/Converter/airtex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityCompressorAt(
                (TileEntityAirCompressor) tile, par2, par4, par6, par8
            );
