...
public class RenderBoiler extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityBoilerAt(
        TileEntityBoiler tile, double par2, double par4, double par6, float par8
    ) {
        ModelBoiler var14;
        var14 = BoilerModel;

        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/Converter/boilertex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityBoilerAt(
                (TileEntityBoiler) tile, par2, par4, par6, par8
            );
    ...
    private void
    renderWater(TileEntityBoiler tile, double par2, double par4, double par6) {
