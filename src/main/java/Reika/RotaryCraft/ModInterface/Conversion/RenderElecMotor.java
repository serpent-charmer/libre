...
public class RenderElecMotor extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityElectricMotorAt(
        TileEntityElectricMotor tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/Converter/elecmotortex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityElectricMotorAt(
                (TileEntityElectricMotor) tile, par2, par4, par6, par8
            );
