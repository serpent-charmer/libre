...
public class RenderPneumatic extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityPneumaticEngineAt(
        TileEntityPneumaticEngine tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/Converter/pneutex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityPneumaticEngineAt(
                (TileEntityPneumaticEngine) tile, par2, par4, par6, par8
            );
