...
public class RenderGenerator extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityGeneratorAt(
        TileEntityGenerator tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/Converter/generatortex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityGeneratorAt(
                (TileEntityGenerator) tile, par2, par4, par6, par8
            );
