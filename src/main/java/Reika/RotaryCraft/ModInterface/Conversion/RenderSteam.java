...
public class RenderSteam extends RotaryTERenderer {
     ...
     */
    public void renderTileEntitySteamAt(
        TileEntitySteam tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/Converter/steamturbtex.png"
        );
