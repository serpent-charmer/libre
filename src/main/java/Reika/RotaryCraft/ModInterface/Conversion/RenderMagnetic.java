...
public class RenderMagnetic extends RotaryTERenderer {
    ...
    public void renderTileEntityDynamoAt(
        TileEntityMagnetic tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
        ...
        this.bindTextureByName(
            "/Reika/RotaryCraft/Textures/TileEntityTex/Converter/magneticmotortex.png"
        );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityDynamoAt(
                (TileEntityMagnetic) tile, par2, par4, par6, par8
            );
