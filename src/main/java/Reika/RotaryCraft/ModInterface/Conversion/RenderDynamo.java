...
public class RenderDynamo extends RotaryTERenderer {
     ...
     */
    public void renderTileEntityStaticAt(
        TileEntityDynamo tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((RotaryCraftTileEntity) tile))
            this.renderTileEntityStaticAt(
                (TileEntityDynamo) tile, par2, par4, par6, par8
            );
