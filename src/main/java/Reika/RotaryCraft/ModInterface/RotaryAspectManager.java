...
public class RotaryAspectManager {
    public static void addThaumAspects() {
        ...
        ReikaThaumHelper.addAspects(
            ItemRegistry.BEDSICKLE.getStackOf(), Aspect.HARVEST, 20
        );
        if (ModList.MULTIPART.isLoaded())
            ReikaThaumHelper.addAspects(
                ItemRegistry.BEDSAW.getStackOf(), Aspect.TOOL, 80
            );
        if (ModList.FORESTRY.isLoaded())
            ReikaThaumHelper.addAspects(
                ItemRegistry.BEDGRAFTER.getStackOf(), Aspect.TOOL, 72
            );
        ...
        ReikaThaumHelper.addAspects(
            ItemRegistry.STEELHOE.getStackOf(), Aspect.HARVEST, 4
        );
        ReikaThaumHelper.addAspects(
            ItemRegistry.STEELSWORD.getStackOf(), Aspect.TOOL, 14
        );
        ReikaThaumHelper.addAspects(
            ItemRegistry.STEELSHEARS.getStackOf(), Aspect.TOOL, 14
        );
        ReikaThaumHelper.addAspects(
            ItemRegistry.STEELSHOVEL.getStackOf(), Aspect.TOOL, 12
        );
        ReikaThaumHelper.addAspects(
            ItemRegistry.STEELSICKLE.getStackOf(), Aspect.TOOL, 18
        );
        ReikaThaumHelper.addAspects(
            ItemRegistry.STEELSICKLE.getStackOf(), Aspect.HARVEST, 4
        );
        ...
        ReikaThaumHelper.addAspects(
            ItemRegistry.BEDCHEST.getStackOf(), Aspect.ARMOR, 160
        );
        ReikaThaumHelper.addAspects(
            ItemRegistry.BEDREVEAL.getStackOf(),
            Aspect.ARMOR,
            140,
            Aspect.SENSES,
            20,
        ...
        ReikaThaumHelper.addAspects(
            ItemRegistry.BEDPACK.getStackOf(), Aspect.ARMOR, 160, Aspect.FLIGHT, 40
        );
        ReikaThaumHelper.addAspects(
            ItemRegistry.STEELPACK.getStackOf(), Aspect.ARMOR, 40, Aspect.FLIGHT, 40
        );
        ReikaThaumHelper.addAspects(
            ItemRegistry.JETPACK.getStackOf(), Aspect.TOOL, 40, Aspect.FLIGHT, 40
        );

        ReikaThaumHelper.addAspects(
            ItemRegistry.BEDJUMP.getStackOf(), Aspect.ARMOR, 120, Aspect.TRAVEL, 20
        );
        ReikaThaumHelper.addAspects(
            ItemRegistry.JUMP.getStackOf(), Aspect.TOOL, 20, Aspect.TRAVEL, 20
        );
        ...
        ReikaThaumHelper.addAspects(
            ItemRegistry.SHELL.getStackOf(), Aspect.FIRE, 8, Aspect.WEAPON, 8
        );

        ReikaThaumHelper.addAspects(
            ItemStacks.steelingot, Aspect.METAL, 10, Aspect.MECHANISM, 6
        );
        ...
        ReikaThaumHelper.addAspects(
            ItemStacks.anthracite, Aspect.FIRE, 4, Aspect.ENERGY, 4
        );
        ReikaThaumHelper.addAspects(ItemStacks.coke, Aspect.FIRE, 2, Aspect.MECHANISM, 2);

        ReikaThaumHelper.addAspects(
            ItemRegistry.HANDBOOK.getStackOf(),
            Aspect.MIND,
            4,
            Aspect.MECHANISM,
            3,
        ...
        ReikaThaumHelper.addAspects(
            BlockRegistry.BLASTPANE.getStackOf(),
            Aspect.CRYSTAL,
            2,
            Aspect.ARMOR,
            4,
