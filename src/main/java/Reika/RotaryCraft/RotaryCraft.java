...
public class RotaryCraft extends DragonAPIMod {
    ...
    public static final ArmorMaterial NVHM = EnumHelper.addArmorMaterial(
        "NVHelmet",
        ArmorMaterial.DIAMOND.getDurability(0),
        dmgs,
        ArmorMaterial.GOLD.getEnchantability()
    );
    public static final ArmorMaterial NVGM
        = EnumHelper.addArmorMaterial("NVGoggles", 65536, new int[] { 0, 0, 0, 0 }, 0);
    public static final ArmorMaterial IOGM
        = EnumHelper.addArmorMaterial("IOGoggles", 65536, new int[] { 0, 0, 0, 0 }, 0);
    public static final ArmorMaterial JETPACK
        = EnumHelper.addArmorMaterial("Jetpack", 65536, new int[] { 0, 0, 0, 0 }, 0);
    public static final ArmorMaterial JUMP
        = EnumHelper.addArmorMaterial("Jump", 65536, new int[] { 0, 0, 0, 0 }, 0);

    public static final ArmorMaterial BEDROCK = EnumHelper.addArmorMaterial(
        "Bedrock", Integer.MAX_VALUE, new int[] { 6, 12, 10, 5 }, 18
    );
    public static final ArmorMaterial HSLA = EnumHelper.addArmorMaterial(
        "HSLA", 24, new int[] { 3, 7, 5, 3 }, ArmorMaterial.IRON.getEnchantability()
    );

    public static final EnhancedFluid jetFuelFluid
        = (EnhancedFluid) new EnhancedFluid("rc jet fuel")
              .setColor(0xFB5C90)
              .setDensity(810)
              .setViscosity(800);
    public static final EnhancedFluid lubeFluid
        = (EnhancedFluid) new EnhancedFluid("rc lubricant")
              .setColor(0xE4E18E)
              .setDensity(750)
              .setViscosity(1200);
    public static final EnhancedFluid ethanolFluid
        = (EnhancedFluid) new EnhancedFluid("rc ethanol")
              .setColor(0x5CC5B2)
              .setDensity(789)
              .setViscosity(950)
              .setTemperature(340);
    public static final EnhancedFluid nitrogenFluid
        = (EnhancedFluid) new EnhancedFluid("rc liquid nitrogen")
              .setColor(0xB37ECC)
              .setDensity(808)
              .setViscosity(158)
              .setTemperature(77);
    public static final Fluid poisonFluid = new Fluid("poison"); //for defoliator
    public static final Fluid hslaFluid = new EnhancedFluid("molten hsla")
                                              .setColor(0xF0B564)
                                              .setTemperature(1873)
                                              .setDensity(7000)
                                              .setViscosity(6100); //for TiC

    public static final MachineDamage jetingest
        = new MachineDamage("was sucked into a jet engine")
              .setArmorBlocking(1F, 90, 1, 2, 3, 4);
    public static final MachineDamage hydrokinetic
        = new MachineDamage("was paddled to death").setArmorBlocking(0.5F, 2, 4);
    public static final MachineDamage shock
        = (MachineDamage) new MachineDamage("was electrified").setDamageBypassesArmor();
    public static final MachineDamage grind
        = new MachineDamage("was ground to a pulp").setArmorBlocking(0.5F, 6, 1);
    public static final MachineDamage freezeDamage = new MachineDamage("froze");
    public static final MachineDamage heatDamage
        = (MachineDamage) new MachineDamage("burned up").setFireDamage();
    ...
    public static final RotaryConfig config
        = new RotaryConfig(instance, ConfigRegistry.optionList, ExtraConfigIDs.idList);
    ...
    @SidedProxy(
        clientSide = "Reika.RotaryCraft.ClientProxy",
        serverSide = "Reika.RotaryCraft.CommonProxy"
    )
    ...
    public void preload(FMLPreInitializationEvent evt) {
        ...
        ReikaPacketHelper.registerPacketHandler(
            instance, packetChannel, new PacketHandlerCore()
        );
        ...
        //CompatibilityTracker.instance.registerIncompatibility(ModList.ROTARYCRAFT,
        //ModList.OPTIFINE, CompatibilityTracker.Severity.GLITCH, "Optifine is known to
        //break some rendering and cause framerate drops.");
        CompatibilityTracker.instance.registerIncompatibility(
            ModList.ROTARYCRAFT,
            ModList.GREGTECH,
            CompatibilityTracker.Severity.GLITCH,
            "The GT unifier registers HSLA steel as standard OreDict steel. This breaks the techtrees of mods like RailCraft and TConstruct."
        );
    ...
    public void load(FMLInitializationEvent event) {
        ...
        if (this.isLocked()) {
            ...
            ReikaJavaLibrary.pConsole(
                "\tNOTICE: It has been detected that third-party plugins are being used to disable parts of RotaryCraft."
            );
            ReikaJavaLibrary.pConsole(
            ...
            ReikaJavaLibrary.pConsole(
                "\tTo regain functionality, unban the RotaryCraft content, and then reload the game. All functionality"
            );
            ReikaJavaLibrary.pConsole(
        ...
        ReikaDispenserHelper.addDispenserAction(
            ItemStacks.compost, ReikaDispenserHelper.bonemealEffect
        );
        ...
        if (iron > 1) {
            ...
            logger.log(String.format(
                "Extra iron ore gen enabled, with a scaling factor of %.1fx.", iron
            ));
        }
        ...
        //MinecraftForge.setToolClass(ItemRegistry.STEELPICK.getItemInstance(), "pickaxe",
        //2); MinecraftForge.setToolClass(ItemRegistry.STEELSHOVEL.getItemInstance(),
        //"shovel", 2);

        FMLInterModComms.sendMessage(
            ModList.THAUMCRAFT.modLabel,
            "harvestStandardCrop",
            BlockRegistry.CANOLA.getStackOfMetadata(9)
        );
        ...
        FMLInterModComms.sendMessage(
            "ForgeMicroblock", "microMaterial", BlockRegistry.BLASTGLASS.getStackOf()
        );
        ...
        if (!this.isLocked())
            IntegrityChecker.instance.addMod(
                instance, BlockRegistry.blockList, ItemRegistry.itemList
            );
        ...
        SuggestedModsTracker.instance.addSuggestedMod(
            instance,
            ModList.REACTORCRAFT,
            "Endgame power generation of multiple gigawatts"
        );
        SuggestedModsTracker.instance.addSuggestedMod(
            instance,
            ModList.ELECTRICRAFT,
            "Easier and lower-CPU-load power transmission and distribution"
        );
        SuggestedModsTracker.instance.addSuggestedMod(
            instance, ModList.BCENERGY, "Access to alternate lubricant production"
        );
        SuggestedModsTracker.instance.addSuggestedMod(
            instance, ModList.THERMALEXPANSION, "Access to some interface recipes"
        );
        SuggestedModsTracker.instance.addSuggestedMod(
            instance,
            ModList.FORESTRY,
            "Access to Canola bees to speed canola growth and produce some lubricant"
        );
        SuggestedModsTracker.instance.addSuggestedMod(
            instance,
            ModList.RAILCRAFT,
            "Access to steam power generation and consumption"
        );
        SuggestedModsTracker.instance.addSuggestedMod(
            instance, ModList.TWILIGHT, "Special integration with TF mobs and structures"
        );

        SensitiveItemRegistry.instance.registerItem(
            this, BlockRegistry.BLASTGLASS.getBlockInstance(), false
        );
        SensitiveItemRegistry.instance.registerItem(
            this, BlockRegistry.BLASTPANE.getBlockInstance(), true
        );

        SensitiveItemRegistry.instance.registerItem(
            this, ItemRegistry.YEAST.getItemInstance(), true
        );
        SensitiveItemRegistry.instance.registerItem(
            this, ItemRegistry.ETHANOL.getItemInstance(), true
        );
        //SensitiveItemRegistry.instance.registerItem(this,
        //ItemRegistry.CANOLA.getItemInstance(), true);
        //SensitiveItemRegistry.instance.registerItem(this,
        //ItemRegistry.EXTRACTS.getItemInstance(), true);
        //SensitiveItemRegistry.instance.registerItem(this,
        //ItemRegistry.MODEXTRACTS.getItemInstance(), true);
        //SensitiveItemRegistry.instance.registerItem(this,
        //ItemRegistry.CUSTOMEXTRACT.getItemInstance(), true);
        SensitiveItemRegistry.instance.registerItem(
            this, ItemRegistry.ENGINE.getItemInstance(), true
        );
        SensitiveItemRegistry.instance.registerItem(
            this, ItemRegistry.SHAFT.getItemInstance(), true
        );
        SensitiveItemRegistry.instance.registerItem(
            this, ItemRegistry.FLYWHEEL.getItemInstance(), true
        );
        SensitiveItemRegistry.instance.registerItem(
            this, ItemRegistry.GEARBOX.getItemInstance(), true
        );
        SensitiveItemRegistry.instance.registerItem(
            this, ItemRegistry.MACHINE.getItemInstance(), true
        );
        /*
        SensitiveItemRegistry.instance.registerItem(this,
        ItemRegistry.SHAFTCRAFT.getItemInstance(), true);
        SensitiveItemRegistry.instance.registerItem(this,
        ItemRegistry.BORECRAFT.getItemInstance(), true);
        SensitiveItemRegistry.instance.registerItem(this,
        ItemRegistry.ENGINECRAFT.getItemInstance(), true);
        SensitiveItemRegistry.instance.registerItem(this,
        ItemRegistry.MISCCRAFT.getItemInstance(), true);
         */
        for (int i = 0; i < ItemRegistry.itemList.length; i++) {
        ...
        SensitiveItemRegistry.instance.registerItem(
            this, ItemStacks.netherrackdust, false
        );
        ...
        SensitiveItemRegistry.instance.registerItem(
            this, ItemStacks.tungsteningot, false
        );
        ...
        SensitiveItemRegistry.instance.registerItem(
            this, ItemRegistry.UPGRADE.getItemInstance(), true
        );

        SensitiveItemRegistry.instance.registerItem(
            this, ItemStacks.aluminumcylinder, false
        );
        SensitiveItemRegistry.instance.registerItem(this, ItemStacks.bedrockdrill, false);
        SensitiveItemRegistry.instance.registerItem(
            this, ItemStacks.highcombustor, false
        );
        SensitiveItemRegistry.instance.registerItem(this, ItemStacks.compoundturb, false);
        SensitiveItemRegistry.instance.registerItem(
            this, ItemStacks.compoundcompress, false
        );

        if (MTInteractionManager.isMTLoaded()) {
            MTInteractionManager.instance.blacklistRecipeRemovalFor(
                MachineRegistry.BLASTFURNACE.getCraftedProduct()
            );
            MTInteractionManager.instance.blacklistRecipeRemovalFor(
                MachineRegistry.WORKTABLE.getCraftedProduct()
            );
        ...
        FurnaceFuelRegistry.instance.registerItemSimple(
            ItemRegistry.ETHANOL.getStackOf(), 5
        );
        ...
        FurnaceFuelRegistry.instance.registerItemSimple(
            ItemStacks.cokeblock,
            12 * FurnaceFuelRegistry.instance.getBlockOverItemFactor()
        );
        FurnaceFuelRegistry.instance.registerItemSimple(
            ItemStacks.anthrablock,
            24 * FurnaceFuelRegistry.instance.getBlockOverItemFactor()
        );
    ...
    private void fixAEPowerRatio() {
        ...
        if (ReikaMathLibrary.isValueInsideBoundsIncl(
                f - 0.005, f + 0.005, PowerUnits.WA.conversionRatio
            )) {
    ...
    public void postload(FMLPostInitializationEvent evt) {
        ...
        ModCropList.addCustomCropType(new SimpleCropHandler(
            ModList.ROTARYCRAFT,
            0x00cc00,
            "CANOLA",
            BlockRegistry.CANOLA.getBlockInstance(),
            9,
            ...
            if (ModList.FORESTRY.isLoaded()) {
                try {
                    ...
                    RecipeManagers.centrifugeManager.addRecipe(
                        30, ItemStacks.slipperyComb, map
                    );
                    FluidStack fs = new FluidStack(
                        FluidRegistry.getFluid("rc lubricant"), 20
                    ); //was 150
                    RecipeManagers.squeezerManager.addRecipe(
                        30, new ItemStack[] { ItemStacks.slipperyPropolis }, fs
                    );
                ...
                //MobBait.addBait("BUTTERFLY", ReikaBeeHelper.getButterflyClass(), -1,
                //ForestryHandler.ItemEntry.POLLEN.getItem(), Items.gunpowder);
            }

            if (ModList.TINKERER.isLoaded()
                && (Pulses.TOOLS.isLoaded() || Pulses.WEAPONS.isLoaded())) {
                int id = ExtraConfigIDs.BEDROCKID.getValue();
                CustomTinkerMaterial mat
                    = TinkerMaterialHelper.instance.createMaterial(id, this, "Bedrock");
                ...
                mat.disableToolPart(ToolParts.PICK)
                    .disableToolPart(ToolParts.AXEHEAD)
                    .disableToolPart(ToolParts.LUMBER);
                mat.disableToolPart(ToolParts.SHOVEL)
                    .disableToolPart(ToolParts.SWORD)
                    .disableToolPart(ToolParts.SCYTHE);
                ...
                mat.registerWeapons(
                    ItemStacks.steelblock, 8, 0.75F, 2F, 2.5F, 8F, 0.015F
                );
                mat.registerSmelteryCasting(
                    ItemStacks.steelingot, hslaFluid, 750, ItemStacks.steelblock
                );
            }
        ...
        if (ModList.ROUTER.isLoaded()) {
            RouterHelper.blacklistTileEntity(
                TileEntityExtractor.class, "Extractor", "BlockMIMachine:10"
            ); //Extractor
        }
    ...
    public void reinitRecipes() {
        if (!this.isLocked()) {
            if (!ReikaRecipeHelper.isCraftable(
                    MachineRegistry.BLASTFURNACE.getCraftedProduct()
                )) {
                GameRegistry.addRecipe(new ShapedOreRecipe(
                    MachineRegistry.BLASTFURNACE.getCraftedProduct(),
                    RotaryRecipes.getBlastFurnaceIngredients()
                ));
            }
            if (!ReikaRecipeHelper.isCraftable(
                    MachineRegistry.WORKTABLE.getCraftedProduct()
                ...
                GameRegistry.addRecipe(new ShapedOreRecipe(
                    MachineRegistry.WORKTABLE.getCraftedProduct(),
                    RotaryRecipes.getWorktableIngredients()
                ));
            }
        }
    }
    ...
    private static void setupClassFiles() {
        ReikaRegistryHelper.instantiateAndRegisterBlocks(
            RotaryCraft.instance, BlockRegistry.blockList, RotaryCraft.blocks
        );
        ReikaRegistryHelper.instantiateAndRegisterItems(
            RotaryCraft.instance, ItemRegistry.itemList, RotaryCraft.items
        );
