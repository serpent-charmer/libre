...
public class ContainerCompactor extends ContainerIOMachine {
    ...
    public ContainerCompactor(
        EntityPlayer player, TileEntityCompactor par2TileEntityCompactor
    ) {
        ...
        this.addSlotToContainer(
            new SlotMachineOut(player, par2TileEntityCompactor, 4, 80, 35)
        );
    ...
    public void detectAndSendChanges() {
        ...
        ReikaPacketHelper.sendSyncPacket(
            RotaryCraft.packetChannel, compactor, "pressure"
        );
    }
