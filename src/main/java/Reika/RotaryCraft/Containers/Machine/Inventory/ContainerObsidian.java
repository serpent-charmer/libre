...
public class ContainerObsidian extends ContainerIOMachine {
    ...
    public ContainerObsidian(
        EntityPlayer player, TileEntityObsidianMaker par2TileEntityObsidian
    ) {
    ...
    public void detectAndSendChanges() {
        ...
        ReikaPacketHelper.sendTankSyncPacket(
            RotaryCraft.packetChannel, obsidian, "water"
        );
    }
