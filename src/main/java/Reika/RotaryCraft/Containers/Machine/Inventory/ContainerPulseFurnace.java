...
public class ContainerPulseFurnace extends ContainerIOMachine {
    ...
    public ContainerPulseFurnace(
        EntityPlayer player, TileEntityPulseFurnace par2TileEntityPulseFurnace
    ) {
        ...
        this.addSlotToContainer(
            new SlotFurnace(player, par2TileEntityPulseFurnace, 2, 125, 52)
        );
    ...
    public void detectAndSendChanges() {
        ...
        ReikaPacketHelper.sendTankSyncPacket(
            RotaryCraft.packetChannel, pulseFurnace, "water"
        );
        ReikaPacketHelper.sendTankSyncPacket(
            RotaryCraft.packetChannel, pulseFurnace, "fuel"
        );
        ReikaPacketHelper.sendTankSyncPacket(
            RotaryCraft.packetChannel, pulseFurnace, "accel"
        );
    }
