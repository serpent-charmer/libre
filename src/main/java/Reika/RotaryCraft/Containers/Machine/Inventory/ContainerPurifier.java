...
public class ContainerPurifier extends ContainerIOMachine {
    ...
    public ContainerPurifier(
        EntityPlayer player, TileEntityPurifier par2TileEntityPurifier
    ) {
        ...
        for (int i = 0; i < 5; i++)
            this.addSlotToContainer(
                new Slot(par2TileEntityPurifier, i + 1, 8 + i * 18, 52)
            );

        this.addSlotToContainer(
            new SlotFurnace(player, par2TileEntityPurifier, 6, 134, 34)
        );
