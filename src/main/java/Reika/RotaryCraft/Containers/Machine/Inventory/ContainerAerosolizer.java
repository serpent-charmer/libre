...
public class ContainerAerosolizer extends ContainerIOMachine {
    ...
    public ContainerAerosolizer(
        EntityPlayer player, TileEntityAerosolizer par2TileEntityAerosolizer
    ) {
        ...
        //par2TileEntityAerosolizer, 2, 116, 35));
