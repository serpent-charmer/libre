...
public class ContainerFermenter extends ContainerIOMachine {
    ...
    public ContainerFermenter(
        EntityPlayer player, TileEntityFermenter par2TileEntityFermenter
    ) {
        ...
        //if (tile.worldObj.isBlockIndirectlyGettingPowered(tile.xCoord, tile.yCoord,
        //tile.zCoord)) this.addSlotToContainer(new Slot(par2TileEntityFermenter, 1, 55,
        //35)); else
        this.addSlotToContainer(new Slot(par2TileEntityFermenter, 1, 55, 53));
        this.addSlotToContainer(
            new SlotFurnace(player, par2TileEntityFermenter, 2, 116, 35)
        );
