...
public class ContainerFractionator extends ContainerIOMachine {
    ...
    public ContainerFractionator(
        EntityPlayer player, TileEntityFractionator par2TileEntityFractionator
    ) {
    ...
    public void detectAndSendChanges() {
        ...
        ReikaPacketHelper.sendTankSyncPacket(
            RotaryCraft.packetChannel, Fraction, "input"
        );
        ReikaPacketHelper.sendTankSyncPacket(
            RotaryCraft.packetChannel, Fraction, "output"
        );
    }
