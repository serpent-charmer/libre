...
public class SynthesizerHandler extends TemplateRecipeHandler {
    ...
    public void loadTransferRects() {
        transferRects.add(
            new RecipeTransferRect(new Rectangle(95, 8, 30, 60), "rcammonia")
        );
    }
    ...
    public void drawExtras(int recipe) {
        ...
        //ReikaGuiAPI.instance.drawCenteredStringNoShadow(fr,
        //rec.recipe.input.getLocalizedName(), 20, 70, 0);
        //ReikaGuiAPI.instance.drawCenteredStringNoShadow(fr,
        //rec.recipe.output.getLocalizedName(), 137, 70, 0);
        ReikaGuiAPI.instance.drawCenteredStringNoShadow(
            fr, rec.recipe.fluidConsumed + "mB", 20, 70, 0
        );
        ReikaGuiAPI.instance.drawCenteredStringNoShadow(
            fr, rec.recipe.fluidProduced + "mB", 137, 70, 0
        );
        ReikaGuiAPI.instance.drawCenteredStringNoShadow(
            fr, rec.recipe.minTemp + "C", 80, 65, 0
        );
        int j = 130;
        int k = 53;
        if (ReikaGuiAPI.instance.isMouseInBox(j + 12, j + 28, k + 7, k + 67)) {
            ...
            ReikaGuiAPI.instance.drawCenteredStringNoShadow(
                fr, rec.recipe.input.getLocalizedName(), 80, 80, 0
            );
        }
        if (ReikaGuiAPI.instance.isMouseInBox(j + 129, j + 145, k + 7, k + 67)) {
            ...
            ReikaGuiAPI.instance.drawCenteredStringNoShadow(
                fr, rec.recipe.output.getLocalizedName(), 80, 80, 0
            );
        }
