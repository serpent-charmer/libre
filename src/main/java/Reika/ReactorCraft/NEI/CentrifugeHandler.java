...
public class CentrifugeHandler extends TemplateRecipeHandler {
    ...
    public void drawExtras(int recipe) {
        ...
        ReikaGuiAPI.instance.drawCenteredStringNoShadow(
            Minecraft.getMinecraft().fontRenderer, ch, 49, 70, 0x000000
        );
        ReikaGuiAPI.instance.drawCenteredStringNoShadow(
            Minecraft.getMinecraft().fontRenderer, ch2, 122, 70, 0x000000
        );

        ReikaGuiAPI.instance.drawCenteredStringNoShadow(
            Minecraft.getMinecraft().fontRenderer,
            cr.recipe.fluidAmount + "mB",
            85,
            70,
            0x000000
        );
