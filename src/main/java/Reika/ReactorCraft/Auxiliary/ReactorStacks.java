...
public class ReactorStacks {
    ...
    public static final ItemStack hotco2can
        = ReactorItems.CANISTER.getStackOfMetadata(10);
    ...
    public static final ItemStack hotlifbecan
        = ReactorItems.CANISTER.getStackOfMetadata(14);
    public static final ItemStack lifbefuelcan
        = ReactorItems.CANISTER.getStackOfMetadata(15);

    public static final ItemStack maxMagnet = ReactorItems.MAGNET.getStackOfMetadata(
        ReactorItems.MAGNET.getNumberMetadatas() - 1
    );
    public static final ItemStack weakerMagnet = ReactorItems.MAGNET.getStackOfMetadata(
        ReactorItems.MAGNET.getNumberMetadatas() - 2
    );

    public static final ItemStack insulCore
        = new ItemStack(ReactorBlocks.HEATERMULTI.getBlockInstance(), 1, 1);
}
