...
public class HydrogenExplosion extends Explosion {
    ...
    public HydrogenExplosion(
        World world, Entity e, double x, double y, double z, float power
    ) {
        this(world, e, x, y, z, power, 1);
    }

    public HydrogenExplosion(
        World world, Entity e, double x, double y, double z, float power, double fraction
    ) {
    ...
    public void doExplosionA() {
        ...
        //scatterFraction = RadiationEffects.instance.contaminateArea(world, x, y, z,
        //(int)(explosionSize*4), 8, 2, true);
    ...
    public void doExplosionB(boolean fire) {
        ...
        int y = (int)Math.floor(explosionY);
        int z = (int)Math.floor(explosionZ);
        RadiationEffects.instance.contaminateArea(world, x, y, z, (int)(explosionSize*4),
        8, true);
         */
    }
