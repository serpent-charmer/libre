...
@Mod(
    ...
    dependencies = "required-after:DragonAPI;required-after:RotaryCraft"
)
public class ReactorCraft extends DragonAPIMod {
    @Instance("ReactorCraft")
    public static ReactorCraft instance = new ReactorCraft();

    public static final ReactorConfig config
        = new ReactorConfig(instance, ReactorOptions.optionList, null);
    ...
    public static final ArmorMaterial HAZ = EnumHelper.addArmorMaterial(
        "RCHazmat", 0 /*Integer.MAX_VALUE*/, new int[] { 0, 0, 0, 0 }, 0
    );
    ...
    public static final Fluid D2O
        = new Fluid("rc heavy water").setDensity(1100).setViscosity(1050);
    public static final Fluid HF = new Fluid("rc hydrofluoric acid")
                                       .setDensity(115)
                                       .setViscosity(10)
                                       .setGaseous(true);
    public static final Fluid UF6 = new Fluid("rc uranium hexafluoride")
                                        .setDensity(15)
                                        .setViscosity(10)
                                        .setGaseous(true);

    public static final Fluid NH3
        = new Fluid("rc ammonia").setDensity(682).setViscosity(600);
    public static final Fluid NA
        = new Fluid("rc sodium").setDensity(927).setViscosity(700).setTemperature(800);
    public static final Fluid CL
        = new Fluid("rc chlorine").setDensity(320).setViscosity(12).setGaseous(true);
    public static final Fluid O
        = new Fluid("rc oxygen").setDensity(138).setViscosity(20).setGaseous(true);
    public static final Fluid Oliq = new Fluid("rc liquid oxygen")
                                         .setDensity(1141)
                                         .setViscosity(195)
                                         .setGaseous(false)
                                         .setTemperature(90);
    ...
    public static final Fluid NH3_lo
        = new Fluid("rc lowpammonia").setDensity(200).setViscosity(600);
    public static final Fluid H2O_lo
        = new Fluid("rc lowpwater").setDensity(800).setViscosity(800);
    public static final Fluid NA_hot = new Fluid("rc hotsodium")
                                           .setDensity(720)
                                           .setViscosity(650)
                                           .setTemperature(2000)
                                           .setLuminosity(8);
    public static final Fluid NA_warm = new Fluid("rc warmsodium")
                                            .setDensity(864)
                                            .setViscosity(650)
                                            .setTemperature(1100)
                                            .setLuminosity(6);
    ...
    public static final Fluid H2
        = new Fluid("rc deuterium").setDensity(-1).setViscosity(10).setGaseous(true);
    public static final Fluid H3
        = new Fluid("rc tritium").setDensity(-1).setViscosity(10).setGaseous(true);

    public static final Fluid CO2
        = new Fluid("rc co2").setDensity(2).setViscosity(7).setGaseous(true);
    public static final Fluid CO2_hot = new Fluid("rc hot co2")
                                            .setDensity(1)
                                            .setViscosity(5)
                                            .setGaseous(true)
                                            .setLuminosity(2);
    ...
    public static final Fluid PLASMA
        = new Fluid("rc fusion plasma")
              .setDensity(-1)
              .setViscosity(100)
              .setGaseous(true)
              .setTemperature(TileEntityFusionHeater.PLASMA_TEMP)
              .setLuminosity(15);

    public static final Fluid CORIUM
        = new Fluid("rc corium").setDensity(5000).setViscosity(8000).setTemperature(2173);
    public static final Fluid WASTE = new Fluid("rc nuclear waste")
                                          .setDensity(4000)
                                          .setViscosity(12000)
                                          .setTemperature(800);

    public static final Fluid LI = new Fluid("rc lithium")
                                       .setDensity(516)
                                       .setViscosity(645)
                                       .setTemperature(454)
                                       .setLuminosity(6);

    public static final Fluid LIFBe = new Fluid("rc lifbe")
                                          .setDensity(6300)
                                          .setViscosity(800 * 3)
                                          .setTemperature(773);
    public static final Fluid LIFBe_fuel = new Fluid("rc lifbe fuel")
                                               .setDensity(6750)
                                               .setViscosity(850 * 3)
                                               .setTemperature(473);
    public static final Fluid LIFBe_fuel_preheat = new Fluid("rc lifbe fuel preheat")
                                                       .setDensity(6700)
                                                       .setViscosity(850 * 5 / 2)
                                                       .setTemperature(673);
    public static final Fluid LIFBe_hot = new Fluid("rc hot lifbe")
                                              .setDensity(6000)
                                              .setViscosity(800 * 3)
                                              .setTemperature(1273)
                                              .setLuminosity(8);
    ...
    public static final CustomStringDamageSource fusionDamage
        = new CustomStringDamageSource("jumped in a Fusion Reactor");
    public static final PoisonGasDamage gasDamage = new PoisonGasDamage();

    @SidedProxy(
        clientSide = "Reika.ReactorCraft.ClientProxy",
        serverSide = "Reika.ReactorCraft.CommonProxy"
    )
    public static CommonProxy proxy;

    public final boolean isLocked() {
        return !ModLockController.instance.verify(this)
            || RotaryCraft.instance.isLocked();
    }
    ...
    public void preload(FMLPreInitializationEvent evt) {
        ...
        ReikaPacketHelper.registerPacketHandler(
            instance, packetChannel, new ReactorPacketCore()
        );

        //if (ReactorBlocks.CORIUMSTILL.getBlock() !=
        //ReactorBlocks.CORIUMFLOWING.getBlock()+1) 	throw new
        //InstallationException(instance, "The still corium block ID needs to be exactly
        //one more than the flowing ID!");
        ...
        IDCollisionTracker.instance
            .addPotionID(instance, config.getRadiationPotionID(), PotionRadiation.class);
        radiation = (PotionRadiation) new PotionRadiation(config.getRadiationPotionID())
                        .setPotionName("Radiation Sickness");

        OreDictionary.registerOre(
            "depletedUranium", ReactorItems.DEPLETED.getItemInstance()
        );
        OreDictionary.registerOre(
            "depletedUranium", ReactorItems.OLDPELLET.getItemInstance()
        );
        ...
        if (ModList.GENDUSTRY.isLoaded()) {
            try {
                GendustryAPI.Registries.getMutagenRegistry().add(
                    ReactorItems.WASTE.getItemInstance(), 10000
                );
                GendustryAPI.Registries.getMutagenRegistry().add(
                    ReactorItems.FUEL.getItemInstance(), 2000
                );
                GendustryAPI.Registries.getMutagenRegistry().add(
                    ReactorItems.PLUTONIUM.getItemInstance(), 5000
                );
                GendustryAPI.Registries.getMutagenRegistry().add(
                    ReactorItems.PELLET.getItemInstance(), 1200
                );
                //GendustryAPI.Registries.getMutagenRegistry().add(ReactorItems.THORIUM.getItemInstance(),
                //2000);
            } catch (IncompatibleClassChangeError e) {
                logger.logError(
                    "Could not add Gendustry integration. Check your versions; if you are up-to-date with both mods, notify Reika. "
                    + e.toString()
                );
            } catch (Exception e) {
                logger.logError(
    ...
    public void load(FMLInitializationEvent event) {
        ...
        if (this.isLocked()) {
            ...
            ReikaJavaLibrary.pConsole(
                "\tNOTICE: It has been detected that third-party plugins are being used to disable parts of ReactorCraft."
            );
            ReikaJavaLibrary.pConsole(
            ...
            ReikaJavaLibrary.pConsole(
                "\tTo regain functionality, unban the ReactorCraft content, and then reload the game. All functionality"
            );
            ReikaJavaLibrary.pConsole(
        ...
        for (int i = 0; i < FluoriteTypes.colorList.length; i++) {
            ...
            FMLInterModComms.sendMessage(
                ModList.MINEFACTORY.modLabel, "addLaserPreferredOre", tag
            );
        }

        FMLInterModComms.sendMessage(
            ModList.ARSMAGICA.modLabel, "adb", String.valueOf(radiation.id)
        );
        ...
        //TickRegistry.instance.registerTickHandler(new VolcanicGasController(),
        //Side.SERVER);

        if (!this.isLocked())
            IntegrityChecker.instance.addMod(
                instance, ReactorBlocks.blockList, ReactorItems.itemList
            );
        ...
        if (ModList.APPENG.isLoaded()) {
            MESystemReader.registerMESystemEffect(
                RadiationEffects.instance.createMESystemEffect()
            );
        }

        SuggestedModsTracker.instance.addSuggestedMod(
            instance, ModList.CHROMATICRAFT, "Dense pitchblende generation in its biomes"
        );
        SuggestedModsTracker.instance.addSuggestedMod(
            instance, ModList.TWILIGHT, "Dense pitchblende generation in its biomes"
        );

        SensitiveItemRegistry.instance.registerItem(
            this, ReactorItems.FUEL.getItemInstance(), false
        );
        SensitiveItemRegistry.instance.registerItem(
            this, ReactorItems.BREEDERFUEL.getItemInstance(), false
        );
        SensitiveItemRegistry.instance.registerItem(
            this, ReactorItems.PLUTONIUM.getItemInstance(), false
        );
        //SensitiveItemRegistry.instance.registerItem(this,
        //ReactorItems.THORIUM.getItemInstance(), true);
        SensitiveItemRegistry.instance.registerItem(
            this, ReactorItems.PELLET.getItemInstance(), false
        );
        ...
        //SensitiveItemRegistry.instance.registerItem(this,
        //ReactorItems.CRAFTING.getItemInstance(), false);
    ...
    public void postload(FMLPostInitializationEvent evt) {
        ...
        //	BlockColorMapper.instance.addModBlockColor(ReactorBlocks.FLUORITEORE.getBlock(),
        //i, fl.red, fl.green, fl.blue);
        //}
        for (int i = 0; i < ReactorTiles.TEList.length; i++) {
            ReactorTiles r = ReactorTiles.TEList[i];
            //BlockColorMapper.instance.addModBlockColor(r.getBlock(),
            //r.getBlockMetadata(), ReikaColorAPI.RGBtoHex(200, 200, 200));
            BlockColorInterface.addGPRBlockColor(
                r.getBlock(), r.getBlockMetadata(), 200, 200, 200
            );
        }
        ...
        TileEntityReservoir.addFluidEffect(
            "rc nuclear waste", new RadiationFluidEffect()
        );
        ...
        for (int i = 0; i < ReactorTiles.TEList.length; i++) {
            ...
            if (m != ReactorTiles.PROCESSOR) {
                if (ModList.CHROMATICRAFT.isLoaded()) {
                    ChromatiAPI.getAPI().adjacency().addAcceleratorBlacklist(
                        m.getTEClass(),
                        m.getName(),
                        m.getCraftedProduct(),
                        BlacklistReason.EXPLOIT
                    );
                }
        ...
        if (ModList.THAUMCRAFT.isLoaded()) {
            ...
            ReikaThaumHelper.addAspects(
                ReactorOres.CADMIUM.getOreBlock(), Aspect.METAL, 1
            );
            ReikaThaumHelper.addAspects(
                ReactorOres.INDIUM.getOreBlock(), Aspect.METAL, 1, Aspect.GREED, 1
            );
            ReikaThaumHelper.addAspects(
                ReactorOres.CALCITE.getOreBlock(), Aspect.CRYSTAL, 1
            );
            ReikaThaumHelper.addAspects(
                ReactorOres.MAGNETITE.getOreBlock(),
                Aspect.METAL,
                1,
                Aspect.CRYSTAL,
                1,
            ...
            ReikaThaumHelper.addAspects(
                ReactorOres.AMMONIUM.getOreBlock(), Aspect.FIRE, 1
            );

            ReikaThaumHelper.addAspects(
                ReactorOres.MAGNETITE.getProduct(),
                Aspect.AURA,
                2,
                Aspect.METAL,
                2,
            ...
            ReikaThaumHelper.addAspects(
                ReactorOres.CALCITE.getProduct(), Aspect.CRYSTAL, 2
            );
            ReikaThaumHelper.addAspects(
                ReactorOres.AMMONIUM.getProduct(), Aspect.FIRE, 2
            );
        ...
        if (ModList.CHROMATICRAFT.isLoaded()) {
            ChromatiAPI.getAPI().adjacency().addCustomHealing(
                TileEntityTurbineCore.class,
                new CustomTileHealing() {
                    @Override
    ...
    private static void addItems() {
        ReikaRegistryHelper.instantiateAndRegisterItems(
            instance, ReactorItems.itemList, items
        );
    }
    ...
    private static void addBlocks() {
        ReikaRegistryHelper.instantiateAndRegisterBlocks(
            instance, ReactorBlocks.blockList, blocks
        );
        for (int i = 0; i < ReactorTiles.TEList.length; i++) {
            GameRegistry.registerTileEntity(
                ReactorTiles.TEList[i].getTEClass(),
                "Reactor" + ReactorTiles.TEList[i].getName()
            );
            ReikaJavaLibrary.initClass(ReactorTiles.TEList[i].getTEClass(), true);
        }
        GameRegistry.registerTileEntity(
            TileEntitySteamInjector.class, "ReactorSteamInjector"
        );
        GameRegistry.registerTileEntity(
            TileEntityTritiumLamp.class, "ReactorTritiumLamp"
        );
    }
    ...
    private static void addLiquidContainers() {
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(D2O, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorItems.BUCKET.getStackOfMetadata(0),
            new ItemStack(Items.bucket)
        );
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(HF, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.hfcan,
            ReactorStacks.emptycan
        );
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(UF6, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.uf6can,
            ReactorStacks.emptycan
        );

        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(NH3, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.nh3can,
            ReactorStacks.emptycan
        );
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(NA, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.nacan,
            ReactorStacks.emptycan
        );
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(CL, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.clcan,
            ReactorStacks.emptycan
        );
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(O, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.ocan,
            ReactorStacks.emptycan
        );

        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(H2, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.h2can,
            ReactorStacks.emptycan
        );
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(H3, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.h3can,
            ReactorStacks.emptycan
        );

        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(CO2, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.co2can,
            ReactorStacks.emptycan
        );

        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(CO2_hot, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.hotco2can,
            ReactorStacks.emptycan
        );
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(NA_hot, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.hotnacan,
            ReactorStacks.emptycan
        );

        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(LI, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.lican,
            ReactorStacks.emptycan
        );

        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(LIFBe, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.lifbecan,
            ReactorStacks.emptycan
        );
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(LIFBe_hot, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.hotlifbecan,
            ReactorStacks.emptycan
        );
        FluidContainerRegistry.registerFluidContainer(
            new FluidStack(LIFBe_fuel, FluidContainerRegistry.BUCKET_VOLUME),
            ReactorStacks.lifbefuelcan,
            ReactorStacks.emptycan
        );
    }

    public static final boolean
    hasGui(World world, int x, int y, int z, EntityPlayer ep) {
        if (FMLCommonHandler.instance().getEffectiveSide() == Side.CLIENT) {
            Object GUI
                = ReactorGuiHandler.instance.getClientGuiElement(0, ep, world, x, y, z);
            if (GUI != null)
                return true;
        }
        if (FMLCommonHandler.instance().getEffectiveSide() == Side.SERVER) {
            Object GUI
                = ReactorGuiHandler.instance.getServerGuiElement(0, ep, world, x, y, z);
            if (GUI != null)
                return true;
        }
        return false;
    ...
    private static void registerOres() {
        for (int i = 0; i < ReactorOres.oreList.length; i++) {
            ...
            if (ore != ReactorOres.FLUORITE) {
                ...
                OreDictionary.registerOre(
                    ore.getProductDictionaryName(), ore.getProduct()
                );
            }
        }
        ...
        for (int i = 0; i < FluoriteTypes.colorList.length; i++) {
            FluoriteTypes fl = FluoriteTypes.colorList[i];
            ItemStack is
                = new ItemStack(ReactorBlocks.FLUORITEORE.getBlockInstance(), 1, i);
            //ReikaOreHelper.addOreForReference(is);
            OreDictionary.registerOre(ReactorOres.FLUORITE.getDictionaryName(), is);
            OreDictionary.registerOre(
                ReactorOres.FLUORITE.getProductDictionaryName(), fl.getItem()
            );
        }
    }
            ...
            while (it.hasNext()) {
                ...
                if (ReactorItems.WASTE.matchWith(is)) {
                    ReikaItemHelper.dropItem(
                        te.worldObj, te.xCoord + 0.5, te.yCoord + 1.5, te.zCoord + 0.5, is
                    );
                    it.remove();
                    try {
