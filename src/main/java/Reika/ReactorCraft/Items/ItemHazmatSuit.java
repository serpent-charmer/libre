...
public class ItemHazmatSuit
    extends ItemArmor implements IndexedItemSprites, ISpecialArmor {
    ...
    public ItemHazmatSuit(int ind, int render, int type) {
        ...
        sprite = ind;
        this.setCreativeTab(
            ReactorCraft.instance.isLocked() ? null : ReactorCraft.tabRctrItems
        );
    }
    ...
    public ArmorProperties getProperties(
        ...
        ArmorProperties prop
            = new ArmorProperties(Integer.MAX_VALUE, 0, Integer.MAX_VALUE);
        return prop;
    }
