...
public class ItemBlockFluorite extends ItemBlock {
    ...
    private int getDataValues() {
        if (ReactorOptions.RAINBOW.getState()
            && this
                == Item.getItemFromBlock(ReactorBlocks.FLUORITEORE.getBlockInstance()))
            return 1;
    ...
    public String getItemStackDisplayName(ItemStack itemstack) {
        ReactorBlocks b = ReactorBlocks.FLUORITEORE.matchItem(itemstack)
            ? ReactorBlocks.FLUORITEORE
            : ReactorBlocks.FLUORITE;
