...
public class ItemBlockReactorOre extends ItemBlock {
    ...
    public void onUpdate(ItemStack is, World world, Entity e, int slot, boolean flag) {
        if (e instanceof EntityPlayer && ReactorOptions.RADIOORE.getState() &&
    ReactorOres.oreList[is.getItemDamage()].isUranium()) { EntityPlayer ep =
    (EntityPlayer)e; if (!ep.capabilities.isCreativeMode) {
