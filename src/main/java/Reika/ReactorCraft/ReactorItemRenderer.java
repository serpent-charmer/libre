    ...
    public void renderItem(ItemRenderType type, ItemStack item, Object... data) {
        ...
        if (machine.isPipe()) {
            ...
            rb.renderBlockAsItem(
                ReactorBlocks.DUCT.getBlockInstance(), machine.getBlockMetadata(), 1
            );
        } else if (machine.hasRender())
            TileEntityRendererDispatcher.instance.renderTileEntityAt(
                machine.createTEInstanceForRender(), a, -0.1D, b, 0.0F
            );
        else {
            ReikaTextureHelper.bindTerrainTexture();
            ...
            rb.renderBlockAsItem(
                machine.getBlockInstance(), machine.getBlockMetadata(), 1
            );
        }
    }
}
