...
public class RenderRadiation extends Render {
    public void renderEntity(
        EntityRadiation er, double par2, double par4, double par6, float par8, float par9
    ) {
        EntityClientPlayerMP cam = Minecraft.getMinecraft().thePlayer;
        ItemStack helmet = cam.inventory.armorInventory[3];
        if (helmet != null
            && helmet.getItem() == ReactorItems.GOGGLES.getItemInstance()) {
            GL11.glPushMatrix();
            ...
            ReikaTextureHelper.bindFinalTexture(
                ReactorCraft.class, "/Reika/ReactorCraft/Textures/radiation2.png"
            );
