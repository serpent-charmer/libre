...
public class BlockHeaterMulti extends BlockReCMultiBlock implements SemiTransparent {
    ...
    public Boolean checkForFullMultiBlock(
        ...
        Set<BlockKey> set = ReikaJavaLibrary.getSet(
            new BlockKey(this), new BlockKey(ReactorTiles.HEATER)
        );
        blocks.recursiveAddMultipleWithBounds(
            world, x, y, z, set, x - 6, y - 6, z - 6, x + 6, y + 6, z + 6
        );
    ...
    private boolean checkPipe(
        ...
        for (int i = 3; i <= 6; i++) {
            if (ReactorTiles.getTE(world, mx + 2, my + i, mz + 2)
            ...
            for (int j = 1; j < 4; j++) {
                for (int k = 1; k < 4; k++) {
                    ...
                    if (i == 2 && k == 2 && j == 3) {
                        ...
                        if (ReactorTiles.getTE(blocks.world, dx, dy, dz)
                            != ReactorTiles.MAGNETPIPE) {
                            if (call != null)
                                call.onBlockFailure(
                                    world,
                        ...
                        if (block == null) {
                            MachineRegistry m
                                = MachineRegistry.getMachine(blocks.world, dx, dy, dz);
                            if (m == null || !m.isStandardPipe()) {
                                if (call != null)
                                    call.onBlockFailure(
                                        ...
                                        dy,
                                        dz,
                                        new BlockKey(MachineRegistry.PIPE)
                                    );
                                return false;
                            }
                        } else {
                            ...
                            if (i == 2 && j == 2 && k == 2) {
                                if (id != ReactorTiles.HEATER.getBlock()
                                    || meta != ReactorTiles.HEATER.getBlockMetadata()) {
                                    if (call != null)
                                        call.onBlockFailure(
                                            world,
                                            dx,
                                            dy,
                                            dz,
                                            new BlockKey(ReactorTiles.HEATER)
                                        );
                                    return false;
                                }
                            } else {
                                if (id == this) {
                                    if (meta > 1) {
                                        if (call != null)
                                            call.onBlockFailure(
                                                world, dx, dy, dz, new BlockKey(this, 1)
                                            );
                                        return false;
                                    } else
                                        total++;
                                    ...
                                    if (j != 2) {
                                        if (call != null)
                                            call.onBlockFailure(
                                                world, dx, dy, dz, new BlockKey(this)
                                            );
                                        return false;
                                    }
                                } else {
            ...
            for (int k = 1; k < 4; k++) {
                if (i == 2 && k == 2) {
                    ...
                    if (ReactorTiles.getTE(blocks.world, dx, dy, dz)
                        ...
                        if (call != null)
                            call.onBlockFailure(
                                world, dx, dy, dz, new BlockKey(ReactorTiles.MAGNETPIPE)
                            );
                        return false;
                    }
                } else {
                    ...
                    if (block == null || block.blockID != this
                        || block.metadata != meta2) {
                        if (call != null)
                            call.onBlockFailure(
                                world,
                                blocks.getMinX() + i,
    ...
    private boolean checkCorners(
        ...
        //ReikaJavaLibrary.pConsole(block.getMinX()+", "+block.getMinY()+",
        //"+block.getMinZ());
    ...
    onCreateFullMultiBlock(World world, int x, int y, int z, Boolean complete) {
        ...
        blocks.recursiveAddWithBounds(
            world, x, y, z, this, x - 6, y - 6, z - 6, x + 6, y + 6, z + 6
        );
        for (int i = 0; i < blocks.getSize(); i++) {
            ...
            if (meta == 0) {
                for (int k = 2; k < 6; k++) {
                    ...
                    //ReikaJavaLibrary.pConsole(world.getBlock(dx, dy,
                    //dz)+":"+world.getBlockMetadata(dx, dy, dz)+" from
                    //"+Arrays.toString(xyz));
                    if (ReactorTiles.getTE(world, dx, dy, dz) == ReactorTiles.HEATER) {
                        TileEntityFusionHeater te
                            = (TileEntityFusionHeater) world.getTileEntity(dx, dy, dz);
    ...
    getTextureIndex(IBlockAccess world, int x, int y, int z, int side, int meta) {
            ...
            switch (side) {
                case 0:
                    if (world.getBlock(x + 1, y, z + 1) == this
                        && world.getBlockMetadata(x + 1, y, z + 1) == 12)
                        return 2;
                    if (world.getBlock(x - 1, y, z + 1) == this
                        && world.getBlockMetadata(x - 1, y, z + 1) == 12)
                        return 3;
                ...
                case 1:
                    if (world.getBlock(x + 1, y, z + 1) == this
                        && world.getBlockMetadata(x + 1, y, z + 1) == 9)
                        return 2;
                    if (world.getBlock(x - 1, y, z + 1) == this
                        && world.getBlockMetadata(x - 1, y, z + 1) == 9)
                        return 3;
                    ...
                    if (world.getBlock(x, y - 1, z) == this
                        && world.getBlockMetadata(x, y - 1, z) == 9) {
                        Block did = ReactorTiles.MAGNETPIPE.getBlock();
                        int dmeta = ReactorTiles.MAGNETPIPE.getBlockMetadata();
                        if (world.getBlock(x + 1, y, z + 1) == did
                            && world.getBlockMetadata(x + 1, y, z + 1) == dmeta
                ...
                case 2:
                    if (world.getBlock(x + 1, y + 1, z) == this
                        && world.getBlockMetadata(x + 1, y + 1, z) == 12)
                        return 4;
                    if (world.getBlock(x - 1, y + 1, z) == this
                        && world.getBlockMetadata(x - 1, y + 1, z) == 12)
                        return 5;
                ...
                case 4:
                    if (world.getBlock(x, y + 1, z + 1) == this
                        && world.getBlockMetadata(x, y + 1, z + 1) == 12)
                        return 5;
                    if (world.getBlock(x, y + 1, z - 1) == this
                        && world.getBlockMetadata(x, y + 1, z - 1) == 12)
                        return 4;
        ...
        if (meta == 11) {
            switch (side) {
                ...
                case 1:
                    if (world.getBlock(x + 1, y, z) == this
                        && world.getBlockMetadata(x + 1, y, z) == 9)
                        return 8;
                    if (world.getBlock(x - 1, y, z) == this
                        && world.getBlockMetadata(x - 1, y, z) == 9)
                        return 7;
                    if (world.getBlock(x, y, z + 1) == this
                        && world.getBlockMetadata(x, y, z + 1) == 9)
                        return 9;
                    if (world.getBlock(x, y, z - 1) == this
                        && world.getBlockMetadata(x, y, z - 1) == 9)
                        return 6;
                    ...
                    if (world.getBlock(x, y - 1, z) == this
                        ...
                        Block did = ReactorTiles.MAGNETPIPE.getBlock();
                        int dmeta = ReactorTiles.MAGNETPIPE.getBlockMetadata();
                        if (world.getBlock(x + 1, y, z) == did
                            && world.getBlockMetadata(x + 1, y, z) == dmeta
                        ...
                        if (world.getBlock(x - 1, y, z) == did
                            ...
                            && world.getBlock(x + 1, y, z) == Blocks.air)
                            return 7;
                        if (world.getBlock(x, y, z + 1) == did
                            && world.getBlockMetadata(x, y, z + 1) == dmeta
                ...
                case 2:
                    ...
                    if (world.getBlock(x - 1, y, z) == this
                        ...
                        return 8;
                    if (world.getBlock(x, y + 1, z) == this
                        && world.getBlockMetadata(x, y + 1, z) == 12)
                        return 6;
                    if (world.getBlock(x, y - 1, z) == this
                        && world.getBlockMetadata(x, y - 1, z) == 12)
                        return 9;
    ...
    protected TileEntity getTileEntityForPosition(World world, int x, int y, int z) {
        StructuredBlockArray blocks = new StructuredBlockArray(world);
        Set<BlockKey> li = ReikaJavaLibrary.getSet(
            new BlockKey(this), new BlockKey(ReactorTiles.HEATER)
        );
        blocks.recursiveAddMultipleWithBounds(
            world, x, y, z, li, x - 6, y - 6, z - 6, x + 6, y + 6, z + 6
        );
        int mx = blocks.getMidX();
        int my = blocks.getMidY() - 1;
        int mz = blocks.getMidZ();
        return ReactorTiles.getTE(world, mx, my, mz) == ReactorTiles.HEATER
            ? world.getTileEntity(mx, my, mz)
            : null;
    }
}
