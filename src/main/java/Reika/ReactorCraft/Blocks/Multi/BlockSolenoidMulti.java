...
public class BlockSolenoidMulti
    extends BlockReCMultiBlock implements Transducerable, NeutronBlock {
    ...
    public Boolean checkForFullMultiBlock(
        ...
        blocks.recursiveAddWithBoundsRanged(
            world, x, y, z, this, x - 20, y - 3, z - 20, x + 20, y + 3, z + 20, 1
        );
        ...
        if (ReactorTiles.getTE(world, midX, midY, midZ) != ReactorTiles.SOLENOID) {
            if (call != null)
                call.onBlockFailure(
                    world, midX, midY, midZ, new BlockKey(ReactorTiles.SOLENOID)
                );
            return false;
        }
    ...
    private boolean checkSpokes(
        ...
        for (int i = 2; i <= 7; i++) {
            ...
            if (id != this || meta != 4) {
                if (call != null)
                    call.onBlockFailure(
                        world, midX + i, midY, midZ, new BlockKey(this, 4)
                    );
                return false;
            }
            ...
            if (id != this || meta != 4) {
                if (call != null)
                    call.onBlockFailure(
                        world, midX, midY, midZ + i, new BlockKey(this, 4)
                    );
                return false;
            }
            ...
            if (i < 6) {
                ...
                if (id != this || meta != 4) {
                    if (call != null)
                        call.onBlockFailure(
                            world, midX + i, midY, midZ + i, new BlockKey(this, 4)
                        );
                    return false;
                }
    ...
    private boolean checkCorners(
        ...
        for (int i = 6; i <= 6; i++) {
            ...
            if (id != this || meta != 1) {
                if (call != null)
                    call.onBlockFailure(
                        world, midX - i, midY + 1, midZ - i, new BlockKey(this, 1)
                    );
                return false;
            }
    ...
    public void breakMultiBlock(World world, int x, int y, int z) {
        ...
        blocks.recursiveAddWithBoundsRanged(
            world, x + 1, y, z, this, x - 20, y - 3, z - 20, x + 20, y + 3, z + 20, 1
        );
        blocks.recursiveAddWithBoundsRanged(
            world, x - 1, y, z, this, x - 20, y - 3, z - 20, x + 20, y + 3, z + 20, 1
        );
        blocks.recursiveAddWithBoundsRanged(
            world, x, y + 1, z, this, x - 20, y - 3, z - 20, x + 20, y + 3, z + 20, 1
        );
        blocks.recursiveAddWithBoundsRanged(
            world, x, y - 1, z, this, x - 20, y - 3, z - 20, x + 20, y + 3, z + 20, 1
        );
        blocks.recursiveAddWithBoundsRanged(
            world, x, y, z + 1, this, x - 20, y - 3, z - 20, x + 20, y + 3, z + 20, 1
        );
        blocks.recursiveAddWithBoundsRanged(
            world, x, y, z - 1, this, x - 20, y - 3, z - 20, x + 20, y + 3, z + 20, 1
        );
        ...
        if (ReactorTiles.getTE(world, midX, midY, midZ) == ReactorTiles.SOLENOID) {
            TileEntitySolenoidMagnet te
                = (TileEntitySolenoidMagnet) world.getTileEntity(midX, midY, midZ);
    ...
    getTextureIndex(IBlockAccess world, int x, int y, int z, int side, int meta) {
        if (meta >= 8)
            return 10;
        if (meta == 4) {
            boolean f = world.getBlock(x + 1, y, z) == this
                || world.getBlock(x - 1, y, z) == this;
            boolean f2 = world.getBlock(x, y, z + 1) == this
