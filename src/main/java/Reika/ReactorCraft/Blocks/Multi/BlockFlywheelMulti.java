...
public class BlockFlywheelMulti extends BlockReCMultiBlock {
    ...
    public Boolean checkForFullMultiBlock(
        ...
        blocks.recursiveAddWithBoundsRanged(
            world, x, y, z, this, x - 6, y - 6, z - 6, x + 6, y + 6, z + 6, 1
        );
        ...
        if (ReactorTiles.getTE(world, midX, midY, midZ) != ReactorTiles.FLYWHEEL) {
            if (call != null)
                call.onBlockFailure(
                    world, midX, midY, midZ, new BlockKey(ReactorTiles.FLYWHEEL)
                );
            return false;
        }
        TileEntityReactorFlywheel te
            = (TileEntityReactorFlywheel) world.getTileEntity(midX, midY, midZ);
        ...
        for (int i = 1; i <= 2; i++) {
            ...
            int m = i == 1 ? 0 : 2;
            if (world.getBlock(dx, midY, dz) != this
                || world.getBlockMetadata(dx, midY, dz) != m) {
                if (call != null)
            ...
            if (world.getBlock(midX, midY - i, midZ) != this
                || world.getBlockMetadata(midX, midY - i, midZ) != m) {
                if (call != null)
                    call.onBlockFailure(
                        world, midX, midY - i, midZ, new BlockKey(this, m)
                    );
                return false;
            }
            if (world.getBlock(midX, midY + i, midZ) != this
        ...
        if (world.getBlock(dx, midY + 1, dz) != this
            || world.getBlockMetadata(dx, midY + 1, dz) != 1) {
            if (call != null)
        ...
        dx = midX + left.offsetX;
        dz = midZ + left.offsetZ;
        if (world.getBlock(dx, midY + 2, dz) != this
            || world.getBlockMetadata(dx, midY + 2, dz) != 2) {
            if (call != null)
        ...
        if (world.getBlock(dx, midY + 1, dz) != this
            || world.getBlockMetadata(dx, midY + 1, dz) != 2) {
            if (call != null)
    ...
    public void breakMultiBlock(World world, int x, int y, int z) {
        ...
        blocks.recursiveAddWithBoundsRanged(
            world, x + 1, y, z, this, x - 6, y - 6, z - 6, x + 6, y + 6, z + 6, 1
        );
        blocks.recursiveAddWithBoundsRanged(
            world, x - 1, y, z, this, x - 6, y - 6, z - 6, x + 6, y + 6, z + 6, 1
        );
        blocks.recursiveAddWithBoundsRanged(
            world, x, y + 1, z, this, x - 6, y - 6, z - 6, x + 6, y + 6, z + 6, 1
        );
        blocks.recursiveAddWithBoundsRanged(
            world, x, y - 1, z, this, x - 6, y - 6, z - 6, x + 6, y + 6, z + 6, 1
        );
        blocks.recursiveAddWithBoundsRanged(
            world, x, y, z + 1, this, x - 6, y - 6, z - 6, x + 6, y + 6, z + 6, 1
        );
        blocks.recursiveAddWithBoundsRanged(
            world, x, y, z - 1, this, x - 6, y - 6, z - 6, x + 6, y + 6, z + 6, 1
        );
