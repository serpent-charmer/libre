...
public class RenderControl extends ReactorRenderBase {
     ...
     */
    public void renderTileEntityControlRodAt(
        TileEntityControlRod tile, double par2, double par4, double par6, float par8
    ) {
        ModelControl var14;
        var14 = ControlModel;
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((TileEntityReactorBase) tile))
            this.renderTileEntityControlRodAt(
                (TileEntityControlRod) tile, par2, par4, par6, par8
            );
    }
