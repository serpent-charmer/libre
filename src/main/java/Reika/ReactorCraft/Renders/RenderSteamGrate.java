...
public class RenderSteamGrate extends ReactorRenderBase {
     ...
     */
    public void renderTileEntitySteamGrateAt(
        TileEntitySteamGrate tile, double par2, double par4, double par6, float par8
    ) {
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((TileEntityReactorBase) tile))
            this.renderTileEntitySteamGrateAt(
                (TileEntitySteamGrate) tile, par2, par4, par6, par8
            );
    }
