...
public class RenderFusionHeater extends ReactorRenderBase {
     ...
     */
    public void renderTileEntityFusionHeaterAt(
        TileEntityFusionHeater tile, double par2, double par4, double par6, float par8
    ) {
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((TileEntityReactorBase) tile))
            this.renderTileEntityFusionHeaterAt(
                (TileEntityFusionHeater) tile, par2, par4, par6, par8
            );
    }
