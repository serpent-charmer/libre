...
public class RenderSteamDiffuser extends ReactorRenderBase {
     ...
     */
    public void renderTileEntityDiffuserAt(
        TileEntitySteamDiffuser tile, double par2, double par4, double par6, float par8
    ) {
        ModelDiffuser var14;
        var14 = DiffuserModel;
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((TileEntityReactorBase) tile))
            this.renderTileEntityDiffuserAt(
                (TileEntitySteamDiffuser) tile, par2, par4, par6, par8
            );
