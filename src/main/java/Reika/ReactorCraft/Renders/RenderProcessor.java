...
public class RenderProcessor extends ReactorRenderBase {
     ...
     */
    public void renderTileEntityUProcessorAt(
        TileEntityUProcessor tile, double par2, double par4, double par6, float par8
    ) {
    ...
    private void
    renderLiquids(TileEntityUProcessor tile, double par2, double par4, double par6) {
        for (int i = 0; i < 3; i++) {
            Fluid f = null;
            int amount = 0;
            switch (i) {
            ...
            GL11.glScaled(
                this.getLiquidScaleX(tile, liquid, i),
                this.getLiquidScaleY(tile, liquid, i),
                this.getLiquidScaleZ(tile, liquid, i)
            );
            GL11.glTranslated(
                this.getLiquidOffsetX(tile, liquid, i),
                this.getLiquidOffsetY(tile, liquid, i),
                this.getLiquidOffsetZ(tile, liquid, i)
            );
            ...
            ) (Math.min(1, amount / (3000D)) * (ReikaLiquidRenderer.LEVELS - 1))]);
