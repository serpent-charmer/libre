...
public class RenderWaterLine extends ReactorRenderBase {
     ...
     */
    @Deprecated
    private void renderTileEntityWaterLineAt(
        TileEntitySteamLine tile, double par2, double par4, double par6, float par8
    ) {
    ...
    public void renderTileEntityAt(
        ...
        //	this.renderTileEntityWaterLineAt((TileEntitySteamLine)tile, par2, par4, par6,
        //par8);
