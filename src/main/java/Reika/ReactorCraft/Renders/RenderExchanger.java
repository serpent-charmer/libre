...
public class RenderExchanger extends ReactorRenderBase {
     ...
     */
    public void renderTileEntityHeatExchangerAt(
        TileEntityHeatExchanger tile, double par2, double par4, double par6, float par8
    ) {
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((TileEntityReactorBase) tile))
            this.renderTileEntityHeatExchangerAt(
                (TileEntityHeatExchanger) tile, par2, par4, par6, par8
            );
