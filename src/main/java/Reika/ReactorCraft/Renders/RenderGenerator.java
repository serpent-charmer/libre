...
public class RenderGenerator extends ReactorRenderBase {
    ...
    public void renderTileEntityReactorGeneratorAt(
        TileEntityReactorGenerator tile, double par2, double par4, double par6, float par8
    ) {
        this.bindTextureByName(
            "/Reika/ReactorCraft/Textures/TileEntity/generator" + tile.getMode().ordinal()
            + ".png"
        );
        ...
        if (tile.isInWorld() || StructureRenderer.isRenderingTiles()) {
            if (tile.hasMultiBlock())
                ...
                IIcon ico = ReactorBlocks.GENERATORMULTI.getBlockInstance().getIcon(
                    0, -(1 + tile.getMode().ordinal())
                );
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((TileEntityReactorBase) tile))
            this.renderTileEntityReactorGeneratorAt(
                (TileEntityReactorGenerator) tile, par2, par4, par6, par8
            );
