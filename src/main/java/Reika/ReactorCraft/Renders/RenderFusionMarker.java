...
public class RenderFusionMarker extends ReactorRenderBase {
    public void renderTileEntityFusionMarkerAt(
        TileEntityFusionMarker tile, double par2, double par4, double par6, float par8
    ) {
    ...
    private void
    renderMarkerBody(TileEntityFusionMarker tile, double par2, double par4, double par6) {
    ...
    private void
    renderSolenoid(TileEntityFusionMarker tile, double par2, double par4, double par6) {
        Tessellator v5 = Tessellator.instance;
    ...
    private void
    renderPositions(TileEntityFusionMarker tile, double par2, double par4, double par6) {
    ...
    private void renderInjectorBoxAt(
        TileEntityFusionMarker tile,
        Aim a,
        int x,
        int y,
        int z,
    ...
    private void renderToroidBoxAt(
        TileEntityFusionMarker tile,
        Aim a,
        int x,
        int y,
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((TileEntityReactorBase) tile))
            this.renderTileEntityFusionMarkerAt(
                (TileEntityFusionMarker) tile, par2, par4, par6, par8
            );
    }
