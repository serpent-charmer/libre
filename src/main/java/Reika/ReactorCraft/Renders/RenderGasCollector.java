...
public class RenderGasCollector extends ReactorRenderBase {
     ...
     */
    public void renderTileEntityGasCollectorAt(
        TileEntityGasCollector tile, double par2, double par4, double par6, float par8
    ) {
        int var9;
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((TileEntityReactorBase) tile))
            this.renderTileEntityGasCollectorAt(
                (TileEntityGasCollector) tile, par2, par4, par6, par8
            );
    ...
    private void
    renderTarget(TileEntityGasCollector tile, double par2, double par4, double par6) {
