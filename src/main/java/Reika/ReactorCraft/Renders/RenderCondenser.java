...
public class RenderCondenser extends ReactorRenderBase {
     ...
     */
    public void renderTileEntityCondenserAt(
        TileEntityCondenser tile, double par2, double par4, double par6, float par8
    ) {
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((TileEntityReactorBase) tile))
            this.renderTileEntityCondenserAt(
                (TileEntityCondenser) tile, par2, par4, par6, par8
            );
    }
