...
public class RenderHeavyPump extends ReactorRenderBase {
     ...
     */
    public void renderTileEntityHeavyPumpAt(
        TileEntityHeavyPump tile, double par2, double par4, double par6, float par8
    ) {
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((TileEntityReactorBase) tile))
            this.renderTileEntityHeavyPumpAt(
                (TileEntityHeavyPump) tile, par2, par4, par6, par8
            );
