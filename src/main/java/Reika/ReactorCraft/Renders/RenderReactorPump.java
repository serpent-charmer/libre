...
public class RenderReactorPump extends ReactorRenderBase {
    private ModelReactorPump ReactorPumpModel = new ModelReactorPump();

    /**
     * Renders the TileEntity for the position.
     */
    public void renderTileEntityReactorPumpAt(
        TileEntityReactorPump tile, double par2, double par4, double par6, float par8
    ) {
        ModelReactorPump var14;
        var14 = ReactorPumpModel;

        this.bindTextureByName("/Reika/ReactorCraft/Textures/TileEntity/pump.png");
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((TileEntityReactorBase) tile))
            this.renderTileEntityReactorPumpAt(
                (TileEntityReactorPump) tile, par2, par4, par6, par8
            );
