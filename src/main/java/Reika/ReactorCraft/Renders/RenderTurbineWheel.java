...
public class RenderTurbineWheel extends ReactorRenderBase {
    ...
    public void renderTileEntityReactorFlywheelAt(
        TileEntityReactorFlywheel tile, double par2, double par4, double par6, float par8
    ) {
    ...
    public void renderTileEntityAt(
        ...
        if (this.doRenderModel((TileEntityReactorBase) tile))
            this.renderTileEntityReactorFlywheelAt(
                (TileEntityReactorFlywheel) tile, par2, par4, par6, par8
            );
