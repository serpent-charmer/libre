...
//Stackable, 3x3 wide, power out top of top one, cold fluid out bottom of bottom one; each
//one adds some torque and some efficiency, up to 6(?) Handles any fluid identically (easy
//to use, no bonuses from ammonia; can also handle hot CO2 maybe need housing blocks
