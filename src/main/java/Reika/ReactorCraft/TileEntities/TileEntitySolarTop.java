...
public class TileEntitySolarTop
    extends TileEntityReactorBase implements TemperatureTE, SodiumSolarReceiver {
    ...
    public boolean isActive() {
        return ReactorTiles.getTE(worldObj, xCoord, yCoord + 1, zCoord) == this.getTile()
            && this.getAdjacentTileEntity(ForgeDirection.DOWN) instanceof TileEntitySolar;
    }
    ...
    public int getTemperature() {
        ...
        if (te instanceof TileEntitySolarTop)
            ...
            return ReikaWorldHelper.getAmbientTemperatureAt(
