...
public class TileEntityFusionInjector extends TileEntityReactorBase
    implements IFluidHandler, PipeConnector, MultiBlockTile, FusionReactorToroidPart,
    ...
    public ForgeDirection getFacing() {
        if (FMLCommonHandler.instance().getEffectiveSide() == Side.CLIENT
            && this.shouldFlip())
            return System.currentTimeMillis() % 4000 >= 2000 ? ForgeDirection.NORTH
    ...
    public boolean canFill(ForgeDirection from, Fluid fluid) {
        return fluid.equals(FluidRegistry.getFluid("rc fusion plasma"))
