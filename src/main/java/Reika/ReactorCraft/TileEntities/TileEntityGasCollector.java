...
public class TileEntityGasCollector extends TileEntityReactorBase
    implements IFluidHandler, PipeConnector, RefrigeratorAttachment {
    ...
    public void updateEntity(World world, int x, int y, int z, int meta) {
        ...
        if (id == Blocks.lit_furnace) {
            TileEntityFurnace te
                = (TileEntityFurnace) this.getAdjacentTileEntity(readDir);
            ...
            TileEntityRefrigerator te
                = (TileEntityRefrigerator) this.getAdjacentTileEntity(readDir);
    ...
    public boolean hasFurnace() {
        ...
        return id == Blocks.furnace || id == Blocks.lit_furnace
            || id == MachineRegistry.REFRIGERATOR.getBlock()
            && this.getAdjacentLocation(readDir).getBlockMetadata(worldObj)
                == MachineRegistry.REFRIGERATOR.getBlockMetadata();
    }
