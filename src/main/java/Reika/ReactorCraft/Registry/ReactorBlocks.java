...
public enum ReactorBlocks implements BlockEnum {
    ...
    INJECTORMULTI(
        BlockInjectorMulti.class, ItemBlockMultiBlock.class, "multiblock.injector", false
    ),
    HEATERMULTI(
        BlockHeaterMulti.class, ItemBlockMultiBlock.class, "multiblock.heater", false
    ),
    SOLENOIDMULTI(
        BlockSolenoidMulti.class, ItemBlockMultiBlock.class, "multiblock.solenoid", false
    ),
    GENERATORMULTI(
        BlockGeneratorMulti.class,
        ItemBlockMultiBlock.class,
        "multiblock.generator",
        false
    ),
    TURBINEMULTI(
        BlockTurbineMulti.class, ItemBlockMultiBlock.class, "multiblock.turbine", false
    ),
    FLYWHEELMULTI(
        BlockFlywheelMulti.class, ItemBlockMultiBlock.class, "multiblock.flywheel", false
    ),
    ...
    private ReactorBlocks(
        Class<? extends Block> cl, Class<? extends ItemBlock> ib, String n, boolean m
    ) {
        blockClass = cl;
        blockName = n;
        itemBlock = ib;
    ...
    public String getMultiValuedName(int meta) {
        switch (this) {
            ...
            case LAMP:
                return FluoriteTypes.colorList[meta].getName() + " "
                    + StatCollector.translateToLocal(this.getBasicName());
            default:
