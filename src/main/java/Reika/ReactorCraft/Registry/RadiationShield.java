...
public enum RadiationShield {
    ...
    CONCRETE(
        ...
        60,
        70,
        new BlockKey(ReactorBlocks.MATS.getBlockInstance(), MatBlocks.CONCRETE.ordinal())
    ),
    WATER(
    ...
    BLASTGLASS(
        "Blast Glass", 80, 20, new BlockKey(BlockRegistry.BLASTGLASS.getBlockInstance())
    );
    ...
    public static String getDataAsString() {
        ...
        for (int i = 0; i < shieldList.length; i++) {
            ...
            sb.append(
                type.displayName + ": " + type.neutronAbsorbChance
                + "% neutron absorption, " + type.radiationDeflectChance
